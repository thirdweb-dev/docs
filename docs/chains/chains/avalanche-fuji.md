...
# Building contracts and apps on Avalanche Fuji Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Avalanche Fuji Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Avalanche Fuji Testnet. If you want to check details such as RPCs for Avalanche Fuji Testnet, check out our [chainlist page for Avalanche Fuji Testnet](https://thirdweb.com/avalanche-fuji).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Avalanche Fuji Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Avalanche Fuji Testnet as the network
...
### Initialize SDK On Avalanche Fuji Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Avalanche Fuji Testnet
