...
# Building contracts and apps on Teslafunds

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Teslafunds. By the end of the guide, you should be able to create smart contracts and dApps on Teslafunds. If you want to check details such as RPCs for Teslafunds, check out our [chainlist page for Teslafunds](https://thirdweb.com/teslafunds).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Teslafunds using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Teslafunds as the network
...
### Initialize SDK On Teslafunds

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Teslafunds

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Teslafunds } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Teslafunds}>
      <YourApp />
    </ThirdwebProvider>
  );
};
