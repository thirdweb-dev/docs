...
# Building contracts and apps on OHO Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OHO Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on OHO Mainnet. If you want to check details such as RPCs for OHO Mainnet, check out our [chainlist page for OHO Mainnet](https://thirdweb.com/oho).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OHO Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OHO Mainnet as the network
...
### Initialize SDK On OHO Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OHO Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Oho } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Oho}>
      <YourApp />
    </ThirdwebProvider>
  );
};
