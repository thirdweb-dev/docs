...
# Building contracts and apps on Stratos Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Stratos Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Stratos Mainnet. If you want to check details such as RPCs for Stratos Mainnet, check out our [chainlist page for Stratos Mainnet](https://thirdweb.com/stratos).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Stratos Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Stratos Mainnet as the network
...
### Initialize SDK On Stratos Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Stratos Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Stratos } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Stratos}>
      <YourApp />
    </ThirdwebProvider>
  );
};
