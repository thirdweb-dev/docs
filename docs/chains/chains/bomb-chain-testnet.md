...
# Building contracts and apps on BOMB Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BOMB Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on BOMB Chain Testnet. If you want to check details such as RPCs for BOMB Chain Testnet, check out our [chainlist page for BOMB Chain Testnet](https://thirdweb.com/bomb-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BOMB Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BOMB Chain Testnet as the network
...
### Initialize SDK On BOMB Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BOMB Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BombChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BombChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
