...
# Building contracts and apps on Mix

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Mix. By the end of the guide, you should be able to create smart contracts and dApps on Mix. If you want to check details such as RPCs for Mix, check out our [chainlist page for Mix](https://thirdweb.com/mix).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Mix using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Mix

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Mix

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Mix } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Mix}>
      <YourApp />
    </ThirdwebProvider>
  );
};
