...
# Building contracts and apps on OpenVessel

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OpenVessel. By the end of the guide, you should be able to create smart contracts and dApps on OpenVessel. If you want to check details such as RPCs for OpenVessel, check out our [chainlist page for OpenVessel](https://thirdweb.com/openvessel).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OpenVessel using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OpenVessel as the network
...
### Initialize SDK On OpenVessel

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OpenVessel

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Openvessel } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Openvessel}>
      <YourApp />
    </ThirdwebProvider>
  );
};
