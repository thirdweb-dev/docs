...
# Building contracts and apps on Coinbit Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Coinbit Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Coinbit Mainnet. If you want to check details such as RPCs for Coinbit Mainnet, check out our [chainlist page for Coinbit Mainnet](https://thirdweb.com/coinbit).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Coinbit Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Coinbit Mainnet as the network
...
### Initialize SDK On Coinbit Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Coinbit Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Coinbit } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Coinbit}>
      <YourApp />
    </ThirdwebProvider>
  );
};
