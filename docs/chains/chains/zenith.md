...
# Building contracts and apps on Zenith Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Zenith Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Zenith Mainnet. If you want to check details such as RPCs for Zenith Mainnet, check out our [chainlist page for Zenith Mainnet](https://thirdweb.com/zenith).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Zenith Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Zenith Mainnet as the network
...
### Initialize SDK On Zenith Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Zenith Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Zenith } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Zenith}>
      <YourApp />
    </ThirdwebProvider>
  );
};
