...
# Building contracts and apps on PandoProject Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PandoProject Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on PandoProject Mainnet. If you want to check details such as RPCs for PandoProject Mainnet, check out our [chainlist page for PandoProject Mainnet](https://thirdweb.com/pandoproject).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PandoProject Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PandoProject Mainnet as the network
...
### Initialize SDK On PandoProject Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PandoProject Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Pandoproject } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Pandoproject}>
      <YourApp />
    </ThirdwebProvider>
  );
};
