...
# Building contracts and apps on Athereum

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Athereum. By the end of the guide, you should be able to create smart contracts and dApps on Athereum. If you want to check details such as RPCs for Athereum, check out our [chainlist page for Athereum](https://thirdweb.com/athereum).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Athereum using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Athereum as the network
...
### Initialize SDK On Athereum

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Athereum

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Athereum } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Athereum}>
      <YourApp />
    </ThirdwebProvider>
  );
};
