...
# Building contracts and apps on High Performance Blockchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on High Performance Blockchain. By the end of the guide, you should be able to create smart contracts and dApps on High Performance Blockchain. If you want to check details such as RPCs for High Performance Blockchain, check out our [chainlist page for High Performance Blockchain](https://thirdweb.com/high-performance-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to High Performance Blockchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select High Performance Blockchain as the network
...
### Initialize SDK On High Performance Blockchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to High Performance Blockchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HighPerformanceBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HighPerformanceBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
