---
title: Ethereum Classic Testnet Morden
slug: /ethereum-classic-testnet-morden
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Ethereum Classic Testnet Morden

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ethereum Classic Testnet Morden. By the end of the guide, you should be able to create smart contracts and dApps on Ethereum Classic Testnet Morden. If you want to check details such as RPCs for Ethereum Classic Testnet Morden, check out our [chainlist page for Ethereum Classic Testnet Morden](https://thirdweb.com/ethereum-classic-testnet-morden).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ethereum Classic Testnet Morden using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ethereum Classic Testnet Morden as the network
...
### Initialize SDK On Ethereum Classic Testnet Morden

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ethereum Classic Testnet Morden
