...
# Building contracts and apps on ELA-DID-Sidechain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ELA-DID-Sidechain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on ELA-DID-Sidechain Testnet. If you want to check details such as RPCs for ELA-DID-Sidechain Testnet, check out our [chainlist page for ELA-DID-Sidechain Testnet](https://thirdweb.com/ela-did-sidechain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ELA-DID-Sidechain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ELA-DID-Sidechain Testnet as the network
...
### Initialize SDK On ELA-DID-Sidechain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ELA-DID-Sidechain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ElaDidSidechainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ElaDidSidechainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
