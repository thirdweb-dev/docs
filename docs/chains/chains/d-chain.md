...
# Building contracts and apps on D-Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on D-Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on D-Chain Mainnet. If you want to check details such as RPCs for D-Chain Mainnet, check out our [chainlist page for D-Chain Mainnet](https://thirdweb.com/d-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to D-Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select D-Chain Mainnet as the network
...
### Initialize SDK On D-Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to D-Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
