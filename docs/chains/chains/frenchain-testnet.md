---
title: Frenchain Testnet
slug: /frenchain-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Frenchain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Frenchain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Frenchain Testnet. If you want to check details such as RPCs for Frenchain Testnet, check out our [chainlist page for Frenchain Testnet](https://thirdweb.com/frenchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Frenchain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Frenchain Testnet as the network
...
### Initialize SDK On Frenchain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Frenchain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FrenchainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FrenchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
