...
# Building contracts and apps on Telos EVM Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Telos EVM Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Telos EVM Testnet. If you want to check details such as RPCs for Telos EVM Testnet, check out our [chainlist page for Telos EVM Testnet](https://thirdweb.com/telos-evm-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Telos EVM Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Telos EVM Testnet as the network
...
### Initialize SDK On Telos EVM Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Telos EVM Testnet
