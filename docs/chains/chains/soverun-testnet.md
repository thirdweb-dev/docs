---
title: Soverun Testnet
slug: /soverun-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Soverun Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Soverun Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Soverun Testnet. If you want to check details such as RPCs for Soverun Testnet, check out our [chainlist page for Soverun Testnet](https://thirdweb.com/soverun-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Soverun Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Soverun Testnet as the network
...
### Initialize SDK On Soverun Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Soverun Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SoverunTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SoverunTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
