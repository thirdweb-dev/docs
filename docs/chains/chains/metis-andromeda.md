...
# Building contracts and apps on Metis Andromeda Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Metis Andromeda Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Metis Andromeda Mainnet. If you want to check details such as RPCs for Metis Andromeda Mainnet, check out our [chainlist page for Metis Andromeda Mainnet](https://thirdweb.com/metis-andromeda).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Metis Andromeda Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Metis Andromeda Mainnet as the network
...
### Initialize SDK On Metis Andromeda Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Metis Andromeda Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MetisAndromeda } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MetisAndromeda}>
      <YourApp />
    </ThirdwebProvider>
  );
};
