...
# Building contracts and apps on DoKEN Super Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DoKEN Super Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on DoKEN Super Chain Mainnet. If you want to check details such as RPCs for DoKEN Super Chain Mainnet, check out our [chainlist page for DoKEN Super Chain Mainnet](https://thirdweb.com/doken-super-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DoKEN Super Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DoKEN Super Chain Mainnet as the network
...
### Initialize SDK On DoKEN Super Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DoKEN Super Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DokenSuperChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DokenSuperChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
