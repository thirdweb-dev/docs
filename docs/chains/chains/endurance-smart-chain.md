...
# Building contracts and apps on Endurance Smart Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Endurance Smart Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Endurance Smart Chain Mainnet. If you want to check details such as RPCs for Endurance Smart Chain Mainnet, check out our [chainlist page for Endurance Smart Chain Mainnet](https://thirdweb.com/endurance-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Endurance Smart Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Endurance Smart Chain Mainnet as the network
...
### Initialize SDK On Endurance Smart Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Endurance Smart Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EnduranceSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EnduranceSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
