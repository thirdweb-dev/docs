...
5. After modifying your contract with your desired custom logic, you may deploy it to Posichain Devnet Shard 1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Posichain Devnet Shard 1 as the network
...
### Initialize SDK On Posichain Devnet Shard 1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Posichain Devnet Shard 1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PosichainDevnetShard1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PosichainDevnetShard1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
