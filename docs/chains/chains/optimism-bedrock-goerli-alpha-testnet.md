...
# Building contracts and apps on Optimism Bedrock (Goerli Alpha Testnet)

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Optimism Bedrock (Goerli Alpha Testnet). By the end of the guide, you should be able to create smart contracts and dApps on Optimism Bedrock (Goerli Alpha Testnet). If you want to check details such as RPCs for Optimism Bedrock (Goerli Alpha Testnet), check out our [chainlist page for Optimism Bedrock (Goerli Alpha Testnet)](https://thirdweb.com/optimism-bedrock-goerli-alpha-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Optimism Bedrock (Goerli Alpha Testnet) using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Optimism Bedrock (Goerli Alpha Testnet) as the network
...
### Initialize SDK On Optimism Bedrock (Goerli Alpha Testnet)

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Optimism Bedrock (Goerli Alpha Testnet)

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OptimismBedrockGoerliAlphaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OptimismBedrockGoerliAlphaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
