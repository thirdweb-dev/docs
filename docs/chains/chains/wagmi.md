...
# Building contracts and apps on WAGMI

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on WAGMI. By the end of the guide, you should be able to create smart contracts and dApps on WAGMI. If you want to check details such as RPCs for WAGMI, check out our [chainlist page for WAGMI](https://thirdweb.com/wagmi).
...
5. After modifying your contract with your desired custom logic, you may deploy it to WAGMI using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On WAGMI

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to WAGMI

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Wagmi } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Wagmi}>
      <YourApp />
    </ThirdwebProvider>
  );
};
