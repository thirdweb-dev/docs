...
# Building contracts and apps on Vision - Vpioneer Test Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Vision - Vpioneer Test Chain. By the end of the guide, you should be able to create smart contracts and dApps on Vision - Vpioneer Test Chain. If you want to check details such as RPCs for Vision - Vpioneer Test Chain, check out our [chainlist page for Vision - Vpioneer Test Chain](https://thirdweb.com/vision-vpioneer-test-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Vision - Vpioneer Test Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Vision - Vpioneer Test Chain as the network
...
### Initialize SDK On Vision - Vpioneer Test Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Vision - Vpioneer Test Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { VisionVpioneerTestChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={VisionVpioneerTestChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
