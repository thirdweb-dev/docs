...
# Building contracts and apps on ARC Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ARC Testnet. By the end of the guide, you should be able to create smart contracts and dApps on ARC Testnet. If you want to check details such as RPCs for ARC Testnet, check out our [chainlist page for ARC Testnet](https://thirdweb.com/arc-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ARC Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On ARC Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ARC Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={ArcTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
