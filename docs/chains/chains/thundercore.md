...
# Building contracts and apps on ThunderCore Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ThunderCore Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on ThunderCore Mainnet. If you want to check details such as RPCs for ThunderCore Mainnet, check out our [chainlist page for ThunderCore Mainnet](https://thirdweb.com/thundercore).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ThunderCore Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ThunderCore Mainnet as the network
...
### Initialize SDK On ThunderCore Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ThunderCore Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Thundercore } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Thundercore}>
      <YourApp />
    </ThirdwebProvider>
  );
};
