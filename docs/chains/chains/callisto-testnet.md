...
# Building contracts and apps on Callisto Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Callisto Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Callisto Testnet. If you want to check details such as RPCs for Callisto Testnet, check out our [chainlist page for Callisto Testnet](https://thirdweb.com/callisto-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Callisto Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Callisto Testnet as the network
...
### Initialize SDK On Callisto Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Callisto Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CallistoTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CallistoTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
