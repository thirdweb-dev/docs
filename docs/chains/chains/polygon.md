...
# Building contracts and apps on Polygon Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Polygon Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Polygon Mainnet. If you want to check details such as RPCs for Polygon Mainnet, check out our [chainlist page for Polygon Mainnet](https://thirdweb.com/polygon).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Polygon Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Polygon Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Polygon Mainnet
