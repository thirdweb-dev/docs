---
title: SeedCoin-Network
slug: /seedcoin-network
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on SeedCoin-Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SeedCoin-Network. By the end of the guide, you should be able to create smart contracts and dApps on SeedCoin-Network. If you want to check details such as RPCs for SeedCoin-Network, check out our [chainlist page for SeedCoin-Network](https://thirdweb.com/seedcoin-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SeedCoin-Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SeedCoin-Network as the network
...
### Initialize SDK On SeedCoin-Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SeedCoin-Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SeedcoinNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SeedcoinNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
