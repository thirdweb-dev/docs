...
# Building contracts and apps on QEasyWeb3 Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on QEasyWeb3 Testnet. By the end of the guide, you should be able to create smart contracts and dApps on QEasyWeb3 Testnet. If you want to check details such as RPCs for QEasyWeb3 Testnet, check out our [chainlist page for QEasyWeb3 Testnet](https://thirdweb.com/qeasyweb3-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to QEasyWeb3 Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select QEasyWeb3 Testnet as the network
...
### Initialize SDK On QEasyWeb3 Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to QEasyWeb3 Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Qeasyweb3Testnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Qeasyweb3Testnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
