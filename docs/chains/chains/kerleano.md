...
# Building contracts and apps on Kerleano

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Kerleano. By the end of the guide, you should be able to create smart contracts and dApps on Kerleano. If you want to check details such as RPCs for Kerleano, check out our [chainlist page for Kerleano](https://thirdweb.com/kerleano).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Kerleano using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Kerleano as the network
...
### Initialize SDK On Kerleano

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Kerleano

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Kerleano } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Kerleano}>
      <YourApp />
    </ThirdwebProvider>
  );
};
