...
# Building contracts and apps on Armonia Eva Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Armonia Eva Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Armonia Eva Chain Testnet. If you want to check details such as RPCs for Armonia Eva Chain Testnet, check out our [chainlist page for Armonia Eva Chain Testnet](https://thirdweb.com/armonia-eva-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Armonia Eva Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Armonia Eva Chain Testnet as the network
...
### Initialize SDK On Armonia Eva Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Armonia Eva Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ArmoniaEvaChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ArmoniaEvaChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
