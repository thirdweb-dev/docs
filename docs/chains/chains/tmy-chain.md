...
# Building contracts and apps on TMY Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on TMY Chain. By the end of the guide, you should be able to create smart contracts and dApps on TMY Chain. If you want to check details such as RPCs for TMY Chain, check out our [chainlist page for TMY Chain](https://thirdweb.com/tmy-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to TMY Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select TMY Chain as the network
...
### Initialize SDK On TMY Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to TMY Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TmyChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TmyChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
