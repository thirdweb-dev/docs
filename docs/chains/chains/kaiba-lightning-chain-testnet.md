...
# Building contracts and apps on Kaiba Lightning Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Kaiba Lightning Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Kaiba Lightning Chain Testnet. If you want to check details such as RPCs for Kaiba Lightning Chain Testnet, check out our [chainlist page for Kaiba Lightning Chain Testnet](https://thirdweb.com/kaiba-lightning-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Kaiba Lightning Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Kaiba Lightning Chain Testnet as the network
...
### Initialize SDK On Kaiba Lightning Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Kaiba Lightning Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { KaibaLightningChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={KaibaLightningChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
