...
# Building contracts and apps on Realchain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Realchain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Realchain Mainnet. If you want to check details such as RPCs for Realchain Mainnet, check out our [chainlist page for Realchain Mainnet](https://thirdweb.com/realchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Realchain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Realchain Mainnet as the network
...
### Initialize SDK On Realchain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Realchain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Realchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Realchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
