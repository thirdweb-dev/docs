...
# Building contracts and apps on Taycan

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Taycan. By the end of the guide, you should be able to create smart contracts and dApps on Taycan. If you want to check details such as RPCs for Taycan, check out our [chainlist page for Taycan](https://thirdweb.com/taycan).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Taycan using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Taycan as the network
...
### Initialize SDK On Taycan

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Taycan

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Taycan } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Taycan}>
      <YourApp />
    </ThirdwebProvider>
  );
};
