...
# Building contracts and apps on ThaiChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ThaiChain. By the end of the guide, you should be able to create smart contracts and dApps on ThaiChain. If you want to check details such as RPCs for ThaiChain, check out our [chainlist page for ThaiChain](https://thirdweb.com/thaichain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ThaiChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ThaiChain as the network
...
### Initialize SDK On ThaiChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ThaiChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Thaichain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Thaichain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
