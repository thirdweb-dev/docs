...
# Building contracts and apps on Beresheet BereEVM Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Beresheet BereEVM Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Beresheet BereEVM Testnet. If you want to check details such as RPCs for Beresheet BereEVM Testnet, check out our [chainlist page for Beresheet BereEVM Testnet](https://thirdweb.com/beresheet-bereevm-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Beresheet BereEVM Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Beresheet BereEVM Testnet as the network
...
### Initialize SDK On Beresheet BereEVM Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Beresheet BereEVM Testnet
