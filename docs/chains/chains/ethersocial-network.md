...
# Building contracts and apps on Ethersocial Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ethersocial Network. By the end of the guide, you should be able to create smart contracts and dApps on Ethersocial Network. If you want to check details such as RPCs for Ethersocial Network, check out our [chainlist page for Ethersocial Network](https://thirdweb.com/ethersocial-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ethersocial Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ethersocial Network as the network
...
### Initialize SDK On Ethersocial Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ethersocial Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EthersocialNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EthersocialNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
