...
# Building contracts and apps on Posichain Mainnet Shard 0

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Posichain Mainnet Shard 0. By the end of the guide, you should be able to create smart contracts and dApps on Posichain Mainnet Shard 0. If you want to check details such as RPCs for Posichain Mainnet Shard 0, check out our [chainlist page for Posichain Mainnet Shard 0](https://thirdweb.com/posichain-shard-0).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Posichain Mainnet Shard 0 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Posichain Mainnet Shard 0 as the network
...
### Initialize SDK On Posichain Mainnet Shard 0

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Posichain Mainnet Shard 0
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={PosichainShard0}>
      <YourApp />
    </ThirdwebProvider>
  );
};
