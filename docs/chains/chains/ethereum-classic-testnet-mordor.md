---
title: Ethereum Classic Testnet Mordor
slug: /ethereum-classic-testnet-mordor
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Ethereum Classic Testnet Mordor

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ethereum Classic Testnet Mordor. By the end of the guide, you should be able to create smart contracts and dApps on Ethereum Classic Testnet Mordor. If you want to check details such as RPCs for Ethereum Classic Testnet Mordor, check out our [chainlist page for Ethereum Classic Testnet Mordor](https://thirdweb.com/ethereum-classic-testnet-mordor).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ethereum Classic Testnet Mordor using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ethereum Classic Testnet Mordor as the network
...
### Initialize SDK On Ethereum Classic Testnet Mordor

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ethereum Classic Testnet Mordor

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EthereumClassicTestnetMordor } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EthereumClassicTestnetMordor}>
      <YourApp />
    </ThirdwebProvider>
  );
};
