...
# Building contracts and apps on GTON Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on GTON Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on GTON Mainnet. If you want to check details such as RPCs for GTON Mainnet, check out our [chainlist page for GTON Mainnet](https://thirdweb.com/gton).
...
5. After modifying your contract with your desired custom logic, you may deploy it to GTON Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select GTON Mainnet as the network
...
### Initialize SDK On GTON Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to GTON Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Gton } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Gton}>
      <YourApp />
    </ThirdwebProvider>
  );
};
