...
# Building contracts and apps on IRIShub

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on IRIShub. By the end of the guide, you should be able to create smart contracts and dApps on IRIShub. If you want to check details such as RPCs for IRIShub, check out our [chainlist page for IRIShub](https://thirdweb.com/irishub).
...
5. After modifying your contract with your desired custom logic, you may deploy it to IRIShub using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select IRIShub as the network
...
### Initialize SDK On IRIShub

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to IRIShub

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Irishub } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Irishub}>
      <YourApp />
    </ThirdwebProvider>
  );
};
