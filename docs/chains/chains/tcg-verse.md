...
# Building contracts and apps on TCG Verse Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on TCG Verse Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on TCG Verse Mainnet. If you want to check details such as RPCs for TCG Verse Mainnet, check out our [chainlist page for TCG Verse Mainnet](https://thirdweb.com/tcg-verse).
...
5. After modifying your contract with your desired custom logic, you may deploy it to TCG Verse Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select TCG Verse Mainnet as the network
...
### Initialize SDK On TCG Verse Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to TCG Verse Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TcgVerse } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TcgVerse}>
      <YourApp />
    </ThirdwebProvider>
  );
};
