...
# Building contracts and apps on ARTIS sigma1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ARTIS sigma1. By the end of the guide, you should be able to create smart contracts and dApps on ARTIS sigma1. If you want to check details such as RPCs for ARTIS sigma1, check out our [chainlist page for ARTIS sigma1](https://thirdweb.com/artis-sigma1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ARTIS sigma1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ARTIS sigma1 as the network
...
### Initialize SDK On ARTIS sigma1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ARTIS sigma1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ArtisSigma1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ArtisSigma1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
