...
# Building contracts and apps on Imversed Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Imversed Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Imversed Testnet. If you want to check details such as RPCs for Imversed Testnet, check out our [chainlist page for Imversed Testnet](https://thirdweb.com/imversed-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Imversed Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Imversed Testnet as the network
...
### Initialize SDK On Imversed Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Imversed Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ImversedTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ImversedTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
