...
# Building contracts and apps on Mizana Privnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Mizana Privnet. By the end of the guide, you should be able to create smart contracts and dApps on Mizana Privnet. If you want to check details such as RPCs for Mizana Privnet, check out our [chainlist page for Mizana Privnet](https://thirdweb.com/mizana-privnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Mizana Privnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Mizana Privnet as the network
...
### Initialize SDK On Mizana Privnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Mizana Privnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MizanaPrivnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MizanaPrivnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
