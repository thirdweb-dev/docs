...
# Building contracts and apps on Debounce Subnet Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Debounce Subnet Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Debounce Subnet Testnet. If you want to check details such as RPCs for Debounce Subnet Testnet, check out our [chainlist page for Debounce Subnet Testnet](https://thirdweb.com/debounce-subnet-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Debounce Subnet Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Debounce Subnet Testnet as the network
...
### Initialize SDK On Debounce Subnet Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Debounce Subnet Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DebounceSubnetTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DebounceSubnetTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
