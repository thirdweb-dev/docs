...
# Building contracts and apps on Phoenix Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Phoenix Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Phoenix Mainnet. If you want to check details such as RPCs for Phoenix Mainnet, check out our [chainlist page for Phoenix Mainnet](https://thirdweb.com/phoenix).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Phoenix Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Phoenix Mainnet as the network
...
### Initialize SDK On Phoenix Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Phoenix Mainnet
