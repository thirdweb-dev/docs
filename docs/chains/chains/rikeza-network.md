...
# Building contracts and apps on Rikeza Network Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rikeza Network Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Rikeza Network Mainnet. If you want to check details such as RPCs for Rikeza Network Mainnet, check out our [chainlist page for Rikeza Network Mainnet](https://thirdweb.com/rikeza-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rikeza Network Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rikeza Network Mainnet as the network
...
### Initialize SDK On Rikeza Network Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rikeza Network Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { RikezaNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={RikezaNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
