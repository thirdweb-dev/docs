...
# Building contracts and apps on Rinia Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rinia Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Rinia Testnet. If you want to check details such as RPCs for Rinia Testnet, check out our [chainlist page for Rinia Testnet](https://thirdweb.com/rinia-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rinia Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rinia Testnet as the network
...
### Initialize SDK On Rinia Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rinia Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { RiniaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={RiniaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
