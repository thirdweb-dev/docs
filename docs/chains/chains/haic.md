...
# Building contracts and apps on Haic

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Haic. By the end of the guide, you should be able to create smart contracts and dApps on Haic. If you want to check details such as RPCs for Haic, check out our [chainlist page for Haic](https://thirdweb.com/haic).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Haic using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Haic

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Haic

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Haic } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Haic}>
      <YourApp />
    </ThirdwebProvider>
  );
};
