...
# Building contracts and apps on Double-A Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Double-A Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Double-A Chain Mainnet. If you want to check details such as RPCs for Double-A Chain Mainnet, check out our [chainlist page for Double-A Chain Mainnet](https://thirdweb.com/double-a-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Double-A Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Double-A Chain Mainnet as the network
...
### Initialize SDK On Double-A Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Double-A Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DoubleAChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DoubleAChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
