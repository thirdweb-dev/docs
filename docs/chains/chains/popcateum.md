...
# Building contracts and apps on Popcateum Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Popcateum Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Popcateum Mainnet. If you want to check details such as RPCs for Popcateum Mainnet, check out our [chainlist page for Popcateum Mainnet](https://thirdweb.com/popcateum).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Popcateum Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Popcateum Mainnet as the network
...
### Initialize SDK On Popcateum Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Popcateum Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Popcateum } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Popcateum}>
      <YourApp />
    </ThirdwebProvider>
  );
};
