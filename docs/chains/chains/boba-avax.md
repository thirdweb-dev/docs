...
# Building contracts and apps on Boba Avax

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Boba Avax. By the end of the guide, you should be able to create smart contracts and dApps on Boba Avax. If you want to check details such as RPCs for Boba Avax, check out our [chainlist page for Boba Avax](https://thirdweb.com/boba-avax).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Boba Avax using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Boba Avax as the network
...
### Initialize SDK On Boba Avax

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Boba Avax

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BobaAvax } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BobaAvax}>
      <YourApp />
    </ThirdwebProvider>
  );
};
