...
# Building contracts and apps on Quadrans Blockchain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Quadrans Blockchain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Quadrans Blockchain Testnet. If you want to check details such as RPCs for Quadrans Blockchain Testnet, check out our [chainlist page for Quadrans Blockchain Testnet](https://thirdweb.com/quadrans-blockchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Quadrans Blockchain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Quadrans Blockchain Testnet as the network
...
### Initialize SDK On Quadrans Blockchain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Quadrans Blockchain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { QuadransBlockchainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={QuadransBlockchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
