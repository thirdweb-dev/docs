...
# Building contracts and apps on Base

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Base. By the end of the guide, you should be able to create smart contracts and dApps on Base. If you want to check details such as RPCs for Base, check out our [chainlist page for Base](https://thirdweb.com/base).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Base using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Base

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Base
