...
# Building contracts and apps on JFIN Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on JFIN Chain. By the end of the guide, you should be able to create smart contracts and dApps on JFIN Chain. If you want to check details such as RPCs for JFIN Chain, check out our [chainlist page for JFIN Chain](https://thirdweb.com/jfin-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to JFIN Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select JFIN Chain as the network
...
### Initialize SDK On JFIN Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to JFIN Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { JfinChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={JfinChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
