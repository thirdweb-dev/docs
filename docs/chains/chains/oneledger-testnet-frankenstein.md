...
# Building contracts and apps on OneLedger Testnet Frankenstein

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OneLedger Testnet Frankenstein. By the end of the guide, you should be able to create smart contracts and dApps on OneLedger Testnet Frankenstein. If you want to check details such as RPCs for OneLedger Testnet Frankenstein, check out our [chainlist page for OneLedger Testnet Frankenstein](https://thirdweb.com/oneledger-testnet-frankenstein).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OneLedger Testnet Frankenstein using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OneLedger Testnet Frankenstein as the network
...
### Initialize SDK On OneLedger Testnet Frankenstein

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OneLedger Testnet Frankenstein

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OneledgerTestnetFrankenstein } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OneledgerTestnetFrankenstein}>
      <YourApp />
    </ThirdwebProvider>
  );
};
