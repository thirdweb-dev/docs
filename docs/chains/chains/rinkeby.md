...
# Building contracts and apps on Rinkeby

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rinkeby. By the end of the guide, you should be able to create smart contracts and dApps on Rinkeby. If you want to check details such as RPCs for Rinkeby, check out our [chainlist page for Rinkeby](https://thirdweb.com/rinkeby).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rinkeby using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rinkeby as the network
...
### Initialize SDK On Rinkeby

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rinkeby
