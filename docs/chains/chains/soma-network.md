...
# Building contracts and apps on SOMA Network Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SOMA Network Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on SOMA Network Mainnet. If you want to check details such as RPCs for SOMA Network Mainnet, check out our [chainlist page for SOMA Network Mainnet](https://thirdweb.com/soma-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SOMA Network Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SOMA Network Mainnet as the network
...
### Initialize SDK On SOMA Network Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SOMA Network Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SomaNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SomaNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
