...
# Building contracts and apps on Weelink Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Weelink Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Weelink Testnet. If you want to check details such as RPCs for Weelink Testnet, check out our [chainlist page for Weelink Testnet](https://thirdweb.com/weelink-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Weelink Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Weelink Testnet as the network
...
### Initialize SDK On Weelink Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Weelink Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { WeelinkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={WeelinkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
