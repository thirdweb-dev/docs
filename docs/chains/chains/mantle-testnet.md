...
# Building contracts and apps on Mantle Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Mantle Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Mantle Testnet. If you want to check details such as RPCs for Mantle Testnet, check out our [chainlist page for Mantle Testnet](https://thirdweb.com/mantle-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Mantle Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Mantle Testnet as the network
...
### Initialize SDK On Mantle Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Mantle Testnet
