...
# Building contracts and apps on Ethereum Classic Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ethereum Classic Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Ethereum Classic Mainnet. If you want to check details such as RPCs for Ethereum Classic Mainnet, check out our [chainlist page for Ethereum Classic Mainnet](https://thirdweb.com/ethereum-classic).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ethereum Classic Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ethereum Classic Mainnet as the network
...
### Initialize SDK On Ethereum Classic Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ethereum Classic Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EthereumClassic } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EthereumClassic}>
      <YourApp />
    </ThirdwebProvider>
  );
};
