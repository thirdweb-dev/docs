...
# Building contracts and apps on Oasis Emerald Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oasis Emerald Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Oasis Emerald Testnet. If you want to check details such as RPCs for Oasis Emerald Testnet, check out our [chainlist page for Oasis Emerald Testnet](https://thirdweb.com/oasis-emerald-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oasis Emerald Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oasis Emerald Testnet as the network
...
### Initialize SDK On Oasis Emerald Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oasis Emerald Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OasisEmeraldTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OasisEmeraldTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
