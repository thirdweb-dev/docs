...
# Building contracts and apps on Moonbase Alpha

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Moonbase Alpha. By the end of the guide, you should be able to create smart contracts and dApps on Moonbase Alpha. If you want to check details such as RPCs for Moonbase Alpha, check out our [chainlist page for Moonbase Alpha](https://thirdweb.com/moonbase-alpha).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Moonbase Alpha using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Moonbase Alpha as the network
...
### Initialize SDK On Moonbase Alpha

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Moonbase Alpha
