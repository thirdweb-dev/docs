...
# Building contracts and apps on Bitgert Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bitgert Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Bitgert Mainnet. If you want to check details such as RPCs for Bitgert Mainnet, check out our [chainlist page for Bitgert Mainnet](https://thirdweb.com/bitgert).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bitgert Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bitgert Mainnet as the network
...
### Initialize SDK On Bitgert Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bitgert Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bitgert } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bitgert}>
      <YourApp />
    </ThirdwebProvider>
  );
};
