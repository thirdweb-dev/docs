...
# Building contracts and apps on Tres Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Tres Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Tres Mainnet. If you want to check details such as RPCs for Tres Mainnet, check out our [chainlist page for Tres Mainnet](https://thirdweb.com/tres).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Tres Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Tres Mainnet as the network
...
### Initialize SDK On Tres Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Tres Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Tres } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Tres}>
      <YourApp />
    </ThirdwebProvider>
  );
};
