...
# Building contracts and apps on ShimmerEVM Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ShimmerEVM Testnet. By the end of the guide, you should be able to create smart contracts and dApps on ShimmerEVM Testnet. If you want to check details such as RPCs for ShimmerEVM Testnet, check out our [chainlist page for ShimmerEVM Testnet](https://thirdweb.com/shimmerevm-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ShimmerEVM Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ShimmerEVM Testnet as the network
...
### Initialize SDK On ShimmerEVM Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ShimmerEVM Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ShimmerevmTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ShimmerevmTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
