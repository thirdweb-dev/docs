...
# Building contracts and apps on zkSync Era Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on zkSync Era Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on zkSync Era Mainnet. If you want to check details such as RPCs for zkSync Era Mainnet, check out our [chainlist page for zkSync Era Mainnet](https://thirdweb.com/zksync-era).
...
5. After modifying your contract with your desired custom logic, you may deploy it to zkSync Era Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select zkSync Era Mainnet as the network
...
### Initialize SDK On zkSync Era Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to zkSync Era Mainnet
