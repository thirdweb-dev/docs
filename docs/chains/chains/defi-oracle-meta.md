...
# Building contracts and apps on Defi Oracle Meta Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Defi Oracle Meta Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Defi Oracle Meta Mainnet. If you want to check details such as RPCs for Defi Oracle Meta Mainnet, check out our [chainlist page for Defi Oracle Meta Mainnet](https://thirdweb.com/defi-oracle-meta).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Defi Oracle Meta Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Defi Oracle Meta Mainnet as the network
...
### Initialize SDK On Defi Oracle Meta Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Defi Oracle Meta Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DefiOracleMeta } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DefiOracleMeta}>
      <YourApp />
    </ThirdwebProvider>
  );
};
