...
# Building contracts and apps on Linea Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Linea Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Linea Testnet. If you want to check details such as RPCs for Linea Testnet, check out our [chainlist page for Linea Testnet](https://thirdweb.com/linea-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Linea Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Linea Testnet as the network
...
### Initialize SDK On Linea Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Linea Testnet
