...
# Building contracts and apps on BeanEco SmartChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BeanEco SmartChain. By the end of the guide, you should be able to create smart contracts and dApps on BeanEco SmartChain. If you want to check details such as RPCs for BeanEco SmartChain, check out our [chainlist page for BeanEco SmartChain](https://thirdweb.com/beaneco-smartchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BeanEco SmartChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BeanEco SmartChain as the network
...
### Initialize SDK On BeanEco SmartChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BeanEco SmartChain
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={BeanecoSmartchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
