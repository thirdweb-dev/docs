...
# Building contracts and apps on Oone Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oone Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Oone Chain Testnet. If you want to check details such as RPCs for Oone Chain Testnet, check out our [chainlist page for Oone Chain Testnet](https://thirdweb.com/oone-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oone Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oone Chain Testnet as the network
...
### Initialize SDK On Oone Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oone Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OoneChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OoneChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
