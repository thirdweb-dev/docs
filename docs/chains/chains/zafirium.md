...
# Building contracts and apps on Zafirium Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Zafirium Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Zafirium Mainnet. If you want to check details such as RPCs for Zafirium Mainnet, check out our [chainlist page for Zafirium Mainnet](https://thirdweb.com/zafirium).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Zafirium Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Zafirium Mainnet as the network
...
### Initialize SDK On Zafirium Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Zafirium Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Zafirium } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Zafirium}>
      <YourApp />
    </ThirdwebProvider>
  );
};
