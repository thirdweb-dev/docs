...
# Building contracts and apps on Decentralized Web Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Decentralized Web Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Decentralized Web Mainnet. If you want to check details such as RPCs for Decentralized Web Mainnet, check out our [chainlist page for Decentralized Web Mainnet](https://thirdweb.com/decentralized-web).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Decentralized Web Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Decentralized Web Mainnet as the network
...
### Initialize SDK On Decentralized Web Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Decentralized Web Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DecentralizedWeb } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DecentralizedWeb}>
      <YourApp />
    </ThirdwebProvider>
  );
};
