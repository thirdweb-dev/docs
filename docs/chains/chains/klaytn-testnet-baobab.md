...
# Building contracts and apps on Klaytn Testnet Baobab

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Klaytn Testnet Baobab. By the end of the guide, you should be able to create smart contracts and dApps on Klaytn Testnet Baobab. If you want to check details such as RPCs for Klaytn Testnet Baobab, check out our [chainlist page for Klaytn Testnet Baobab](https://thirdweb.com/klaytn-testnet-baobab).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Klaytn Testnet Baobab using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Klaytn Testnet Baobab as the network
...
### Initialize SDK On Klaytn Testnet Baobab

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Klaytn Testnet Baobab
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={KlaytnTestnetBaobab}>
      <YourApp />
    </ThirdwebProvider>
  );
};
