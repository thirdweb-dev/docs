...
# Building contracts and apps on Autonity Piccadilly (Thames) Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Autonity Piccadilly (Thames) Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Autonity Piccadilly (Thames) Testnet. If you want to check details such as RPCs for Autonity Piccadilly (Thames) Testnet, check out our [chainlist page for Autonity Piccadilly (Thames) Testnet](https://thirdweb.com/autonity-piccadilly-thames-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Autonity Piccadilly (Thames) Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Autonity Piccadilly (Thames) Testnet as the network
...
### Initialize SDK On Autonity Piccadilly (Thames) Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Autonity Piccadilly (Thames) Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AutonityPiccadillyThamesTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AutonityPiccadillyThamesTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
