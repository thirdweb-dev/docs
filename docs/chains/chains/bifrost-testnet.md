...
# Building contracts and apps on Bifrost Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bifrost Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Bifrost Testnet. If you want to check details such as RPCs for Bifrost Testnet, check out our [chainlist page for Bifrost Testnet](https://thirdweb.com/bifrost-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bifrost Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bifrost Testnet as the network
...
### Initialize SDK On Bifrost Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bifrost Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BifrostTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BifrostTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
