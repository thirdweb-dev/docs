---
title: Acala Mandala Testnet
slug: /acala-mandala-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Acala Mandala Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Acala Mandala Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Acala Mandala Testnet. If you want to check details such as RPCs for Acala Mandala Testnet, check out our [chainlist page for Acala Mandala Testnet](https://thirdweb.com/acala-mandala-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Acala Mandala Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Acala Mandala Testnet as the network
...
### Initialize SDK On Acala Mandala Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Acala Mandala Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AcalaMandalaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AcalaMandalaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
