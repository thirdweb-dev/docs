...
# Building contracts and apps on Nexi Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Nexi Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Nexi Mainnet. If you want to check details such as RPCs for Nexi Mainnet, check out our [chainlist page for Nexi Mainnet](https://thirdweb.com/nexi).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Nexi Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Nexi Mainnet as the network
...
### Initialize SDK On Nexi Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Nexi Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Nexi } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Nexi}>
      <YourApp />
    </ThirdwebProvider>
  );
};
