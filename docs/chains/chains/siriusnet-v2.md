...
# Building contracts and apps on SiriusNet V2

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SiriusNet V2. By the end of the guide, you should be able to create smart contracts and dApps on SiriusNet V2. If you want to check details such as RPCs for SiriusNet V2, check out our [chainlist page for SiriusNet V2](https://thirdweb.com/siriusnet-v2).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SiriusNet V2 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SiriusNet V2 as the network
...
### Initialize SDK On SiriusNet V2

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SiriusNet V2

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SiriusnetV2 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SiriusnetV2}>
      <YourApp />
    </ThirdwebProvider>
  );
};
