...
# Building contracts and apps on Gather Mainnet Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Gather Mainnet Network. By the end of the guide, you should be able to create smart contracts and dApps on Gather Mainnet Network. If you want to check details such as RPCs for Gather Mainnet Network, check out our [chainlist page for Gather Mainnet Network](https://thirdweb.com/gather-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Gather Mainnet Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Gather Mainnet Network as the network
...
### Initialize SDK On Gather Mainnet Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Gather Mainnet Network
