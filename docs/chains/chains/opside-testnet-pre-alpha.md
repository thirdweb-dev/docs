---
title: Opside Testnet Pre-Alpha
slug: /opside-testnet-pre-alpha
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Opside Testnet Pre-Alpha

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Opside Testnet Pre-Alpha. By the end of the guide, you should be able to create smart contracts and dApps on Opside Testnet Pre-Alpha. If you want to check details such as RPCs for Opside Testnet Pre-Alpha, check out our [chainlist page for Opside Testnet Pre-Alpha](https://thirdweb.com/opside-testnet-pre-alpha).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Opside Testnet Pre-Alpha using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Opside Testnet Pre-Alpha as the network
...
### Initialize SDK On Opside Testnet Pre-Alpha

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Opside Testnet Pre-Alpha

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OpsideTestnetPreAlpha } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OpsideTestnetPreAlpha}>
      <YourApp />
    </ThirdwebProvider>
  );
};
