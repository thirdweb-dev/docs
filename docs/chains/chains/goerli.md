...
# Building contracts and apps on Goerli

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Goerli. By the end of the guide, you should be able to create smart contracts and dApps on Goerli. If you want to check details such as RPCs for Goerli, check out our [chainlist page for Goerli](https://thirdweb.com/goerli).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Goerli using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Goerli as the network
...
### Initialize SDK On Goerli

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Goerli
