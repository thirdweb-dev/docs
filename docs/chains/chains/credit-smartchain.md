---
title: Credit Smartchain Mainnet
slug: /credit-smartchain
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Credit Smartchain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Credit Smartchain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Credit Smartchain Mainnet. If you want to check details such as RPCs for Credit Smartchain Mainnet, check out our [chainlist page for Credit Smartchain Mainnet](https://thirdweb.com/credit-smartchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Credit Smartchain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Credit Smartchain Mainnet as the network
...
### Initialize SDK On Credit Smartchain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Credit Smartchain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CreditSmartchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CreditSmartchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
