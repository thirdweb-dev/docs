...
# Building contracts and apps on Decimal Smart Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Decimal Smart Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Decimal Smart Chain Mainnet. If you want to check details such as RPCs for Decimal Smart Chain Mainnet, check out our [chainlist page for Decimal Smart Chain Mainnet](https://thirdweb.com/decimal-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Decimal Smart Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Decimal Smart Chain Mainnet as the network
...
### Initialize SDK On Decimal Smart Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Decimal Smart Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DecimalSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DecimalSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
