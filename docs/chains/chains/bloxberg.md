...
# Building contracts and apps on bloxberg

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on bloxberg. By the end of the guide, you should be able to create smart contracts and dApps on bloxberg. If you want to check details such as RPCs for bloxberg, check out our [chainlist page for bloxberg](https://thirdweb.com/bloxberg).
...
5. After modifying your contract with your desired custom logic, you may deploy it to bloxberg using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select bloxberg as the network
...
### Initialize SDK On bloxberg

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to bloxberg

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bloxberg } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bloxberg}>
      <YourApp />
    </ThirdwebProvider>
  );
};
