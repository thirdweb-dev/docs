...
# Building contracts and apps on Carbon EVM Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Carbon EVM Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Carbon EVM Testnet. If you want to check details such as RPCs for Carbon EVM Testnet, check out our [chainlist page for Carbon EVM Testnet](https://thirdweb.com/carbon-evm-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Carbon EVM Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Carbon EVM Testnet as the network
...
### Initialize SDK On Carbon EVM Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Carbon EVM Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CarbonEvmTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CarbonEvmTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
