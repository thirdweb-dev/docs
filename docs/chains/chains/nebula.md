...
# Building contracts and apps on Nebula Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Nebula Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Nebula Mainnet. If you want to check details such as RPCs for Nebula Mainnet, check out our [chainlist page for Nebula Mainnet](https://thirdweb.com/nebula).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Nebula Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Nebula Mainnet as the network
...
### Initialize SDK On Nebula Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Nebula Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Nebula } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Nebula}>
      <YourApp />
    </ThirdwebProvider>
  );
};
