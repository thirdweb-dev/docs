...
# Building contracts and apps on Rangers Protocol Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rangers Protocol Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Rangers Protocol Mainnet. If you want to check details such as RPCs for Rangers Protocol Mainnet, check out our [chainlist page for Rangers Protocol Mainnet](https://thirdweb.com/rangers-protocol).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rangers Protocol Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rangers Protocol Mainnet as the network
...
### Initialize SDK On Rangers Protocol Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rangers Protocol Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { RangersProtocol } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={RangersProtocol}>
      <YourApp />
    </ThirdwebProvider>
  );
};
