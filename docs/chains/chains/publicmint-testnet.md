...
# Building contracts and apps on PublicMint Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PublicMint Testnet. By the end of the guide, you should be able to create smart contracts and dApps on PublicMint Testnet. If you want to check details such as RPCs for PublicMint Testnet, check out our [chainlist page for PublicMint Testnet](https://thirdweb.com/publicmint-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PublicMint Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PublicMint Testnet as the network
...
### Initialize SDK On PublicMint Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PublicMint Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PublicmintTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PublicmintTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
