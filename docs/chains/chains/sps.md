...
# Building contracts and apps on SPS

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SPS. By the end of the guide, you should be able to create smart contracts and dApps on SPS. If you want to check details such as RPCs for SPS, check out our [chainlist page for SPS](https://thirdweb.com/sps).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SPS using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On SPS

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SPS

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Sps } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Sps}>
      <YourApp />
    </ThirdwebProvider>
  );
};
