...
# Building contracts and apps on MAP Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MAP Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on MAP Mainnet. If you want to check details such as RPCs for MAP Mainnet, check out our [chainlist page for MAP Mainnet](https://thirdweb.com/map).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MAP Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MAP Mainnet as the network
...
### Initialize SDK On MAP Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MAP Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Map } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Map}>
      <YourApp />
    </ThirdwebProvider>
  );
};
