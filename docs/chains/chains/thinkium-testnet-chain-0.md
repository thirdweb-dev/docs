...
# Building contracts and apps on Thinkium Testnet Chain 0

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Thinkium Testnet Chain 0. By the end of the guide, you should be able to create smart contracts and dApps on Thinkium Testnet Chain 0. If you want to check details such as RPCs for Thinkium Testnet Chain 0, check out our [chainlist page for Thinkium Testnet Chain 0](https://thirdweb.com/thinkium-testnet-chain-0).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Thinkium Testnet Chain 0 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Thinkium Testnet Chain 0 as the network
...
### Initialize SDK On Thinkium Testnet Chain 0

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Thinkium Testnet Chain 0

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ThinkiumTestnetChain0 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ThinkiumTestnetChain0}>
      <YourApp />
    </ThirdwebProvider>
  );
};
