...
# Building contracts and apps on Lightlink Phoenix Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Lightlink Phoenix Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Lightlink Phoenix Mainnet. If you want to check details such as RPCs for Lightlink Phoenix Mainnet, check out our [chainlist page for Lightlink Phoenix Mainnet](https://thirdweb.com/lightlink-phoenix).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Lightlink Phoenix Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Lightlink Phoenix Mainnet as the network
...
### Initialize SDK On Lightlink Phoenix Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Lightlink Phoenix Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={LightlinkPhoenix}>
      <YourApp />
    </ThirdwebProvider>
  );
};
