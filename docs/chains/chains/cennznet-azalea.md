...
# Building contracts and apps on CENNZnet Azalea

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on CENNZnet Azalea. By the end of the guide, you should be able to create smart contracts and dApps on CENNZnet Azalea. If you want to check details such as RPCs for CENNZnet Azalea, check out our [chainlist page for CENNZnet Azalea](https://thirdweb.com/cennznet-azalea).
...
5. After modifying your contract with your desired custom logic, you may deploy it to CENNZnet Azalea using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select CENNZnet Azalea as the network
...
### Initialize SDK On CENNZnet Azalea

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to CENNZnet Azalea

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CennznetAzalea } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CennznetAzalea}>
      <YourApp />
    </ThirdwebProvider>
  );
};
