...
# Building contracts and apps on BitEth

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BitEth. By the end of the guide, you should be able to create smart contracts and dApps on BitEth. If you want to check details such as RPCs for BitEth, check out our [chainlist page for BitEth](https://thirdweb.com/biteth).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BitEth using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BitEth as the network
...
### Initialize SDK On BitEth

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BitEth

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Biteth } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Biteth}>
      <YourApp />
    </ThirdwebProvider>
  );
};
