...
# Building contracts and apps on Syscoin Tanenbaum Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Syscoin Tanenbaum Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Syscoin Tanenbaum Testnet. If you want to check details such as RPCs for Syscoin Tanenbaum Testnet, check out our [chainlist page for Syscoin Tanenbaum Testnet](https://thirdweb.com/syscoin-tanenbaum-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Syscoin Tanenbaum Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Syscoin Tanenbaum Testnet as the network
...
### Initialize SDK On Syscoin Tanenbaum Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Syscoin Tanenbaum Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SyscoinTanenbaumTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SyscoinTanenbaumTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
