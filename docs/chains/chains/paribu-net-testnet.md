...
# Building contracts and apps on Paribu Net Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Paribu Net Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Paribu Net Testnet. If you want to check details such as RPCs for Paribu Net Testnet, check out our [chainlist page for Paribu Net Testnet](https://thirdweb.com/paribu-net-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Paribu Net Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Paribu Net Testnet as the network
...
### Initialize SDK On Paribu Net Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Paribu Net Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ParibuNetTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ParibuNetTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
