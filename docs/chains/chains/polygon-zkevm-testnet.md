...
# Building contracts and apps on Polygon zkEVM Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Polygon zkEVM Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Polygon zkEVM Testnet. If you want to check details such as RPCs for Polygon zkEVM Testnet, check out our [chainlist page for Polygon zkEVM Testnet](https://thirdweb.com/polygon-zkevm-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Polygon zkEVM Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Polygon zkEVM Testnet as the network
...
### Initialize SDK On Polygon zkEVM Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Polygon zkEVM Testnet
