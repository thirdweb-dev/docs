...
# Building contracts and apps on TechPay Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on TechPay Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on TechPay Mainnet. If you want to check details such as RPCs for TechPay Mainnet, check out our [chainlist page for TechPay Mainnet](https://thirdweb.com/techpay).
...
5. After modifying your contract with your desired custom logic, you may deploy it to TechPay Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select TechPay Mainnet as the network
...
### Initialize SDK On TechPay Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to TechPay Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Techpay } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Techpay}>
      <YourApp />
    </ThirdwebProvider>
  );
};
