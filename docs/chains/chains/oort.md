...
# Building contracts and apps on Oort Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oort Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Oort Mainnet. If you want to check details such as RPCs for Oort Mainnet, check out our [chainlist page for Oort Mainnet](https://thirdweb.com/oort).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oort Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oort Mainnet as the network
...
### Initialize SDK On Oort Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oort Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Oort } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Oort}>
      <YourApp />
    </ThirdwebProvider>
  );
};
