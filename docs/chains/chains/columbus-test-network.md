...
# Building contracts and apps on Columbus Test Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Columbus Test Network. By the end of the guide, you should be able to create smart contracts and dApps on Columbus Test Network. If you want to check details such as RPCs for Columbus Test Network, check out our [chainlist page for Columbus Test Network](https://thirdweb.com/columbus-test-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Columbus Test Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Columbus Test Network as the network
...
### Initialize SDK On Columbus Test Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Columbus Test Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ColumbusTestNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ColumbusTestNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
