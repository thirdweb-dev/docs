...
# Building contracts and apps on Wanchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Wanchain. By the end of the guide, you should be able to create smart contracts and dApps on Wanchain. If you want to check details such as RPCs for Wanchain, check out our [chainlist page for Wanchain](https://thirdweb.com/wanchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Wanchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Wanchain as the network
...
### Initialize SDK On Wanchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Wanchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Wanchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Wanchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
