---
title: Nahmii Mainnet
slug: /nahmii
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Nahmii Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Nahmii Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Nahmii Mainnet. If you want to check details such as RPCs for Nahmii Mainnet, check out our [chainlist page for Nahmii Mainnet](https://thirdweb.com/nahmii).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Nahmii Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Nahmii Mainnet as the network
...
### Initialize SDK On Nahmii Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Nahmii Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Nahmii } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Nahmii}>
      <YourApp />
    </ThirdwebProvider>
  );
};
