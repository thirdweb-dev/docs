...
# Building contracts and apps on XANAChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on XANAChain. By the end of the guide, you should be able to create smart contracts and dApps on XANAChain. If you want to check details such as RPCs for XANAChain, check out our [chainlist page for XANAChain](https://thirdweb.com/xanachain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to XANAChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select XANAChain as the network
...
### Initialize SDK On XANAChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to XANAChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Xanachain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Xanachain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
