...
# Building contracts and apps on BLG Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BLG Testnet. By the end of the guide, you should be able to create smart contracts and dApps on BLG Testnet. If you want to check details such as RPCs for BLG Testnet, check out our [chainlist page for BLG Testnet](https://thirdweb.com/blg-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BLG Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BLG Testnet as the network
...
### Initialize SDK On BLG Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BLG Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BlgTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BlgTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
