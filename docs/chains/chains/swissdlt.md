...
# Building contracts and apps on SwissDLT

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SwissDLT. By the end of the guide, you should be able to create smart contracts and dApps on SwissDLT. If you want to check details such as RPCs for SwissDLT, check out our [chainlist page for SwissDLT](https://thirdweb.com/swissdlt).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SwissDLT using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SwissDLT as the network
...
### Initialize SDK On SwissDLT

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SwissDLT

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Swissdlt } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Swissdlt}>
      <YourApp />
    </ThirdwebProvider>
  );
};
