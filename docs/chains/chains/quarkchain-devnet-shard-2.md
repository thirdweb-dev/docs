...
5. After modifying your contract with your desired custom logic, you may deploy it to QuarkChain Devnet Shard 2 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select QuarkChain Devnet Shard 2 as the network
...
### Initialize SDK On QuarkChain Devnet Shard 2

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to QuarkChain Devnet Shard 2

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { QuarkchainDevnetShard2 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={QuarkchainDevnetShard2}>
      <YourApp />
    </ThirdwebProvider>
  );
};
