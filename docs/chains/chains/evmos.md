...
# Building contracts and apps on Evmos

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Evmos. By the end of the guide, you should be able to create smart contracts and dApps on Evmos. If you want to check details such as RPCs for Evmos, check out our [chainlist page for Evmos](https://thirdweb.com/evmos).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Evmos using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Evmos

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Evmos
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Evmos}>
      <YourApp />
    </ThirdwebProvider>
  );
};
