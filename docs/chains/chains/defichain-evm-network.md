...
# Building contracts and apps on DeFiChain EVM Network Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DeFiChain EVM Network Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on DeFiChain EVM Network Mainnet. If you want to check details such as RPCs for DeFiChain EVM Network Mainnet, check out our [chainlist page for DeFiChain EVM Network Mainnet](https://thirdweb.com/defichain-evm-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DeFiChain EVM Network Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DeFiChain EVM Network Mainnet as the network
...
### Initialize SDK On DeFiChain EVM Network Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DeFiChain EVM Network Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DefichainEvmNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DefichainEvmNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
