...
# Building contracts and apps on Nova Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Nova Network. By the end of the guide, you should be able to create smart contracts and dApps on Nova Network. If you want to check details such as RPCs for Nova Network, check out our [chainlist page for Nova Network](https://thirdweb.com/nova-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Nova Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Nova Network as the network
...
### Initialize SDK On Nova Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Nova Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { NovaNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={NovaNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
