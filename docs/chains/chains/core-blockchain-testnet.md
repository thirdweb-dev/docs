...
# Building contracts and apps on Core Blockchain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Core Blockchain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Core Blockchain Testnet. If you want to check details such as RPCs for Core Blockchain Testnet, check out our [chainlist page for Core Blockchain Testnet](https://thirdweb.com/core-blockchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Core Blockchain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Core Blockchain Testnet as the network
...
### Initialize SDK On Core Blockchain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Core Blockchain Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={CoreBlockchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
