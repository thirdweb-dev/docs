...
# Building contracts and apps on DOS Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DOS Chain. By the end of the guide, you should be able to create smart contracts and dApps on DOS Chain. If you want to check details such as RPCs for DOS Chain, check out our [chainlist page for DOS Chain](https://thirdweb.com/dos-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DOS Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DOS Chain as the network
...
### Initialize SDK On DOS Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DOS Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DosChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DosChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
