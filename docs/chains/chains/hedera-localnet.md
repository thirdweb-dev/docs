...
# Building contracts and apps on Hedera Localnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Hedera Localnet. By the end of the guide, you should be able to create smart contracts and dApps on Hedera Localnet. If you want to check details such as RPCs for Hedera Localnet, check out our [chainlist page for Hedera Localnet](https://thirdweb.com/hedera-localnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Hedera Localnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Hedera Localnet as the network
...
### Initialize SDK On Hedera Localnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Hedera Localnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HederaLocalnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HederaLocalnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
