...
# Building contracts and apps on Auxilium Network Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Auxilium Network Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Auxilium Network Mainnet. If you want to check details such as RPCs for Auxilium Network Mainnet, check out our [chainlist page for Auxilium Network Mainnet](https://thirdweb.com/auxilium-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Auxilium Network Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Auxilium Network Mainnet as the network
...
### Initialize SDK On Auxilium Network Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Auxilium Network Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AuxiliumNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AuxiliumNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
