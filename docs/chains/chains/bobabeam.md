...
# Building contracts and apps on Bobabeam

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bobabeam. By the end of the guide, you should be able to create smart contracts and dApps on Bobabeam. If you want to check details such as RPCs for Bobabeam, check out our [chainlist page for Bobabeam](https://thirdweb.com/bobabeam).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bobabeam using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bobabeam as the network
...
### Initialize SDK On Bobabeam

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bobabeam

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bobabeam } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bobabeam}>
      <YourApp />
    </ThirdwebProvider>
  );
};
