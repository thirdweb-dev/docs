...
# Building contracts and apps on Saakuru Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Saakuru Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Saakuru Testnet. If you want to check details such as RPCs for Saakuru Testnet, check out our [chainlist page for Saakuru Testnet](https://thirdweb.com/saakuru-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Saakuru Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Saakuru Testnet as the network
...
### Initialize SDK On Saakuru Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Saakuru Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SaakuruTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SaakuruTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
