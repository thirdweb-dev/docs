...
# Building contracts and apps on JIBCHAIN L1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on JIBCHAIN L1. By the end of the guide, you should be able to create smart contracts and dApps on JIBCHAIN L1. If you want to check details such as RPCs for JIBCHAIN L1, check out our [chainlist page for JIBCHAIN L1](https://thirdweb.com/jibchain-l1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to JIBCHAIN L1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select JIBCHAIN L1 as the network
...
### Initialize SDK On JIBCHAIN L1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to JIBCHAIN L1
