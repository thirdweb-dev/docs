...
# Building contracts and apps on Oasis Emerald

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oasis Emerald. By the end of the guide, you should be able to create smart contracts and dApps on Oasis Emerald. If you want to check details such as RPCs for Oasis Emerald, check out our [chainlist page for Oasis Emerald](https://thirdweb.com/oasis-emerald).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oasis Emerald using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oasis Emerald as the network
...
### Initialize SDK On Oasis Emerald

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oasis Emerald

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OasisEmerald } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OasisEmerald}>
      <YourApp />
    </ThirdwebProvider>
  );
};
