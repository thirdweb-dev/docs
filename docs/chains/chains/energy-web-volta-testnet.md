...
# Building contracts and apps on Energy Web Volta Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Energy Web Volta Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Energy Web Volta Testnet. If you want to check details such as RPCs for Energy Web Volta Testnet, check out our [chainlist page for Energy Web Volta Testnet](https://thirdweb.com/energy-web-volta-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Energy Web Volta Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Energy Web Volta Testnet as the network
...
### Initialize SDK On Energy Web Volta Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Energy Web Volta Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={EnergyWebVoltaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
