...
# Building contracts and apps on Dxchain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dxchain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Dxchain Mainnet. If you want to check details such as RPCs for Dxchain Mainnet, check out our [chainlist page for Dxchain Mainnet](https://thirdweb.com/dxchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dxchain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dxchain Mainnet as the network
...
### Initialize SDK On Dxchain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dxchain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Dxchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Dxchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
