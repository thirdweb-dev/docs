...
# Building contracts and apps on HAPchain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on HAPchain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on HAPchain Testnet. If you want to check details such as RPCs for HAPchain Testnet, check out our [chainlist page for HAPchain Testnet](https://thirdweb.com/hapchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to HAPchain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select HAPchain Testnet as the network
...
### Initialize SDK On HAPchain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to HAPchain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HapchainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HapchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
