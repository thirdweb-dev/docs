...
# Building contracts and apps on Moonriver

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Moonriver. By the end of the guide, you should be able to create smart contracts and dApps on Moonriver. If you want to check details such as RPCs for Moonriver, check out our [chainlist page for Moonriver](https://thirdweb.com/moonriver).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Moonriver using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Moonriver as the network
...
### Initialize SDK On Moonriver

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Moonriver

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Moonriver } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Moonriver}>
      <YourApp />
    </ThirdwebProvider>
  );
};
