...
# Building contracts and apps on Taraxa Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Taraxa Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Taraxa Testnet. If you want to check details such as RPCs for Taraxa Testnet, check out our [chainlist page for Taraxa Testnet](https://thirdweb.com/taraxa-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Taraxa Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Taraxa Testnet as the network
...
### Initialize SDK On Taraxa Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Taraxa Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TaraxaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TaraxaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
