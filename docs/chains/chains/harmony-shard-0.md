...
# Building contracts and apps on Harmony Mainnet Shard 0

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Harmony Mainnet Shard 0. By the end of the guide, you should be able to create smart contracts and dApps on Harmony Mainnet Shard 0. If you want to check details such as RPCs for Harmony Mainnet Shard 0, check out our [chainlist page for Harmony Mainnet Shard 0](https://thirdweb.com/harmony-shard-0).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Harmony Mainnet Shard 0 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Harmony Mainnet Shard 0 as the network
...
### Initialize SDK On Harmony Mainnet Shard 0

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Harmony Mainnet Shard 0
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={HarmonyShard0}>
      <YourApp />
    </ThirdwebProvider>
  );
};
