...
# Building contracts and apps on Milkomeda A1 Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Milkomeda A1 Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Milkomeda A1 Mainnet. If you want to check details such as RPCs for Milkomeda A1 Mainnet, check out our [chainlist page for Milkomeda A1 Mainnet](https://thirdweb.com/milkomeda-a1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Milkomeda A1 Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Milkomeda A1 Mainnet as the network
...
### Initialize SDK On Milkomeda A1 Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Milkomeda A1 Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MilkomedaA1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MilkomedaA1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
