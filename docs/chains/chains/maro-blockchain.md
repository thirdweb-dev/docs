...
# Building contracts and apps on MARO Blockchain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MARO Blockchain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on MARO Blockchain Mainnet. If you want to check details such as RPCs for MARO Blockchain Mainnet, check out our [chainlist page for MARO Blockchain Mainnet](https://thirdweb.com/maro-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MARO Blockchain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MARO Blockchain Mainnet as the network
...
### Initialize SDK On MARO Blockchain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MARO Blockchain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MaroBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MaroBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
