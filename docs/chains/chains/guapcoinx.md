...
# Building contracts and apps on GuapcoinX

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on GuapcoinX. By the end of the guide, you should be able to create smart contracts and dApps on GuapcoinX. If you want to check details such as RPCs for GuapcoinX, check out our [chainlist page for GuapcoinX](https://thirdweb.com/guapcoinx).
...
5. After modifying your contract with your desired custom logic, you may deploy it to GuapcoinX using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select GuapcoinX as the network
...
### Initialize SDK On GuapcoinX

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to GuapcoinX
