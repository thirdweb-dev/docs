...
# Building contracts and apps on Star Social Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Star Social Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Star Social Testnet. If you want to check details such as RPCs for Star Social Testnet, check out our [chainlist page for Star Social Testnet](https://thirdweb.com/star-social-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Star Social Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Star Social Testnet as the network
...
### Initialize SDK On Star Social Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Star Social Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { StarSocialTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={StarSocialTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
