...
# Building contracts and apps on Canxium Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Canxium Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Canxium Mainnet. If you want to check details such as RPCs for Canxium Mainnet, check out our [chainlist page for Canxium Mainnet](https://thirdweb.com/canxium).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Canxium Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Canxium Mainnet as the network
...
### Initialize SDK On Canxium Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Canxium Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Canxium } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Canxium}>
      <YourApp />
    </ThirdwebProvider>
  );
};
