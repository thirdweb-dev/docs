...
# Building contracts and apps on Tenet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Tenet. By the end of the guide, you should be able to create smart contracts and dApps on Tenet. If you want to check details such as RPCs for Tenet, check out our [chainlist page for Tenet](https://thirdweb.com/tenet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Tenet using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Tenet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Tenet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Tenet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Tenet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
