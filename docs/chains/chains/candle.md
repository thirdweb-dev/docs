...
# Building contracts and apps on Candle

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Candle. By the end of the guide, you should be able to create smart contracts and dApps on Candle. If you want to check details such as RPCs for Candle, check out our [chainlist page for Candle](https://thirdweb.com/candle).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Candle using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Candle as the network
...
### Initialize SDK On Candle

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Candle

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Candle } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Candle}>
      <YourApp />
    </ThirdwebProvider>
  );
};
