...
# Building contracts and apps on Celo Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Celo Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Celo Mainnet. If you want to check details such as RPCs for Celo Mainnet, check out our [chainlist page for Celo Mainnet](https://thirdweb.com/celo).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Celo Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Celo Mainnet as the network
...
### Initialize SDK On Celo Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Celo Mainnet
