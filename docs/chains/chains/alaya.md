...
# Building contracts and apps on Alaya Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Alaya Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Alaya Mainnet. If you want to check details such as RPCs for Alaya Mainnet, check out our [chainlist page for Alaya Mainnet](https://thirdweb.com/alaya).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Alaya Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Alaya Mainnet as the network
...
### Initialize SDK On Alaya Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Alaya Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Alaya } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Alaya}>
      <YourApp />
    </ThirdwebProvider>
  );
};
