...
# Building contracts and apps on LUKSO Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on LUKSO Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on LUKSO Mainnet. If you want to check details such as RPCs for LUKSO Mainnet, check out our [chainlist page for LUKSO Mainnet](https://thirdweb.com/lukso).
...
5. After modifying your contract with your desired custom logic, you may deploy it to LUKSO Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select LUKSO Mainnet as the network
...
### Initialize SDK On LUKSO Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to LUKSO Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Lukso}>
      <YourApp />
    </ThirdwebProvider>
  );
};
