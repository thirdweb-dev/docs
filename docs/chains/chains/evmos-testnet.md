...
# Building contracts and apps on Evmos Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Evmos Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Evmos Testnet. If you want to check details such as RPCs for Evmos Testnet, check out our [chainlist page for Evmos Testnet](https://thirdweb.com/evmos-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Evmos Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Evmos Testnet as the network
...
### Initialize SDK On Evmos Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Evmos Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={EvmosTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
