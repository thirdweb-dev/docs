...
# Building contracts and apps on Flana

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Flana. By the end of the guide, you should be able to create smart contracts and dApps on Flana. If you want to check details such as RPCs for Flana, check out our [chainlist page for Flana](https://thirdweb.com/flana).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Flana using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Flana

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Flana

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Flana } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Flana}>
      <YourApp />
    </ThirdwebProvider>
  );
};
