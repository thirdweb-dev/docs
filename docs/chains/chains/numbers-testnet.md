...
# Building contracts and apps on Numbers Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Numbers Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Numbers Testnet. If you want to check details such as RPCs for Numbers Testnet, check out our [chainlist page for Numbers Testnet](https://thirdweb.com/numbers-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Numbers Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Numbers Testnet as the network
...
### Initialize SDK On Numbers Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Numbers Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { NumbersTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={NumbersTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
