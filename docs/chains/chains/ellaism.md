...
# Building contracts and apps on Ellaism

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ellaism. By the end of the guide, you should be able to create smart contracts and dApps on Ellaism. If you want to check details such as RPCs for Ellaism, check out our [chainlist page for Ellaism](https://thirdweb.com/ellaism).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ellaism using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ellaism as the network
...
### Initialize SDK On Ellaism

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ellaism

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ellaism } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ellaism}>
      <YourApp />
    </ThirdwebProvider>
  );
};
