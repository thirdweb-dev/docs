...
# Building contracts and apps on EZChain C-Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on EZChain C-Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on EZChain C-Chain Mainnet. If you want to check details such as RPCs for EZChain C-Chain Mainnet, check out our [chainlist page for EZChain C-Chain Mainnet](https://thirdweb.com/ezchain-c-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to EZChain C-Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select EZChain C-Chain Mainnet as the network
...
### Initialize SDK On EZChain C-Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to EZChain C-Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EzchainCChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EzchainCChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
