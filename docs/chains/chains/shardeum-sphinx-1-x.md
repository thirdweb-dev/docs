...
# Building contracts and apps on Shardeum Sphinx 1.X

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Shardeum Sphinx 1.X. By the end of the guide, you should be able to create smart contracts and dApps on Shardeum Sphinx 1.X. If you want to check details such as RPCs for Shardeum Sphinx 1.X, check out our [chainlist page for Shardeum Sphinx 1.X](https://thirdweb.com/shardeum-sphinx-1-x).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Shardeum Sphinx 1.X using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Shardeum Sphinx 1.X as the network
...
### Initialize SDK On Shardeum Sphinx 1.X

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Shardeum Sphinx 1.X
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={ShardeumSphinx1X}>
      <YourApp />
    </ThirdwebProvider>
  );
};
