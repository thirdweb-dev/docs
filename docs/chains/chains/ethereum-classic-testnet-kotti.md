---
title: Ethereum Classic Testnet Kotti
slug: /ethereum-classic-testnet-kotti
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Ethereum Classic Testnet Kotti

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ethereum Classic Testnet Kotti. By the end of the guide, you should be able to create smart contracts and dApps on Ethereum Classic Testnet Kotti. If you want to check details such as RPCs for Ethereum Classic Testnet Kotti, check out our [chainlist page for Ethereum Classic Testnet Kotti](https://thirdweb.com/ethereum-classic-testnet-kotti).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ethereum Classic Testnet Kotti using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ethereum Classic Testnet Kotti as the network
...
### Initialize SDK On Ethereum Classic Testnet Kotti

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ethereum Classic Testnet Kotti

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EthereumClassicTestnetKotti } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EthereumClassicTestnetKotti}>
      <YourApp />
    </ThirdwebProvider>
  );
};
