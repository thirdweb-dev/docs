...
# Building contracts and apps on RSK Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on RSK Testnet. By the end of the guide, you should be able to create smart contracts and dApps on RSK Testnet. If you want to check details such as RPCs for RSK Testnet, check out our [chainlist page for RSK Testnet](https://thirdweb.com/rsk-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to RSK Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select RSK Testnet as the network
...
### Initialize SDK On RSK Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to RSK Testnet
