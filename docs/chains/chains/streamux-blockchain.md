...
# Building contracts and apps on StreamuX Blockchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on StreamuX Blockchain. By the end of the guide, you should be able to create smart contracts and dApps on StreamuX Blockchain. If you want to check details such as RPCs for StreamuX Blockchain, check out our [chainlist page for StreamuX Blockchain](https://thirdweb.com/streamux-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to StreamuX Blockchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select StreamuX Blockchain as the network
...
### Initialize SDK On StreamuX Blockchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to StreamuX Blockchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { StreamuxBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={StreamuxBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
