...
# Building contracts and apps on T-EKTA

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on T-EKTA. By the end of the guide, you should be able to create smart contracts and dApps on T-EKTA. If you want to check details such as RPCs for T-EKTA, check out our [chainlist page for T-EKTA](https://thirdweb.com/t-ekta).
...
5. After modifying your contract with your desired custom logic, you may deploy it to T-EKTA using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select T-EKTA as the network
...
### Initialize SDK On T-EKTA

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to T-EKTA

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TEkta } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TEkta}>
      <YourApp />
    </ThirdwebProvider>
  );
};
