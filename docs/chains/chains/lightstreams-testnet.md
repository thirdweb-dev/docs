...
# Building contracts and apps on Lightstreams Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Lightstreams Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Lightstreams Testnet. If you want to check details such as RPCs for Lightstreams Testnet, check out our [chainlist page for Lightstreams Testnet](https://thirdweb.com/lightstreams-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Lightstreams Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Lightstreams Testnet as the network
...
### Initialize SDK On Lightstreams Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Lightstreams Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { LightstreamsTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={LightstreamsTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
