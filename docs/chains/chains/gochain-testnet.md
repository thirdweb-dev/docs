...
# Building contracts and apps on GoChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on GoChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on GoChain Testnet. If you want to check details such as RPCs for GoChain Testnet, check out our [chainlist page for GoChain Testnet](https://thirdweb.com/gochain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to GoChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select GoChain Testnet as the network
...
### Initialize SDK On GoChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to GoChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GochainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GochainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
