...
# Building contracts and apps on Garizon Stage2

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Garizon Stage2. By the end of the guide, you should be able to create smart contracts and dApps on Garizon Stage2. If you want to check details such as RPCs for Garizon Stage2, check out our [chainlist page for Garizon Stage2](https://thirdweb.com/garizon-stage2).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Garizon Stage2 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Garizon Stage2 as the network
...
### Initialize SDK On Garizon Stage2

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Garizon Stage2

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GarizonStage2 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GarizonStage2}>
      <YourApp />
    </ThirdwebProvider>
  );
};
