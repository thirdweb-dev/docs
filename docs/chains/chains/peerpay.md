...
# Building contracts and apps on Peerpay

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Peerpay. By the end of the guide, you should be able to create smart contracts and dApps on Peerpay. If you want to check details such as RPCs for Peerpay, check out our [chainlist page for Peerpay](https://thirdweb.com/peerpay).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Peerpay using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Peerpay as the network
...
### Initialize SDK On Peerpay

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Peerpay

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Peerpay } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Peerpay}>
      <YourApp />
    </ThirdwebProvider>
  );
};
