...
# Building contracts and apps on AxelChain Dev-Net

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on AxelChain Dev-Net. By the end of the guide, you should be able to create smart contracts and dApps on AxelChain Dev-Net. If you want to check details such as RPCs for AxelChain Dev-Net, check out our [chainlist page for AxelChain Dev-Net](https://thirdweb.com/axelchain-dev-net).
...
5. After modifying your contract with your desired custom logic, you may deploy it to AxelChain Dev-Net using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select AxelChain Dev-Net as the network
...
### Initialize SDK On AxelChain Dev-Net

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to AxelChain Dev-Net

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AxelchainDevNet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AxelchainDevNet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
