---
title: Metadium Testnet
slug: /metadium-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Metadium Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Metadium Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Metadium Testnet. If you want to check details such as RPCs for Metadium Testnet, check out our [chainlist page for Metadium Testnet](https://thirdweb.com/metadium-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Metadium Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Metadium Testnet as the network
...
### Initialize SDK On Metadium Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Metadium Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MetadiumTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MetadiumTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
