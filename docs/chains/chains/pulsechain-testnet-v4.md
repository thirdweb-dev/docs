...
# Building contracts and apps on PulseChain Testnet v4

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PulseChain Testnet v4. By the end of the guide, you should be able to create smart contracts and dApps on PulseChain Testnet v4. If you want to check details such as RPCs for PulseChain Testnet v4, check out our [chainlist page for PulseChain Testnet v4](https://thirdweb.com/pulsechain-testnet-v4).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PulseChain Testnet v4 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PulseChain Testnet v4 as the network
...
### Initialize SDK On PulseChain Testnet v4

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PulseChain Testnet v4
