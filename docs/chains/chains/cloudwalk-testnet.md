...
# Building contracts and apps on CloudWalk Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on CloudWalk Testnet. By the end of the guide, you should be able to create smart contracts and dApps on CloudWalk Testnet. If you want to check details such as RPCs for CloudWalk Testnet, check out our [chainlist page for CloudWalk Testnet](https://thirdweb.com/cloudwalk-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to CloudWalk Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select CloudWalk Testnet as the network
...
### Initialize SDK On CloudWalk Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to CloudWalk Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CloudwalkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CloudwalkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
