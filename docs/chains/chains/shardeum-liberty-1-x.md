...
# Building contracts and apps on Shardeum Liberty 1.X

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Shardeum Liberty 1.X. By the end of the guide, you should be able to create smart contracts and dApps on Shardeum Liberty 1.X. If you want to check details such as RPCs for Shardeum Liberty 1.X, check out our [chainlist page for Shardeum Liberty 1.X](https://thirdweb.com/shardeum-liberty-1-x).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Shardeum Liberty 1.X using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Shardeum Liberty 1.X as the network
...
### Initialize SDK On Shardeum Liberty 1.X

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Shardeum Liberty 1.X

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ShardeumLiberty1X } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ShardeumLiberty1X}>
      <YourApp />
    </ThirdwebProvider>
  );
};
