...
# Building contracts and apps on Frontier of Dreams Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Frontier of Dreams Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Frontier of Dreams Testnet. If you want to check details such as RPCs for Frontier of Dreams Testnet, check out our [chainlist page for Frontier of Dreams Testnet](https://thirdweb.com/frontier-of-dreams-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Frontier of Dreams Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Frontier of Dreams Testnet as the network
...
### Initialize SDK On Frontier of Dreams Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Frontier of Dreams Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FrontierOfDreamsTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FrontierOfDreamsTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
