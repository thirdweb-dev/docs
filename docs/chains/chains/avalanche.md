...
# Building contracts and apps on Avalanche C-Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Avalanche C-Chain. By the end of the guide, you should be able to create smart contracts and dApps on Avalanche C-Chain. If you want to check details such as RPCs for Avalanche C-Chain, check out our [chainlist page for Avalanche C-Chain](https://thirdweb.com/avalanche).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Avalanche C-Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Avalanche C-Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Avalanche C-Chain
