...
# Building contracts and apps on Bobaopera Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bobaopera Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Bobaopera Testnet. If you want to check details such as RPCs for Bobaopera Testnet, check out our [chainlist page for Bobaopera Testnet](https://thirdweb.com/bobaopera-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bobaopera Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bobaopera Testnet as the network
...
### Initialize SDK On Bobaopera Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bobaopera Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BobaoperaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BobaoperaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
