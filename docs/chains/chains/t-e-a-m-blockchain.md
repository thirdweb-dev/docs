...
# Building contracts and apps on T.E.A.M Blockchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on T.E.A.M Blockchain. By the end of the guide, you should be able to create smart contracts and dApps on T.E.A.M Blockchain. If you want to check details such as RPCs for T.E.A.M Blockchain, check out our [chainlist page for T.E.A.M Blockchain](https://thirdweb.com/t-e-a-m-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to T.E.A.M Blockchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select T.E.A.M Blockchain as the network
...
### Initialize SDK On T.E.A.M Blockchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to T.E.A.M Blockchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TEAMBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TEAMBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
