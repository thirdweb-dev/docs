...
# Building contracts and apps on Arbitrum One

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Arbitrum One. By the end of the guide, you should be able to create smart contracts and dApps on Arbitrum One. If you want to check details such as RPCs for Arbitrum One, check out our [chainlist page for Arbitrum One](https://thirdweb.com/arbitrum).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Arbitrum One using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Arbitrum One as the network
...
### Initialize SDK On Arbitrum One

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Arbitrum One
