...
# Building contracts and apps on Bronos Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bronos Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Bronos Mainnet. If you want to check details such as RPCs for Bronos Mainnet, check out our [chainlist page for Bronos Mainnet](https://thirdweb.com/bronos).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bronos Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bronos Mainnet as the network
...
### Initialize SDK On Bronos Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bronos Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bronos } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bronos}>
      <YourApp />
    </ThirdwebProvider>
  );
};
