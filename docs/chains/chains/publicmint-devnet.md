...
# Building contracts and apps on PublicMint Devnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PublicMint Devnet. By the end of the guide, you should be able to create smart contracts and dApps on PublicMint Devnet. If you want to check details such as RPCs for PublicMint Devnet, check out our [chainlist page for PublicMint Devnet](https://thirdweb.com/publicmint-devnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PublicMint Devnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PublicMint Devnet as the network
...
### Initialize SDK On PublicMint Devnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PublicMint Devnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PublicmintDevnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PublicmintDevnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
