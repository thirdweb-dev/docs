...
# Building contracts and apps on Rupaya

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rupaya. By the end of the guide, you should be able to create smart contracts and dApps on Rupaya. If you want to check details such as RPCs for Rupaya, check out our [chainlist page for Rupaya](https://thirdweb.com/rupaya).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rupaya using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rupaya as the network
...
### Initialize SDK On Rupaya

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rupaya

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Rupaya } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Rupaya}>
      <YourApp />
    </ThirdwebProvider>
  );
};
