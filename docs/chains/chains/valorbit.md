...
# Building contracts and apps on Valorbit

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Valorbit. By the end of the guide, you should be able to create smart contracts and dApps on Valorbit. If you want to check details such as RPCs for Valorbit, check out our [chainlist page for Valorbit](https://thirdweb.com/valorbit).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Valorbit using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Valorbit as the network
...
### Initialize SDK On Valorbit

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Valorbit

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Valorbit } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Valorbit}>
      <YourApp />
    </ThirdwebProvider>
  );
};
