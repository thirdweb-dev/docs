...
# Building contracts and apps on Tenet Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Tenet Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Tenet Testnet. If you want to check details such as RPCs for Tenet Testnet, check out our [chainlist page for Tenet Testnet](https://thirdweb.com/tenet-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Tenet Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Tenet Testnet as the network
...
### Initialize SDK On Tenet Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Tenet Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={TenetTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
