...
# Building contracts and apps on P12 Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on P12 Chain. By the end of the guide, you should be able to create smart contracts and dApps on P12 Chain. If you want to check details such as RPCs for P12 Chain, check out our [chainlist page for P12 Chain](https://thirdweb.com/p12-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to P12 Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select P12 Chain as the network
...
### Initialize SDK On P12 Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to P12 Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { P12Chain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={P12Chain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
