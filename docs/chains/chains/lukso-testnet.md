...
# Building contracts and apps on LUKSO Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on LUKSO Testnet. By the end of the guide, you should be able to create smart contracts and dApps on LUKSO Testnet. If you want to check details such as RPCs for LUKSO Testnet, check out our [chainlist page for LUKSO Testnet](https://thirdweb.com/lukso-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to LUKSO Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select LUKSO Testnet as the network
...
### Initialize SDK On LUKSO Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to LUKSO Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={LuksoTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
