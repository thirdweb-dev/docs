...
# Building contracts and apps on The Root Network - Porcini Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on The Root Network - Porcini Testnet. By the end of the guide, you should be able to create smart contracts and dApps on The Root Network - Porcini Testnet. If you want to check details such as RPCs for The Root Network - Porcini Testnet, check out our [chainlist page for The Root Network - Porcini Testnet](https://thirdweb.com/the-root-network-porcini-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to The Root Network - Porcini Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select The Root Network - Porcini Testnet as the network
...
### Initialize SDK On The Root Network - Porcini Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to The Root Network - Porcini Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TheRootNetworkPorciniTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TheRootNetworkPorciniTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
