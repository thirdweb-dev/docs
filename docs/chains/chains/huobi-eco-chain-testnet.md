...
# Building contracts and apps on Huobi ECO Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Huobi ECO Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Huobi ECO Chain Testnet. If you want to check details such as RPCs for Huobi ECO Chain Testnet, check out our [chainlist page for Huobi ECO Chain Testnet](https://thirdweb.com/huobi-eco-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Huobi ECO Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Huobi ECO Chain Testnet as the network
...
### Initialize SDK On Huobi ECO Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Huobi ECO Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HuobiEcoChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HuobiEcoChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
