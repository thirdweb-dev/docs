...
# Building contracts and apps on Stratos Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Stratos Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Stratos Testnet. If you want to check details such as RPCs for Stratos Testnet, check out our [chainlist page for Stratos Testnet](https://thirdweb.com/stratos-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Stratos Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Stratos Testnet as the network
...
### Initialize SDK On Stratos Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Stratos Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { StratosTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={StratosTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
