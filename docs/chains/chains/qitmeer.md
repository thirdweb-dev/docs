...
# Building contracts and apps on Qitmeer

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Qitmeer. By the end of the guide, you should be able to create smart contracts and dApps on Qitmeer. If you want to check details such as RPCs for Qitmeer, check out our [chainlist page for Qitmeer](https://thirdweb.com/qitmeer).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Qitmeer using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Qitmeer as the network
...
### Initialize SDK On Qitmeer

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Qitmeer

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Qitmeer } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Qitmeer}>
      <YourApp />
    </ThirdwebProvider>
  );
};
