...
# Building contracts and apps on Nepal Blockchain Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Nepal Blockchain Network. By the end of the guide, you should be able to create smart contracts and dApps on Nepal Blockchain Network. If you want to check details such as RPCs for Nepal Blockchain Network, check out our [chainlist page for Nepal Blockchain Network](https://thirdweb.com/nepal-blockchain-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Nepal Blockchain Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Nepal Blockchain Network as the network
...
### Initialize SDK On Nepal Blockchain Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Nepal Blockchain Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { NepalBlockchainNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={NepalBlockchainNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
