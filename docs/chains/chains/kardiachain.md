...
# Building contracts and apps on KardiaChain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on KardiaChain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on KardiaChain Mainnet. If you want to check details such as RPCs for KardiaChain Mainnet, check out our [chainlist page for KardiaChain Mainnet](https://thirdweb.com/kardiachain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to KardiaChain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select KardiaChain Mainnet as the network
...
### Initialize SDK On KardiaChain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to KardiaChain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Kardiachain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Kardiachain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
