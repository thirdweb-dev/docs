...
# Building contracts and apps on Tao Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Tao Network. By the end of the guide, you should be able to create smart contracts and dApps on Tao Network. If you want to check details such as RPCs for Tao Network, check out our [chainlist page for Tao Network](https://thirdweb.com/tao-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Tao Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Tao Network as the network
...
### Initialize SDK On Tao Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Tao Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TaoNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TaoNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
