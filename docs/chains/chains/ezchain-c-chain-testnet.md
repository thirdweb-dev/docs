...
# Building contracts and apps on EZChain C-Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on EZChain C-Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on EZChain C-Chain Testnet. If you want to check details such as RPCs for EZChain C-Chain Testnet, check out our [chainlist page for EZChain C-Chain Testnet](https://thirdweb.com/ezchain-c-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to EZChain C-Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select EZChain C-Chain Testnet as the network
...
### Initialize SDK On EZChain C-Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to EZChain C-Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EzchainCChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EzchainCChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
