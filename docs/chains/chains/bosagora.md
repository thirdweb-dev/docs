...
# Building contracts and apps on BOSagora Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BOSagora Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on BOSagora Mainnet. If you want to check details such as RPCs for BOSagora Mainnet, check out our [chainlist page for BOSagora Mainnet](https://thirdweb.com/bosagora).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BOSagora Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BOSagora Mainnet as the network
...
### Initialize SDK On BOSagora Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BOSagora Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bosagora } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bosagora}>
      <YourApp />
    </ThirdwebProvider>
  );
};
