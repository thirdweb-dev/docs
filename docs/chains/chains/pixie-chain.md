...
# Building contracts and apps on Pixie Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Pixie Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Pixie Chain Mainnet. If you want to check details such as RPCs for Pixie Chain Mainnet, check out our [chainlist page for Pixie Chain Mainnet](https://thirdweb.com/pixie-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Pixie Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Pixie Chain Mainnet as the network
...
### Initialize SDK On Pixie Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Pixie Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PixieChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PixieChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
