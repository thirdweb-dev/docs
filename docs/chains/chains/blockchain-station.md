...
# Building contracts and apps on BlockChain Station Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BlockChain Station Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on BlockChain Station Mainnet. If you want to check details such as RPCs for BlockChain Station Mainnet, check out our [chainlist page for BlockChain Station Mainnet](https://thirdweb.com/blockchain-station).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BlockChain Station Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BlockChain Station Mainnet as the network
...
### Initialize SDK On BlockChain Station Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BlockChain Station Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BlockchainStation } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BlockchainStation}>
      <YourApp />
    </ThirdwebProvider>
  );
};
