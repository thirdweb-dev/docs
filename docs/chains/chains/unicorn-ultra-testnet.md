---
title: Unicorn Ultra Testnet
slug: /unicorn-ultra-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Unicorn Ultra Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Unicorn Ultra Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Unicorn Ultra Testnet. If you want to check details such as RPCs for Unicorn Ultra Testnet, check out our [chainlist page for Unicorn Ultra Testnet](https://thirdweb.com/unicorn-ultra-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Unicorn Ultra Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Unicorn Ultra Testnet as the network
...
### Initialize SDK On Unicorn Ultra Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Unicorn Ultra Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { UnicornUltraTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={UnicornUltraTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
