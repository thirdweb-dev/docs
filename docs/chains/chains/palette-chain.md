...
# Building contracts and apps on Palette Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Palette Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Palette Chain Mainnet. If you want to check details such as RPCs for Palette Chain Mainnet, check out our [chainlist page for Palette Chain Mainnet](https://thirdweb.com/palette-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Palette Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Palette Chain Mainnet as the network
...
### Initialize SDK On Palette Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Palette Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PaletteChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PaletteChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
