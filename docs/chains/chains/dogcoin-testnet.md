...
# Building contracts and apps on Dogcoin Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dogcoin Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Dogcoin Testnet. If you want to check details such as RPCs for Dogcoin Testnet, check out our [chainlist page for Dogcoin Testnet](https://thirdweb.com/dogcoin-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dogcoin Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dogcoin Testnet as the network
...
### Initialize SDK On Dogcoin Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dogcoin Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DogcoinTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DogcoinTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
