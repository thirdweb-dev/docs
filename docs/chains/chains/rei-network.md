...
# Building contracts and apps on REI Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on REI Network. By the end of the guide, you should be able to create smart contracts and dApps on REI Network. If you want to check details such as RPCs for REI Network, check out our [chainlist page for REI Network](https://thirdweb.com/rei-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to REI Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select REI Network as the network
...
### Initialize SDK On REI Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to REI Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ReiNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ReiNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
