...
# Building contracts and apps on Kava EVM Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Kava EVM Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Kava EVM Testnet. If you want to check details such as RPCs for Kava EVM Testnet, check out our [chainlist page for Kava EVM Testnet](https://thirdweb.com/kava-evm-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Kava EVM Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Kava EVM Testnet as the network
...
### Initialize SDK On Kava EVM Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Kava EVM Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={KavaEvmTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
