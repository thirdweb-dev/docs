...
# Building contracts and apps on Blockchain Genesis Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Blockchain Genesis Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Blockchain Genesis Mainnet. If you want to check details such as RPCs for Blockchain Genesis Mainnet, check out our [chainlist page for Blockchain Genesis Mainnet](https://thirdweb.com/blockchain-genesis).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Blockchain Genesis Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Blockchain Genesis Mainnet as the network
...
### Initialize SDK On Blockchain Genesis Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Blockchain Genesis Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BlockchainGenesis } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BlockchainGenesis}>
      <YourApp />
    </ThirdwebProvider>
  );
};
