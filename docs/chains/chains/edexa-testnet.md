...
# Building contracts and apps on edeXa Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on edeXa Testnet. By the end of the guide, you should be able to create smart contracts and dApps on edeXa Testnet. If you want to check details such as RPCs for edeXa Testnet, check out our [chainlist page for edeXa Testnet](https://thirdweb.com/edexa-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to edeXa Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select edeXa Testnet as the network
...
### Initialize SDK On edeXa Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to edeXa Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EdexaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EdexaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
