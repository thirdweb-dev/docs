...
# Building contracts and apps on WoopChain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on WoopChain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on WoopChain Mainnet. If you want to check details such as RPCs for WoopChain Mainnet, check out our [chainlist page for WoopChain Mainnet](https://thirdweb.com/woopchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to WoopChain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select WoopChain Mainnet as the network
...
### Initialize SDK On WoopChain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to WoopChain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Woopchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Woopchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
