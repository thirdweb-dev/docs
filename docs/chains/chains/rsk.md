...
# Building contracts and apps on RSK Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on RSK Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on RSK Mainnet. If you want to check details such as RPCs for RSK Mainnet, check out our [chainlist page for RSK Mainnet](https://thirdweb.com/rsk).
...
5. After modifying your contract with your desired custom logic, you may deploy it to RSK Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select RSK Mainnet as the network
...
### Initialize SDK On RSK Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to RSK Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Rsk } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Rsk}>
      <YourApp />
    </ThirdwebProvider>
  );
};
