...
# Building contracts and apps on MathChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MathChain. By the end of the guide, you should be able to create smart contracts and dApps on MathChain. If you want to check details such as RPCs for MathChain, check out our [chainlist page for MathChain](https://thirdweb.com/mathchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MathChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MathChain as the network
...
### Initialize SDK On MathChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MathChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Mathchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Mathchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
