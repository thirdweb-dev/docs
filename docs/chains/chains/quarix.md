...
# Building contracts and apps on Quarix

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Quarix. By the end of the guide, you should be able to create smart contracts and dApps on Quarix. If you want to check details such as RPCs for Quarix, check out our [chainlist page for Quarix](https://thirdweb.com/quarix).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Quarix using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Quarix as the network
...
### Initialize SDK On Quarix

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Quarix

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Quarix } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Quarix}>
      <YourApp />
    </ThirdwebProvider>
  );
};
