...
# Building contracts and apps on Garizon Testnet Stage1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Garizon Testnet Stage1. By the end of the guide, you should be able to create smart contracts and dApps on Garizon Testnet Stage1. If you want to check details such as RPCs for Garizon Testnet Stage1, check out our [chainlist page for Garizon Testnet Stage1](https://thirdweb.com/garizon-testnet-stage1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Garizon Testnet Stage1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Garizon Testnet Stage1 as the network
...
### Initialize SDK On Garizon Testnet Stage1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Garizon Testnet Stage1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GarizonTestnetStage1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GarizonTestnetStage1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
