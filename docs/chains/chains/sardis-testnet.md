...
# Building contracts and apps on Sardis Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Sardis Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Sardis Testnet. If you want to check details such as RPCs for Sardis Testnet, check out our [chainlist page for Sardis Testnet](https://thirdweb.com/sardis-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Sardis Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Sardis Testnet as the network
...
### Initialize SDK On Sardis Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Sardis Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SardisTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SardisTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
