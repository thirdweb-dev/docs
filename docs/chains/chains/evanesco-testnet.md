...
# Building contracts and apps on Evanesco Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Evanesco Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Evanesco Testnet. If you want to check details such as RPCs for Evanesco Testnet, check out our [chainlist page for Evanesco Testnet](https://thirdweb.com/evanesco-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Evanesco Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Evanesco Testnet as the network
...
### Initialize SDK On Evanesco Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Evanesco Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EvanescoTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EvanescoTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
