...
# Building contracts and apps on Findora Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Findora Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Findora Mainnet. If you want to check details such as RPCs for Findora Mainnet, check out our [chainlist page for Findora Mainnet](https://thirdweb.com/findora).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Findora Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Findora Mainnet as the network
...
### Initialize SDK On Findora Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Findora Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Findora } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Findora}>
      <YourApp />
    </ThirdwebProvider>
  );
};
