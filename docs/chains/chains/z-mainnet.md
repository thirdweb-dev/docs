...
# Building contracts and apps on MainnetZ Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MainnetZ Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on MainnetZ Mainnet. If you want to check details such as RPCs for MainnetZ Mainnet, check out our [chainlist page for MainnetZ Mainnet](https://thirdweb.com/z-mainnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MainnetZ Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MainnetZ Mainnet as the network
...
### Initialize SDK On MainnetZ Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MainnetZ Mainnet
