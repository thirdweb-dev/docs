...
# Building contracts and apps on Memo Smart Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Memo Smart Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Memo Smart Chain Mainnet. If you want to check details such as RPCs for Memo Smart Chain Mainnet, check out our [chainlist page for Memo Smart Chain Mainnet](https://thirdweb.com/memo-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Memo Smart Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Memo Smart Chain Mainnet as the network
...
### Initialize SDK On Memo Smart Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Memo Smart Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MemoSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MemoSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
