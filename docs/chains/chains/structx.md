...
# Building contracts and apps on Structx Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Structx Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Structx Mainnet. If you want to check details such as RPCs for Structx Mainnet, check out our [chainlist page for Structx Mainnet](https://thirdweb.com/structx).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Structx Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Structx Mainnet as the network
...
### Initialize SDK On Structx Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Structx Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Structx } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Structx}>
      <YourApp />
    </ThirdwebProvider>
  );
};
