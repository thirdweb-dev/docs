---
title: OKBChain Testnet
slug: /okbchain-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on OKBChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OKBChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on OKBChain Testnet. If you want to check details such as RPCs for OKBChain Testnet, check out our [chainlist page for OKBChain Testnet](https://thirdweb.com/okbchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OKBChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OKBChain Testnet as the network
...
### Initialize SDK On OKBChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OKBChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OkbchainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OkbchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
