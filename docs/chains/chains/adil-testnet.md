...
# Building contracts and apps on ADIL Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ADIL Testnet. By the end of the guide, you should be able to create smart contracts and dApps on ADIL Testnet. If you want to check details such as RPCs for ADIL Testnet, check out our [chainlist page for ADIL Testnet](https://thirdweb.com/adil-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ADIL Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ADIL Testnet as the network
...
### Initialize SDK On ADIL Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ADIL Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={AdilTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
