...
# Building contracts and apps on Armonia Eva Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Armonia Eva Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Armonia Eva Chain Mainnet. If you want to check details such as RPCs for Armonia Eva Chain Mainnet, check out our [chainlist page for Armonia Eva Chain Mainnet](https://thirdweb.com/armonia-eva-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Armonia Eva Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Armonia Eva Chain Mainnet as the network
...
### Initialize SDK On Armonia Eva Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Armonia Eva Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ArmoniaEvaChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ArmoniaEvaChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
