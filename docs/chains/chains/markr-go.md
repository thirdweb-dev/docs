...
# Building contracts and apps on Markr Go

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Markr Go. By the end of the guide, you should be able to create smart contracts and dApps on Markr Go. If you want to check details such as RPCs for Markr Go, check out our [chainlist page for Markr Go](https://thirdweb.com/markr-go).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Markr Go using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Markr Go as the network
...
### Initialize SDK On Markr Go

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Markr Go

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MarkrGo } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MarkrGo}>
      <YourApp />
    </ThirdwebProvider>
  );
};
