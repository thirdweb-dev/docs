...
# Building contracts and apps on PublicMint Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PublicMint Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on PublicMint Mainnet. If you want to check details such as RPCs for PublicMint Mainnet, check out our [chainlist page for PublicMint Mainnet](https://thirdweb.com/publicmint).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PublicMint Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PublicMint Mainnet as the network
...
### Initialize SDK On PublicMint Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PublicMint Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Publicmint } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Publicmint}>
      <YourApp />
    </ThirdwebProvider>
  );
};
