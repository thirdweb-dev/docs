...
# Building contracts and apps on ZetaChain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ZetaChain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on ZetaChain Mainnet. If you want to check details such as RPCs for ZetaChain Mainnet, check out our [chainlist page for ZetaChain Mainnet](https://thirdweb.com/zetachain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ZetaChain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ZetaChain Mainnet as the network
...
### Initialize SDK On ZetaChain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ZetaChain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Zetachain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Zetachain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
