...
# Building contracts and apps on Oasis Sapphire

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oasis Sapphire. By the end of the guide, you should be able to create smart contracts and dApps on Oasis Sapphire. If you want to check details such as RPCs for Oasis Sapphire, check out our [chainlist page for Oasis Sapphire](https://thirdweb.com/oasis-sapphire).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oasis Sapphire using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oasis Sapphire as the network
...
### Initialize SDK On Oasis Sapphire

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oasis Sapphire

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OasisSapphire } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OasisSapphire}>
      <YourApp />
    </ThirdwebProvider>
  );
};
