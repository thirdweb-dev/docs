...
# Building contracts and apps on Camelark Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Camelark Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Camelark Mainnet. If you want to check details such as RPCs for Camelark Mainnet, check out our [chainlist page for Camelark Mainnet](https://thirdweb.com/camelark).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Camelark Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Camelark Mainnet as the network
...
### Initialize SDK On Camelark Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Camelark Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Camelark } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Camelark}>
      <YourApp />
    </ThirdwebProvider>
  );
};
