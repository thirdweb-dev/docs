...
# Building contracts and apps on BeOne Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BeOne Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on BeOne Chain Mainnet. If you want to check details such as RPCs for BeOne Chain Mainnet, check out our [chainlist page for BeOne Chain Mainnet](https://thirdweb.com/beone-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BeOne Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BeOne Chain Mainnet as the network
...
### Initialize SDK On BeOne Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BeOne Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BeoneChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BeoneChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
