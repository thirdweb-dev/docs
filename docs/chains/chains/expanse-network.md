...
# Building contracts and apps on Expanse Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Expanse Network. By the end of the guide, you should be able to create smart contracts and dApps on Expanse Network. If you want to check details such as RPCs for Expanse Network, check out our [chainlist page for Expanse Network](https://thirdweb.com/expanse-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Expanse Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Expanse Network as the network
...
### Initialize SDK On Expanse Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Expanse Network
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={ExpanseNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
