...
# Building contracts and apps on EnterChain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on EnterChain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on EnterChain Mainnet. If you want to check details such as RPCs for EnterChain Mainnet, check out our [chainlist page for EnterChain Mainnet](https://thirdweb.com/enterchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to EnterChain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select EnterChain Mainnet as the network
...
### Initialize SDK On EnterChain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to EnterChain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Enterchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Enterchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
