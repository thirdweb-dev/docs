...
# Building contracts and apps on Sakura

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Sakura. By the end of the guide, you should be able to create smart contracts and dApps on Sakura. If you want to check details such as RPCs for Sakura, check out our [chainlist page for Sakura](https://thirdweb.com/sakura).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Sakura using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Sakura as the network
...
### Initialize SDK On Sakura

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Sakura

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Sakura } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Sakura}>
      <YourApp />
    </ThirdwebProvider>
  );
};
