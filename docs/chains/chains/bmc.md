...
# Building contracts and apps on BMC Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BMC Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on BMC Mainnet. If you want to check details such as RPCs for BMC Mainnet, check out our [chainlist page for BMC Mainnet](https://thirdweb.com/bmc).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BMC Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BMC Mainnet as the network
...
### Initialize SDK On BMC Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BMC Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bmc } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bmc}>
      <YourApp />
    </ThirdwebProvider>
  );
};
