...
# Building contracts and apps on Ganache

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ganache. By the end of the guide, you should be able to create smart contracts and dApps on Ganache. If you want to check details such as RPCs for Ganache, check out our [chainlist page for Ganache](https://thirdweb.com/ganache).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ganache using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ganache as the network
...
### Initialize SDK On Ganache

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ganache

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ganache } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ganache}>
      <YourApp />
    </ThirdwebProvider>
  );
};
