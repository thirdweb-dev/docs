...
# Building contracts and apps on Dogechain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dogechain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Dogechain Testnet. If you want to check details such as RPCs for Dogechain Testnet, check out our [chainlist page for Dogechain Testnet](https://thirdweb.com/dogechain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dogechain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dogechain Testnet as the network
...
### Initialize SDK On Dogechain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dogechain Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={DogechainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
