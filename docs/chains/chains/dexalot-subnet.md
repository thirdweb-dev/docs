...
# Building contracts and apps on Dexalot Subnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dexalot Subnet. By the end of the guide, you should be able to create smart contracts and dApps on Dexalot Subnet. If you want to check details such as RPCs for Dexalot Subnet, check out our [chainlist page for Dexalot Subnet](https://thirdweb.com/dexalot-subnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dexalot Subnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dexalot Subnet as the network
...
### Initialize SDK On Dexalot Subnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dexalot Subnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DexalotSubnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DexalotSubnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
