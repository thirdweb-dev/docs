...
# Building contracts and apps on IOLite

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on IOLite. By the end of the guide, you should be able to create smart contracts and dApps on IOLite. If you want to check details such as RPCs for IOLite, check out our [chainlist page for IOLite](https://thirdweb.com/iolite).
...
5. After modifying your contract with your desired custom logic, you may deploy it to IOLite using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select IOLite as the network
...
### Initialize SDK On IOLite

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to IOLite

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Iolite } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Iolite}>
      <YourApp />
    </ThirdwebProvider>
  );
};
