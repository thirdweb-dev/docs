...
# Building contracts and apps on Filecoin - Calibration testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Filecoin - Calibration testnet. By the end of the guide, you should be able to create smart contracts and dApps on Filecoin - Calibration testnet. If you want to check details such as RPCs for Filecoin - Calibration testnet, check out our [chainlist page for Filecoin - Calibration testnet](https://thirdweb.com/filecoin-calibration-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Filecoin - Calibration testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Filecoin - Calibration testnet as the network
...
### Initialize SDK On Filecoin - Calibration testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Filecoin - Calibration testnet
