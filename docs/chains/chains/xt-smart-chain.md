...
# Building contracts and apps on XT Smart Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on XT Smart Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on XT Smart Chain Mainnet. If you want to check details such as RPCs for XT Smart Chain Mainnet, check out our [chainlist page for XT Smart Chain Mainnet](https://thirdweb.com/xt-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to XT Smart Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select XT Smart Chain Mainnet as the network
...
### Initialize SDK On XT Smart Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to XT Smart Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { XtSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={XtSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
