...
# Building contracts and apps on Palm Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Palm Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Palm Testnet. If you want to check details such as RPCs for Palm Testnet, check out our [chainlist page for Palm Testnet](https://thirdweb.com/palm-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Palm Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Palm Testnet as the network
...
### Initialize SDK On Palm Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Palm Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PalmTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PalmTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
