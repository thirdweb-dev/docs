...
# Building contracts and apps on HashKey Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on HashKey Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on HashKey Chain Testnet. If you want to check details such as RPCs for HashKey Chain Testnet, check out our [chainlist page for HashKey Chain Testnet](https://thirdweb.com/hashkey-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to HashKey Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select HashKey Chain Testnet as the network
...
### Initialize SDK On HashKey Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to HashKey Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HashkeyChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HashkeyChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
