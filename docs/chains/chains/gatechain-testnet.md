...
# Building contracts and apps on GateChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on GateChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on GateChain Testnet. If you want to check details such as RPCs for GateChain Testnet, check out our [chainlist page for GateChain Testnet](https://thirdweb.com/gatechain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to GateChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select GateChain Testnet as the network
...
### Initialize SDK On GateChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to GateChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GatechainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GatechainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
