...
# Building contracts and apps on Ctex Scan Blockchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ctex Scan Blockchain. By the end of the guide, you should be able to create smart contracts and dApps on Ctex Scan Blockchain. If you want to check details such as RPCs for Ctex Scan Blockchain, check out our [chainlist page for Ctex Scan Blockchain](https://thirdweb.com/ctex-scan-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ctex Scan Blockchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ctex Scan Blockchain as the network
...
### Initialize SDK On Ctex Scan Blockchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ctex Scan Blockchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CtexScanBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CtexScanBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
