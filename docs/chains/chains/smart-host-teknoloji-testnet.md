...
# Building contracts and apps on Smart Host Teknoloji TESTNET

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Smart Host Teknoloji TESTNET. By the end of the guide, you should be able to create smart contracts and dApps on Smart Host Teknoloji TESTNET. If you want to check details such as RPCs for Smart Host Teknoloji TESTNET, check out our [chainlist page for Smart Host Teknoloji TESTNET](https://thirdweb.com/smart-host-teknoloji-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Smart Host Teknoloji TESTNET using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Smart Host Teknoloji TESTNET as the network
...
### Initialize SDK On Smart Host Teknoloji TESTNET

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Smart Host Teknoloji TESTNET

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SmartHostTeknolojiTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SmartHostTeknolojiTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
