...
# Building contracts and apps on AmStar Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on AmStar Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on AmStar Mainnet. If you want to check details such as RPCs for AmStar Mainnet, check out our [chainlist page for AmStar Mainnet](https://thirdweb.com/amstar).
...
5. After modifying your contract with your desired custom logic, you may deploy it to AmStar Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select AmStar Mainnet as the network
...
### Initialize SDK On AmStar Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to AmStar Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Amstar } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Amstar}>
      <YourApp />
    </ThirdwebProvider>
  );
};
