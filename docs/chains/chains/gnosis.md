...
# Building contracts and apps on Gnosis

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Gnosis. By the end of the guide, you should be able to create smart contracts and dApps on Gnosis. If you want to check details such as RPCs for Gnosis, check out our [chainlist page for Gnosis](https://thirdweb.com/gnosis).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Gnosis using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Gnosis as the network
...
### Initialize SDK On Gnosis

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Gnosis
