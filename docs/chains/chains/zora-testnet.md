...
# Building contracts and apps on Zora Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Zora Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Zora Testnet. If you want to check details such as RPCs for Zora Testnet, check out our [chainlist page for Zora Testnet](https://thirdweb.com/zora-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Zora Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Zora Testnet as the network
...
### Initialize SDK On Zora Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Zora Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={ZoraTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
