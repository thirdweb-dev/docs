...
# Building contracts and apps on Zeniq

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Zeniq. By the end of the guide, you should be able to create smart contracts and dApps on Zeniq. If you want to check details such as RPCs for Zeniq, check out our [chainlist page for Zeniq](https://thirdweb.com/zeniq).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Zeniq using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Zeniq

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Zeniq

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Zeniq } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Zeniq}>
      <YourApp />
    </ThirdwebProvider>
  );
};
