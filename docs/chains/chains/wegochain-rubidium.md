...
# Building contracts and apps on Wegochain Rubidium Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Wegochain Rubidium Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Wegochain Rubidium Mainnet. If you want to check details such as RPCs for Wegochain Rubidium Mainnet, check out our [chainlist page for Wegochain Rubidium Mainnet](https://thirdweb.com/wegochain-rubidium).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Wegochain Rubidium Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Wegochain Rubidium Mainnet as the network
...
### Initialize SDK On Wegochain Rubidium Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Wegochain Rubidium Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { WegochainRubidium } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={WegochainRubidium}>
      <YourApp />
    </ThirdwebProvider>
  );
};
