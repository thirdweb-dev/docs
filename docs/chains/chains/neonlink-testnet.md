...
# Building contracts and apps on Neonlink Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Neonlink Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Neonlink Testnet. If you want to check details such as RPCs for Neonlink Testnet, check out our [chainlist page for Neonlink Testnet](https://thirdweb.com/neonlink-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Neonlink Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Neonlink Testnet as the network
...
### Initialize SDK On Neonlink Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Neonlink Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { NeonlinkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={NeonlinkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
