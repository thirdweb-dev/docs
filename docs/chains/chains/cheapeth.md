...
# Building contracts and apps on cheapETH

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on cheapETH. By the end of the guide, you should be able to create smart contracts and dApps on cheapETH. If you want to check details such as RPCs for cheapETH, check out our [chainlist page for cheapETH](https://thirdweb.com/cheapeth).
...
5. After modifying your contract with your desired custom logic, you may deploy it to cheapETH using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select cheapETH as the network
...
### Initialize SDK On cheapETH

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to cheapETH

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Cheapeth } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Cheapeth}>
      <YourApp />
    </ThirdwebProvider>
  );
};
