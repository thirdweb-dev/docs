...
# Building contracts and apps on Scroll Alpha Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Scroll Alpha Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Scroll Alpha Testnet. If you want to check details such as RPCs for Scroll Alpha Testnet, check out our [chainlist page for Scroll Alpha Testnet](https://thirdweb.com/scroll-alpha-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Scroll Alpha Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Scroll Alpha Testnet as the network
...
### Initialize SDK On Scroll Alpha Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Scroll Alpha Testnet
