...
# Building contracts and apps on Soverun Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Soverun Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Soverun Mainnet. If you want to check details such as RPCs for Soverun Mainnet, check out our [chainlist page for Soverun Mainnet](https://thirdweb.com/soverun).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Soverun Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Soverun Mainnet as the network
...
### Initialize SDK On Soverun Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Soverun Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Soverun } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Soverun}>
      <YourApp />
    </ThirdwebProvider>
  );
};
