...
# Building contracts and apps on Super Smart Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Super Smart Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Super Smart Chain Mainnet. If you want to check details such as RPCs for Super Smart Chain Mainnet, check out our [chainlist page for Super Smart Chain Mainnet](https://thirdweb.com/super-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Super Smart Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Super Smart Chain Mainnet as the network
...
### Initialize SDK On Super Smart Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Super Smart Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SuperSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SuperSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
