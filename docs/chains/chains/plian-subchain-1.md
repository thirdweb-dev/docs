...
# Building contracts and apps on Plian Mainnet Subchain 1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Plian Mainnet Subchain 1. By the end of the guide, you should be able to create smart contracts and dApps on Plian Mainnet Subchain 1. If you want to check details such as RPCs for Plian Mainnet Subchain 1, check out our [chainlist page for Plian Mainnet Subchain 1](https://thirdweb.com/plian-subchain-1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Plian Mainnet Subchain 1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Plian Mainnet Subchain 1 as the network
...
### Initialize SDK On Plian Mainnet Subchain 1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Plian Mainnet Subchain 1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PlianSubchain1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PlianSubchain1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
