...
# Building contracts and apps on Aves Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Aves Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Aves Mainnet. If you want to check details such as RPCs for Aves Mainnet, check out our [chainlist page for Aves Mainnet](https://thirdweb.com/aves).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Aves Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Aves Mainnet as the network
...
### Initialize SDK On Aves Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Aves Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Aves } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Aves}>
      <YourApp />
    </ThirdwebProvider>
  );
};
