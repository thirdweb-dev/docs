...
# Building contracts and apps on Worlds Caldera

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Worlds Caldera. By the end of the guide, you should be able to create smart contracts and dApps on Worlds Caldera. If you want to check details such as RPCs for Worlds Caldera, check out our [chainlist page for Worlds Caldera](https://thirdweb.com/worlds-caldera).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Worlds Caldera using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Worlds Caldera as the network
...
### Initialize SDK On Worlds Caldera

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Worlds Caldera

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { WorldsCaldera } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={WorldsCaldera}>
      <YourApp />
    </ThirdwebProvider>
  );
};
