...
# Building contracts and apps on Arbitrum Goerli

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Arbitrum Goerli. By the end of the guide, you should be able to create smart contracts and dApps on Arbitrum Goerli. If you want to check details such as RPCs for Arbitrum Goerli, check out our [chainlist page for Arbitrum Goerli](https://thirdweb.com/arbitrum-goerli).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Arbitrum Goerli using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Arbitrum Goerli as the network
...
### Initialize SDK On Arbitrum Goerli

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Arbitrum Goerli
