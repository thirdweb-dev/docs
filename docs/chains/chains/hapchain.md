...
# Building contracts and apps on HAPchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on HAPchain. By the end of the guide, you should be able to create smart contracts and dApps on HAPchain. If you want to check details such as RPCs for HAPchain, check out our [chainlist page for HAPchain](https://thirdweb.com/hapchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to HAPchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select HAPchain as the network
...
### Initialize SDK On HAPchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to HAPchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Hapchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Hapchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
