...
# Building contracts and apps on Alyx Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Alyx Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Alyx Mainnet. If you want to check details such as RPCs for Alyx Mainnet, check out our [chainlist page for Alyx Mainnet](https://thirdweb.com/alyx).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Alyx Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Alyx Mainnet as the network
...
### Initialize SDK On Alyx Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Alyx Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Alyx } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Alyx}>
      <YourApp />
    </ThirdwebProvider>
  );
};
