...
# Building contracts and apps on Eleanor

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Eleanor. By the end of the guide, you should be able to create smart contracts and dApps on Eleanor. If you want to check details such as RPCs for Eleanor, check out our [chainlist page for Eleanor](https://thirdweb.com/eleanor).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Eleanor using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Eleanor as the network
...
### Initialize SDK On Eleanor

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Eleanor

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Eleanor } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Eleanor}>
      <YourApp />
    </ThirdwebProvider>
  );
};
