...
# Building contracts and apps on Rikeza Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rikeza Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Rikeza Network Testnet. If you want to check details such as RPCs for Rikeza Network Testnet, check out our [chainlist page for Rikeza Network Testnet](https://thirdweb.com/rikeza-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rikeza Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rikeza Network Testnet as the network
...
### Initialize SDK On Rikeza Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rikeza Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { RikezaNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={RikezaNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
