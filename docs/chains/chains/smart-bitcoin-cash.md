...
# Building contracts and apps on Smart Bitcoin Cash

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Smart Bitcoin Cash. By the end of the guide, you should be able to create smart contracts and dApps on Smart Bitcoin Cash. If you want to check details such as RPCs for Smart Bitcoin Cash, check out our [chainlist page for Smart Bitcoin Cash](https://thirdweb.com/smart-bitcoin-cash).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Smart Bitcoin Cash using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Smart Bitcoin Cash as the network
...
### Initialize SDK On Smart Bitcoin Cash

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Smart Bitcoin Cash

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SmartBitcoinCash } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SmartBitcoinCash}>
      <YourApp />
    </ThirdwebProvider>
  );
};
