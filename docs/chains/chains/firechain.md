...
# Building contracts and apps on Firechain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Firechain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Firechain Mainnet. If you want to check details such as RPCs for Firechain Mainnet, check out our [chainlist page for Firechain Mainnet](https://thirdweb.com/firechain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Firechain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Firechain Mainnet as the network
...
### Initialize SDK On Firechain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Firechain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Firechain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Firechain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
