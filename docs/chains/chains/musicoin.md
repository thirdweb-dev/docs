...
# Building contracts and apps on Musicoin

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Musicoin. By the end of the guide, you should be able to create smart contracts and dApps on Musicoin. If you want to check details such as RPCs for Musicoin, check out our [chainlist page for Musicoin](https://thirdweb.com/musicoin).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Musicoin using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Musicoin as the network
...
### Initialize SDK On Musicoin

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Musicoin

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Musicoin } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Musicoin}>
      <YourApp />
    </ThirdwebProvider>
  );
};
