...
# Building contracts and apps on ARC Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ARC Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on ARC Mainnet. If you want to check details such as RPCs for ARC Mainnet, check out our [chainlist page for ARC Mainnet](https://thirdweb.com/arc).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ARC Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ARC Mainnet as the network
...
### Initialize SDK On ARC Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ARC Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Arc } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Arc}>
      <YourApp />
    </ThirdwebProvider>
  );
};
