...
# Building contracts and apps on Elysium Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Elysium Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Elysium Testnet. If you want to check details such as RPCs for Elysium Testnet, check out our [chainlist page for Elysium Testnet](https://thirdweb.com/elysium-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Elysium Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Elysium Testnet as the network
...
### Initialize SDK On Elysium Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Elysium Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={ElysiumTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
