...
# Building contracts and apps on Hedera Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Hedera Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Hedera Testnet. If you want to check details such as RPCs for Hedera Testnet, check out our [chainlist page for Hedera Testnet](https://thirdweb.com/hedera-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Hedera Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Hedera Testnet as the network
...
### Initialize SDK On Hedera Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Hedera Testnet
