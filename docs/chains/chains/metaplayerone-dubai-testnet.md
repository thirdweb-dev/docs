...
# Building contracts and apps on Metaplayerone Dubai Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Metaplayerone Dubai Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Metaplayerone Dubai Testnet. If you want to check details such as RPCs for Metaplayerone Dubai Testnet, check out our [chainlist page for Metaplayerone Dubai Testnet](https://thirdweb.com/metaplayerone-dubai-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Metaplayerone Dubai Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Metaplayerone Dubai Testnet as the network
...
### Initialize SDK On Metaplayerone Dubai Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Metaplayerone Dubai Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MetaplayeroneDubaiTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MetaplayeroneDubaiTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
