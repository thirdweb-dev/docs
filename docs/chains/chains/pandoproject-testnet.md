...
# Building contracts and apps on PandoProject Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PandoProject Testnet. By the end of the guide, you should be able to create smart contracts and dApps on PandoProject Testnet. If you want to check details such as RPCs for PandoProject Testnet, check out our [chainlist page for PandoProject Testnet](https://thirdweb.com/pandoproject-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PandoProject Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PandoProject Testnet as the network
...
### Initialize SDK On PandoProject Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PandoProject Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PandoprojectTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PandoprojectTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
