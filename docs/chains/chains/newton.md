...
# Building contracts and apps on Newton

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Newton. By the end of the guide, you should be able to create smart contracts and dApps on Newton. If you want to check details such as RPCs for Newton, check out our [chainlist page for Newton](https://thirdweb.com/newton).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Newton using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Newton as the network
...
### Initialize SDK On Newton

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Newton

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Newton } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Newton}>
      <YourApp />
    </ThirdwebProvider>
  );
};
