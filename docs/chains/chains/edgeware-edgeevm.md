...
# Building contracts and apps on Edgeware EdgeEVM Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Edgeware EdgeEVM Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Edgeware EdgeEVM Mainnet. If you want to check details such as RPCs for Edgeware EdgeEVM Mainnet, check out our [chainlist page for Edgeware EdgeEVM Mainnet](https://thirdweb.com/edgeware-edgeevm).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Edgeware EdgeEVM Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Edgeware EdgeEVM Mainnet as the network
...
### Initialize SDK On Edgeware EdgeEVM Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Edgeware EdgeEVM Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={EdgewareEdgeevm}>
      <YourApp />
    </ThirdwebProvider>
  );
};
