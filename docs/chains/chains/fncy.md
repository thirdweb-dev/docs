...
# Building contracts and apps on FNCY

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on FNCY. By the end of the guide, you should be able to create smart contracts and dApps on FNCY. If you want to check details such as RPCs for FNCY, check out our [chainlist page for FNCY](https://thirdweb.com/fncy).
...
5. After modifying your contract with your desired custom logic, you may deploy it to FNCY using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On FNCY

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to FNCY

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Fncy } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Fncy}>
      <YourApp />
    </ThirdwebProvider>
  );
};
