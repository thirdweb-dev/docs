...
# Building contracts and apps on Rise of the Warbots Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rise of the Warbots Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Rise of the Warbots Testnet. If you want to check details such as RPCs for Rise of the Warbots Testnet, check out our [chainlist page for Rise of the Warbots Testnet](https://thirdweb.com/rise-of-the-warbots-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rise of the Warbots Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rise of the Warbots Testnet as the network
...
### Initialize SDK On Rise of the Warbots Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rise of the Warbots Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { RiseOfTheWarbotsTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={RiseOfTheWarbotsTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
