...
# Building contracts and apps on Thinkium Testnet Chain 1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Thinkium Testnet Chain 1. By the end of the guide, you should be able to create smart contracts and dApps on Thinkium Testnet Chain 1. If you want to check details such as RPCs for Thinkium Testnet Chain 1, check out our [chainlist page for Thinkium Testnet Chain 1](https://thirdweb.com/thinkium-testnet-chain-1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Thinkium Testnet Chain 1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Thinkium Testnet Chain 1 as the network
...
### Initialize SDK On Thinkium Testnet Chain 1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Thinkium Testnet Chain 1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ThinkiumTestnetChain1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ThinkiumTestnetChain1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
