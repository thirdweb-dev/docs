...
# Building contracts and apps on Zeeth Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Zeeth Chain. By the end of the guide, you should be able to create smart contracts and dApps on Zeeth Chain. If you want to check details such as RPCs for Zeeth Chain, check out our [chainlist page for Zeeth Chain](https://thirdweb.com/zeeth-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Zeeth Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Zeeth Chain as the network
...
### Initialize SDK On Zeeth Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Zeeth Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ZeethChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ZeethChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
