...
# Building contracts and apps on PHI Network v2

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PHI Network v2. By the end of the guide, you should be able to create smart contracts and dApps on PHI Network v2. If you want to check details such as RPCs for PHI Network v2, check out our [chainlist page for PHI Network v2](https://thirdweb.com/phi-network-v2).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PHI Network v2 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PHI Network v2 as the network
...
### Initialize SDK On PHI Network v2

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PHI Network v2

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PhiNetworkV2 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PhiNetworkV2}>
      <YourApp />
    </ThirdwebProvider>
  );
};
