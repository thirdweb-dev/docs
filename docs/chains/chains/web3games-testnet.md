...
# Building contracts and apps on Web3Games Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Web3Games Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Web3Games Testnet. If you want to check details such as RPCs for Web3Games Testnet, check out our [chainlist page for Web3Games Testnet](https://thirdweb.com/web3games-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Web3Games Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Web3Games Testnet as the network
...
### Initialize SDK On Web3Games Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Web3Games Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Web3gamesTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Web3gamesTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
