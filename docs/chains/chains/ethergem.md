...
# Building contracts and apps on EtherGem

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on EtherGem. By the end of the guide, you should be able to create smart contracts and dApps on EtherGem. If you want to check details such as RPCs for EtherGem, check out our [chainlist page for EtherGem](https://thirdweb.com/ethergem).
...
5. After modifying your contract with your desired custom logic, you may deploy it to EtherGem using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select EtherGem as the network
...
### Initialize SDK On EtherGem

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to EtherGem
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Ethergem}>
      <YourApp />
    </ThirdwebProvider>
  );
};
