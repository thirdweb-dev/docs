...
# Building contracts and apps on Haqq Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Haqq Network. By the end of the guide, you should be able to create smart contracts and dApps on Haqq Network. If you want to check details such as RPCs for Haqq Network, check out our [chainlist page for Haqq Network](https://thirdweb.com/haqq-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Haqq Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Haqq Network as the network
...
### Initialize SDK On Haqq Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Haqq Network
