...
# Building contracts and apps on VeChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on VeChain. By the end of the guide, you should be able to create smart contracts and dApps on VeChain. If you want to check details such as RPCs for VeChain, check out our [chainlist page for VeChain](https://thirdweb.com/vechain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to VeChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select VeChain as the network
...
### Initialize SDK On VeChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to VeChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Vechain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Vechain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
