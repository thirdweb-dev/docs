...
# Building contracts and apps on KCC Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on KCC Testnet. By the end of the guide, you should be able to create smart contracts and dApps on KCC Testnet. If you want to check details such as RPCs for KCC Testnet, check out our [chainlist page for KCC Testnet](https://thirdweb.com/kcc-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to KCC Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select KCC Testnet as the network
...
### Initialize SDK On KCC Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to KCC Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { KccTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={KccTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
