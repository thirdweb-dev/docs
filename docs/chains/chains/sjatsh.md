...
# Building contracts and apps on SJATSH

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SJATSH. By the end of the guide, you should be able to create smart contracts and dApps on SJATSH. If you want to check details such as RPCs for SJATSH, check out our [chainlist page for SJATSH](https://thirdweb.com/sjatsh).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SJATSH using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SJATSH as the network
...
### Initialize SDK On SJATSH

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SJATSH

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Sjatsh } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Sjatsh}>
      <YourApp />
    </ThirdwebProvider>
  );
};
