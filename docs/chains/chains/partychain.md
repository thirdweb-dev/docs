...
# Building contracts and apps on PartyChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PartyChain. By the end of the guide, you should be able to create smart contracts and dApps on PartyChain. If you want to check details such as RPCs for PartyChain, check out our [chainlist page for PartyChain](https://thirdweb.com/partychain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PartyChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PartyChain as the network
...
### Initialize SDK On PartyChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PartyChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Partychain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Partychain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
