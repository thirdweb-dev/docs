...
# Building contracts and apps on QL1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on QL1. By the end of the guide, you should be able to create smart contracts and dApps on QL1. If you want to check details such as RPCs for QL1, check out our [chainlist page for QL1](https://thirdweb.com/ql1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to QL1 using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On QL1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to QL1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ql1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ql1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
