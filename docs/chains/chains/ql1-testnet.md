...
# Building contracts and apps on QL1 Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on QL1 Testnet. By the end of the guide, you should be able to create smart contracts and dApps on QL1 Testnet. If you want to check details such as RPCs for QL1 Testnet, check out our [chainlist page for QL1 Testnet](https://thirdweb.com/ql1-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to QL1 Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select QL1 Testnet as the network
...
### Initialize SDK On QL1 Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to QL1 Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ql1Testnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ql1Testnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
