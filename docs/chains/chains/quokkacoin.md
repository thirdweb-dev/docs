...
# Building contracts and apps on Quokkacoin Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Quokkacoin Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Quokkacoin Mainnet. If you want to check details such as RPCs for Quokkacoin Mainnet, check out our [chainlist page for Quokkacoin Mainnet](https://thirdweb.com/quokkacoin).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Quokkacoin Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Quokkacoin Mainnet as the network
...
### Initialize SDK On Quokkacoin Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Quokkacoin Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Quokkacoin } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Quokkacoin}>
      <YourApp />
    </ThirdwebProvider>
  );
};
