...
# Building contracts and apps on Meld

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Meld. By the end of the guide, you should be able to create smart contracts and dApps on Meld. If you want to check details such as RPCs for Meld, check out our [chainlist page for Meld](https://thirdweb.com/meld).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Meld using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Meld

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Meld

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Meld } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Meld}>
      <YourApp />
    </ThirdwebProvider>
  );
};
