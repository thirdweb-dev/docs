...
# Building contracts and apps on Theta Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Theta Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Theta Testnet. If you want to check details such as RPCs for Theta Testnet, check out our [chainlist page for Theta Testnet](https://thirdweb.com/theta-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Theta Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Theta Testnet as the network
...
### Initialize SDK On Theta Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Theta Testnet
