...
# Building contracts and apps on Excoincial Chain Volta-Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Excoincial Chain Volta-Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Excoincial Chain Volta-Testnet. If you want to check details such as RPCs for Excoincial Chain Volta-Testnet, check out our [chainlist page for Excoincial Chain Volta-Testnet](https://thirdweb.com/excoincial-chain-volta-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Excoincial Chain Volta-Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Excoincial Chain Volta-Testnet as the network
...
### Initialize SDK On Excoincial Chain Volta-Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Excoincial Chain Volta-Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ExcoincialChainVoltaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ExcoincialChainVoltaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
