...
# Building contracts and apps on Optimism

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Optimism. By the end of the guide, you should be able to create smart contracts and dApps on Optimism. If you want to check details such as RPCs for Optimism, check out our [chainlist page for Optimism](https://thirdweb.com/optimism).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Optimism using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Optimism

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Optimism
