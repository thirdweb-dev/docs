...
# Building contracts and apps on Opside Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Opside Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Opside Testnet. If you want to check details such as RPCs for Opside Testnet, check out our [chainlist page for Opside Testnet](https://thirdweb.com/opside-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Opside Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Opside Testnet as the network
...
### Initialize SDK On Opside Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Opside Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OpsideTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OpsideTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
