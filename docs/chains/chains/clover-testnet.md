...
# Building contracts and apps on Clover Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Clover Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Clover Testnet. If you want to check details such as RPCs for Clover Testnet, check out our [chainlist page for Clover Testnet](https://thirdweb.com/clover-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Clover Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Clover Testnet as the network
...
### Initialize SDK On Clover Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Clover Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={CloverTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
