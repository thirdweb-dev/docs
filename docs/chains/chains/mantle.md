...
# Building contracts and apps on Mantle

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Mantle. By the end of the guide, you should be able to create smart contracts and dApps on Mantle. If you want to check details such as RPCs for Mantle, check out our [chainlist page for Mantle](https://thirdweb.com/mantle).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Mantle using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Mantle as the network
...
### Initialize SDK On Mantle

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Mantle
