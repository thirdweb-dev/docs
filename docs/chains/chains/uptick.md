...
# Building contracts and apps on Uptick Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Uptick Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Uptick Mainnet. If you want to check details such as RPCs for Uptick Mainnet, check out our [chainlist page for Uptick Mainnet](https://thirdweb.com/uptick).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Uptick Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Uptick Mainnet as the network
...
### Initialize SDK On Uptick Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Uptick Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Uptick } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Uptick}>
      <YourApp />
    </ThirdwebProvider>
  );
};
