...
# Building contracts and apps on Hammer Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Hammer Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Hammer Chain Mainnet. If you want to check details such as RPCs for Hammer Chain Mainnet, check out our [chainlist page for Hammer Chain Mainnet](https://thirdweb.com/hammer-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Hammer Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Hammer Chain Mainnet as the network
...
### Initialize SDK On Hammer Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Hammer Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HammerChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HammerChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
