...
# Building contracts and apps on WEMIX3.0 Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on WEMIX3.0 Testnet. By the end of the guide, you should be able to create smart contracts and dApps on WEMIX3.0 Testnet. If you want to check details such as RPCs for WEMIX3.0 Testnet, check out our [chainlist page for WEMIX3.0 Testnet](https://thirdweb.com/wemix3-0-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to WEMIX3.0 Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select WEMIX3.0 Testnet as the network
...
### Initialize SDK On WEMIX3.0 Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to WEMIX3.0 Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Wemix30Testnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Wemix30Testnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
