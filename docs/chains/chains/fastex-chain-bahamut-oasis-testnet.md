...
# Building contracts and apps on Fastex Chain (Bahamut) Oasis Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Fastex Chain (Bahamut) Oasis Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Fastex Chain (Bahamut) Oasis Testnet. If you want to check details such as RPCs for Fastex Chain (Bahamut) Oasis Testnet, check out our [chainlist page for Fastex Chain (Bahamut) Oasis Testnet](https://thirdweb.com/fastex-chain-bahamut-oasis-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Fastex Chain (Bahamut) Oasis Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Fastex Chain (Bahamut) Oasis Testnet as the network
...
### Initialize SDK On Fastex Chain (Bahamut) Oasis Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Fastex Chain (Bahamut) Oasis Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FastexChainBahamutOasisTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FastexChainBahamutOasisTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
