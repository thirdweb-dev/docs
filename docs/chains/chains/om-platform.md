...
# Building contracts and apps on OM Platform Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OM Platform Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on OM Platform Mainnet. If you want to check details such as RPCs for OM Platform Mainnet, check out our [chainlist page for OM Platform Mainnet](https://thirdweb.com/om-platform).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OM Platform Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OM Platform Mainnet as the network
...
### Initialize SDK On OM Platform Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OM Platform Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OmPlatform } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OmPlatform}>
      <YourApp />
    </ThirdwebProvider>
  );
};
