...
# Building contracts and apps on Chiliz Scoville Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Chiliz Scoville Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Chiliz Scoville Testnet. If you want to check details such as RPCs for Chiliz Scoville Testnet, check out our [chainlist page for Chiliz Scoville Testnet](https://thirdweb.com/chiliz-scoville-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Chiliz Scoville Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Chiliz Scoville Testnet as the network
...
### Initialize SDK On Chiliz Scoville Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Chiliz Scoville Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ChilizScovilleTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ChilizScovilleTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
