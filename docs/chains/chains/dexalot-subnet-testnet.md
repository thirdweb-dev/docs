...
# Building contracts and apps on Dexalot Subnet Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dexalot Subnet Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Dexalot Subnet Testnet. If you want to check details such as RPCs for Dexalot Subnet Testnet, check out our [chainlist page for Dexalot Subnet Testnet](https://thirdweb.com/dexalot-subnet-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dexalot Subnet Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dexalot Subnet Testnet as the network
...
### Initialize SDK On Dexalot Subnet Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dexalot Subnet Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DexalotSubnetTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DexalotSubnetTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
