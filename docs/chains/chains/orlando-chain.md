...
# Building contracts and apps on Orlando Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Orlando Chain. By the end of the guide, you should be able to create smart contracts and dApps on Orlando Chain. If you want to check details such as RPCs for Orlando Chain, check out our [chainlist page for Orlando Chain](https://thirdweb.com/orlando-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Orlando Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Orlando Chain as the network
...
### Initialize SDK On Orlando Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Orlando Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OrlandoChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OrlandoChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
