...
# Building contracts and apps on Telos EVM Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Telos EVM Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Telos EVM Mainnet. If you want to check details such as RPCs for Telos EVM Mainnet, check out our [chainlist page for Telos EVM Mainnet](https://thirdweb.com/telos-evm).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Telos EVM Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Telos EVM Mainnet as the network
...
### Initialize SDK On Telos EVM Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Telos EVM Mainnet
