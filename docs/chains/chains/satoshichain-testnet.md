...
# Building contracts and apps on SatoshiChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SatoshiChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on SatoshiChain Testnet. If you want to check details such as RPCs for SatoshiChain Testnet, check out our [chainlist page for SatoshiChain Testnet](https://thirdweb.com/satoshichain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SatoshiChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SatoshiChain Testnet as the network
...
### Initialize SDK On SatoshiChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SatoshiChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SatoshichainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SatoshichainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
