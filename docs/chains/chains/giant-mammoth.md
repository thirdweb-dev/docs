...
# Building contracts and apps on Giant Mammoth Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Giant Mammoth Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Giant Mammoth Mainnet. If you want to check details such as RPCs for Giant Mammoth Mainnet, check out our [chainlist page for Giant Mammoth Mainnet](https://thirdweb.com/giant-mammoth).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Giant Mammoth Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Giant Mammoth Mainnet as the network
...
### Initialize SDK On Giant Mammoth Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Giant Mammoth Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GiantMammoth } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GiantMammoth}>
      <YourApp />
    </ThirdwebProvider>
  );
};
