...
# Building contracts and apps on DOS Tesnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DOS Tesnet. By the end of the guide, you should be able to create smart contracts and dApps on DOS Tesnet. If you want to check details such as RPCs for DOS Tesnet, check out our [chainlist page for DOS Tesnet](https://thirdweb.com/dos-tesnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DOS Tesnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DOS Tesnet as the network
...
### Initialize SDK On DOS Tesnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DOS Tesnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DosTesnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DosTesnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
