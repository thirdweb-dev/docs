...
# Building contracts and apps on Molereum Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Molereum Network. By the end of the guide, you should be able to create smart contracts and dApps on Molereum Network. If you want to check details such as RPCs for Molereum Network, check out our [chainlist page for Molereum Network](https://thirdweb.com/molereum-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Molereum Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Molereum Network as the network
...
### Initialize SDK On Molereum Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Molereum Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MolereumNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MolereumNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
