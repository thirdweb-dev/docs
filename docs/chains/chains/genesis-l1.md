...
# Building contracts and apps on Genesis L1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Genesis L1. By the end of the guide, you should be able to create smart contracts and dApps on Genesis L1. If you want to check details such as RPCs for Genesis L1, check out our [chainlist page for Genesis L1](https://thirdweb.com/genesis-l1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Genesis L1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Genesis L1 as the network
...
### Initialize SDK On Genesis L1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Genesis L1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GenesisL1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GenesisL1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
