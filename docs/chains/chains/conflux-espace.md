...
# Building contracts and apps on Conflux eSpace

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Conflux eSpace. By the end of the guide, you should be able to create smart contracts and dApps on Conflux eSpace. If you want to check details such as RPCs for Conflux eSpace, check out our [chainlist page for Conflux eSpace](https://thirdweb.com/conflux-espace).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Conflux eSpace using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Conflux eSpace

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Conflux eSpace
