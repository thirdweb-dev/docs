...
# Building contracts and apps on Milkomeda C1 Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Milkomeda C1 Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Milkomeda C1 Testnet. If you want to check details such as RPCs for Milkomeda C1 Testnet, check out our [chainlist page for Milkomeda C1 Testnet](https://thirdweb.com/milkomeda-c1-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Milkomeda C1 Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Milkomeda C1 Testnet as the network
...
### Initialize SDK On Milkomeda C1 Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Milkomeda C1 Testnet
