...
# Building contracts and apps on Planq Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Planq Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Planq Mainnet. If you want to check details such as RPCs for Planq Mainnet, check out our [chainlist page for Planq Mainnet](https://thirdweb.com/planq).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Planq Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Planq Mainnet as the network
...
### Initialize SDK On Planq Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Planq Mainnet
