...
# Building contracts and apps on Bitindi Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bitindi Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Bitindi Testnet. If you want to check details such as RPCs for Bitindi Testnet, check out our [chainlist page for Bitindi Testnet](https://thirdweb.com/bitindi-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bitindi Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bitindi Testnet as the network
...
### Initialize SDK On Bitindi Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bitindi Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={BitindiTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
