...
# Building contracts and apps on SPS Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SPS Testnet. By the end of the guide, you should be able to create smart contracts and dApps on SPS Testnet. If you want to check details such as RPCs for SPS Testnet, check out our [chainlist page for SPS Testnet](https://thirdweb.com/sps-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SPS Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SPS Testnet as the network
...
### Initialize SDK On SPS Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SPS Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SpsTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SpsTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
