...
# Building contracts and apps on Ambros Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ambros Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Ambros Chain Mainnet. If you want to check details such as RPCs for Ambros Chain Mainnet, check out our [chainlist page for Ambros Chain Mainnet](https://thirdweb.com/ambros-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ambros Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ambros Chain Mainnet as the network
...
### Initialize SDK On Ambros Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ambros Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AmbrosChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AmbrosChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
