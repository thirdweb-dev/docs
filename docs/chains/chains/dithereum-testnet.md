---
title: Dithereum Testnet
slug: /dithereum-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Dithereum Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dithereum Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Dithereum Testnet. If you want to check details such as RPCs for Dithereum Testnet, check out our [chainlist page for Dithereum Testnet](https://thirdweb.com/dithereum-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dithereum Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dithereum Testnet as the network
...
### Initialize SDK On Dithereum Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dithereum Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DithereumTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DithereumTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
