...
# Building contracts and apps on DecentraBone Layer1 Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DecentraBone Layer1 Testnet. By the end of the guide, you should be able to create smart contracts and dApps on DecentraBone Layer1 Testnet. If you want to check details such as RPCs for DecentraBone Layer1 Testnet, check out our [chainlist page for DecentraBone Layer1 Testnet](https://thirdweb.com/decentrabone-layer1-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DecentraBone Layer1 Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DecentraBone Layer1 Testnet as the network
...
### Initialize SDK On DecentraBone Layer1 Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DecentraBone Layer1 Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DecentraboneLayer1Testnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DecentraboneLayer1Testnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
