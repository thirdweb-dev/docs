...
# Building contracts and apps on POA Network Sokol

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on POA Network Sokol. By the end of the guide, you should be able to create smart contracts and dApps on POA Network Sokol. If you want to check details such as RPCs for POA Network Sokol, check out our [chainlist page for POA Network Sokol](https://thirdweb.com/poa-network-sokol).
...
5. After modifying your contract with your desired custom logic, you may deploy it to POA Network Sokol using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select POA Network Sokol as the network
...
### Initialize SDK On POA Network Sokol

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to POA Network Sokol

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PoaNetworkSokol } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PoaNetworkSokol}>
      <YourApp />
    </ThirdwebProvider>
  );
};
