...
# Building contracts and apps on Mammoth Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Mammoth Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Mammoth Mainnet. If you want to check details such as RPCs for Mammoth Mainnet, check out our [chainlist page for Mammoth Mainnet](https://thirdweb.com/mammoth).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Mammoth Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Mammoth Mainnet as the network
...
### Initialize SDK On Mammoth Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Mammoth Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Mammoth } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Mammoth}>
      <YourApp />
    </ThirdwebProvider>
  );
};
