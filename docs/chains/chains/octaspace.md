...
# Building contracts and apps on OctaSpace

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OctaSpace. By the end of the guide, you should be able to create smart contracts and dApps on OctaSpace. If you want to check details such as RPCs for OctaSpace, check out our [chainlist page for OctaSpace](https://thirdweb.com/octaspace).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OctaSpace using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OctaSpace as the network
...
### Initialize SDK On OctaSpace

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OctaSpace

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Octaspace } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Octaspace}>
      <YourApp />
    </ThirdwebProvider>
  );
};
