...
# Building contracts and apps on Hika Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Hika Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Hika Network Testnet. If you want to check details such as RPCs for Hika Network Testnet, check out our [chainlist page for Hika Network Testnet](https://thirdweb.com/hika-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Hika Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Hika Network Testnet as the network
...
### Initialize SDK On Hika Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Hika Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HikaNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HikaNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
