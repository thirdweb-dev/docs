...
# Building contracts and apps on BitTorrent Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BitTorrent Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on BitTorrent Chain Mainnet. If you want to check details such as RPCs for BitTorrent Chain Mainnet, check out our [chainlist page for BitTorrent Chain Mainnet](https://thirdweb.com/bittorrent-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BitTorrent Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BitTorrent Chain Mainnet as the network
...
### Initialize SDK On BitTorrent Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BitTorrent Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BittorrentChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BittorrentChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
