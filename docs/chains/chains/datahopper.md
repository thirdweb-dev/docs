...
# Building contracts and apps on DataHopper

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DataHopper. By the end of the guide, you should be able to create smart contracts and dApps on DataHopper. If you want to check details such as RPCs for DataHopper, check out our [chainlist page for DataHopper](https://thirdweb.com/datahopper).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DataHopper using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DataHopper as the network
...
### Initialize SDK On DataHopper

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DataHopper

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Datahopper } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Datahopper}>
      <YourApp />
    </ThirdwebProvider>
  );
};
