...
# Building contracts and apps on Dexilla Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dexilla Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Dexilla Testnet. If you want to check details such as RPCs for Dexilla Testnet, check out our [chainlist page for Dexilla Testnet](https://thirdweb.com/dexilla-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dexilla Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dexilla Testnet as the network
...
### Initialize SDK On Dexilla Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dexilla Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DexillaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DexillaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
