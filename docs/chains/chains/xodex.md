...
# Building contracts and apps on XODEX

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on XODEX. By the end of the guide, you should be able to create smart contracts and dApps on XODEX. If you want to check details such as RPCs for XODEX, check out our [chainlist page for XODEX](https://thirdweb.com/xodex).
...
5. After modifying your contract with your desired custom logic, you may deploy it to XODEX using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On XODEX

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to XODEX

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Xodex } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Xodex}>
      <YourApp />
    </ThirdwebProvider>
  );
};
