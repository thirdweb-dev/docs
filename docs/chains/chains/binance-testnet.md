...
# Building contracts and apps on Binance Smart Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Binance Smart Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Binance Smart Chain Testnet. If you want to check details such as RPCs for Binance Smart Chain Testnet, check out our [chainlist page for Binance Smart Chain Testnet](https://thirdweb.com/binance-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Binance Smart Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Binance Smart Chain Testnet as the network
...
### Initialize SDK On Binance Smart Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Binance Smart Chain Testnet
