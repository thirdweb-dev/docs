...
# Building contracts and apps on AirDAO Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on AirDAO Testnet. By the end of the guide, you should be able to create smart contracts and dApps on AirDAO Testnet. If you want to check details such as RPCs for AirDAO Testnet, check out our [chainlist page for AirDAO Testnet](https://thirdweb.com/airdao-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to AirDAO Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select AirDAO Testnet as the network
...
### Initialize SDK On AirDAO Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to AirDAO Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={AirdaoTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
