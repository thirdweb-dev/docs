---
title: MAAL Sharia Chain
slug: /maal-sharia-chain
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on MAAL Sharia Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MAAL Sharia Chain. By the end of the guide, you should be able to create smart contracts and dApps on MAAL Sharia Chain. If you want to check details such as RPCs for MAAL Sharia Chain, check out our [chainlist page for MAAL Sharia Chain](https://thirdweb.com/maal-sharia-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MAAL Sharia Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MAAL Sharia Chain as the network
...
### Initialize SDK On MAAL Sharia Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MAAL Sharia Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MaalShariaChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MaalShariaChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
