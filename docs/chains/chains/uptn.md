...
# Building contracts and apps on UPTN

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on UPTN. By the end of the guide, you should be able to create smart contracts and dApps on UPTN. If you want to check details such as RPCs for UPTN, check out our [chainlist page for UPTN](https://thirdweb.com/uptn).
...
5. After modifying your contract with your desired custom logic, you may deploy it to UPTN using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On UPTN

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to UPTN

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Uptn } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Uptn}>
      <YourApp />
    </ThirdwebProvider>
  );
};
