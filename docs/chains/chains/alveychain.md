...
# Building contracts and apps on AlveyChain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on AlveyChain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on AlveyChain Mainnet. If you want to check details such as RPCs for AlveyChain Mainnet, check out our [chainlist page for AlveyChain Mainnet](https://thirdweb.com/alveychain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to AlveyChain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select AlveyChain Mainnet as the network
...
### Initialize SDK On AlveyChain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to AlveyChain Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Alveychain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
