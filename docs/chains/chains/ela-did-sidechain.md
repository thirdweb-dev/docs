...
# Building contracts and apps on ELA-DID-Sidechain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ELA-DID-Sidechain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on ELA-DID-Sidechain Mainnet. If you want to check details such as RPCs for ELA-DID-Sidechain Mainnet, check out our [chainlist page for ELA-DID-Sidechain Mainnet](https://thirdweb.com/ela-did-sidechain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ELA-DID-Sidechain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ELA-DID-Sidechain Mainnet as the network
...
### Initialize SDK On ELA-DID-Sidechain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ELA-DID-Sidechain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ElaDidSidechain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ElaDidSidechain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
