...
# Building contracts and apps on Aquachain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Aquachain. By the end of the guide, you should be able to create smart contracts and dApps on Aquachain. If you want to check details such as RPCs for Aquachain, check out our [chainlist page for Aquachain](https://thirdweb.com/aquachain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Aquachain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Aquachain as the network
...
### Initialize SDK On Aquachain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Aquachain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Aquachain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Aquachain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
