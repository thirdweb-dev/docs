...
# Building contracts and apps on 0XTade

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on 0XTade. By the end of the guide, you should be able to create smart contracts and dApps on 0XTade. If you want to check details such as RPCs for 0XTade, check out our [chainlist page for 0XTade](https://thirdweb.com/0xtade).
...
5. After modifying your contract with your desired custom logic, you may deploy it to 0XTade using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select 0XTade as the network
...
### Initialize SDK On 0XTade

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to 0XTade

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { _0xtade } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={_0xtade}>
      <YourApp />
    </ThirdwebProvider>
  );
};
