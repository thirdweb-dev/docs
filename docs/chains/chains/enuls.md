...
# Building contracts and apps on ENULS Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ENULS Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on ENULS Mainnet. If you want to check details such as RPCs for ENULS Mainnet, check out our [chainlist page for ENULS Mainnet](https://thirdweb.com/enuls).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ENULS Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ENULS Mainnet as the network
...
### Initialize SDK On ENULS Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ENULS Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Enuls } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Enuls}>
      <YourApp />
    </ThirdwebProvider>
  );
};
