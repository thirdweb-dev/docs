...
# Building contracts and apps on Gnosis Chiado Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Gnosis Chiado Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Gnosis Chiado Testnet. If you want to check details such as RPCs for Gnosis Chiado Testnet, check out our [chainlist page for Gnosis Chiado Testnet](https://thirdweb.com/gnosis-chiado-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Gnosis Chiado Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Gnosis Chiado Testnet as the network
...
### Initialize SDK On Gnosis Chiado Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Gnosis Chiado Testnet
