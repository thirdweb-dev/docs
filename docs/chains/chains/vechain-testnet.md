...
# Building contracts and apps on VeChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on VeChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on VeChain Testnet. If you want to check details such as RPCs for VeChain Testnet, check out our [chainlist page for VeChain Testnet](https://thirdweb.com/vechain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to VeChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select VeChain Testnet as the network
...
### Initialize SDK On VeChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to VeChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { VechainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={VechainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
