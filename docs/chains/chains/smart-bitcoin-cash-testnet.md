...
# Building contracts and apps on Smart Bitcoin Cash Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Smart Bitcoin Cash Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Smart Bitcoin Cash Testnet. If you want to check details such as RPCs for Smart Bitcoin Cash Testnet, check out our [chainlist page for Smart Bitcoin Cash Testnet](https://thirdweb.com/smart-bitcoin-cash-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Smart Bitcoin Cash Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Smart Bitcoin Cash Testnet as the network
...
### Initialize SDK On Smart Bitcoin Cash Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Smart Bitcoin Cash Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SmartBitcoinCashTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SmartBitcoinCashTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
