...
# Building contracts and apps on Altcoinchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Altcoinchain. By the end of the guide, you should be able to create smart contracts and dApps on Altcoinchain. If you want to check details such as RPCs for Altcoinchain, check out our [chainlist page for Altcoinchain](https://thirdweb.com/altcoinchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Altcoinchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Altcoinchain as the network
...
### Initialize SDK On Altcoinchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Altcoinchain
