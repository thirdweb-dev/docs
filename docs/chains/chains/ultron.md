...
# Building contracts and apps on Ultron Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ultron Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Ultron Mainnet. If you want to check details such as RPCs for Ultron Mainnet, check out our [chainlist page for Ultron Mainnet](https://thirdweb.com/ultron).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ultron Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ultron Mainnet as the network
...
### Initialize SDK On Ultron Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ultron Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Ultron}>
      <YourApp />
    </ThirdwebProvider>
  );
};
