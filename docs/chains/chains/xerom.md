...
# Building contracts and apps on Xerom

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Xerom. By the end of the guide, you should be able to create smart contracts and dApps on Xerom. If you want to check details such as RPCs for Xerom, check out our [chainlist page for Xerom](https://thirdweb.com/xerom).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Xerom using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Xerom

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Xerom

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Xerom } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Xerom}>
      <YourApp />
    </ThirdwebProvider>
  );
};
