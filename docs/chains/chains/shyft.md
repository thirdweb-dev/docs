...
# Building contracts and apps on Shyft Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Shyft Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Shyft Mainnet. If you want to check details such as RPCs for Shyft Mainnet, check out our [chainlist page for Shyft Mainnet](https://thirdweb.com/shyft).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Shyft Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Shyft Mainnet as the network
...
### Initialize SDK On Shyft Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Shyft Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Shyft } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Shyft}>
      <YourApp />
    </ThirdwebProvider>
  );
};
