...
# Building contracts and apps on Eluvio Content Fabric

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Eluvio Content Fabric. By the end of the guide, you should be able to create smart contracts and dApps on Eluvio Content Fabric. If you want to check details such as RPCs for Eluvio Content Fabric, check out our [chainlist page for Eluvio Content Fabric](https://thirdweb.com/eluvio-content-fabric).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Eluvio Content Fabric using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Eluvio Content Fabric as the network
...
### Initialize SDK On Eluvio Content Fabric

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Eluvio Content Fabric

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EluvioContentFabric } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EluvioContentFabric}>
      <YourApp />
    </ThirdwebProvider>
  );
};
