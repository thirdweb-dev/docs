...
# Building contracts and apps on Bitkub Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bitkub Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Bitkub Chain Testnet. If you want to check details such as RPCs for Bitkub Chain Testnet, check out our [chainlist page for Bitkub Chain Testnet](https://thirdweb.com/bitkub-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bitkub Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bitkub Chain Testnet as the network
...
### Initialize SDK On Bitkub Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bitkub Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BitkubChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BitkubChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
