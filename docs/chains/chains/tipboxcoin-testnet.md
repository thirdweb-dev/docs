...
# Building contracts and apps on Tipboxcoin Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Tipboxcoin Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Tipboxcoin Testnet. If you want to check details such as RPCs for Tipboxcoin Testnet, check out our [chainlist page for Tipboxcoin Testnet](https://thirdweb.com/tipboxcoin-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Tipboxcoin Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Tipboxcoin Testnet as the network
...
### Initialize SDK On Tipboxcoin Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Tipboxcoin Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TipboxcoinTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TipboxcoinTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
