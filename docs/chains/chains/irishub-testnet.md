...
# Building contracts and apps on IRIShub Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on IRIShub Testnet. By the end of the guide, you should be able to create smart contracts and dApps on IRIShub Testnet. If you want to check details such as RPCs for IRIShub Testnet, check out our [chainlist page for IRIShub Testnet](https://thirdweb.com/irishub-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to IRIShub Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select IRIShub Testnet as the network
...
### Initialize SDK On IRIShub Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to IRIShub Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { IrishubTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={IrishubTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
