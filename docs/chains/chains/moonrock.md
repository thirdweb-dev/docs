...
# Building contracts and apps on Moonrock

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Moonrock. By the end of the guide, you should be able to create smart contracts and dApps on Moonrock. If you want to check details such as RPCs for Moonrock, check out our [chainlist page for Moonrock](https://thirdweb.com/moonrock).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Moonrock using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Moonrock as the network
...
### Initialize SDK On Moonrock

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Moonrock

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Moonrock } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Moonrock}>
      <YourApp />
    </ThirdwebProvider>
  );
};
