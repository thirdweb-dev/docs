...
# Building contracts and apps on HOME Verse Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on HOME Verse Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on HOME Verse Mainnet. If you want to check details such as RPCs for HOME Verse Mainnet, check out our [chainlist page for HOME Verse Mainnet](https://thirdweb.com/home-verse).
...
5. After modifying your contract with your desired custom logic, you may deploy it to HOME Verse Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select HOME Verse Mainnet as the network
...
### Initialize SDK On HOME Verse Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to HOME Verse Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HomeVerse } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HomeVerse}>
      <YourApp />
    </ThirdwebProvider>
  );
};
