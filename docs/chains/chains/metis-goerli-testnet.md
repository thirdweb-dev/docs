...
# Building contracts and apps on Metis Goerli Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Metis Goerli Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Metis Goerli Testnet. If you want to check details such as RPCs for Metis Goerli Testnet, check out our [chainlist page for Metis Goerli Testnet](https://thirdweb.com/metis-goerli-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Metis Goerli Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Metis Goerli Testnet as the network
...
### Initialize SDK On Metis Goerli Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Metis Goerli Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MetisGoerliTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MetisGoerliTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
