...
# Building contracts and apps on Gitshock Cartenz Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Gitshock Cartenz Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Gitshock Cartenz Testnet. If you want to check details such as RPCs for Gitshock Cartenz Testnet, check out our [chainlist page for Gitshock Cartenz Testnet](https://thirdweb.com/gitshock-cartenz-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Gitshock Cartenz Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Gitshock Cartenz Testnet as the network
...
### Initialize SDK On Gitshock Cartenz Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Gitshock Cartenz Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GitshockCartenzTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GitshockCartenzTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
