...
# Building contracts and apps on Etica Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Etica Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Etica Mainnet. If you want to check details such as RPCs for Etica Mainnet, check out our [chainlist page for Etica Mainnet](https://thirdweb.com/etica).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Etica Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Etica Mainnet as the network
...
### Initialize SDK On Etica Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Etica Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Etica } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Etica}>
      <YourApp />
    </ThirdwebProvider>
  );
};
