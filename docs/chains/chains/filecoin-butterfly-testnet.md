...
# Building contracts and apps on Filecoin - Butterfly testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Filecoin - Butterfly testnet. By the end of the guide, you should be able to create smart contracts and dApps on Filecoin - Butterfly testnet. If you want to check details such as RPCs for Filecoin - Butterfly testnet, check out our [chainlist page for Filecoin - Butterfly testnet](https://thirdweb.com/filecoin-butterfly-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Filecoin - Butterfly testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Filecoin - Butterfly testnet as the network
...
### Initialize SDK On Filecoin - Butterfly testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Filecoin - Butterfly testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FilecoinButterflyTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FilecoinButterflyTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
