...
# Building contracts and apps on Fantom Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Fantom Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Fantom Testnet. If you want to check details such as RPCs for Fantom Testnet, check out our [chainlist page for Fantom Testnet](https://thirdweb.com/fantom-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Fantom Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Fantom Testnet as the network
...
### Initialize SDK On Fantom Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Fantom Testnet
