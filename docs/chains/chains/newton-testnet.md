...
# Building contracts and apps on Newton Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Newton Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Newton Testnet. If you want to check details such as RPCs for Newton Testnet, check out our [chainlist page for Newton Testnet](https://thirdweb.com/newton-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Newton Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Newton Testnet as the network
...
### Initialize SDK On Newton Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Newton Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { NewtonTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={NewtonTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
