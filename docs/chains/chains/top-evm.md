...
# Building contracts and apps on TOP Mainnet EVM

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on TOP Mainnet EVM. By the end of the guide, you should be able to create smart contracts and dApps on TOP Mainnet EVM. If you want to check details such as RPCs for TOP Mainnet EVM, check out our [chainlist page for TOP Mainnet EVM](https://thirdweb.com/top-evm).
...
5. After modifying your contract with your desired custom logic, you may deploy it to TOP Mainnet EVM using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select TOP Mainnet EVM as the network
...
### Initialize SDK On TOP Mainnet EVM

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to TOP Mainnet EVM

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TopEvm } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TopEvm}>
      <YourApp />
    </ThirdwebProvider>
  );
};
