...
# Building contracts and apps on Metaplayerone Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Metaplayerone Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Metaplayerone Mainnet. If you want to check details such as RPCs for Metaplayerone Mainnet, check out our [chainlist page for Metaplayerone Mainnet](https://thirdweb.com/metaplayerone).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Metaplayerone Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Metaplayerone Mainnet as the network
...
### Initialize SDK On Metaplayerone Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Metaplayerone Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Metaplayerone } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Metaplayerone}>
      <YourApp />
    </ThirdwebProvider>
  );
};
