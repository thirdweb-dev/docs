...
# Building contracts and apps on omChain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on omChain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on omChain Mainnet. If you want to check details such as RPCs for omChain Mainnet, check out our [chainlist page for omChain Mainnet](https://thirdweb.com/omchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to omChain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select omChain Mainnet as the network
...
### Initialize SDK On omChain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to omChain Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Omchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
