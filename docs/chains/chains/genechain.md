...
# Building contracts and apps on GeneChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on GeneChain. By the end of the guide, you should be able to create smart contracts and dApps on GeneChain. If you want to check details such as RPCs for GeneChain, check out our [chainlist page for GeneChain](https://thirdweb.com/genechain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to GeneChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select GeneChain as the network
...
### Initialize SDK On GeneChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to GeneChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Genechain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Genechain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
