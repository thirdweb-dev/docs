...
# Building contracts and apps on Arbitrum Nova

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Arbitrum Nova. By the end of the guide, you should be able to create smart contracts and dApps on Arbitrum Nova. If you want to check details such as RPCs for Arbitrum Nova, check out our [chainlist page for Arbitrum Nova](https://thirdweb.com/arbitrum-nova).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Arbitrum Nova using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Arbitrum Nova as the network
...
### Initialize SDK On Arbitrum Nova

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Arbitrum Nova
