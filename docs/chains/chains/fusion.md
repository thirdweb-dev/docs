...
# Building contracts and apps on Fusion Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Fusion Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Fusion Mainnet. If you want to check details such as RPCs for Fusion Mainnet, check out our [chainlist page for Fusion Mainnet](https://thirdweb.com/fusion).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Fusion Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Fusion Mainnet as the network
...
### Initialize SDK On Fusion Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Fusion Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Fusion } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Fusion}>
      <YourApp />
    </ThirdwebProvider>
  );
};
