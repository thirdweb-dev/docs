...
# Building contracts and apps on Decimal Smart Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Decimal Smart Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Decimal Smart Chain Testnet. If you want to check details such as RPCs for Decimal Smart Chain Testnet, check out our [chainlist page for Decimal Smart Chain Testnet](https://thirdweb.com/decimal-smart-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Decimal Smart Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Decimal Smart Chain Testnet as the network
...
### Initialize SDK On Decimal Smart Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Decimal Smart Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DecimalSmartChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DecimalSmartChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
