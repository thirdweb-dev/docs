...
# Building contracts and apps on Palm

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Palm. By the end of the guide, you should be able to create smart contracts and dApps on Palm. If you want to check details such as RPCs for Palm, check out our [chainlist page for Palm](https://thirdweb.com/palm).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Palm using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Palm

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Palm

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Palm } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Palm}>
      <YourApp />
    </ThirdwebProvider>
  );
};
