...
# Building contracts and apps on Energi Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Energi Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Energi Mainnet. If you want to check details such as RPCs for Energi Mainnet, check out our [chainlist page for Energi Mainnet](https://thirdweb.com/energi).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Energi Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Energi Mainnet as the network
...
### Initialize SDK On Energi Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Energi Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Energi } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Energi}>
      <YourApp />
    </ThirdwebProvider>
  );
};
