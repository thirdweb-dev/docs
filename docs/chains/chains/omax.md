...
# Building contracts and apps on Omax Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Omax Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Omax Mainnet. If you want to check details such as RPCs for Omax Mainnet, check out our [chainlist page for Omax Mainnet](https://thirdweb.com/omax).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Omax Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Omax Mainnet as the network
...
### Initialize SDK On Omax Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Omax Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Omax } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Omax}>
      <YourApp />
    </ThirdwebProvider>
  );
};
