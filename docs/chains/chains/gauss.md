...
# Building contracts and apps on Gauss Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Gauss Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Gauss Mainnet. If you want to check details such as RPCs for Gauss Mainnet, check out our [chainlist page for Gauss Mainnet](https://thirdweb.com/gauss).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Gauss Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Gauss Mainnet as the network
...
### Initialize SDK On Gauss Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Gauss Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Gauss } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Gauss}>
      <YourApp />
    </ThirdwebProvider>
  );
};
