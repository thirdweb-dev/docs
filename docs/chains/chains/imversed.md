...
# Building contracts and apps on Imversed Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Imversed Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Imversed Mainnet. If you want to check details such as RPCs for Imversed Mainnet, check out our [chainlist page for Imversed Mainnet](https://thirdweb.com/imversed).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Imversed Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Imversed Mainnet as the network
...
### Initialize SDK On Imversed Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Imversed Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Imversed } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Imversed}>
      <YourApp />
    </ThirdwebProvider>
  );
};
