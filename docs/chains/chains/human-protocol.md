...
# Building contracts and apps on HUMAN Protocol

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on HUMAN Protocol. By the end of the guide, you should be able to create smart contracts and dApps on HUMAN Protocol. If you want to check details such as RPCs for HUMAN Protocol, check out our [chainlist page for HUMAN Protocol](https://thirdweb.com/human-protocol).
...
5. After modifying your contract with your desired custom logic, you may deploy it to HUMAN Protocol using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select HUMAN Protocol as the network
...
### Initialize SDK On HUMAN Protocol

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to HUMAN Protocol

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HumanProtocol } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HumanProtocol}>
      <YourApp />
    </ThirdwebProvider>
  );
};
