...
# Building contracts and apps on PHI Network V1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PHI Network V1. By the end of the guide, you should be able to create smart contracts and dApps on PHI Network V1. If you want to check details such as RPCs for PHI Network V1, check out our [chainlist page for PHI Network V1](https://thirdweb.com/phi-network-v1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PHI Network V1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PHI Network V1 as the network
...
### Initialize SDK On PHI Network V1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PHI Network V1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PhiNetworkV1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PhiNetworkV1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
