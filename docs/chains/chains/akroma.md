...
# Building contracts and apps on Akroma

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Akroma. By the end of the guide, you should be able to create smart contracts and dApps on Akroma. If you want to check details such as RPCs for Akroma, check out our [chainlist page for Akroma](https://thirdweb.com/akroma).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Akroma using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Akroma as the network
...
### Initialize SDK On Akroma

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Akroma

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Akroma } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Akroma}>
      <YourApp />
    </ThirdwebProvider>
  );
};
