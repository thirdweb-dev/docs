...
# Building contracts and apps on Quadrans Blockchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Quadrans Blockchain. By the end of the guide, you should be able to create smart contracts and dApps on Quadrans Blockchain. If you want to check details such as RPCs for Quadrans Blockchain, check out our [chainlist page for Quadrans Blockchain](https://thirdweb.com/quadrans-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Quadrans Blockchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Quadrans Blockchain as the network
...
### Initialize SDK On Quadrans Blockchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Quadrans Blockchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { QuadransBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={QuadransBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
