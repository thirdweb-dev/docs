...
# Building contracts and apps on Amana

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Amana. By the end of the guide, you should be able to create smart contracts and dApps on Amana. If you want to check details such as RPCs for Amana, check out our [chainlist page for Amana](https://thirdweb.com/amana).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Amana using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Amana

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Amana

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Amana } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Amana}>
      <YourApp />
    </ThirdwebProvider>
  );
};
