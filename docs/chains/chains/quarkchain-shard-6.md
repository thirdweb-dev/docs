...
# Building contracts and apps on QuarkChain Mainnet Shard 6

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on QuarkChain Mainnet Shard 6. By the end of the guide, you should be able to create smart contracts and dApps on QuarkChain Mainnet Shard 6. If you want to check details such as RPCs for QuarkChain Mainnet Shard 6, check out our [chainlist page for QuarkChain Mainnet Shard 6](https://thirdweb.com/quarkchain-shard-6).
...
5. After modifying your contract with your desired custom logic, you may deploy it to QuarkChain Mainnet Shard 6 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select QuarkChain Mainnet Shard 6 as the network
...
### Initialize SDK On QuarkChain Mainnet Shard 6

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to QuarkChain Mainnet Shard 6

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { QuarkchainShard6 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={QuarkchainShard6}>
      <YourApp />
    </ThirdwebProvider>
  );
};
