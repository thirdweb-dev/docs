...
# Building contracts and apps on EtherInc

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on EtherInc. By the end of the guide, you should be able to create smart contracts and dApps on EtherInc. If you want to check details such as RPCs for EtherInc, check out our [chainlist page for EtherInc](https://thirdweb.com/etherinc).
...
5. After modifying your contract with your desired custom logic, you may deploy it to EtherInc using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select EtherInc as the network
...
### Initialize SDK On EtherInc

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to EtherInc

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Etherinc } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Etherinc}>
      <YourApp />
    </ThirdwebProvider>
  );
};
