...
# Building contracts and apps on zkSync Era Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on zkSync Era Testnet. By the end of the guide, you should be able to create smart contracts and dApps on zkSync Era Testnet. If you want to check details such as RPCs for zkSync Era Testnet, check out our [chainlist page for zkSync Era Testnet](https://thirdweb.com/zksync-era-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to zkSync Era Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select zkSync Era Testnet as the network
...
### Initialize SDK On zkSync Era Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to zkSync Era Testnet
