...
# Building contracts and apps on CURVE Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on CURVE Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on CURVE Mainnet. If you want to check details such as RPCs for CURVE Mainnet, check out our [chainlist page for CURVE Mainnet](https://thirdweb.com/curve).
...
5. After modifying your contract with your desired custom logic, you may deploy it to CURVE Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select CURVE Mainnet as the network
...
### Initialize SDK On CURVE Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to CURVE Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Curve } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Curve}>
      <YourApp />
    </ThirdwebProvider>
  );
};
