...
# Building contracts and apps on Bobabase Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bobabase Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Bobabase Testnet. If you want to check details such as RPCs for Bobabase Testnet, check out our [chainlist page for Bobabase Testnet](https://thirdweb.com/bobabase-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bobabase Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bobabase Testnet as the network
...
### Initialize SDK On Bobabase Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bobabase Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BobabaseTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BobabaseTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
