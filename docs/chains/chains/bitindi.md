...
# Building contracts and apps on Bitindi Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bitindi Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Bitindi Mainnet. If you want to check details such as RPCs for Bitindi Mainnet, check out our [chainlist page for Bitindi Mainnet](https://thirdweb.com/bitindi).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bitindi Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bitindi Mainnet as the network
...
### Initialize SDK On Bitindi Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bitindi Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Bitindi}>
      <YourApp />
    </ThirdwebProvider>
  );
};
