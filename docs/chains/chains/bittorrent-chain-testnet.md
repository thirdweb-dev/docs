...
# Building contracts and apps on BitTorrent Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BitTorrent Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on BitTorrent Chain Testnet. If you want to check details such as RPCs for BitTorrent Chain Testnet, check out our [chainlist page for BitTorrent Chain Testnet](https://thirdweb.com/bittorrent-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BitTorrent Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BitTorrent Chain Testnet as the network
...
### Initialize SDK On BitTorrent Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BitTorrent Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BittorrentChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BittorrentChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
