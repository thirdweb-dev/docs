...
# Building contracts and apps on Astra

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Astra. By the end of the guide, you should be able to create smart contracts and dApps on Astra. If you want to check details such as RPCs for Astra, check out our [chainlist page for Astra](https://thirdweb.com/astra).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Astra using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Astra

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Astra

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Astra } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Astra}>
      <YourApp />
    </ThirdwebProvider>
  );
};
