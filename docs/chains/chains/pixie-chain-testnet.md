...
# Building contracts and apps on Pixie Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Pixie Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Pixie Chain Testnet. If you want to check details such as RPCs for Pixie Chain Testnet, check out our [chainlist page for Pixie Chain Testnet](https://thirdweb.com/pixie-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Pixie Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Pixie Chain Testnet as the network
...
### Initialize SDK On Pixie Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Pixie Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PixieChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PixieChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
