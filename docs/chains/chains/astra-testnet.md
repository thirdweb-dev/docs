...
# Building contracts and apps on Astra Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Astra Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Astra Testnet. If you want to check details such as RPCs for Astra Testnet, check out our [chainlist page for Astra Testnet](https://thirdweb.com/astra-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Astra Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Astra Testnet as the network
...
### Initialize SDK On Astra Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Astra Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AstraTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AstraTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
