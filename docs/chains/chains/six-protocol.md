...
# Building contracts and apps on Six Protocol

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Six Protocol. By the end of the guide, you should be able to create smart contracts and dApps on Six Protocol. If you want to check details such as RPCs for Six Protocol, check out our [chainlist page for Six Protocol](https://thirdweb.com/six-protocol).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Six Protocol using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Six Protocol as the network
...
### Initialize SDK On Six Protocol

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Six Protocol

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SixProtocol } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SixProtocol}>
      <YourApp />
    </ThirdwebProvider>
  );
};
