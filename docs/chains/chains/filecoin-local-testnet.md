...
# Building contracts and apps on Filecoin - Local testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Filecoin - Local testnet. By the end of the guide, you should be able to create smart contracts and dApps on Filecoin - Local testnet. If you want to check details such as RPCs for Filecoin - Local testnet, check out our [chainlist page for Filecoin - Local testnet](https://thirdweb.com/filecoin-local-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Filecoin - Local testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Filecoin - Local testnet as the network
...
### Initialize SDK On Filecoin - Local testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Filecoin - Local testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FilecoinLocalTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FilecoinLocalTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
