...
# Building contracts and apps on CMP-Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on CMP-Testnet. By the end of the guide, you should be able to create smart contracts and dApps on CMP-Testnet. If you want to check details such as RPCs for CMP-Testnet, check out our [chainlist page for CMP-Testnet](https://thirdweb.com/cmp-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to CMP-Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select CMP-Testnet as the network
...
### Initialize SDK On CMP-Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to CMP-Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CmpTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CmpTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
