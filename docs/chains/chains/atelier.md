...
# Building contracts and apps on Atelier

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Atelier. By the end of the guide, you should be able to create smart contracts and dApps on Atelier. If you want to check details such as RPCs for Atelier, check out our [chainlist page for Atelier](https://thirdweb.com/atelier).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Atelier using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Atelier as the network
...
### Initialize SDK On Atelier

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Atelier

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Atelier } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Atelier}>
      <YourApp />
    </ThirdwebProvider>
  );
};
