---
title: Europa SKALE Chain
slug: /europa-skale-chain
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Europa SKALE Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Europa SKALE Chain. By the end of the guide, you should be able to create smart contracts and dApps on Europa SKALE Chain. If you want to check details such as RPCs for Europa SKALE Chain, check out our [chainlist page for Europa SKALE Chain](https://thirdweb.com/europa-skale-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Europa SKALE Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Europa SKALE Chain as the network
...
### Initialize SDK On Europa SKALE Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Europa SKALE Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EuropaSkaleChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EuropaSkaleChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
