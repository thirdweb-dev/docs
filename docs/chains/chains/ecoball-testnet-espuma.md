...
# Building contracts and apps on Ecoball Testnet Espuma

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ecoball Testnet Espuma. By the end of the guide, you should be able to create smart contracts and dApps on Ecoball Testnet Espuma. If you want to check details such as RPCs for Ecoball Testnet Espuma, check out our [chainlist page for Ecoball Testnet Espuma](https://thirdweb.com/ecoball-testnet-espuma).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ecoball Testnet Espuma using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ecoball Testnet Espuma as the network
...
### Initialize SDK On Ecoball Testnet Espuma

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ecoball Testnet Espuma

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EcoballTestnetEspuma } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EcoballTestnetEspuma}>
      <YourApp />
    </ThirdwebProvider>
  );
};
