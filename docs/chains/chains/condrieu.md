...
# Building contracts and apps on Condrieu

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Condrieu. By the end of the guide, you should be able to create smart contracts and dApps on Condrieu. If you want to check details such as RPCs for Condrieu, check out our [chainlist page for Condrieu](https://thirdweb.com/condrieu).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Condrieu using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Condrieu as the network
...
### Initialize SDK On Condrieu

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Condrieu

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Condrieu } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Condrieu}>
      <YourApp />
    </ThirdwebProvider>
  );
};
