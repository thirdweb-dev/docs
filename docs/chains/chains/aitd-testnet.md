...
# Building contracts and apps on Aitd Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Aitd Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Aitd Testnet. If you want to check details such as RPCs for Aitd Testnet, check out our [chainlist page for Aitd Testnet](https://thirdweb.com/aitd-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Aitd Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Aitd Testnet as the network
...
### Initialize SDK On Aitd Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Aitd Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AitdTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AitdTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
