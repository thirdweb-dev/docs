...
# Building contracts and apps on Ecoball Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ecoball Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Ecoball Mainnet. If you want to check details such as RPCs for Ecoball Mainnet, check out our [chainlist page for Ecoball Mainnet](https://thirdweb.com/ecoball).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ecoball Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ecoball Mainnet as the network
...
### Initialize SDK On Ecoball Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ecoball Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ecoball } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ecoball}>
      <YourApp />
    </ThirdwebProvider>
  );
};
