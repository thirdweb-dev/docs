...
# Building contracts and apps on ChainX-EVM

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ChainX-EVM. By the end of the guide, you should be able to create smart contracts and dApps on ChainX-EVM. If you want to check details such as RPCs for ChainX-EVM, check out our [chainlist page for ChainX-EVM](https://thirdweb.com/chainx-evm).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ChainX-EVM using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ChainX-EVM as the network
...
### Initialize SDK On ChainX-EVM

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ChainX-EVM

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ChainxEvm } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ChainxEvm}>
      <YourApp />
    </ThirdwebProvider>
  );
};
