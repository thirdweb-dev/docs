...
# Building contracts and apps on Redlight Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Redlight Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Redlight Chain Mainnet. If you want to check details such as RPCs for Redlight Chain Mainnet, check out our [chainlist page for Redlight Chain Mainnet](https://thirdweb.com/redlight-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Redlight Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Redlight Chain Mainnet as the network
...
### Initialize SDK On Redlight Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Redlight Chain Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={RedlightChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
