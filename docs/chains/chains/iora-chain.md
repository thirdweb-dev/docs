...
# Building contracts and apps on Iora Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Iora Chain. By the end of the guide, you should be able to create smart contracts and dApps on Iora Chain. If you want to check details such as RPCs for Iora Chain, check out our [chainlist page for Iora Chain](https://thirdweb.com/iora-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Iora Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Iora Chain as the network
...
### Initialize SDK On Iora Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Iora Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { IoraChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={IoraChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
