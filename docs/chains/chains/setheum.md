...
# Building contracts and apps on Setheum

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Setheum. By the end of the guide, you should be able to create smart contracts and dApps on Setheum. If you want to check details such as RPCs for Setheum, check out our [chainlist page for Setheum](https://thirdweb.com/setheum).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Setheum using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Setheum as the network
...
### Initialize SDK On Setheum

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Setheum

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Setheum } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Setheum}>
      <YourApp />
    </ThirdwebProvider>
  );
};
