...
# Building contracts and apps on AIOZ Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on AIOZ Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on AIOZ Network Testnet. If you want to check details such as RPCs for AIOZ Network Testnet, check out our [chainlist page for AIOZ Network Testnet](https://thirdweb.com/aioz-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to AIOZ Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select AIOZ Network Testnet as the network
...
### Initialize SDK On AIOZ Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to AIOZ Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AiozNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AiozNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
