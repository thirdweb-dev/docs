...
# Building contracts and apps on Freight Trust Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Freight Trust Network. By the end of the guide, you should be able to create smart contracts and dApps on Freight Trust Network. If you want to check details such as RPCs for Freight Trust Network, check out our [chainlist page for Freight Trust Network](https://thirdweb.com/freight-trust-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Freight Trust Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Freight Trust Network as the network
...
### Initialize SDK On Freight Trust Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Freight Trust Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FreightTrustNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FreightTrustNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
