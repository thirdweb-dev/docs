...
# Building contracts and apps on Neonlink Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Neonlink Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Neonlink Mainnet. If you want to check details such as RPCs for Neonlink Mainnet, check out our [chainlist page for Neonlink Mainnet](https://thirdweb.com/neonlink).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Neonlink Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Neonlink Mainnet as the network
...
### Initialize SDK On Neonlink Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Neonlink Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Neonlink } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Neonlink}>
      <YourApp />
    </ThirdwebProvider>
  );
};
