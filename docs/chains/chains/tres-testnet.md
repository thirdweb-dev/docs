...
# Building contracts and apps on Tres Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Tres Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Tres Testnet. If you want to check details such as RPCs for Tres Testnet, check out our [chainlist page for Tres Testnet](https://thirdweb.com/tres-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Tres Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Tres Testnet as the network
...
### Initialize SDK On Tres Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Tres Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TresTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TresTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
