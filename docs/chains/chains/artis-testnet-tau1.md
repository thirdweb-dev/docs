...
# Building contracts and apps on ARTIS Testnet tau1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ARTIS Testnet tau1. By the end of the guide, you should be able to create smart contracts and dApps on ARTIS Testnet tau1. If you want to check details such as RPCs for ARTIS Testnet tau1, check out our [chainlist page for ARTIS Testnet tau1](https://thirdweb.com/artis-testnet-tau1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ARTIS Testnet tau1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ARTIS Testnet tau1 as the network
...
### Initialize SDK On ARTIS Testnet tau1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ARTIS Testnet tau1

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ArtisTestnetTau1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ArtisTestnetTau1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
