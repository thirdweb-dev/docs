...
# Building contracts and apps on Openpiece Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Openpiece Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Openpiece Testnet. If you want to check details such as RPCs for Openpiece Testnet, check out our [chainlist page for Openpiece Testnet](https://thirdweb.com/openpiece-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Openpiece Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Openpiece Testnet as the network
...
### Initialize SDK On Openpiece Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Openpiece Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OpenpieceTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OpenpieceTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
