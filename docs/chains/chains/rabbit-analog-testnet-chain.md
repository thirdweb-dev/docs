...
# Building contracts and apps on Rabbit Analog Testnet Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rabbit Analog Testnet Chain. By the end of the guide, you should be able to create smart contracts and dApps on Rabbit Analog Testnet Chain. If you want to check details such as RPCs for Rabbit Analog Testnet Chain, check out our [chainlist page for Rabbit Analog Testnet Chain](https://thirdweb.com/rabbit-analog-testnet-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rabbit Analog Testnet Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rabbit Analog Testnet Chain as the network
...
### Initialize SDK On Rabbit Analog Testnet Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rabbit Analog Testnet Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { RabbitAnalogTestnetChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={RabbitAnalogTestnetChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
