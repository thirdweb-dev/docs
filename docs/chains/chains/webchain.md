...
# Building contracts and apps on Webchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Webchain. By the end of the guide, you should be able to create smart contracts and dApps on Webchain. If you want to check details such as RPCs for Webchain, check out our [chainlist page for Webchain](https://thirdweb.com/webchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Webchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Webchain as the network
...
### Initialize SDK On Webchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Webchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Webchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Webchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
