...
# Building contracts and apps on BlockChain Station Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BlockChain Station Testnet. By the end of the guide, you should be able to create smart contracts and dApps on BlockChain Station Testnet. If you want to check details such as RPCs for BlockChain Station Testnet, check out our [chainlist page for BlockChain Station Testnet](https://thirdweb.com/blockchain-station-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BlockChain Station Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BlockChain Station Testnet as the network
...
### Initialize SDK On BlockChain Station Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BlockChain Station Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BlockchainStationTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BlockchainStationTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
