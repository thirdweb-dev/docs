---
title: ZetaChain Athens Testnet
slug: /zetachain-athens-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on ZetaChain Athens Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ZetaChain Athens Testnet. By the end of the guide, you should be able to create smart contracts and dApps on ZetaChain Athens Testnet. If you want to check details such as RPCs for ZetaChain Athens Testnet, check out our [chainlist page for ZetaChain Athens Testnet](https://thirdweb.com/zetachain-athens-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ZetaChain Athens Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ZetaChain Athens Testnet as the network
...
### Initialize SDK On ZetaChain Athens Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ZetaChain Athens Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={ZetachainAthensTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
