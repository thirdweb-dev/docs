...
# Building contracts and apps on Fantasia Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Fantasia Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Fantasia Chain Mainnet. If you want to check details such as RPCs for Fantasia Chain Mainnet, check out our [chainlist page for Fantasia Chain Mainnet](https://thirdweb.com/fantasia-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Fantasia Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Fantasia Chain Mainnet as the network
...
### Initialize SDK On Fantasia Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Fantasia Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FantasiaChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FantasiaChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
