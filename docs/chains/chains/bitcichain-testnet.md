...
# Building contracts and apps on Bitcichain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bitcichain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Bitcichain Testnet. If you want to check details such as RPCs for Bitcichain Testnet, check out our [chainlist page for Bitcichain Testnet](https://thirdweb.com/bitcichain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bitcichain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bitcichain Testnet as the network
...
### Initialize SDK On Bitcichain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bitcichain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BitcichainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BitcichainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
