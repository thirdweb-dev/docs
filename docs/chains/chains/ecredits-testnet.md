...
# Building contracts and apps on eCredits Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on eCredits Testnet. By the end of the guide, you should be able to create smart contracts and dApps on eCredits Testnet. If you want to check details such as RPCs for eCredits Testnet, check out our [chainlist page for eCredits Testnet](https://thirdweb.com/ecredits-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to eCredits Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select eCredits Testnet as the network
...
### Initialize SDK On eCredits Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to eCredits Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EcreditsTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EcreditsTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
