---
title: Nahmii Testnet
slug: /nahmii-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Nahmii Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Nahmii Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Nahmii Testnet. If you want to check details such as RPCs for Nahmii Testnet, check out our [chainlist page for Nahmii Testnet](https://thirdweb.com/nahmii-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Nahmii Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Nahmii Testnet as the network
...
### Initialize SDK On Nahmii Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Nahmii Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { NahmiiTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={NahmiiTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
