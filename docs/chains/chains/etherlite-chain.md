---
title: EtherLite Chain
slug: /etherlite-chain
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on EtherLite Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on EtherLite Chain. By the end of the guide, you should be able to create smart contracts and dApps on EtherLite Chain. If you want to check details such as RPCs for EtherLite Chain, check out our [chainlist page for EtherLite Chain](https://thirdweb.com/etherlite-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to EtherLite Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select EtherLite Chain as the network
...
### Initialize SDK On EtherLite Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to EtherLite Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EtherliteChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EtherliteChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
