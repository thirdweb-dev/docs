...
# Building contracts and apps on BOMB Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BOMB Chain. By the end of the guide, you should be able to create smart contracts and dApps on BOMB Chain. If you want to check details such as RPCs for BOMB Chain, check out our [chainlist page for BOMB Chain](https://thirdweb.com/bomb-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BOMB Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BOMB Chain as the network
...
### Initialize SDK On BOMB Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BOMB Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BombChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BombChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
