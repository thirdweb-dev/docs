...
# Building contracts and apps on Sepolia

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Sepolia. By the end of the guide, you should be able to create smart contracts and dApps on Sepolia. If you want to check details such as RPCs for Sepolia, check out our [chainlist page for Sepolia](https://thirdweb.com/sepolia).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Sepolia using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Sepolia

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Sepolia
