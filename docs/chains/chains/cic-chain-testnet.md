...
# Building contracts and apps on CIC Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on CIC Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on CIC Chain Testnet. If you want to check details such as RPCs for CIC Chain Testnet, check out our [chainlist page for CIC Chain Testnet](https://thirdweb.com/cic-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to CIC Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select CIC Chain Testnet as the network
...
### Initialize SDK On CIC Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to CIC Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CicChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CicChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
