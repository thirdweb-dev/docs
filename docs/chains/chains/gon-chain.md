...
# Building contracts and apps on Gon Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Gon Chain. By the end of the guide, you should be able to create smart contracts and dApps on Gon Chain. If you want to check details such as RPCs for Gon Chain, check out our [chainlist page for Gon Chain](https://thirdweb.com/gon-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Gon Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Gon Chain as the network
...
### Initialize SDK On Gon Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Gon Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GonChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GonChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
