...
# Building contracts and apps on Harmony Mainnet Shard 2

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Harmony Mainnet Shard 2. By the end of the guide, you should be able to create smart contracts and dApps on Harmony Mainnet Shard 2. If you want to check details such as RPCs for Harmony Mainnet Shard 2, check out our [chainlist page for Harmony Mainnet Shard 2](https://thirdweb.com/harmony-shard-2).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Harmony Mainnet Shard 2 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Harmony Mainnet Shard 2 as the network
...
### Initialize SDK On Harmony Mainnet Shard 2

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Harmony Mainnet Shard 2

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HarmonyShard2 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HarmonyShard2}>
      <YourApp />
    </ThirdwebProvider>
  );
};
