...
# Building contracts and apps on Ferrum Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ferrum Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Ferrum Testnet. If you want to check details such as RPCs for Ferrum Testnet, check out our [chainlist page for Ferrum Testnet](https://thirdweb.com/ferrum-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ferrum Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ferrum Testnet as the network
...
### Initialize SDK On Ferrum Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ferrum Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FerrumTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FerrumTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
