---
title: IVAR Chain Mainnet
slug: /ivar-chain
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on IVAR Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on IVAR Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on IVAR Chain Mainnet. If you want to check details such as RPCs for IVAR Chain Mainnet, check out our [chainlist page for IVAR Chain Mainnet](https://thirdweb.com/ivar-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to IVAR Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select IVAR Chain Mainnet as the network
...
### Initialize SDK On IVAR Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to IVAR Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { IvarChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={IvarChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
