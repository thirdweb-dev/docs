...
# Building contracts and apps on Deamchain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Deamchain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Deamchain Mainnet. If you want to check details such as RPCs for Deamchain Mainnet, check out our [chainlist page for Deamchain Mainnet](https://thirdweb.com/deamchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Deamchain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Deamchain Mainnet as the network
...
### Initialize SDK On Deamchain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Deamchain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Deamchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Deamchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
