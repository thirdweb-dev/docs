...
# Building contracts and apps on Dehvo

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dehvo. By the end of the guide, you should be able to create smart contracts and dApps on Dehvo. If you want to check details such as RPCs for Dehvo, check out our [chainlist page for Dehvo](https://thirdweb.com/dehvo).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dehvo using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Dehvo

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dehvo

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Dehvo } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Dehvo}>
      <YourApp />
    </ThirdwebProvider>
  );
};
