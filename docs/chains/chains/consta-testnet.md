...
# Building contracts and apps on Consta Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Consta Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Consta Testnet. If you want to check details such as RPCs for Consta Testnet, check out our [chainlist page for Consta Testnet](https://thirdweb.com/consta-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Consta Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Consta Testnet as the network
...
### Initialize SDK On Consta Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Consta Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ConstaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ConstaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
