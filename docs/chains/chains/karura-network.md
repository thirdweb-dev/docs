...
# Building contracts and apps on Karura Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Karura Network. By the end of the guide, you should be able to create smart contracts and dApps on Karura Network. If you want to check details such as RPCs for Karura Network, check out our [chainlist page for Karura Network](https://thirdweb.com/karura-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Karura Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Karura Network as the network
...
### Initialize SDK On Karura Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Karura Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { KaruraNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={KaruraNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
