...
# Building contracts and apps on Pirl

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Pirl. By the end of the guide, you should be able to create smart contracts and dApps on Pirl. If you want to check details such as RPCs for Pirl, check out our [chainlist page for Pirl](https://thirdweb.com/pirl).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Pirl using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Pirl

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Pirl

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Pirl } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Pirl}>
      <YourApp />
    </ThirdwebProvider>
  );
};
