...
# Building contracts and apps on Bitfinity Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bitfinity Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Bitfinity Network Testnet. If you want to check details such as RPCs for Bitfinity Network Testnet, check out our [chainlist page for Bitfinity Network Testnet](https://thirdweb.com/bitfinity-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bitfinity Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bitfinity Network Testnet as the network
...
### Initialize SDK On Bitfinity Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bitfinity Network Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={BitfinityNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
