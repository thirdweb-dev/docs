...
# Building contracts and apps on LaTestnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on LaTestnet. By the end of the guide, you should be able to create smart contracts and dApps on LaTestnet. If you want to check details such as RPCs for LaTestnet, check out our [chainlist page for LaTestnet](https://thirdweb.com/latestnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to LaTestnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select LaTestnet as the network
...
### Initialize SDK On LaTestnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to LaTestnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Latestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Latestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
