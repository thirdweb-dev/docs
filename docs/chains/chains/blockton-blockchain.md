...
# Building contracts and apps on Blockton Blockchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Blockton Blockchain. By the end of the guide, you should be able to create smart contracts and dApps on Blockton Blockchain. If you want to check details such as RPCs for Blockton Blockchain, check out our [chainlist page for Blockton Blockchain](https://thirdweb.com/blockton-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Blockton Blockchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Blockton Blockchain as the network
...
### Initialize SDK On Blockton Blockchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Blockton Blockchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BlocktonBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BlocktonBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
