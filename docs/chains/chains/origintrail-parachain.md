---
title: OriginTrail Parachain
slug: /origintrail-parachain
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on OriginTrail Parachain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OriginTrail Parachain. By the end of the guide, you should be able to create smart contracts and dApps on OriginTrail Parachain. If you want to check details such as RPCs for OriginTrail Parachain, check out our [chainlist page for OriginTrail Parachain](https://thirdweb.com/origintrail-parachain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OriginTrail Parachain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OriginTrail Parachain as the network
...
### Initialize SDK On OriginTrail Parachain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OriginTrail Parachain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OrigintrailParachain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OrigintrailParachain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
