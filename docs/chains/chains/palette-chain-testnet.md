...
# Building contracts and apps on Palette Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Palette Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Palette Chain Testnet. If you want to check details such as RPCs for Palette Chain Testnet, check out our [chainlist page for Palette Chain Testnet](https://thirdweb.com/palette-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Palette Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Palette Chain Testnet as the network
...
### Initialize SDK On Palette Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Palette Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PaletteChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PaletteChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
