...
# Building contracts and apps on Shibarium Beta

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Shibarium Beta. By the end of the guide, you should be able to create smart contracts and dApps on Shibarium Beta. If you want to check details such as RPCs for Shibarium Beta, check out our [chainlist page for Shibarium Beta](https://thirdweb.com/shibarium-beta).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Shibarium Beta using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Shibarium Beta as the network
...
### Initialize SDK On Shibarium Beta

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Shibarium Beta

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ShibariumBeta } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ShibariumBeta}>
      <YourApp />
    </ThirdwebProvider>
  );
};
