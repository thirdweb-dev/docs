...
# Building contracts and apps on Double-A Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Double-A Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Double-A Chain Testnet. If you want to check details such as RPCs for Double-A Chain Testnet, check out our [chainlist page for Double-A Chain Testnet](https://thirdweb.com/double-a-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Double-A Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Double-A Chain Testnet as the network
...
### Initialize SDK On Double-A Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Double-A Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DoubleAChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DoubleAChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
