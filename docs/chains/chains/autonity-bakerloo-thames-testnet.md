...
# Building contracts and apps on Autonity Bakerloo (Thames) Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Autonity Bakerloo (Thames) Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Autonity Bakerloo (Thames) Testnet. If you want to check details such as RPCs for Autonity Bakerloo (Thames) Testnet, check out our [chainlist page for Autonity Bakerloo (Thames) Testnet](https://thirdweb.com/autonity-bakerloo-thames-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Autonity Bakerloo (Thames) Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Autonity Bakerloo (Thames) Testnet as the network
...
### Initialize SDK On Autonity Bakerloo (Thames) Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Autonity Bakerloo (Thames) Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AutonityBakerlooThamesTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AutonityBakerlooThamesTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
