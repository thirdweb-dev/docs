...
# Building contracts and apps on Jellie

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Jellie. By the end of the guide, you should be able to create smart contracts and dApps on Jellie. If you want to check details such as RPCs for Jellie, check out our [chainlist page for Jellie](https://thirdweb.com/jellie).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Jellie using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Jellie as the network
...
### Initialize SDK On Jellie

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Jellie

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Jellie } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Jellie}>
      <YourApp />
    </ThirdwebProvider>
  );
};
