...
# Building contracts and apps on Scolcoin WeiChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Scolcoin WeiChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Scolcoin WeiChain Testnet. If you want to check details such as RPCs for Scolcoin WeiChain Testnet, check out our [chainlist page for Scolcoin WeiChain Testnet](https://thirdweb.com/scolcoin-weichain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Scolcoin WeiChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Scolcoin WeiChain Testnet as the network
...
### Initialize SDK On Scolcoin WeiChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Scolcoin WeiChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ScolcoinWeichainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ScolcoinWeichainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
