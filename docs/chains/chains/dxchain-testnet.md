...
# Building contracts and apps on DxChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DxChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on DxChain Testnet. If you want to check details such as RPCs for DxChain Testnet, check out our [chainlist page for DxChain Testnet](https://thirdweb.com/dxchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DxChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DxChain Testnet as the network
...
### Initialize SDK On DxChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DxChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DxchainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DxchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
