...
# Building contracts and apps on PLAYA3ULL GAMES

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PLAYA3ULL GAMES. By the end of the guide, you should be able to create smart contracts and dApps on PLAYA3ULL GAMES. If you want to check details such as RPCs for PLAYA3ULL GAMES, check out our [chainlist page for PLAYA3ULL GAMES](https://thirdweb.com/playa3ull-games).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PLAYA3ULL GAMES using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PLAYA3ULL GAMES as the network
...
### Initialize SDK On PLAYA3ULL GAMES

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PLAYA3ULL GAMES

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Playa3ullGames } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Playa3ullGames}>
      <YourApp />
    </ThirdwebProvider>
  );
};
