...
# Building contracts and apps on PlatON Dev Testnet2

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PlatON Dev Testnet2. By the end of the guide, you should be able to create smart contracts and dApps on PlatON Dev Testnet2. If you want to check details such as RPCs for PlatON Dev Testnet2, check out our [chainlist page for PlatON Dev Testnet2](https://thirdweb.com/platon-dev-testnet2).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PlatON Dev Testnet2 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PlatON Dev Testnet2 as the network
...
### Initialize SDK On PlatON Dev Testnet2

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PlatON Dev Testnet2

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PlatonDevTestnet2 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PlatonDevTestnet2}>
      <YourApp />
    </ThirdwebProvider>
  );
};
