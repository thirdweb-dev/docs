...
# Building contracts and apps on Bifrost Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bifrost Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Bifrost Mainnet. If you want to check details such as RPCs for Bifrost Mainnet, check out our [chainlist page for Bifrost Mainnet](https://thirdweb.com/bifrost).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bifrost Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bifrost Mainnet as the network
...
### Initialize SDK On Bifrost Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bifrost Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bifrost } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bifrost}>
      <YourApp />
    </ThirdwebProvider>
  );
};
