...
# Building contracts and apps on Dogechain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dogechain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Dogechain Mainnet. If you want to check details such as RPCs for Dogechain Mainnet, check out our [chainlist page for Dogechain Mainnet](https://thirdweb.com/dogechain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dogechain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dogechain Mainnet as the network
...
### Initialize SDK On Dogechain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dogechain Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Dogechain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
