...
# Building contracts and apps on OYchain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OYchain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on OYchain Testnet. If you want to check details such as RPCs for OYchain Testnet, check out our [chainlist page for OYchain Testnet](https://thirdweb.com/oychain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OYchain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OYchain Testnet as the network
...
### Initialize SDK On OYchain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OYchain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OychainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OychainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
