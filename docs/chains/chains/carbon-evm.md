...
# Building contracts and apps on Carbon EVM

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Carbon EVM. By the end of the guide, you should be able to create smart contracts and dApps on Carbon EVM. If you want to check details such as RPCs for Carbon EVM, check out our [chainlist page for Carbon EVM](https://thirdweb.com/carbon-evm).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Carbon EVM using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Carbon EVM as the network
...
### Initialize SDK On Carbon EVM

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Carbon EVM

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CarbonEvm } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CarbonEvm}>
      <YourApp />
    </ThirdwebProvider>
  );
};
