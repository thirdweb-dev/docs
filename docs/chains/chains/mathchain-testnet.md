...
# Building contracts and apps on MathChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MathChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on MathChain Testnet. If you want to check details such as RPCs for MathChain Testnet, check out our [chainlist page for MathChain Testnet](https://thirdweb.com/mathchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MathChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MathChain Testnet as the network
...
### Initialize SDK On MathChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MathChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MathchainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MathchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
