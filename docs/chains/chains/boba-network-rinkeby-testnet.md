...
# Building contracts and apps on Boba Network Rinkeby Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Boba Network Rinkeby Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Boba Network Rinkeby Testnet. If you want to check details such as RPCs for Boba Network Rinkeby Testnet, check out our [chainlist page for Boba Network Rinkeby Testnet](https://thirdweb.com/boba-network-rinkeby-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Boba Network Rinkeby Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Boba Network Rinkeby Testnet as the network
...
### Initialize SDK On Boba Network Rinkeby Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Boba Network Rinkeby Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BobaNetworkRinkebyTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BobaNetworkRinkebyTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
