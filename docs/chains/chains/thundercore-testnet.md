...
# Building contracts and apps on ThunderCore Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ThunderCore Testnet. By the end of the guide, you should be able to create smart contracts and dApps on ThunderCore Testnet. If you want to check details such as RPCs for ThunderCore Testnet, check out our [chainlist page for ThunderCore Testnet](https://thirdweb.com/thundercore-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ThunderCore Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ThunderCore Testnet as the network
...
### Initialize SDK On ThunderCore Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ThunderCore Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ThundercoreTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ThundercoreTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
