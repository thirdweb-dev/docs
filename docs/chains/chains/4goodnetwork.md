...
# Building contracts and apps on 4GoodNetwork

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on 4GoodNetwork. By the end of the guide, you should be able to create smart contracts and dApps on 4GoodNetwork. If you want to check details such as RPCs for 4GoodNetwork, check out our [chainlist page for 4GoodNetwork](https://thirdweb.com/4goodnetwork).
...
5. After modifying your contract with your desired custom logic, you may deploy it to 4GoodNetwork using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select 4GoodNetwork as the network
...
### Initialize SDK On 4GoodNetwork

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to 4GoodNetwork

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { _4goodnetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={_4goodnetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
