...
# Building contracts and apps on Ultron Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ultron Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Ultron Testnet. If you want to check details such as RPCs for Ultron Testnet, check out our [chainlist page for Ultron Testnet](https://thirdweb.com/ultron-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ultron Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ultron Testnet as the network
...
### Initialize SDK On Ultron Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ultron Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { UltronTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={UltronTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
