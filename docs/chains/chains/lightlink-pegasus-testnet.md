...
# Building contracts and apps on Lightlink Pegasus Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Lightlink Pegasus Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Lightlink Pegasus Testnet. If you want to check details such as RPCs for Lightlink Pegasus Testnet, check out our [chainlist page for Lightlink Pegasus Testnet](https://thirdweb.com/lightlink-pegasus-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Lightlink Pegasus Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Lightlink Pegasus Testnet as the network
...
### Initialize SDK On Lightlink Pegasus Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Lightlink Pegasus Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={LightlinkPegasusTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
