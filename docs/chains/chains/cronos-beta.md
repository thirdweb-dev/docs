...
# Building contracts and apps on Cronos Mainnet Beta

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Cronos Mainnet Beta. By the end of the guide, you should be able to create smart contracts and dApps on Cronos Mainnet Beta. If you want to check details such as RPCs for Cronos Mainnet Beta, check out our [chainlist page for Cronos Mainnet Beta](https://thirdweb.com/cronos-beta).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Cronos Mainnet Beta using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Cronos Mainnet Beta as the network
...
### Initialize SDK On Cronos Mainnet Beta

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Cronos Mainnet Beta
