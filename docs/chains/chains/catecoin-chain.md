...
# Building contracts and apps on Catecoin Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Catecoin Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Catecoin Chain Mainnet. If you want to check details such as RPCs for Catecoin Chain Mainnet, check out our [chainlist page for Catecoin Chain Mainnet](https://thirdweb.com/catecoin-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Catecoin Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Catecoin Chain Mainnet as the network
...
### Initialize SDK On Catecoin Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Catecoin Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CatecoinChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CatecoinChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
