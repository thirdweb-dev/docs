...
# Building contracts and apps on OYchain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OYchain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on OYchain Mainnet. If you want to check details such as RPCs for OYchain Mainnet, check out our [chainlist page for OYchain Mainnet](https://thirdweb.com/oychain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OYchain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OYchain Mainnet as the network
...
### Initialize SDK On OYchain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OYchain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Oychain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Oychain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
