...
# Building contracts and apps on Web3Games Devnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Web3Games Devnet. By the end of the guide, you should be able to create smart contracts and dApps on Web3Games Devnet. If you want to check details such as RPCs for Web3Games Devnet, check out our [chainlist page for Web3Games Devnet](https://thirdweb.com/web3games-devnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Web3Games Devnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Web3Games Devnet as the network
...
### Initialize SDK On Web3Games Devnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Web3Games Devnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Web3gamesDevnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Web3gamesDevnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
