...
# Building contracts and apps on Paribu Net Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Paribu Net Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Paribu Net Mainnet. If you want to check details such as RPCs for Paribu Net Mainnet, check out our [chainlist page for Paribu Net Mainnet](https://thirdweb.com/paribu-net).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Paribu Net Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Paribu Net Mainnet as the network
...
### Initialize SDK On Paribu Net Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Paribu Net Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ParibuNet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ParibuNet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
