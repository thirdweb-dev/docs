...
# Building contracts and apps on Seele Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Seele Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Seele Mainnet. If you want to check details such as RPCs for Seele Mainnet, check out our [chainlist page for Seele Mainnet](https://thirdweb.com/seele).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Seele Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Seele Mainnet as the network
...
### Initialize SDK On Seele Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Seele Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Seele } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Seele}>
      <YourApp />
    </ThirdwebProvider>
  );
};
