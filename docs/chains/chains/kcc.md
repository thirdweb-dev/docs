...
# Building contracts and apps on KCC Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on KCC Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on KCC Mainnet. If you want to check details such as RPCs for KCC Mainnet, check out our [chainlist page for KCC Mainnet](https://thirdweb.com/kcc).
...
5. After modifying your contract with your desired custom logic, you may deploy it to KCC Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select KCC Mainnet as the network
...
### Initialize SDK On KCC Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to KCC Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Kcc } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Kcc}>
      <YourApp />
    </ThirdwebProvider>
  );
};
