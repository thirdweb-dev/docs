---
title: BeOne Chain Testnet
slug: /beone-chain-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on BeOne Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BeOne Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on BeOne Chain Testnet. If you want to check details such as RPCs for BeOne Chain Testnet, check out our [chainlist page for BeOne Chain Testnet](https://thirdweb.com/beone-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BeOne Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BeOne Chain Testnet as the network
...
### Initialize SDK On BeOne Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BeOne Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BeoneChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BeoneChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
