...
# Building contracts and apps on Taro Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Taro Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Taro Testnet. If you want to check details such as RPCs for Taro Testnet, check out our [chainlist page for Taro Testnet](https://thirdweb.com/taro-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Taro Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Taro Testnet as the network
...
### Initialize SDK On Taro Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Taro Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={TaroTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
