...
# Building contracts and apps on Piece testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Piece testnet. By the end of the guide, you should be able to create smart contracts and dApps on Piece testnet. If you want to check details such as RPCs for Piece testnet, check out our [chainlist page for Piece testnet](https://thirdweb.com/piece-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Piece testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Piece testnet as the network
...
### Initialize SDK On Piece testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Piece testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PieceTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PieceTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
