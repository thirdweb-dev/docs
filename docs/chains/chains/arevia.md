...
# Building contracts and apps on Arevia

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Arevia. By the end of the guide, you should be able to create smart contracts and dApps on Arevia. If you want to check details such as RPCs for Arevia, check out our [chainlist page for Arevia](https://thirdweb.com/arevia).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Arevia using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Arevia as the network
...
### Initialize SDK On Arevia

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Arevia

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Arevia } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Arevia}>
      <YourApp />
    </ThirdwebProvider>
  );
};
