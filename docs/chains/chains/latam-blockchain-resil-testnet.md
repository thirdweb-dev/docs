...
# Building contracts and apps on Latam-Blockchain Resil Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Latam-Blockchain Resil Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Latam-Blockchain Resil Testnet. If you want to check details such as RPCs for Latam-Blockchain Resil Testnet, check out our [chainlist page for Latam-Blockchain Resil Testnet](https://thirdweb.com/latam-blockchain-resil-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Latam-Blockchain Resil Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Latam-Blockchain Resil Testnet as the network
...
### Initialize SDK On Latam-Blockchain Resil Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Latam-Blockchain Resil Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { LatamBlockchainResilTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={LatamBlockchainResilTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
