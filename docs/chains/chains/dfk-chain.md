...
# Building contracts and apps on DFK Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DFK Chain. By the end of the guide, you should be able to create smart contracts and dApps on DFK Chain. If you want to check details such as RPCs for DFK Chain, check out our [chainlist page for DFK Chain](https://thirdweb.com/dfk-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DFK Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DFK Chain as the network
...
### Initialize SDK On DFK Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DFK Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DfkChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DfkChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
