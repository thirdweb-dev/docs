...
# Building contracts and apps on Meshnyan testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Meshnyan testnet. By the end of the guide, you should be able to create smart contracts and dApps on Meshnyan testnet. If you want to check details such as RPCs for Meshnyan testnet, check out our [chainlist page for Meshnyan testnet](https://thirdweb.com/meshnyan-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Meshnyan testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Meshnyan testnet as the network
...
### Initialize SDK On Meshnyan testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Meshnyan testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MeshnyanTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MeshnyanTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
