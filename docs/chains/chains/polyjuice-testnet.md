...
# Building contracts and apps on Polyjuice Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Polyjuice Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Polyjuice Testnet. If you want to check details such as RPCs for Polyjuice Testnet, check out our [chainlist page for Polyjuice Testnet](https://thirdweb.com/polyjuice-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Polyjuice Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Polyjuice Testnet as the network
...
### Initialize SDK On Polyjuice Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Polyjuice Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { PolyjuiceTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={PolyjuiceTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
