...
# Building contracts and apps on Haqq Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Haqq Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Haqq Chain Testnet. If you want to check details such as RPCs for Haqq Chain Testnet, check out our [chainlist page for Haqq Chain Testnet](https://thirdweb.com/haqq-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Haqq Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Haqq Chain Testnet as the network
...
### Initialize SDK On Haqq Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Haqq Chain Testnet
