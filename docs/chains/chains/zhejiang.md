...
# Building contracts and apps on Zhejiang

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Zhejiang. By the end of the guide, you should be able to create smart contracts and dApps on Zhejiang. If you want to check details such as RPCs for Zhejiang, check out our [chainlist page for Zhejiang](https://thirdweb.com/zhejiang).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Zhejiang using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Zhejiang as the network
...
### Initialize SDK On Zhejiang

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Zhejiang
