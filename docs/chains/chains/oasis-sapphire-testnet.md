...
# Building contracts and apps on Oasis Sapphire Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oasis Sapphire Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Oasis Sapphire Testnet. If you want to check details such as RPCs for Oasis Sapphire Testnet, check out our [chainlist page for Oasis Sapphire Testnet](https://thirdweb.com/oasis-sapphire-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oasis Sapphire Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oasis Sapphire Testnet as the network
...
### Initialize SDK On Oasis Sapphire Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oasis Sapphire Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OasisSapphireTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OasisSapphireTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
