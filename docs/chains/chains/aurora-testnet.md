...
5. After modifying your contract with your desired custom logic, you may deploy it to Aurora Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Aurora Testnet as the network
...
### Initialize SDK On Aurora Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Aurora Testnet
