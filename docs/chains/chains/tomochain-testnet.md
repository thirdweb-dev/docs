---
title: TomoChain Testnet
slug: /tomochain-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on TomoChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on TomoChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on TomoChain Testnet. If you want to check details such as RPCs for TomoChain Testnet, check out our [chainlist page for TomoChain Testnet](https://thirdweb.com/tomochain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to TomoChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select TomoChain Testnet as the network
...
### Initialize SDK On TomoChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to TomoChain Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={TomochainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
