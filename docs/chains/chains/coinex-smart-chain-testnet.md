...
# Building contracts and apps on CoinEx Smart Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on CoinEx Smart Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on CoinEx Smart Chain Testnet. If you want to check details such as RPCs for CoinEx Smart Chain Testnet, check out our [chainlist page for CoinEx Smart Chain Testnet](https://thirdweb.com/coinex-smart-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to CoinEx Smart Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select CoinEx Smart Chain Testnet as the network
...
### Initialize SDK On CoinEx Smart Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to CoinEx Smart Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CoinexSmartChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CoinexSmartChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
