...
# Building contracts and apps on Crystaleum

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Crystaleum. By the end of the guide, you should be able to create smart contracts and dApps on Crystaleum. If you want to check details such as RPCs for Crystaleum, check out our [chainlist page for Crystaleum](https://thirdweb.com/crystaleum).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Crystaleum using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Crystaleum as the network
...
### Initialize SDK On Crystaleum

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Crystaleum

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Crystaleum } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Crystaleum}>
      <YourApp />
    </ThirdwebProvider>
  );
};
