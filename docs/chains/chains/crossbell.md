...
# Building contracts and apps on Crossbell

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Crossbell. By the end of the guide, you should be able to create smart contracts and dApps on Crossbell. If you want to check details such as RPCs for Crossbell, check out our [chainlist page for Crossbell](https://thirdweb.com/crossbell).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Crossbell using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Crossbell as the network
...
### Initialize SDK On Crossbell

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Crossbell

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Crossbell } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Crossbell}>
      <YourApp />
    </ThirdwebProvider>
  );
};
