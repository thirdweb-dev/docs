---
title: Acria IntelliChain
slug: /acria-intellichain
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Acria IntelliChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Acria IntelliChain. By the end of the guide, you should be able to create smart contracts and dApps on Acria IntelliChain. If you want to check details such as RPCs for Acria IntelliChain, check out our [chainlist page for Acria IntelliChain](https://thirdweb.com/acria-intellichain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Acria IntelliChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Acria IntelliChain as the network
...
### Initialize SDK On Acria IntelliChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Acria IntelliChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AcriaIntellichain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AcriaIntellichain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
