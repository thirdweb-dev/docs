...
# Building contracts and apps on Vention Smart Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Vention Smart Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Vention Smart Chain Testnet. If you want to check details such as RPCs for Vention Smart Chain Testnet, check out our [chainlist page for Vention Smart Chain Testnet](https://thirdweb.com/vention-smart-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Vention Smart Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Vention Smart Chain Testnet as the network
...
### Initialize SDK On Vention Smart Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Vention Smart Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { VentionSmartChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={VentionSmartChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
