...
# Building contracts and apps on Boba Network Goerli Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Boba Network Goerli Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Boba Network Goerli Testnet. If you want to check details such as RPCs for Boba Network Goerli Testnet, check out our [chainlist page for Boba Network Goerli Testnet](https://thirdweb.com/boba-network-goerli-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Boba Network Goerli Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Boba Network Goerli Testnet as the network
...
### Initialize SDK On Boba Network Goerli Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Boba Network Goerli Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BobaNetworkGoerliTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BobaNetworkGoerliTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
