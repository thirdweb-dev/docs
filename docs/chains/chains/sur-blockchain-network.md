...
# Building contracts and apps on SUR Blockchain Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SUR Blockchain Network. By the end of the guide, you should be able to create smart contracts and dApps on SUR Blockchain Network. If you want to check details such as RPCs for SUR Blockchain Network, check out our [chainlist page for SUR Blockchain Network](https://thirdweb.com/sur-blockchain-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SUR Blockchain Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SUR Blockchain Network as the network
...
### Initialize SDK On SUR Blockchain Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SUR Blockchain Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SurBlockchainNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SurBlockchainNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
