...
# Building contracts and apps on Proof Of Memes

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Proof Of Memes. By the end of the guide, you should be able to create smart contracts and dApps on Proof Of Memes. If you want to check details such as RPCs for Proof Of Memes, check out our [chainlist page for Proof Of Memes](https://thirdweb.com/proof-of-memes).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Proof Of Memes using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Proof Of Memes as the network
...
### Initialize SDK On Proof Of Memes

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Proof Of Memes

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ProofOfMemes } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ProofOfMemes}>
      <YourApp />
    </ThirdwebProvider>
  );
};
