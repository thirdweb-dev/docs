...
# Building contracts and apps on Raba Network Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Raba Network Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Raba Network Mainnet. If you want to check details such as RPCs for Raba Network Mainnet, check out our [chainlist page for Raba Network Mainnet](https://thirdweb.com/raba-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Raba Network Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Raba Network Mainnet as the network
...
### Initialize SDK On Raba Network Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Raba Network Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { RabaNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={RabaNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
