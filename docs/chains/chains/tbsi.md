...
# Building contracts and apps on TBSI Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on TBSI Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on TBSI Mainnet. If you want to check details such as RPCs for TBSI Mainnet, check out our [chainlist page for TBSI Mainnet](https://thirdweb.com/tbsi).
...
5. After modifying your contract with your desired custom logic, you may deploy it to TBSI Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select TBSI Mainnet as the network
...
### Initialize SDK On TBSI Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to TBSI Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Tbsi } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Tbsi}>
      <YourApp />
    </ThirdwebProvider>
  );
};
