...
# Building contracts and apps on Klaytn Mainnet Cypress

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Klaytn Mainnet Cypress. By the end of the guide, you should be able to create smart contracts and dApps on Klaytn Mainnet Cypress. If you want to check details such as RPCs for Klaytn Mainnet Cypress, check out our [chainlist page for Klaytn Mainnet Cypress](https://thirdweb.com/klaytn-cypress).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Klaytn Mainnet Cypress using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Klaytn Mainnet Cypress as the network
...
### Initialize SDK On Klaytn Mainnet Cypress

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Klaytn Mainnet Cypress
