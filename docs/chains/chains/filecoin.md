...
# Building contracts and apps on Filecoin - Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Filecoin - Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Filecoin - Mainnet. If you want to check details such as RPCs for Filecoin - Mainnet, check out our [chainlist page for Filecoin - Mainnet](https://thirdweb.com/filecoin).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Filecoin - Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Filecoin - Mainnet as the network
...
### Initialize SDK On Filecoin - Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Filecoin - Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Filecoin } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Filecoin}>
      <YourApp />
    </ThirdwebProvider>
  );
};
