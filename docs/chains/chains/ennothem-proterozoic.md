...
# Building contracts and apps on Ennothem Mainnet Proterozoic

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ennothem Mainnet Proterozoic. By the end of the guide, you should be able to create smart contracts and dApps on Ennothem Mainnet Proterozoic. If you want to check details such as RPCs for Ennothem Mainnet Proterozoic, check out our [chainlist page for Ennothem Mainnet Proterozoic](https://thirdweb.com/ennothem-proterozoic).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ennothem Mainnet Proterozoic using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ennothem Mainnet Proterozoic as the network
...
### Initialize SDK On Ennothem Mainnet Proterozoic

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ennothem Mainnet Proterozoic

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EnnothemProterozoic } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EnnothemProterozoic}>
      <YourApp />
    </ThirdwebProvider>
  );
};
