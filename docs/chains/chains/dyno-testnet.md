...
# Building contracts and apps on DYNO Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DYNO Testnet. By the end of the guide, you should be able to create smart contracts and dApps on DYNO Testnet. If you want to check details such as RPCs for DYNO Testnet, check out our [chainlist page for DYNO Testnet](https://thirdweb.com/dyno-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DYNO Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DYNO Testnet as the network
...
### Initialize SDK On DYNO Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DYNO Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DynoTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DynoTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
