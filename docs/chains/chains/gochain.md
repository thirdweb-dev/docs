...
# Building contracts and apps on GoChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on GoChain. By the end of the guide, you should be able to create smart contracts and dApps on GoChain. If you want to check details such as RPCs for GoChain, check out our [chainlist page for GoChain](https://thirdweb.com/gochain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to GoChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select GoChain as the network
...
### Initialize SDK On GoChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to GoChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Gochain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Gochain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
