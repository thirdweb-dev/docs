...
# Building contracts and apps on Milkomeda C1 Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Milkomeda C1 Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Milkomeda C1 Mainnet. If you want to check details such as RPCs for Milkomeda C1 Mainnet, check out our [chainlist page for Milkomeda C1 Mainnet](https://thirdweb.com/milkomeda-c1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Milkomeda C1 Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Milkomeda C1 Mainnet as the network
...
### Initialize SDK On Milkomeda C1 Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Milkomeda C1 Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MilkomedaC1 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MilkomedaC1}>
      <YourApp />
    </ThirdwebProvider>
  );
};
