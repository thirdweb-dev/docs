...
# Building contracts and apps on Scroll

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Scroll. By the end of the guide, you should be able to create smart contracts and dApps on Scroll. If you want to check details such as RPCs for Scroll, check out our [chainlist page for Scroll](https://thirdweb.com/scroll).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Scroll using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Scroll as the network
...
### Initialize SDK On Scroll

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Scroll
