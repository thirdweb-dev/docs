---
title: Neurochain Mainnet
slug: /neurochain
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Neurochain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Neurochain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Neurochain Mainnet. If you want to check details such as RPCs for Neurochain Mainnet, check out our [chainlist page for Neurochain Mainnet](https://thirdweb.com/neurochain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Neurochain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Neurochain Mainnet as the network
...
### Initialize SDK On Neurochain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Neurochain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Neurochain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Neurochain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
