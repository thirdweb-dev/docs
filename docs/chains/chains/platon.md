...
# Building contracts and apps on PlatON Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PlatON Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on PlatON Mainnet. If you want to check details such as RPCs for PlatON Mainnet, check out our [chainlist page for PlatON Mainnet](https://thirdweb.com/platon).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PlatON Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PlatON Mainnet as the network
...
### Initialize SDK On PlatON Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PlatON Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Platon } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Platon}>
      <YourApp />
    </ThirdwebProvider>
  );
};
