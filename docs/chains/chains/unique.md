...
# Building contracts and apps on Unique

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Unique. By the end of the guide, you should be able to create smart contracts and dApps on Unique. If you want to check details such as RPCs for Unique, check out our [chainlist page for Unique](https://thirdweb.com/unique).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Unique using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Unique as the network
...
### Initialize SDK On Unique

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Unique

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Unique } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Unique}>
      <YourApp />
    </ThirdwebProvider>
  );
};
