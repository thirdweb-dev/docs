...
# Building contracts and apps on Lucid Blockchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Lucid Blockchain. By the end of the guide, you should be able to create smart contracts and dApps on Lucid Blockchain. If you want to check details such as RPCs for Lucid Blockchain, check out our [chainlist page for Lucid Blockchain](https://thirdweb.com/lucid-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Lucid Blockchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Lucid Blockchain as the network
...
### Initialize SDK On Lucid Blockchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Lucid Blockchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { LucidBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={LucidBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
