...
# Building contracts and apps on Findora Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Findora Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Findora Testnet. If you want to check details such as RPCs for Findora Testnet, check out our [chainlist page for Findora Testnet](https://thirdweb.com/findora-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Findora Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Findora Testnet as the network
...
### Initialize SDK On Findora Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Findora Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FindoraTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FindoraTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
