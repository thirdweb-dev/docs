...
# Building contracts and apps on Ontology Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ontology Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Ontology Testnet. If you want to check details such as RPCs for Ontology Testnet, check out our [chainlist page for Ontology Testnet](https://thirdweb.com/ontology-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ontology Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ontology Testnet as the network
...
### Initialize SDK On Ontology Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ontology Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OntologyTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OntologyTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
