...
# Building contracts and apps on Oort MainnetDev

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oort MainnetDev. By the end of the guide, you should be able to create smart contracts and dApps on Oort MainnetDev. If you want to check details such as RPCs for Oort MainnetDev, check out our [chainlist page for Oort MainnetDev](https://thirdweb.com/oort-dev).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oort MainnetDev using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oort MainnetDev as the network
...
### Initialize SDK On Oort MainnetDev

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oort MainnetDev

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OortDev } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OortDev}>
      <YourApp />
    </ThirdwebProvider>
  );
};
