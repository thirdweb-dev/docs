...
# Building contracts and apps on LaChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on LaChain. By the end of the guide, you should be able to create smart contracts and dApps on LaChain. If you want to check details such as RPCs for LaChain, check out our [chainlist page for LaChain](https://thirdweb.com/lachain-lachain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to LaChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select LaChain as the network
...
### Initialize SDK On LaChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to LaChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { LachainLachain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={LachainLachain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
