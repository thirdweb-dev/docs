...
# Building contracts and apps on Lycan Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Lycan Chain. By the end of the guide, you should be able to create smart contracts and dApps on Lycan Chain. If you want to check details such as RPCs for Lycan Chain, check out our [chainlist page for Lycan Chain](https://thirdweb.com/lycan-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Lycan Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Lycan Chain as the network
...
### Initialize SDK On Lycan Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Lycan Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { LycanChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={LycanChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
