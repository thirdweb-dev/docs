...
# Building contracts and apps on Mizana Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Mizana Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Mizana Testnet. If you want to check details such as RPCs for Mizana Testnet, check out our [chainlist page for Mizana Testnet](https://thirdweb.com/mizana-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Mizana Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Mizana Testnet as the network
...
### Initialize SDK On Mizana Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Mizana Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MizanaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MizanaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
