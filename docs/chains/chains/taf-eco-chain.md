...
# Building contracts and apps on Taf ECO Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Taf ECO Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Taf ECO Chain Mainnet. If you want to check details such as RPCs for Taf ECO Chain Mainnet, check out our [chainlist page for Taf ECO Chain Mainnet](https://thirdweb.com/taf-eco-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Taf ECO Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Taf ECO Chain Mainnet as the network
...
### Initialize SDK On Taf ECO Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Taf ECO Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TafEcoChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TafEcoChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
