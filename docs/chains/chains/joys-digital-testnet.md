...
# Building contracts and apps on Joys Digital TestNet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Joys Digital TestNet. By the end of the guide, you should be able to create smart contracts and dApps on Joys Digital TestNet. If you want to check details such as RPCs for Joys Digital TestNet, check out our [chainlist page for Joys Digital TestNet](https://thirdweb.com/joys-digital-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Joys Digital TestNet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Joys Digital TestNet as the network
...
### Initialize SDK On Joys Digital TestNet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Joys Digital TestNet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { JoysDigitalTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={JoysDigitalTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
