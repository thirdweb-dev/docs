...
# Building contracts and apps on Scroll Sepolia Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Scroll Sepolia Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Scroll Sepolia Testnet. If you want to check details such as RPCs for Scroll Sepolia Testnet, check out our [chainlist page for Scroll Sepolia Testnet](https://thirdweb.com/scroll-sepolia-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Scroll Sepolia Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Scroll Sepolia Testnet as the network
...
### Initialize SDK On Scroll Sepolia Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Scroll Sepolia Testnet
