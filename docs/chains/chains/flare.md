...
# Building contracts and apps on Flare Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Flare Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Flare Mainnet. If you want to check details such as RPCs for Flare Mainnet, check out our [chainlist page for Flare Mainnet](https://thirdweb.com/flare).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Flare Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Flare Mainnet as the network
...
### Initialize SDK On Flare Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Flare Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Flare}>
      <YourApp />
    </ThirdwebProvider>
  );
};
