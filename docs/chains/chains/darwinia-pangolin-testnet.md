...
# Building contracts and apps on Darwinia Pangolin Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Darwinia Pangolin Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Darwinia Pangolin Testnet. If you want to check details such as RPCs for Darwinia Pangolin Testnet, check out our [chainlist page for Darwinia Pangolin Testnet](https://thirdweb.com/darwinia-pangolin-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Darwinia Pangolin Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Darwinia Pangolin Testnet as the network
...
### Initialize SDK On Darwinia Pangolin Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Darwinia Pangolin Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DarwiniaPangolinTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DarwiniaPangolinTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
