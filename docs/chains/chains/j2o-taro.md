...
# Building contracts and apps on J2O Taro

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on J2O Taro. By the end of the guide, you should be able to create smart contracts and dApps on J2O Taro. If you want to check details such as RPCs for J2O Taro, check out our [chainlist page for J2O Taro](https://thirdweb.com/j2o-taro).
...
5. After modifying your contract with your desired custom logic, you may deploy it to J2O Taro using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select J2O Taro as the network
...
### Initialize SDK On J2O Taro

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to J2O Taro

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { J2oTaro } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={J2oTaro}>
      <YourApp />
    </ThirdwebProvider>
  );
};
