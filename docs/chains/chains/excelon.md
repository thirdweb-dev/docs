...
# Building contracts and apps on Excelon Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Excelon Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Excelon Mainnet. If you want to check details such as RPCs for Excelon Mainnet, check out our [chainlist page for Excelon Mainnet](https://thirdweb.com/excelon).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Excelon Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Excelon Mainnet as the network
...
### Initialize SDK On Excelon Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Excelon Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Excelon } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Excelon}>
      <YourApp />
    </ThirdwebProvider>
  );
};
