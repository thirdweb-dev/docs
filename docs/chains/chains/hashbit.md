...
# Building contracts and apps on HashBit Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on HashBit Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on HashBit Mainnet. If you want to check details such as RPCs for HashBit Mainnet, check out our [chainlist page for HashBit Mainnet](https://thirdweb.com/hashbit).
...
5. After modifying your contract with your desired custom logic, you may deploy it to HashBit Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select HashBit Mainnet as the network
...
### Initialize SDK On HashBit Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to HashBit Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Hashbit } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Hashbit}>
      <YourApp />
    </ThirdwebProvider>
  );
};
