...
# Building contracts and apps on MOAC mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MOAC mainnet. By the end of the guide, you should be able to create smart contracts and dApps on MOAC mainnet. If you want to check details such as RPCs for MOAC mainnet, check out our [chainlist page for MOAC mainnet](https://thirdweb.com/moac).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MOAC mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MOAC mainnet as the network
...
### Initialize SDK On MOAC mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MOAC mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Moac } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Moac}>
      <YourApp />
    </ThirdwebProvider>
  );
};
