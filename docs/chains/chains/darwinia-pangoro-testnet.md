...
# Building contracts and apps on Darwinia Pangoro Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Darwinia Pangoro Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Darwinia Pangoro Testnet. If you want to check details such as RPCs for Darwinia Pangoro Testnet, check out our [chainlist page for Darwinia Pangoro Testnet](https://thirdweb.com/darwinia-pangoro-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Darwinia Pangoro Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Darwinia Pangoro Testnet as the network
...
### Initialize SDK On Darwinia Pangoro Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Darwinia Pangoro Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DarwiniaPangoroTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DarwiniaPangoroTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
