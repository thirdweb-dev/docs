...
# Building contracts and apps on Hertz Network Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Hertz Network Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Hertz Network Mainnet. If you want to check details such as RPCs for Hertz Network Mainnet, check out our [chainlist page for Hertz Network Mainnet](https://thirdweb.com/hertz-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Hertz Network Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Hertz Network Mainnet as the network
...
### Initialize SDK On Hertz Network Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Hertz Network Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { HertzNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={HertzNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
