...
# Building contracts and apps on Genesys Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Genesys Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Genesys Mainnet. If you want to check details such as RPCs for Genesys Mainnet, check out our [chainlist page for Genesys Mainnet](https://thirdweb.com/genesys).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Genesys Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Genesys Mainnet as the network
...
### Initialize SDK On Genesys Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Genesys Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Genesys } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Genesys}>
      <YourApp />
    </ThirdwebProvider>
  );
};
