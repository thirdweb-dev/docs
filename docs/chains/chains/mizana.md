...
# Building contracts and apps on Mizana

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Mizana. By the end of the guide, you should be able to create smart contracts and dApps on Mizana. If you want to check details such as RPCs for Mizana, check out our [chainlist page for Mizana](https://thirdweb.com/mizana).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Mizana using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Mizana as the network
...
### Initialize SDK On Mizana

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Mizana

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Mizana } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Mizana}>
      <YourApp />
    </ThirdwebProvider>
  );
};
