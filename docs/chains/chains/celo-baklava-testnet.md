...
# Building contracts and apps on Celo Baklava Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Celo Baklava Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Celo Baklava Testnet. If you want to check details such as RPCs for Celo Baklava Testnet, check out our [chainlist page for Celo Baklava Testnet](https://thirdweb.com/celo-baklava-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Celo Baklava Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Celo Baklava Testnet as the network
...
### Initialize SDK On Celo Baklava Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Celo Baklava Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CeloBaklavaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CeloBaklavaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
