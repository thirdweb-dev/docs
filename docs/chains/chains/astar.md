...
# Building contracts and apps on Astar

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Astar. By the end of the guide, you should be able to create smart contracts and dApps on Astar. If you want to check details such as RPCs for Astar, check out our [chainlist page for Astar](https://thirdweb.com/astar).
