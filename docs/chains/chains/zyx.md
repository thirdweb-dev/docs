...
# Building contracts and apps on Zyx Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Zyx Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Zyx Mainnet. If you want to check details such as RPCs for Zyx Mainnet, check out our [chainlist page for Zyx Mainnet](https://thirdweb.com/zyx).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Zyx Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Zyx Mainnet as the network
...
### Initialize SDK On Zyx Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Zyx Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Zyx } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Zyx}>
      <YourApp />
    </ThirdwebProvider>
  );
};
