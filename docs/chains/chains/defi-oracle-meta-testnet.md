...
# Building contracts and apps on Defi Oracle Meta Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Defi Oracle Meta Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Defi Oracle Meta Testnet. If you want to check details such as RPCs for Defi Oracle Meta Testnet, check out our [chainlist page for Defi Oracle Meta Testnet](https://thirdweb.com/defi-oracle-meta-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Defi Oracle Meta Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Defi Oracle Meta Testnet as the network
...
### Initialize SDK On Defi Oracle Meta Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Defi Oracle Meta Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DefiOracleMetaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DefiOracleMetaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
