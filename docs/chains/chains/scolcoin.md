...
# Building contracts and apps on Scolcoin Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Scolcoin Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Scolcoin Mainnet. If you want to check details such as RPCs for Scolcoin Mainnet, check out our [chainlist page for Scolcoin Mainnet](https://thirdweb.com/scolcoin).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Scolcoin Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Scolcoin Mainnet as the network
...
### Initialize SDK On Scolcoin Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Scolcoin Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Scolcoin}>
      <YourApp />
    </ThirdwebProvider>
  );
};
