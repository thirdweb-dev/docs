...
# Building contracts and apps on Susono

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Susono. By the end of the guide, you should be able to create smart contracts and dApps on Susono. If you want to check details such as RPCs for Susono, check out our [chainlist page for Susono](https://thirdweb.com/susono).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Susono using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Susono as the network
...
### Initialize SDK On Susono

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Susono

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Susono } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Susono}>
      <YourApp />
    </ThirdwebProvider>
  );
};
