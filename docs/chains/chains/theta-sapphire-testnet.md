...
# Building contracts and apps on Theta Sapphire Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Theta Sapphire Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Theta Sapphire Testnet. If you want to check details such as RPCs for Theta Sapphire Testnet, check out our [chainlist page for Theta Sapphire Testnet](https://thirdweb.com/theta-sapphire-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Theta Sapphire Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Theta Sapphire Testnet as the network
...
### Initialize SDK On Theta Sapphire Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Theta Sapphire Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ThetaSapphireTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ThetaSapphireTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
