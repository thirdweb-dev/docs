---
title: WhiteBIT Network Testnet
slug: /whitebit-network-testnet
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on WhiteBIT Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on WhiteBIT Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on WhiteBIT Network Testnet. If you want to check details such as RPCs for WhiteBIT Network Testnet, check out our [chainlist page for WhiteBIT Network Testnet](https://thirdweb.com/whitebit-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to WhiteBIT Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select WhiteBIT Network Testnet as the network
...
### Initialize SDK On WhiteBIT Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to WhiteBIT Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { WhitebitNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={WhitebitNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
