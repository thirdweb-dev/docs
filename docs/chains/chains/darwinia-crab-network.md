...
# Building contracts and apps on Darwinia Crab Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Darwinia Crab Network. By the end of the guide, you should be able to create smart contracts and dApps on Darwinia Crab Network. If you want to check details such as RPCs for Darwinia Crab Network, check out our [chainlist page for Darwinia Crab Network](https://thirdweb.com/darwinia-crab-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Darwinia Crab Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Darwinia Crab Network as the network
...
### Initialize SDK On Darwinia Crab Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Darwinia Crab Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DarwiniaCrabNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DarwiniaCrabNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
