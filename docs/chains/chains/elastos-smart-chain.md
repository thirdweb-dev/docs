...
# Building contracts and apps on Elastos Smart Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Elastos Smart Chain. By the end of the guide, you should be able to create smart contracts and dApps on Elastos Smart Chain. If you want to check details such as RPCs for Elastos Smart Chain, check out our [chainlist page for Elastos Smart Chain](https://thirdweb.com/elastos-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Elastos Smart Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Elastos Smart Chain as the network
...
### Initialize SDK On Elastos Smart Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Elastos Smart Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ElastosSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ElastosSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
