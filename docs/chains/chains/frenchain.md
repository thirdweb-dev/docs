...
# Building contracts and apps on Frenchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Frenchain. By the end of the guide, you should be able to create smart contracts and dApps on Frenchain. If you want to check details such as RPCs for Frenchain, check out our [chainlist page for Frenchain](https://thirdweb.com/frenchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Frenchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Frenchain as the network
...
### Initialize SDK On Frenchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Frenchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Frenchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Frenchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
