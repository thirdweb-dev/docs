...
# Building contracts and apps on Optimism Goerli Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Optimism Goerli Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Optimism Goerli Testnet. If you want to check details such as RPCs for Optimism Goerli Testnet, check out our [chainlist page for Optimism Goerli Testnet](https://thirdweb.com/optimism-goerli).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Optimism Goerli Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Optimism Goerli Testnet as the network
...
### Initialize SDK On Optimism Goerli Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Optimism Goerli Testnet
