...
# Building contracts and apps on Numbers Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Numbers Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Numbers Mainnet. If you want to check details such as RPCs for Numbers Mainnet, check out our [chainlist page for Numbers Mainnet](https://thirdweb.com/numbers).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Numbers Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Numbers Mainnet as the network
...
### Initialize SDK On Numbers Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Numbers Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Numbers } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Numbers}>
      <YourApp />
    </ThirdwebProvider>
  );
};
