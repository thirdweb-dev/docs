...
# Building contracts and apps on Fantom Opera

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Fantom Opera. By the end of the guide, you should be able to create smart contracts and dApps on Fantom Opera. If you want to check details such as RPCs for Fantom Opera, check out our [chainlist page for Fantom Opera](https://thirdweb.com/fantom).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Fantom Opera using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Fantom Opera as the network
...
### Initialize SDK On Fantom Opera

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Fantom Opera
