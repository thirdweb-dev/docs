...
# Building contracts and apps on Taraxa Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Taraxa Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Taraxa Mainnet. If you want to check details such as RPCs for Taraxa Mainnet, check out our [chainlist page for Taraxa Mainnet](https://thirdweb.com/taraxa).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Taraxa Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Taraxa Mainnet as the network
...
### Initialize SDK On Taraxa Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Taraxa Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Taraxa } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Taraxa}>
      <YourApp />
    </ThirdwebProvider>
  );
};
