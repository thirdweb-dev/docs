...
# Building contracts and apps on SOMA Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SOMA Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on SOMA Network Testnet. If you want to check details such as RPCs for SOMA Network Testnet, check out our [chainlist page for SOMA Network Testnet](https://thirdweb.com/soma-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SOMA Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SOMA Network Testnet as the network
...
### Initialize SDK On SOMA Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SOMA Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SomaNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SomaNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
