...
# Building contracts and apps on Aitd Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Aitd Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Aitd Mainnet. If you want to check details such as RPCs for Aitd Mainnet, check out our [chainlist page for Aitd Mainnet](https://thirdweb.com/aitd).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Aitd Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Aitd Mainnet as the network
...
### Initialize SDK On Aitd Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Aitd Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Aitd } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Aitd}>
      <YourApp />
    </ThirdwebProvider>
  );
};
