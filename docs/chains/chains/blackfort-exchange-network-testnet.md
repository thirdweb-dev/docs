...
# Building contracts and apps on BlackFort Exchange Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BlackFort Exchange Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on BlackFort Exchange Network Testnet. If you want to check details such as RPCs for BlackFort Exchange Network Testnet, check out our [chainlist page for BlackFort Exchange Network Testnet](https://thirdweb.com/blackfort-exchange-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BlackFort Exchange Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BlackFort Exchange Network Testnet as the network
...
### Initialize SDK On BlackFort Exchange Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BlackFort Exchange Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BlackfortExchangeNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BlackfortExchangeNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
