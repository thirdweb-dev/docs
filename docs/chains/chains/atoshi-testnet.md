...
# Building contracts and apps on Atoshi Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Atoshi Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Atoshi Testnet. If you want to check details such as RPCs for Atoshi Testnet, check out our [chainlist page for Atoshi Testnet](https://thirdweb.com/atoshi-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Atoshi Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Atoshi Testnet as the network
...
### Initialize SDK On Atoshi Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Atoshi Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AtoshiTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AtoshiTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
