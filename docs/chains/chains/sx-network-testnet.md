...
# Building contracts and apps on SX Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SX Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on SX Network Testnet. If you want to check details such as RPCs for SX Network Testnet, check out our [chainlist page for SX Network Testnet](https://thirdweb.com/sx-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SX Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SX Network Testnet as the network
...
### Initialize SDK On SX Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SX Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SxNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SxNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
