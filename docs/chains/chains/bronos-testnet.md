...
# Building contracts and apps on Bronos Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bronos Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Bronos Testnet. If you want to check details such as RPCs for Bronos Testnet, check out our [chainlist page for Bronos Testnet](https://thirdweb.com/bronos-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bronos Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bronos Testnet as the network
...
### Initialize SDK On Bronos Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bronos Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BronosTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BronosTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
