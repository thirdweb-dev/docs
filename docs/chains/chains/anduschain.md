...
# Building contracts and apps on Anduschain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Anduschain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Anduschain Mainnet. If you want to check details such as RPCs for Anduschain Mainnet, check out our [chainlist page for Anduschain Mainnet](https://thirdweb.com/anduschain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Anduschain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Anduschain Mainnet as the network
...
### Initialize SDK On Anduschain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Anduschain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Anduschain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Anduschain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
