...
# Building contracts and apps on Alyx Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Alyx Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Alyx Chain Testnet. If you want to check details such as RPCs for Alyx Chain Testnet, check out our [chainlist page for Alyx Chain Testnet](https://thirdweb.com/alyx-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Alyx Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Alyx Chain Testnet as the network
...
### Initialize SDK On Alyx Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Alyx Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AlyxChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AlyxChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
