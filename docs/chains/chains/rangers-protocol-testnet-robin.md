...
# Building contracts and apps on Rangers Protocol Testnet Robin

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Rangers Protocol Testnet Robin. By the end of the guide, you should be able to create smart contracts and dApps on Rangers Protocol Testnet Robin. If you want to check details such as RPCs for Rangers Protocol Testnet Robin, check out our [chainlist page for Rangers Protocol Testnet Robin](https://thirdweb.com/rangers-protocol-testnet-robin).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Rangers Protocol Testnet Robin using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Rangers Protocol Testnet Robin as the network
...
### Initialize SDK On Rangers Protocol Testnet Robin

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Rangers Protocol Testnet Robin

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { RangersProtocolTestnetRobin } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={RangersProtocolTestnetRobin}>
      <YourApp />
    </ThirdwebProvider>
  );
};
