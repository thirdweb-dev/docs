...
# Building contracts and apps on CoinEx Smart Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on CoinEx Smart Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on CoinEx Smart Chain Mainnet. If you want to check details such as RPCs for CoinEx Smart Chain Mainnet, check out our [chainlist page for CoinEx Smart Chain Mainnet](https://thirdweb.com/coinex-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to CoinEx Smart Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select CoinEx Smart Chain Mainnet as the network
...
### Initialize SDK On CoinEx Smart Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to CoinEx Smart Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CoinexSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CoinexSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
