...
# Building contracts and apps on Canto

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Canto. By the end of the guide, you should be able to create smart contracts and dApps on Canto. If you want to check details such as RPCs for Canto, check out our [chainlist page for Canto](https://thirdweb.com/canto).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Canto using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Canto

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Canto

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Canto } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Canto}>
      <YourApp />
    </ThirdwebProvider>
  );
};
