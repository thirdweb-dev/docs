...
# Building contracts and apps on Openpiece Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Openpiece Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Openpiece Mainnet. If you want to check details such as RPCs for Openpiece Mainnet, check out our [chainlist page for Openpiece Mainnet](https://thirdweb.com/openpiece).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Openpiece Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Openpiece Mainnet as the network
...
### Initialize SDK On Openpiece Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Openpiece Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Openpiece } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Openpiece}>
      <YourApp />
    </ThirdwebProvider>
  );
};
