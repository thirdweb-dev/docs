...
# Building contracts and apps on Songbird Canary-Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Songbird Canary-Network. By the end of the guide, you should be able to create smart contracts and dApps on Songbird Canary-Network. If you want to check details such as RPCs for Songbird Canary-Network, check out our [chainlist page for Songbird Canary-Network](https://thirdweb.com/songbird-canary-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Songbird Canary-Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Songbird Canary-Network as the network
...
### Initialize SDK On Songbird Canary-Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Songbird Canary-Network
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={SongbirdCanaryNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
