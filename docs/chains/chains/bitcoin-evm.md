...
# Building contracts and apps on Bitcoin EVM

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bitcoin EVM. By the end of the guide, you should be able to create smart contracts and dApps on Bitcoin EVM. If you want to check details such as RPCs for Bitcoin EVM, check out our [chainlist page for Bitcoin EVM](https://thirdweb.com/bitcoin-evm).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bitcoin EVM using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bitcoin EVM as the network
...
### Initialize SDK On Bitcoin EVM

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bitcoin EVM

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BitcoinEvm } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BitcoinEvm}>
      <YourApp />
    </ThirdwebProvider>
  );
};
