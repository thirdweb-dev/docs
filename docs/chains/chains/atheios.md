...
# Building contracts and apps on Atheios

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Atheios. By the end of the guide, you should be able to create smart contracts and dApps on Atheios. If you want to check details such as RPCs for Atheios, check out our [chainlist page for Atheios](https://thirdweb.com/atheios).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Atheios using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Atheios as the network
...
### Initialize SDK On Atheios

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Atheios

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Atheios } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Atheios}>
      <YourApp />
    </ThirdwebProvider>
  );
};
