...
# Building contracts and apps on MXC Wannsee zkEVM Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MXC Wannsee zkEVM Testnet. By the end of the guide, you should be able to create smart contracts and dApps on MXC Wannsee zkEVM Testnet. If you want to check details such as RPCs for MXC Wannsee zkEVM Testnet, check out our [chainlist page for MXC Wannsee zkEVM Testnet](https://thirdweb.com/mxc-wannsee-zkevm-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MXC Wannsee zkEVM Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MXC Wannsee zkEVM Testnet as the network
...
### Initialize SDK On MXC Wannsee zkEVM Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MXC Wannsee zkEVM Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MxcWannseeZkevmTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MxcWannseeZkevmTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
