...
# Building contracts and apps on Six Protocol Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Six Protocol Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Six Protocol Testnet. If you want to check details such as RPCs for Six Protocol Testnet, check out our [chainlist page for Six Protocol Testnet](https://thirdweb.com/six-protocol-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Six Protocol Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Six Protocol Testnet as the network
...
### Initialize SDK On Six Protocol Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Six Protocol Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SixProtocolTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SixProtocolTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
