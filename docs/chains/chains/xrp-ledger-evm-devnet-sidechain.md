...
# Building contracts and apps on XRP Ledger EVM Devnet Sidechain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on XRP Ledger EVM Devnet Sidechain. By the end of the guide, you should be able to create smart contracts and dApps on XRP Ledger EVM Devnet Sidechain. If you want to check details such as RPCs for XRP Ledger EVM Devnet Sidechain, check out our [chainlist page for XRP Ledger EVM Devnet Sidechain](https://thirdweb.com/xrp-ledger-evm-devnet-sidechain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to XRP Ledger EVM Devnet Sidechain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select XRP Ledger EVM Devnet Sidechain as the network
...
### Initialize SDK On XRP Ledger EVM Devnet Sidechain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to XRP Ledger EVM Devnet Sidechain
