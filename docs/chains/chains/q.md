...
# Building contracts and apps on Q Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Q Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Q Mainnet. If you want to check details such as RPCs for Q Mainnet, check out our [chainlist page for Q Mainnet](https://thirdweb.com/q).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Q Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Q Mainnet as the network
...
### Initialize SDK On Q Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Q Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Q } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Q}>
      <YourApp />
    </ThirdwebProvider>
  );
};
