...
# Building contracts and apps on TTcoin Smart Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on TTcoin Smart Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on TTcoin Smart Chain Mainnet. If you want to check details such as RPCs for TTcoin Smart Chain Mainnet, check out our [chainlist page for TTcoin Smart Chain Mainnet](https://thirdweb.com/ttcoin-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to TTcoin Smart Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select TTcoin Smart Chain Mainnet as the network
...
### Initialize SDK On TTcoin Smart Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to TTcoin Smart Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TtcoinSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TtcoinSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
