...
# Building contracts and apps on Karura Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Karura Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Karura Network Testnet. If you want to check details such as RPCs for Karura Network Testnet, check out our [chainlist page for Karura Network Testnet](https://thirdweb.com/karura-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Karura Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Karura Network Testnet as the network
...
### Initialize SDK On Karura Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Karura Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { KaruraNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={KaruraNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
