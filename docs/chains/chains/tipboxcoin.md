...
# Building contracts and apps on Tipboxcoin Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Tipboxcoin Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Tipboxcoin Mainnet. If you want to check details such as RPCs for Tipboxcoin Mainnet, check out our [chainlist page for Tipboxcoin Mainnet](https://thirdweb.com/tipboxcoin).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Tipboxcoin Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Tipboxcoin Mainnet as the network
...
### Initialize SDK On Tipboxcoin Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Tipboxcoin Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Tipboxcoin } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Tipboxcoin}>
      <YourApp />
    </ThirdwebProvider>
  );
};
