...
5. After modifying your contract with your desired custom logic, you may deploy it to QuarkChain Devnet Shard 7 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select QuarkChain Devnet Shard 7 as the network
...
### Initialize SDK On QuarkChain Devnet Shard 7

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to QuarkChain Devnet Shard 7

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { QuarkchainDevnetShard7 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={QuarkchainDevnetShard7}>
      <YourApp />
    </ThirdwebProvider>
  );
};
