...
# Building contracts and apps on Dracones Financial Services

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Dracones Financial Services. By the end of the guide, you should be able to create smart contracts and dApps on Dracones Financial Services. If you want to check details such as RPCs for Dracones Financial Services, check out our [chainlist page for Dracones Financial Services](https://thirdweb.com/dracones-financial-services).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Dracones Financial Services using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Dracones Financial Services as the network
...
### Initialize SDK On Dracones Financial Services

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Dracones Financial Services

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DraconesFinancialServices } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DraconesFinancialServices}>
      <YourApp />
    </ThirdwebProvider>
  );
};
