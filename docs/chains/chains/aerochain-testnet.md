...
# Building contracts and apps on Aerochain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Aerochain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Aerochain Testnet. If you want to check details such as RPCs for Aerochain Testnet, check out our [chainlist page for Aerochain Testnet](https://thirdweb.com/aerochain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Aerochain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Aerochain Testnet as the network
...
### Initialize SDK On Aerochain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Aerochain Testnet
