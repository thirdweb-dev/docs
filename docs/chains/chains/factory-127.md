...
# Building contracts and apps on Factory 127 Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Factory 127 Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Factory 127 Mainnet. If you want to check details such as RPCs for Factory 127 Mainnet, check out our [chainlist page for Factory 127 Mainnet](https://thirdweb.com/factory-127).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Factory 127 Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Factory 127 Mainnet as the network
...
### Initialize SDK On Factory 127 Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Factory 127 Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Factory127 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Factory127}>
      <YourApp />
    </ThirdwebProvider>
  );
};
