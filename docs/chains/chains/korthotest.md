...
# Building contracts and apps on KorthoTest

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on KorthoTest. By the end of the guide, you should be able to create smart contracts and dApps on KorthoTest. If you want to check details such as RPCs for KorthoTest, check out our [chainlist page for KorthoTest](https://thirdweb.com/korthotest).
...
5. After modifying your contract with your desired custom logic, you may deploy it to KorthoTest using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select KorthoTest as the network
...
### Initialize SDK On KorthoTest

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to KorthoTest

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Korthotest } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Korthotest}>
      <YourApp />
    </ThirdwebProvider>
  );
};
