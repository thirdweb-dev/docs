...
# Building contracts and apps on Elysium Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Elysium Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Elysium Mainnet. If you want to check details such as RPCs for Elysium Mainnet, check out our [chainlist page for Elysium Mainnet](https://thirdweb.com/elysium).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Elysium Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Elysium Mainnet as the network
...
### Initialize SDK On Elysium Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Elysium Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Elysium } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Elysium}>
      <YourApp />
    </ThirdwebProvider>
  );
};
