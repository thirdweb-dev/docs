...
# Building contracts and apps on Kanazawa

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Kanazawa. By the end of the guide, you should be able to create smart contracts and dApps on Kanazawa. If you want to check details such as RPCs for Kanazawa, check out our [chainlist page for Kanazawa](https://thirdweb.com/kanazawa).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Kanazawa using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Kanazawa as the network
...
### Initialize SDK On Kanazawa

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Kanazawa
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Kanazawa}>
      <YourApp />
    </ThirdwebProvider>
  );
};
