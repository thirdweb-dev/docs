...
# Building contracts and apps on Acala Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Acala Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Acala Network Testnet. If you want to check details such as RPCs for Acala Network Testnet, check out our [chainlist page for Acala Network Testnet](https://thirdweb.com/acala-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Acala Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Acala Network Testnet as the network
...
### Initialize SDK On Acala Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Acala Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AcalaNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AcalaNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
