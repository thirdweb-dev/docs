...
# Building contracts and apps on Localhost

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Localhost. By the end of the guide, you should be able to create smart contracts and dApps on Localhost. If you want to check details such as RPCs for Localhost, check out our [chainlist page for Localhost](https://thirdweb.com/localhost).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Localhost using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Localhost as the network
...
### Initialize SDK On Localhost

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Localhost
