...
# Building contracts and apps on Teleport Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Teleport Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Teleport Testnet. If you want to check details such as RPCs for Teleport Testnet, check out our [chainlist page for Teleport Testnet](https://thirdweb.com/teleport-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Teleport Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Teleport Testnet as the network
...
### Initialize SDK On Teleport Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Teleport Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TeleportTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TeleportTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
