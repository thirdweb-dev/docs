...
# Building contracts and apps on BMC Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BMC Testnet. By the end of the guide, you should be able to create smart contracts and dApps on BMC Testnet. If you want to check details such as RPCs for BMC Testnet, check out our [chainlist page for BMC Testnet](https://thirdweb.com/bmc-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BMC Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BMC Testnet as the network
...
### Initialize SDK On BMC Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BMC Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BmcTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BmcTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
