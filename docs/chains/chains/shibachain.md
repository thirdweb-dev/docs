...
# Building contracts and apps on ShibaChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ShibaChain. By the end of the guide, you should be able to create smart contracts and dApps on ShibaChain. If you want to check details such as RPCs for ShibaChain, check out our [chainlist page for ShibaChain](https://thirdweb.com/shibachain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ShibaChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ShibaChain as the network
...
### Initialize SDK On ShibaChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ShibaChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Shibachain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Shibachain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
