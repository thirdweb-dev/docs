...
# Building contracts and apps on Base Goerli Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Base Goerli Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Base Goerli Testnet. If you want to check details such as RPCs for Base Goerli Testnet, check out our [chainlist page for Base Goerli Testnet](https://thirdweb.com/base-goerli).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Base Goerli Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Base Goerli Testnet as the network
...
### Initialize SDK On Base Goerli Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Base Goerli Testnet
