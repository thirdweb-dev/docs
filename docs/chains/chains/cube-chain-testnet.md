...
# Building contracts and apps on Cube Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Cube Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Cube Chain Testnet. If you want to check details such as RPCs for Cube Chain Testnet, check out our [chainlist page for Cube Chain Testnet](https://thirdweb.com/cube-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Cube Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Cube Chain Testnet as the network
...
### Initialize SDK On Cube Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Cube Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { CubeChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={CubeChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
