...
# Building contracts and apps on FNCY Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on FNCY Testnet. By the end of the guide, you should be able to create smart contracts and dApps on FNCY Testnet. If you want to check details such as RPCs for FNCY Testnet, check out our [chainlist page for FNCY Testnet](https://thirdweb.com/fncy-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to FNCY Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select FNCY Testnet as the network
...
### Initialize SDK On FNCY Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to FNCY Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FncyTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FncyTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
