...
# Building contracts and apps on IoTeX Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on IoTeX Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on IoTeX Network Testnet. If you want to check details such as RPCs for IoTeX Network Testnet, check out our [chainlist page for IoTeX Network Testnet](https://thirdweb.com/iotex-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to IoTeX Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select IoTeX Network Testnet as the network
...
### Initialize SDK On IoTeX Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to IoTeX Network Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={IotexNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
