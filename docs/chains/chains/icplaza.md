...
# Building contracts and apps on ICPlaza Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ICPlaza Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on ICPlaza Mainnet. If you want to check details such as RPCs for ICPlaza Mainnet, check out our [chainlist page for ICPlaza Mainnet](https://thirdweb.com/icplaza).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ICPlaza Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ICPlaza Mainnet as the network
...
### Initialize SDK On ICPlaza Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ICPlaza Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Icplaza } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Icplaza}>
      <YourApp />
    </ThirdwebProvider>
  );
};
