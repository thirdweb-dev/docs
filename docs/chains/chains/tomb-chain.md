...
# Building contracts and apps on Tomb Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Tomb Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Tomb Chain Mainnet. If you want to check details such as RPCs for Tomb Chain Mainnet, check out our [chainlist page for Tomb Chain Mainnet](https://thirdweb.com/tomb-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Tomb Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Tomb Chain Mainnet as the network
...
### Initialize SDK On Tomb Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Tomb Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { TombChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={TombChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
