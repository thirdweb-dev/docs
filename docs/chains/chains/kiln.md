...
# Building contracts and apps on Kiln

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Kiln. By the end of the guide, you should be able to create smart contracts and dApps on Kiln. If you want to check details such as RPCs for Kiln, check out our [chainlist page for Kiln](https://thirdweb.com/kiln).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Kiln using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Kiln

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Kiln

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Kiln } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Kiln}>
      <YourApp />
    </ThirdwebProvider>
  );
};
