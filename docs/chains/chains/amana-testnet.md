...
# Building contracts and apps on Amana Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Amana Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Amana Testnet. If you want to check details such as RPCs for Amana Testnet, check out our [chainlist page for Amana Testnet](https://thirdweb.com/amana-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Amana Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Amana Testnet as the network
...
### Initialize SDK On Amana Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Amana Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AmanaTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AmanaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
