...
# Building contracts and apps on Bitcichain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bitcichain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Bitcichain Mainnet. If you want to check details such as RPCs for Bitcichain Mainnet, check out our [chainlist page for Bitcichain Mainnet](https://thirdweb.com/bitcichain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bitcichain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bitcichain Mainnet as the network
...
### Initialize SDK On Bitcichain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bitcichain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bitcichain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bitcichain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
