...
# Building contracts and apps on ARZIO Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ARZIO Chain. By the end of the guide, you should be able to create smart contracts and dApps on ARZIO Chain. If you want to check details such as RPCs for ARZIO Chain, check out our [chainlist page for ARZIO Chain](https://thirdweb.com/arzio-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ARZIO Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ARZIO Chain as the network
...
### Initialize SDK On ARZIO Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ARZIO Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ArzioChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ArzioChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
