...
# Building contracts and apps on Gold Smart Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Gold Smart Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Gold Smart Chain Testnet. If you want to check details such as RPCs for Gold Smart Chain Testnet, check out our [chainlist page for Gold Smart Chain Testnet](https://thirdweb.com/gold-smart-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Gold Smart Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Gold Smart Chain Testnet as the network
...
### Initialize SDK On Gold Smart Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Gold Smart Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GoldSmartChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GoldSmartChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
