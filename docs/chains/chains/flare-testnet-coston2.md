...
# Building contracts and apps on Flare Testnet Coston2

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Flare Testnet Coston2. By the end of the guide, you should be able to create smart contracts and dApps on Flare Testnet Coston2. If you want to check details such as RPCs for Flare Testnet Coston2, check out our [chainlist page for Flare Testnet Coston2](https://thirdweb.com/flare-testnet-coston2).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Flare Testnet Coston2 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Flare Testnet Coston2 as the network
...
### Initialize SDK On Flare Testnet Coston2

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Flare Testnet Coston2

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FlareTestnetCoston2 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FlareTestnetCoston2}>
      <YourApp />
    </ThirdwebProvider>
  );
};
