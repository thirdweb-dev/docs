...
# Building contracts and apps on Kekchain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Kekchain. By the end of the guide, you should be able to create smart contracts and dApps on Kekchain. If you want to check details such as RPCs for Kekchain, check out our [chainlist page for Kekchain](https://thirdweb.com/kekchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Kekchain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Kekchain as the network
...
### Initialize SDK On Kekchain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Kekchain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Kekchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Kekchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
