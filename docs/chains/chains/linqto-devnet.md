...
# Building contracts and apps on Linqto Devnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Linqto Devnet. By the end of the guide, you should be able to create smart contracts and dApps on Linqto Devnet. If you want to check details such as RPCs for Linqto Devnet, check out our [chainlist page for Linqto Devnet](https://thirdweb.com/linqto-devnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Linqto Devnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Linqto Devnet as the network
...
### Initialize SDK On Linqto Devnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Linqto Devnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { LinqtoDevnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={LinqtoDevnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
