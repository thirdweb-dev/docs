...
# Building contracts and apps on BerylBit Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BerylBit Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on BerylBit Mainnet. If you want to check details such as RPCs for BerylBit Mainnet, check out our [chainlist page for BerylBit Mainnet](https://thirdweb.com/berylbit).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BerylBit Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BerylBit Mainnet as the network
...
### Initialize SDK On BerylBit Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BerylBit Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Berylbit } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Berylbit}>
      <YourApp />
    </ThirdwebProvider>
  );
};
