...
# Building contracts and apps on Vela1 Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Vela1 Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Vela1 Chain Mainnet. If you want to check details such as RPCs for Vela1 Chain Mainnet, check out our [chainlist page for Vela1 Chain Mainnet](https://thirdweb.com/vela1-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Vela1 Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Vela1 Chain Mainnet as the network
...
### Initialize SDK On Vela1 Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Vela1 Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Vela1Chain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Vela1Chain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
