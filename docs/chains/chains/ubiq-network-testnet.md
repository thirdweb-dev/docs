...
# Building contracts and apps on Ubiq Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ubiq Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Ubiq Network Testnet. If you want to check details such as RPCs for Ubiq Network Testnet, check out our [chainlist page for Ubiq Network Testnet](https://thirdweb.com/ubiq-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ubiq Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ubiq Network Testnet as the network
...
### Initialize SDK On Ubiq Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ubiq Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { UbiqNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={UbiqNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
