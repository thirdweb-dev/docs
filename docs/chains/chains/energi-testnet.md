...
# Building contracts and apps on Energi Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Energi Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Energi Testnet. If you want to check details such as RPCs for Energi Testnet, check out our [chainlist page for Energi Testnet](https://thirdweb.com/energi-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Energi Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Energi Testnet as the network
...
### Initialize SDK On Energi Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Energi Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EnergiTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EnergiTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
