...
# Building contracts and apps on KLYNTAR

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on KLYNTAR. By the end of the guide, you should be able to create smart contracts and dApps on KLYNTAR. If you want to check details such as RPCs for KLYNTAR, check out our [chainlist page for KLYNTAR](https://thirdweb.com/klyntar).
...
5. After modifying your contract with your desired custom logic, you may deploy it to KLYNTAR using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select KLYNTAR as the network
...
### Initialize SDK On KLYNTAR

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to KLYNTAR

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Klyntar } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Klyntar}>
      <YourApp />
    </ThirdwebProvider>
  );
};
