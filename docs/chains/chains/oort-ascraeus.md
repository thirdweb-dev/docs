...
# Building contracts and apps on Oort Ascraeus

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oort Ascraeus. By the end of the guide, you should be able to create smart contracts and dApps on Oort Ascraeus. If you want to check details such as RPCs for Oort Ascraeus, check out our [chainlist page for Oort Ascraeus](https://thirdweb.com/oort-ascraeus).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oort Ascraeus using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oort Ascraeus as the network
...
### Initialize SDK On Oort Ascraeus

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oort Ascraeus

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OortAscraeus } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OortAscraeus}>
      <YourApp />
    </ThirdwebProvider>
  );
};
