...
# Building contracts and apps on Graphlinq Blockchain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Graphlinq Blockchain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Graphlinq Blockchain Mainnet. If you want to check details such as RPCs for Graphlinq Blockchain Mainnet, check out our [chainlist page for Graphlinq Blockchain Mainnet](https://thirdweb.com/graphlinq-blockchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Graphlinq Blockchain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Graphlinq Blockchain Mainnet as the network
...
### Initialize SDK On Graphlinq Blockchain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Graphlinq Blockchain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GraphlinqBlockchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GraphlinqBlockchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
