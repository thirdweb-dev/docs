...
# Building contracts and apps on Social Smart Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Social Smart Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Social Smart Chain Mainnet. If you want to check details such as RPCs for Social Smart Chain Mainnet, check out our [chainlist page for Social Smart Chain Mainnet](https://thirdweb.com/social-smart-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Social Smart Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Social Smart Chain Mainnet as the network
...
### Initialize SDK On Social Smart Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Social Smart Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SocialSmartChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SocialSmartChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
