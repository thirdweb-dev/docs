...
# Building contracts and apps on ADIL Devnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ADIL Devnet. By the end of the guide, you should be able to create smart contracts and dApps on ADIL Devnet. If you want to check details such as RPCs for ADIL Devnet, check out our [chainlist page for ADIL Devnet](https://thirdweb.com/adil-devnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ADIL Devnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ADIL Devnet as the network
...
### Initialize SDK On ADIL Devnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ADIL Devnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AdilDevnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AdilDevnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
