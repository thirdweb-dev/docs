...
# Building contracts and apps on Garizon Stage0

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Garizon Stage0. By the end of the guide, you should be able to create smart contracts and dApps on Garizon Stage0. If you want to check details such as RPCs for Garizon Stage0, check out our [chainlist page for Garizon Stage0](https://thirdweb.com/garizon-stage0).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Garizon Stage0 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Garizon Stage0 as the network
...
### Initialize SDK On Garizon Stage0

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Garizon Stage0

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GarizonStage0 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GarizonStage0}>
      <YourApp />
    </ThirdwebProvider>
  );
};
