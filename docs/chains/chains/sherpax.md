...
# Building contracts and apps on Sherpax Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Sherpax Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Sherpax Mainnet. If you want to check details such as RPCs for Sherpax Mainnet, check out our [chainlist page for Sherpax Mainnet](https://thirdweb.com/sherpax).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Sherpax Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Sherpax Mainnet as the network
...
### Initialize SDK On Sherpax Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Sherpax Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Sherpax } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Sherpax}>
      <YourApp />
    </ThirdwebProvider>
  );
};
