...
# Building contracts and apps on Fusion Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Fusion Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Fusion Testnet. If you want to check details such as RPCs for Fusion Testnet, check out our [chainlist page for Fusion Testnet](https://thirdweb.com/fusion-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Fusion Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Fusion Testnet as the network
...
### Initialize SDK On Fusion Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Fusion Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FusionTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FusionTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
