...
# Building contracts and apps on Deamchain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Deamchain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Deamchain Testnet. If you want to check details such as RPCs for Deamchain Testnet, check out our [chainlist page for Deamchain Testnet](https://thirdweb.com/deamchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Deamchain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Deamchain Testnet as the network
...
### Initialize SDK On Deamchain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Deamchain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { DeamchainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={DeamchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
