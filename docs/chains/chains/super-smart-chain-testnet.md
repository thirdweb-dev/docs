...
# Building contracts and apps on Super Smart Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Super Smart Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Super Smart Chain Testnet. If you want to check details such as RPCs for Super Smart Chain Testnet, check out our [chainlist page for Super Smart Chain Testnet](https://thirdweb.com/super-smart-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Super Smart Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Super Smart Chain Testnet as the network
...
### Initialize SDK On Super Smart Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Super Smart Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SuperSmartChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SuperSmartChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
