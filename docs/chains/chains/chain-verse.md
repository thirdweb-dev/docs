...
# Building contracts and apps on Chain Verse Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Chain Verse Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Chain Verse Mainnet. If you want to check details such as RPCs for Chain Verse Mainnet, check out our [chainlist page for Chain Verse Mainnet](https://thirdweb.com/chain-verse).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Chain Verse Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Chain Verse Mainnet as the network
...
### Initialize SDK On Chain Verse Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Chain Verse Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ChainVerse } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ChainVerse}>
      <YourApp />
    </ThirdwebProvider>
  );
};
