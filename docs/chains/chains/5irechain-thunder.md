...
# Building contracts and apps on 5ireChain Thunder

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on 5ireChain Thunder. By the end of the guide, you should be able to create smart contracts and dApps on 5ireChain Thunder. If you want to check details such as RPCs for 5ireChain Thunder, check out our [chainlist page for 5ireChain Thunder](https://thirdweb.com/5irechain-thunder).
...
5. After modifying your contract with your desired custom logic, you may deploy it to 5ireChain Thunder using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select 5ireChain Thunder as the network
...
### Initialize SDK On 5ireChain Thunder

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to 5ireChain Thunder

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { _5irechainThunder } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={_5irechainThunder}>
      <YourApp />
    </ThirdwebProvider>
  );
};
