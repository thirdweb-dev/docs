...
# Building contracts and apps on DYNO Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on DYNO Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on DYNO Mainnet. If you want to check details such as RPCs for DYNO Mainnet, check out our [chainlist page for DYNO Mainnet](https://thirdweb.com/dyno).
...
5. After modifying your contract with your desired custom logic, you may deploy it to DYNO Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select DYNO Mainnet as the network
...
### Initialize SDK On DYNO Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to DYNO Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Dyno } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Dyno}>
      <YourApp />
    </ThirdwebProvider>
  );
};
