...
# Building contracts and apps on World Trade Technical Chain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on World Trade Technical Chain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on World Trade Technical Chain Mainnet. If you want to check details such as RPCs for World Trade Technical Chain Mainnet, check out our [chainlist page for World Trade Technical Chain Mainnet](https://thirdweb.com/world-trade-technical-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to World Trade Technical Chain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select World Trade Technical Chain Mainnet as the network
...
### Initialize SDK On World Trade Technical Chain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to World Trade Technical Chain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { WorldTradeTechnicalChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={WorldTradeTechnicalChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
