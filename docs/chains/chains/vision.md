...
# Building contracts and apps on Vision - Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Vision - Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Vision - Mainnet. If you want to check details such as RPCs for Vision - Mainnet, check out our [chainlist page for Vision - Mainnet](https://thirdweb.com/vision).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Vision - Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Vision - Mainnet as the network
...
### Initialize SDK On Vision - Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Vision - Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Vision } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Vision}>
      <YourApp />
    </ThirdwebProvider>
  );
};
