...
# Building contracts and apps on XDC Apothem Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on XDC Apothem Network. By the end of the guide, you should be able to create smart contracts and dApps on XDC Apothem Network. If you want to check details such as RPCs for XDC Apothem Network, check out our [chainlist page for XDC Apothem Network](https://thirdweb.com/xdc-apothem-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to XDC Apothem Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select XDC Apothem Network as the network
...
### Initialize SDK On XDC Apothem Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to XDC Apothem Network
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={XdcApothemNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
