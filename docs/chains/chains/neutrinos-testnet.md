...
# Building contracts and apps on Neutrinos TestNet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Neutrinos TestNet. By the end of the guide, you should be able to create smart contracts and dApps on Neutrinos TestNet. If you want to check details such as RPCs for Neutrinos TestNet, check out our [chainlist page for Neutrinos TestNet](https://thirdweb.com/neutrinos-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Neutrinos TestNet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Neutrinos TestNet as the network
...
### Initialize SDK On Neutrinos TestNet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Neutrinos TestNet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { NeutrinosTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={NeutrinosTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
