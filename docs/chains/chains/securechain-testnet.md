...
# Building contracts and apps on SecureChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SecureChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on SecureChain Testnet. If you want to check details such as RPCs for SecureChain Testnet, check out our [chainlist page for SecureChain Testnet](https://thirdweb.com/securechain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SecureChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SecureChain Testnet as the network
...
### Initialize SDK On SecureChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SecureChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SecurechainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SecurechainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
