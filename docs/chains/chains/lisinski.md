...
# Building contracts and apps on Lisinski

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Lisinski. By the end of the guide, you should be able to create smart contracts and dApps on Lisinski. If you want to check details such as RPCs for Lisinski, check out our [chainlist page for Lisinski](https://thirdweb.com/lisinski).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Lisinski using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Lisinski as the network
...
### Initialize SDK On Lisinski

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Lisinski

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Lisinski } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Lisinski}>
      <YourApp />
    </ThirdwebProvider>
  );
};
