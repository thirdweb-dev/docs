...
# Building contracts and apps on TomoChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on TomoChain. By the end of the guide, you should be able to create smart contracts and dApps on TomoChain. If you want to check details such as RPCs for TomoChain, check out our [chainlist page for TomoChain](https://thirdweb.com/tomochain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to TomoChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select TomoChain as the network
...
### Initialize SDK On TomoChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to TomoChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Tomochain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Tomochain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
