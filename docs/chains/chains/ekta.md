...
# Building contracts and apps on Ekta

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ekta. By the end of the guide, you should be able to create smart contracts and dApps on Ekta. If you want to check details such as RPCs for Ekta, check out our [chainlist page for Ekta](https://thirdweb.com/ekta).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ekta using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Ekta

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ekta

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ekta } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ekta}>
      <YourApp />
    </ThirdwebProvider>
  );
};
