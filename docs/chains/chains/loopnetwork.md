...
# Building contracts and apps on LoopNetwork Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on LoopNetwork Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on LoopNetwork Mainnet. If you want to check details such as RPCs for LoopNetwork Mainnet, check out our [chainlist page for LoopNetwork Mainnet](https://thirdweb.com/loopnetwork).
...
5. After modifying your contract with your desired custom logic, you may deploy it to LoopNetwork Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select LoopNetwork Mainnet as the network
...
### Initialize SDK On LoopNetwork Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to LoopNetwork Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Loopnetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Loopnetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
