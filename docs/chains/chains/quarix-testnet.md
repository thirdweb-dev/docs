...
# Building contracts and apps on Quarix Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Quarix Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Quarix Testnet. If you want to check details such as RPCs for Quarix Testnet, check out our [chainlist page for Quarix Testnet](https://thirdweb.com/quarix-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Quarix Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Quarix Testnet as the network
...
### Initialize SDK On Quarix Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Quarix Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { QuarixTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={QuarixTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
