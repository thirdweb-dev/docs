...
# Building contracts and apps on SanR Chain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SanR Chain. By the end of the guide, you should be able to create smart contracts and dApps on SanR Chain. If you want to check details such as RPCs for SanR Chain, check out our [chainlist page for SanR Chain](https://thirdweb.com/sanr-chain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SanR Chain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SanR Chain as the network
...
### Initialize SDK On SanR Chain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SanR Chain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { SanrChain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={SanrChain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
