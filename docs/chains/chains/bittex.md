...
# Building contracts and apps on Bittex Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bittex Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Bittex Mainnet. If you want to check details such as RPCs for Bittex Mainnet, check out our [chainlist page for Bittex Mainnet](https://thirdweb.com/bittex).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bittex Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bittex Mainnet as the network
...
### Initialize SDK On Bittex Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bittex Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bittex } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bittex}>
      <YourApp />
    </ThirdwebProvider>
  );
};
