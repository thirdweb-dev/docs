...
# Building contracts and apps on Oort Huygens

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Oort Huygens. By the end of the guide, you should be able to create smart contracts and dApps on Oort Huygens. If you want to check details such as RPCs for Oort Huygens, check out our [chainlist page for Oort Huygens](https://thirdweb.com/oort-huygens).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Oort Huygens using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Oort Huygens as the network
...
### Initialize SDK On Oort Huygens

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Oort Huygens

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OortHuygens } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OortHuygens}>
      <YourApp />
    </ThirdwebProvider>
  );
};
