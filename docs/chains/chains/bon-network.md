...
# Building contracts and apps on BON Network

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on BON Network. By the end of the guide, you should be able to create smart contracts and dApps on BON Network. If you want to check details such as RPCs for BON Network, check out our [chainlist page for BON Network](https://thirdweb.com/bon-network).
...
5. After modifying your contract with your desired custom logic, you may deploy it to BON Network using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select BON Network as the network
...
### Initialize SDK On BON Network

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to BON Network

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { BonNetwork } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={BonNetwork}>
      <YourApp />
    </ThirdwebProvider>
  );
};
