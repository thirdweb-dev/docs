...
# Building contracts and apps on Celo Alfajores Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Celo Alfajores Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Celo Alfajores Testnet. If you want to check details such as RPCs for Celo Alfajores Testnet, check out our [chainlist page for Celo Alfajores Testnet](https://thirdweb.com/celo-alfajores-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Celo Alfajores Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Celo Alfajores Testnet as the network
...
### Initialize SDK On Celo Alfajores Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Celo Alfajores Testnet
