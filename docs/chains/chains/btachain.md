...
# Building contracts and apps on Btachain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Btachain. By the end of the guide, you should be able to create smart contracts and dApps on Btachain. If you want to check details such as RPCs for Btachain, check out our [chainlist page for Btachain](https://thirdweb.com/btachain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Btachain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Btachain as the network
...
### Initialize SDK On Btachain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Btachain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Btachain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Btachain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
