---
title: Garizon Testnet Stage3
slug: /garizon-testnet-stage3
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Garizon Testnet Stage3

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Garizon Testnet Stage3. By the end of the guide, you should be able to create smart contracts and dApps on Garizon Testnet Stage3. If you want to check details such as RPCs for Garizon Testnet Stage3, check out our [chainlist page for Garizon Testnet Stage3](https://thirdweb.com/garizon-testnet-stage3).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Garizon Testnet Stage3 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Garizon Testnet Stage3 as the network
...
### Initialize SDK On Garizon Testnet Stage3

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Garizon Testnet Stage3

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GarizonTestnetStage3 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GarizonTestnetStage3}>
      <YourApp />
    </ThirdwebProvider>
  );
};
