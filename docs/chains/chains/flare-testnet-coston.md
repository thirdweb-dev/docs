---
title: Flare Testnet Coston
slug: /flare-testnet-coston
hide_title: true
displayed_sidebar: chains
---

# Building contracts and apps on Flare Testnet Coston

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Flare Testnet Coston. By the end of the guide, you should be able to create smart contracts and dApps on Flare Testnet Coston. If you want to check details such as RPCs for Flare Testnet Coston, check out our [chainlist page for Flare Testnet Coston](https://thirdweb.com/flare-testnet-coston).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Flare Testnet Coston using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Flare Testnet Coston as the network
...
### Initialize SDK On Flare Testnet Coston

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Flare Testnet Coston

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { FlareTestnetCoston } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={FlareTestnetCoston}>
      <YourApp />
    </ThirdwebProvider>
  );
};
