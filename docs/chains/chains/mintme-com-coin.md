...
# Building contracts and apps on MintMe.com Coin

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MintMe.com Coin. By the end of the guide, you should be able to create smart contracts and dApps on MintMe.com Coin. If you want to check details such as RPCs for MintMe.com Coin, check out our [chainlist page for MintMe.com Coin](https://thirdweb.com/mintme-com-coin).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MintMe.com Coin using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MintMe.com Coin as the network
...
### Initialize SDK On MintMe.com Coin

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MintMe.com Coin

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MintmeComCoin } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MintmeComCoin}>
      <YourApp />
    </ThirdwebProvider>
  );
};
