...
# Building contracts and apps on Kintsugi

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Kintsugi. By the end of the guide, you should be able to create smart contracts and dApps on Kintsugi. If you want to check details such as RPCs for Kintsugi, check out our [chainlist page for Kintsugi](https://thirdweb.com/kintsugi).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Kintsugi using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Kintsugi as the network
...
### Initialize SDK On Kintsugi

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Kintsugi

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Kintsugi } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Kintsugi}>
      <YourApp />
    </ThirdwebProvider>
  );
};
