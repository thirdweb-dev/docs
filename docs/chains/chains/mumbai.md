...
# Building contracts and apps on Mumbai

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Mumbai. By the end of the guide, you should be able to create smart contracts and dApps on Mumbai. If you want to check details such as RPCs for Mumbai, check out our [chainlist page for Mumbai](https://thirdweb.com/mumbai).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Mumbai using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Mumbai as the network
...
### Initialize SDK On Mumbai

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Mumbai
