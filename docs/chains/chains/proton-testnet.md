...
# Building contracts and apps on Proton Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Proton Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Proton Testnet. If you want to check details such as RPCs for Proton Testnet, check out our [chainlist page for Proton Testnet](https://thirdweb.com/proton-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Proton Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Proton Testnet as the network
...
### Initialize SDK On Proton Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Proton Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ProtonTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ProtonTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
