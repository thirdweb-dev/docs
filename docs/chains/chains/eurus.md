...
# Building contracts and apps on Eurus Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Eurus Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Eurus Mainnet. If you want to check details such as RPCs for Eurus Mainnet, check out our [chainlist page for Eurus Mainnet](https://thirdweb.com/eurus).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Eurus Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Eurus Mainnet as the network
...
### Initialize SDK On Eurus Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Eurus Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Eurus } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Eurus}>
      <YourApp />
    </ThirdwebProvider>
  );
};
