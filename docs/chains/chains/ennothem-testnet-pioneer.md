...
# Building contracts and apps on Ennothem Testnet Pioneer

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ennothem Testnet Pioneer. By the end of the guide, you should be able to create smart contracts and dApps on Ennothem Testnet Pioneer. If you want to check details such as RPCs for Ennothem Testnet Pioneer, check out our [chainlist page for Ennothem Testnet Pioneer](https://thirdweb.com/ennothem-testnet-pioneer).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ennothem Testnet Pioneer using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ennothem Testnet Pioneer as the network
...
### Initialize SDK On Ennothem Testnet Pioneer

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ennothem Testnet Pioneer

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { EnnothemTestnetPioneer } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={EnnothemTestnetPioneer}>
      <YourApp />
    </ThirdwebProvider>
  );
};
