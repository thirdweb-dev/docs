...
# Building contracts and apps on Teleport

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Teleport. By the end of the guide, you should be able to create smart contracts and dApps on Teleport. If you want to check details such as RPCs for Teleport, check out our [chainlist page for Teleport](https://thirdweb.com/teleport).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Teleport using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Teleport as the network
...
### Initialize SDK On Teleport

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Teleport

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Teleport } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Teleport}>
      <YourApp />
    </ThirdwebProvider>
  );
};
