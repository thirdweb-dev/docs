...
# Building contracts and apps on Wireshape Floripa Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Wireshape Floripa Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Wireshape Floripa Testnet. If you want to check details such as RPCs for Wireshape Floripa Testnet, check out our [chainlist page for Wireshape Floripa Testnet](https://thirdweb.com/wireshape-floripa-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Wireshape Floripa Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Wireshape Floripa Testnet as the network
...
### Initialize SDK On Wireshape Floripa Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Wireshape Floripa Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={WireshapeFloripaTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
