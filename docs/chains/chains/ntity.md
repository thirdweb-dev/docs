...
# Building contracts and apps on Ntity Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ntity Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Ntity Mainnet. If you want to check details such as RPCs for Ntity Mainnet, check out our [chainlist page for Ntity Mainnet](https://thirdweb.com/ntity).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ntity Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ntity Mainnet as the network
...
### Initialize SDK On Ntity Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ntity Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ntity } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ntity}>
      <YourApp />
    </ThirdwebProvider>
  );
};
