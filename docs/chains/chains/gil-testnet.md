...
# Building contracts and apps on GIL Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on GIL Testnet. By the end of the guide, you should be able to create smart contracts and dApps on GIL Testnet. If you want to check details such as RPCs for GIL Testnet, check out our [chainlist page for GIL Testnet](https://thirdweb.com/gil-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to GIL Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select GIL Testnet as the network
...
### Initialize SDK On GIL Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to GIL Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GilTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GilTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
