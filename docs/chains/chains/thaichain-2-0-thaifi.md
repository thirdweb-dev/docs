...
# Building contracts and apps on ThaiChain 2.0 ThaiFi

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on ThaiChain 2.0 ThaiFi. By the end of the guide, you should be able to create smart contracts and dApps on ThaiChain 2.0 ThaiFi. If you want to check details such as RPCs for ThaiChain 2.0 ThaiFi, check out our [chainlist page for ThaiChain 2.0 ThaiFi](https://thirdweb.com/thaichain-2-0-thaifi).
...
5. After modifying your contract with your desired custom logic, you may deploy it to ThaiChain 2.0 ThaiFi using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select ThaiChain 2.0 ThaiFi as the network
...
### Initialize SDK On ThaiChain 2.0 ThaiFi

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to ThaiChain 2.0 ThaiFi

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Thaichain20Thaifi } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Thaichain20Thaifi}>
      <YourApp />
    </ThirdwebProvider>
  );
};
