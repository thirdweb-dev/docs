...
# Building contracts and apps on REI Chain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on REI Chain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on REI Chain Testnet. If you want to check details such as RPCs for REI Chain Testnet, check out our [chainlist page for REI Chain Testnet](https://thirdweb.com/rei-chain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to REI Chain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select REI Chain Testnet as the network
...
### Initialize SDK On REI Chain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to REI Chain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ReiChainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ReiChainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
