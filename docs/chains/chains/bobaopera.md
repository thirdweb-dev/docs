...
# Building contracts and apps on Bobaopera

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Bobaopera. By the end of the guide, you should be able to create smart contracts and dApps on Bobaopera. If you want to check details such as RPCs for Bobaopera, check out our [chainlist page for Bobaopera](https://thirdweb.com/bobaopera).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Bobaopera using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Bobaopera as the network
...
### Initialize SDK On Bobaopera

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Bobaopera

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Bobaopera } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Bobaopera}>
      <YourApp />
    </ThirdwebProvider>
  );
};
