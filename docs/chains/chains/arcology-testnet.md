...
# Building contracts and apps on Arcology Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Arcology Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Arcology Testnet. If you want to check details such as RPCs for Arcology Testnet, check out our [chainlist page for Arcology Testnet](https://thirdweb.com/arcology-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Arcology Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Arcology Testnet as the network
...
### Initialize SDK On Arcology Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Arcology Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { ArcologyTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={ArcologyTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
