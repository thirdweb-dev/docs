...
# Building contracts and apps on MAP Makalu

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on MAP Makalu. By the end of the guide, you should be able to create smart contracts and dApps on MAP Makalu. If you want to check details such as RPCs for MAP Makalu, check out our [chainlist page for MAP Makalu](https://thirdweb.com/map-makalu).
...
5. After modifying your contract with your desired custom logic, you may deploy it to MAP Makalu using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select MAP Makalu as the network
...
### Initialize SDK On MAP Makalu

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to MAP Makalu

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { MapMakalu } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={MapMakalu}>
      <YourApp />
    </ThirdwebProvider>
  );
};
