...
# Building contracts and apps on Shiden

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Shiden. By the end of the guide, you should be able to create smart contracts and dApps on Shiden. If you want to check details such as RPCs for Shiden, check out our [chainlist page for Shiden](https://thirdweb.com/shiden).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Shiden using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Shiden as the network
...
### Initialize SDK On Shiden

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Shiden

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Shiden } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Shiden}>
      <YourApp />
    </ThirdwebProvider>
  );
};
