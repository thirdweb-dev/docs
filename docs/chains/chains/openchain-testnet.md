...
# Building contracts and apps on OpenChain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on OpenChain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on OpenChain Testnet. If you want to check details such as RPCs for OpenChain Testnet, check out our [chainlist page for OpenChain Testnet](https://thirdweb.com/openchain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to OpenChain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select OpenChain Testnet as the network
...
### Initialize SDK On OpenChain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to OpenChain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { OpenchainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={OpenchainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
