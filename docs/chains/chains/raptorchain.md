...
# Building contracts and apps on RaptorChain

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on RaptorChain. By the end of the guide, you should be able to create smart contracts and dApps on RaptorChain. If you want to check details such as RPCs for RaptorChain, check out our [chainlist page for RaptorChain](https://thirdweb.com/raptorchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to RaptorChain using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select RaptorChain as the network
...
### Initialize SDK On RaptorChain

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to RaptorChain

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Raptorchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Raptorchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
