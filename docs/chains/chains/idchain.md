...
# Building contracts and apps on IDChain Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on IDChain Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on IDChain Mainnet. If you want to check details such as RPCs for IDChain Mainnet, check out our [chainlist page for IDChain Mainnet](https://thirdweb.com/idchain).
...
5. After modifying your contract with your desired custom logic, you may deploy it to IDChain Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select IDChain Mainnet as the network
...
### Initialize SDK On IDChain Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to IDChain Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Idchain } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Idchain}>
      <YourApp />
    </ThirdwebProvider>
  );
};
