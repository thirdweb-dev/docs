...
# Building contracts and apps on Canto Tesnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Canto Tesnet. By the end of the guide, you should be able to create smart contracts and dApps on Canto Tesnet. If you want to check details such as RPCs for Canto Tesnet, check out our [chainlist page for Canto Tesnet](https://thirdweb.com/canto-tesnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Canto Tesnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Canto Tesnet as the network
...
### Initialize SDK On Canto Tesnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Canto Tesnet
