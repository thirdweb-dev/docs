...
# Building contracts and apps on Neurochain Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Neurochain Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Neurochain Testnet. If you want to check details such as RPCs for Neurochain Testnet, check out our [chainlist page for Neurochain Testnet](https://thirdweb.com/neurochain-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Neurochain Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Neurochain Testnet as the network
...
### Initialize SDK On Neurochain Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Neurochain Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { NeurochainTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={NeurochainTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
