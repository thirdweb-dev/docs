...
# Building contracts and apps on Q Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Q Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Q Testnet. If you want to check details such as RPCs for Q Testnet, check out our [chainlist page for Q Testnet](https://thirdweb.com/q-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Q Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Q Testnet as the network
...
### Initialize SDK On Q Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Q Testnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={QTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
