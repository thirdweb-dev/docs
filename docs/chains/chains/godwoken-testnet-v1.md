...
# Building contracts and apps on Godwoken Testnet v1

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Godwoken Testnet v1. By the end of the guide, you should be able to create smart contracts and dApps on Godwoken Testnet v1. If you want to check details such as RPCs for Godwoken Testnet v1, check out our [chainlist page for Godwoken Testnet v1](https://thirdweb.com/godwoken-testnet-v1).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Godwoken Testnet v1 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Godwoken Testnet v1 as the network
...
### Initialize SDK On Godwoken Testnet v1

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Godwoken Testnet v1
