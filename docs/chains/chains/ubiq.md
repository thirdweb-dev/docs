...
# Building contracts and apps on Ubiq

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ubiq. By the end of the guide, you should be able to create smart contracts and dApps on Ubiq. If you want to check details such as RPCs for Ubiq, check out our [chainlist page for Ubiq](https://thirdweb.com/ubiq).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ubiq using [Deploy](https://portal.thirdweb.com/deploy).
...
### Initialize SDK On Ubiq

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ubiq

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ubiq } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ubiq}>
      <YourApp />
    </ThirdwebProvider>
  );
};
