...
# Building contracts and apps on SwapDEX

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on SwapDEX. By the end of the guide, you should be able to create smart contracts and dApps on SwapDEX. If you want to check details such as RPCs for SwapDEX, check out our [chainlist page for SwapDEX](https://thirdweb.com/swapdex).
...
5. After modifying your contract with your desired custom logic, you may deploy it to SwapDEX using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select SwapDEX as the network
...
### Initialize SDK On SwapDEX

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to SwapDEX

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Swapdex } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Swapdex}>
      <YourApp />
    </ThirdwebProvider>
  );
};
