...
# Building contracts and apps on Sardis Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Sardis Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Sardis Mainnet. If you want to check details such as RPCs for Sardis Mainnet, check out our [chainlist page for Sardis Mainnet](https://thirdweb.com/sardis).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Sardis Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Sardis Mainnet as the network
...
### Initialize SDK On Sardis Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Sardis Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Sardis } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Sardis}>
      <YourApp />
    </ThirdwebProvider>
  );
};
