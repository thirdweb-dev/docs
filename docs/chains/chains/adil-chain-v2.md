...
# Building contracts and apps on Adil Chain V2 Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Adil Chain V2 Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Adil Chain V2 Mainnet. If you want to check details such as RPCs for Adil Chain V2 Mainnet, check out our [chainlist page for Adil Chain V2 Mainnet](https://thirdweb.com/adil-chain-v2).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Adil Chain V2 Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Adil Chain V2 Mainnet as the network
...
### Initialize SDK On Adil Chain V2 Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Adil Chain V2 Mainnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { AdilChainV2 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={AdilChainV2}>
      <YourApp />
    </ThirdwebProvider>
  );
};
