...
# Building contracts and apps on PoCRNet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on PoCRNet. By the end of the guide, you should be able to create smart contracts and dApps on PoCRNet. If you want to check details such as RPCs for PoCRNet, check out our [chainlist page for PoCRNet](https://thirdweb.com/pocrnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to PoCRNet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select PoCRNet as the network
...
### Initialize SDK On PoCRNet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to PoCRNet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Pocrnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Pocrnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
