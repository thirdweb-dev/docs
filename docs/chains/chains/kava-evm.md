...
# Building contracts and apps on Kava EVM

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Kava EVM. By the end of the guide, you should be able to create smart contracts and dApps on Kava EVM. If you want to check details such as RPCs for Kava EVM, check out our [chainlist page for Kava EVM](https://thirdweb.com/kava-evm).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Kava EVM using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Kava EVM as the network
...
### Initialize SDK On Kava EVM

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Kava EVM

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { KavaEvm } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={KavaEvm}>
      <YourApp />
    </ThirdwebProvider>
  );
};
