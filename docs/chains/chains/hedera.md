...
# Building contracts and apps on Hedera Mainnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Hedera Mainnet. By the end of the guide, you should be able to create smart contracts and dApps on Hedera Mainnet. If you want to check details such as RPCs for Hedera Mainnet, check out our [chainlist page for Hedera Mainnet](https://thirdweb.com/hedera).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Hedera Mainnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Hedera Mainnet as the network
...
### Initialize SDK On Hedera Mainnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Hedera Mainnet
...
const App = () => {
  return (
    <ThirdwebProvider activeChain={Hedera}>
      <YourApp />
    </ThirdwebProvider>
  );
};
