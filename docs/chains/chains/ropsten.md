...
# Building contracts and apps on Ropsten

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Ropsten. By the end of the guide, you should be able to create smart contracts and dApps on Ropsten. If you want to check details such as RPCs for Ropsten, check out our [chainlist page for Ropsten](https://thirdweb.com/ropsten).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Ropsten using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Ropsten as the network
...
### Initialize SDK On Ropsten

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Ropsten

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Ropsten } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Ropsten}>
      <YourApp />
    </ThirdwebProvider>
  );
};
