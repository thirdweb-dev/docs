...
# Building contracts and apps on pegglecoin

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on pegglecoin. By the end of the guide, you should be able to create smart contracts and dApps on pegglecoin. If you want to check details such as RPCs for pegglecoin, check out our [chainlist page for pegglecoin](https://thirdweb.com/pegglecoin).
...
5. After modifying your contract with your desired custom logic, you may deploy it to pegglecoin using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select pegglecoin as the network
...
### Initialize SDK On pegglecoin

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to pegglecoin

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { Pegglecoin } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={Pegglecoin}>
      <YourApp />
    </ThirdwebProvider>
  );
};
