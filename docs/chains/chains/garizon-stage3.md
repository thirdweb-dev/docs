...
# Building contracts and apps on Garizon Stage3

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Garizon Stage3. By the end of the guide, you should be able to create smart contracts and dApps on Garizon Stage3. If you want to check details such as RPCs for Garizon Stage3, check out our [chainlist page for Garizon Stage3](https://thirdweb.com/garizon-stage3).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Garizon Stage3 using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Garizon Stage3 as the network
...
### Initialize SDK On Garizon Stage3

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Garizon Stage3

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { GarizonStage3 } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={GarizonStage3}>
      <YourApp />
    </ThirdwebProvider>
  );
};
