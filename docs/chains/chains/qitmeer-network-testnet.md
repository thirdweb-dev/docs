...
# Building contracts and apps on Qitmeer Network Testnet

This guide will look at how you can create and deploy smart contracts and create apps to interact with these contracts deployed on Qitmeer Network Testnet. By the end of the guide, you should be able to create smart contracts and dApps on Qitmeer Network Testnet. If you want to check details such as RPCs for Qitmeer Network Testnet, check out our [chainlist page for Qitmeer Network Testnet](https://thirdweb.com/qitmeer-network-testnet).
...
5. After modifying your contract with your desired custom logic, you may deploy it to Qitmeer Network Testnet using [Deploy](https://portal.thirdweb.com/deploy).
...
3. Select Qitmeer Network Testnet as the network
...
### Initialize SDK On Qitmeer Network Testnet

Wrap your application in the `ThirdwebProvider` component and change the `activeChain` to Qitmeer Network Testnet

```jsx
import { ThirdwebProvider } from "@thirdweb-dev/react";
import { QitmeerNetworkTestnet } from "@thirdweb-dev/chains";

const App = () => {
  return (
    <ThirdwebProvider activeChain={QitmeerNetworkTestnet}>
      <YourApp />
    </ThirdwebProvider>
  );
};
