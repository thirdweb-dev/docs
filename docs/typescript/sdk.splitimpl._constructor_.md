---
slug: /sdk.splitimpl._constructor_
title: SplitImpl.(constructor)
hide_title: true
...
## SplitImpl.(constructor)

Constructs a new instance of the `SplitImpl` class
...
constructor(network: NetworkOrSignerOrProvider, address: string, storage: ThirdwebStorage, options: {
    ...
    } | undefined, abi: typeof ABI, contractWrapper?: ContractWrapper<SplitContract>);
```
