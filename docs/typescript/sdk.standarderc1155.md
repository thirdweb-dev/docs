...
| ----------------------------------------------------------- | ---------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | --------------------- |
| [airdrop](./sdk.standarderc1155.airdrop.md)                 |                        | { (tokenId: BigNumberish, addresses: string\[\] &#124; { quantity?: string &#124; number &#124; undefined; address: string; }\[\], data?: BytesLike &#124; undefined): Promise&lt;Omit&lt;{ receipt: import("@ethersproject/abstract-provider").TransactionReceipt; data: () =&gt; Promise&lt;unknown&gt;; }, "data"&gt;&gt;; prepare: (tokenId: BigNumberish, addresses: string\[\] &#124; { quantity?: string &#124; number &#124; undefined; address: string; }\[\], data?: BytesLike &#124; undefined) =&gt; Promise&lt;import("./transactions").[Transaction](./sdk.transaction.md)&lt;Omit&lt;{ receipt: import("@ethersproject/abstract-provider").TransactionReceipt; data: () =&gt; Promise&lt;unknown&gt;; }, "data"&gt;&gt;&gt;; } | Airdrop multiple NFTs |
