...
For interacting with non-standard smart contracts, the [`call`](/typescript/sdk.smartcontract.call) function can be used to call any function on the contract.
