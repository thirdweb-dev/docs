---
slug: /sdk.editiondropimpl._constructor_
title: EditionDropImpl.(constructor)
hide_title: true
...
## EditionDropImpl.(constructor)

Constructs a new instance of the `EditionDropImpl` class
...
constructor(network: NetworkOrSignerOrProvider, address: string, storage: IStorage, options: {
    ...
    } | undefined, abi: typeof ABI, contractWrapper?: ContractWrapper<DropERC1155>);
```
