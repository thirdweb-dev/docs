---
slug: /sdk.nftcollectionimpl._constructor_
title: NFTCollectionImpl.(constructor)
hide_title: true
...
## NFTCollectionImpl.(constructor)

Constructs a new instance of the `NFTCollectionImpl` class
...
constructor(network: NetworkOrSignerOrProvider, address: string, storage: ThirdwebStorage, options: {
    ...
    } | undefined, abi: typeof ABI, contractWrapper?: ContractWrapper<TokenERC721>);
```
