...
| ------------------------------------------------- | --------- | ----------------------------------- | ----------------------------------- |
| [batch](./sdk.erc20mintable.batch.md)             |           | Erc20BatchMintable &#124; undefined | Batch mint Tokens to many addresses |
...
```typescript
declare class Erc20Mintable implements DetectableFeature
```
