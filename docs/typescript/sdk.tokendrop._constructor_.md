...
constructor(network: NetworkOrSignerOrProvider, address: string, storage: ThirdwebStorage, options: {
    ...
    } | undefined, abi: typeof ABI, chainId: number, contractWrapper?: ContractWrapper<PrebuiltTokenDrop>);
```
...
| abi             | typeof ABI                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |                   |
| chainId         | number                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |                   |
| contractWrapper | ContractWrapper&lt;PrebuiltTokenDrop&gt;                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | <i>(Optional)</i> |
