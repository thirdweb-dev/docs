---
slug: /sdk.editionimpl._constructor_
title: EditionImpl.(constructor)
hide_title: true
...
## EditionImpl.(constructor)

Constructs a new instance of the `EditionImpl` class
...
constructor(network: NetworkOrSignerOrProvider, address: string, storage: ThirdwebStorage, options: {
    ...
    } | undefined, abi: typeof ABI, contractWrapper?: ContractWrapper<TokenERC1155>);
```
