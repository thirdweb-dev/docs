---
slug: /reference/sdk.erc1155signaturemintable.mintbatch
title: Erc1155SignatureMintable.mintBatch property
hide_title: true
...
# Erc1155SignatureMintable.mintBatch property
...
```typescript
mintBatch: {
        (signedPayloads: SignedPayload1155[]): Promise<TransactionResultWithId<never>[]>;
        prepare: (signedPayloads: SignedPayload1155[]) => Promise<Transaction<TransactionResultWithId<never>[]>>;
    };
```
