---
slug: /reference/sdk.marketplacecontractdeploymetadata
...
| -------------------------------------------------------------------------------------------------- | --------- | ----------------------------------------- | -------------------------------------------------------------------------- |
| [app_uri?](./sdk.marketplacecontractdeploymetadata.app_uri.md)                                     |           | string                                    | _(Optional)_ The default app for this contract                             |
...
| [platform_fee_recipient?](./sdk.marketplacecontractdeploymetadata.platform_fee_recipient.md)       |           | [AddressOrEns](./sdk.addressorens.md)     | _(Optional)_ The address that will receive the proceeds from platform fees |
| [trusted_forwarders?](./sdk.marketplacecontractdeploymetadata.trusted_forwarders.md)               |           | [AddressOrEns](./sdk.addressorens.md)\[\] | _(Optional)_ Custom gasless trusted forwarder addresses                    |
