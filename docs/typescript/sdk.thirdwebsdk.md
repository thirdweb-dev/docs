...
|  [getCustomContract(address)](./sdk.thirdwebsdk.getcustomcontract.md) |  | **<i>(BETA)</i>** Get an instance of a Custom ThirdwebContract |
|  [getCustomContractFromAbi(address, abi)](./sdk.thirdwebsdk.getcustomcontractfromabi.md) |  | **<i>(BETA)</i>** Get an instance of a Custom contract from a json ABI |
