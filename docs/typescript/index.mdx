...
Create an instance of the [`ThirdwebSDK`](/typescript/sdk.thirdwebsdk) class to connect to your smart contract and start
interacting with it&rsquo;s extensions!

## Full Reference

<a href="/reference/sdk/index.html" target="_blank">
  TypeScript SDK
</a>
