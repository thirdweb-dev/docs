...
Promise&lt;{ address: string; contractType: "custom" \| "token" \| "edition" \| "split" \| "edition-drop" \| "token-drop" \| "vote" \| "marketplace" \| "pack" \| "nft-drop" \| "signature-drop" \| "multiwrap" \| "nft-collection"; metadata: () =&gt; Promise&lt;any&gt;; }\[\]&gt;
