---
slug: /sdk.tokendropimpl._constructor_
title: TokenDropImpl.(constructor)
hide_title: true
...
## TokenDropImpl.(constructor)

Constructs a new instance of the `TokenDropImpl` class
...
constructor(network: NetworkOrSignerOrProvider, address: string, storage: ThirdwebStorage, options: {
    ...
    } | undefined, abi: typeof ABI, contractWrapper?: ContractWrapper<DropERC20>);
```
