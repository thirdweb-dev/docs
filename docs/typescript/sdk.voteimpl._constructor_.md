---
slug: /sdk.voteimpl._constructor_
title: VoteImpl.(constructor)
hide_title: true
...
Constructs a new instance of the `VoteImpl` class
...
constructor(network: NetworkOrSignerOrProvider, address: string, storage: ThirdwebStorage, options: {
    ...
    } | undefined, abi: typeof ABI, contractWrapper?: ContractWrapper<VoteERC20>);
```
