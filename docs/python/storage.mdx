...
contract_address = "0x..."
signer_address = "0x..."
sdk.storage.upload(data, contract_address, signer_address)
```
...
#### signer_address (optional)

The address of the signer to get the token for. Must be of type `str`.
...
The address of the contract to get the tokens for. Must be of type `str`.
