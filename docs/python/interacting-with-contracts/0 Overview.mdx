...
1. Generic reading data _from_ and writing transactions _to_ smart contracts using the [`call`](/python/python.smartcontract.call) method.
...
| Name            | Description                                                                            | Documentation                                      |
| --------------- | -------------------------------------------------------------------------------------- | -------------------------------------------------- |
| DirectListings  | List NFTs for sale, allowing other users to make offers or buy them outright           | [DirectListings](/python/python.directlistings)   |
| EnglishAuctions | List NFTs for auction, allowing users to bid on them                                   | [EnglishAuctions](/python/python.englishauctions) |
| Offers          | Allow users to make offers on any NFT on a smart contract, even if not listed for sale | [Offers](/python/python.offers)                   |
...
| PackVRF          | Special functionality for using the [PackVRF contract](https://thirdweb.com/thirdweb.eth/PackVRFDirect) | [PackVRF](/python/python.packvrf)                   |
