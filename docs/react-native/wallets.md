...
**NOTE**: We are going to deprecate `magicWallet` starting in version `@thirdweb-dev/react-native@0.2.49` in favor of `magicLink` for consistency with our React SDK.
