...
<Tabs>
  ...
  <TabItem value="thirdweb-cli-expo" label="thirdweb CLI Expo">
  ...
  <TabItem value="react-native-expo" label="Expo CLI">
    ...
    <CodeBlock
      language={"bash"}
    >{`npx create-expo-app AwesomeProject`}</CodeBlock>
  </TabItem>
</Tabs>
...
<a href="/reference/react-native/index.html" target="_blank">
  React Native SDK
</a>
