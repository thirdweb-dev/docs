...
2. Writing your own smart contract with the help of our [contract extensions](/thirdweb-deploy/contract-extensions) and deploying it with [thirdweb deploy](/thirdweb-cli).
...
of your smart contract before you deploy it.
