...
<div className="col col--6" style={{ marginTop: 8 }}>
  <QuickstartCard
    name="What Are Test Networks?"
    link="/guides/which-network-should-you-use"
    image="/assets/icons/education.png"
  />
</div>
</div>
...
You can check it out on [Etherscan](https://goerli.etherscan.io/)
by entering your contract address _(found underneath your contract name)_.
