...
Now our contract is built, let's use the [CLI](/thirdweb-cli) to release it, by running the following command:
...
Click **Create Release**, and approve the [gasless transaction](/advanced-features/gasless-transactions) to create a
