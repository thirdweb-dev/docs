...
Initialize a read-only instance of the SDK to start viewing data from any smart contract.
...
Get any smart contract inside your application,
with specialized functionality for [pre-built contracts](/pre-built-contracts).
