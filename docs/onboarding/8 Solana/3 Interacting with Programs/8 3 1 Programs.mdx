...
You can get an SDK instance for any program by providing the on-chain address of the program as follows:
...
<CodeSnippetWithSummary contract={"Program"} name={"fetch"} isSolana />
