---
slug: /contracts-sdk/contract-extensions/signatureminterc20
title: Signature Mint ERC20
---
...
The `SignatureMintERC20` smart contract extension is meant to be used with any ERC20 smart contract.

The 'signature minting' mechanism in the `SignatureMintERC20` extension uses EIP 712, and is a way for a contract admin to authorize an external party's request to mint tokens on the admin's contract.
...
contract MyToken is ERC20Base, SignatureMintERC20 {
    constructor(
        string memory _name,
     ...
     *
     *  You MUST complete the body of this function to use the `SignatureMintERC20` extension.
     */
    function mintWithSignature(
        ...
        // Mint tokens according to the mint request via `mintTo` made available by `ERC20Base`.
