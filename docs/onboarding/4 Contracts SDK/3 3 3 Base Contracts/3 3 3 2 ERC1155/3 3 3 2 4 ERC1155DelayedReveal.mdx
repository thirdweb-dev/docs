---
slug: /contracts-sdk/base-contracts/erc-1155/erc1155delayedreveal
...
The `ERC1155DelayedReveal` smart contract uses the [ERC1155LazyMint](/contracts-sdk/base-contracts/erc-1155/erc1155lazymint) base contract along with the `DelayedReveal`contract extension.
...
<div className="col col--6" style={{marginTop:16}} >
  <QuickstartCard
    ...
    link="/contracts-sdk/base-contracts/erc-1155/erc1155lazymint#unlocked-features"
