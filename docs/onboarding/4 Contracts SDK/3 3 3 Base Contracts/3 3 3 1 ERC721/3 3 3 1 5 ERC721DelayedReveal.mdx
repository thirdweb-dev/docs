...
The `ERC721DelayedReveal` smart contract uses the [ERC721LazyMint](/contracts-sdk/base-contracts/erc-721/erc721lazymint) base contract along with the `DelayedReveal`contract extension.
