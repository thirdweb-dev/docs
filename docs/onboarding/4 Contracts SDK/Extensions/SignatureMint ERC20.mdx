---
slug: /solidity/extensions/erc20signaturemintable
...
The `SignatureMintERC20` extension is _already_ available in the following [base contracts](/solidity/base-contracts):

- **ERC20**: [`ERC20SignatureMint`](/solidity/base-contracts/erc-20/erc20signaturemint), [`ERC20SignatureMintVote`](/solidity/base-contracts/erc-20/erc20signaturemint-vote)

## Unlocked Extensions

Once deployed, you can use the features made available by this extensions on the SDK and dashboard:
...
This section is meant for advanced users who want to write functionality from scratch. If that's not you, use one of these [base contracts](/solidity/extension-contracts/sigminterc20#availability-in-base-contracts) that already implement signature minting functionlity for you!
...
| ------------------------------------------------------------------------------------------ | ----------------------- | ---------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSignMintRequest`](/solidity/extension-contracts/sigminterc20#_cansignmintrequest) | internal view _virtual_ | n/a        | `bool`    | Runs on every attempt to mint tokens with signature on the contract. Returns whether the signer is authorized to issue a signature for minting. |
| [`mintWithSignature`](/solidity/extension-contracts/sigminterc20#mintwithsignature)     | external payable        | n/a        | `address` | Mints tokens according to the provided mint request.                                                                                            |
