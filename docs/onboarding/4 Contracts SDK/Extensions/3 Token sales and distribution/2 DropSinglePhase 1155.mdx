---
slug: /solidity/extension-contracts/dropsinglephase1155
...
The `DropSinglePhase1155` extension is _already_ available in the following [base contracts](/solidity/base-contracts):

- **ERC1155**: [`ERC1155Drop`](/solidity/base-contracts/erc-1155/erc1155drop)
...
| ------------------------------------------------------------------------------------------------------- | ----------------------- | ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`_collectPriceOnClaim`](/solidity/extension-contracts/dropsinglephase1155#_collectpriceonclaim)     | internal _virtual_      | n/a        | n/a     | Collects and distributes the primary sale value of NFTs being claimed.                                                                           |
| [`_transferTokensOnClaim`](/solidity/extension-contracts/dropsinglephase1155#_transfertokensonclaim) | internal _virtual_      | n/a        | n/a     | Transfers the NFTs being claimed.                                                                                                                |
| [`_canSetClaimConditions`](/solidity/extension-contracts/dropsinglephase1155#_cansetclaimconditions) | internal view _virtual_ | n/a        | `bool`  | Runs on every attempt to set the claim condition on the contract. Returns whether the claim condition can be set in the given execution context. |
