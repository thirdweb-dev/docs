---
slug: /contractkit/extension-contracts/sigminterc721
title: Signature Minting ERC721
---

import ViewContractCodeButton from "@components/ViewContractCodeButton";
import QuickstartCard from "@components/QuickstartCard";

# Signature Minting ERC721
...
The 'signature minting' mechanism in the `SignatureMintERC721` extension uses [EIP-712](https://eips.ethereum.org/EIPS/eip-712), and is a way for a contract admin to authorize an external party's request to mint tokens on the admin's contract. At a high level, this means you can authorize some external party to mint tokens on your contract, and specify what exactly will be minted by that external party.
...
The `SignatureMintERC721` extension is _already_ available in the following [base contracts](/contractkit/base-contracts):

- **ERC721**: [`ERC721SignatureMint`](/contractkit/base-contracts/erc-721/erc721signaturemint)
...
This section is meant for advanced users who want to write functionality from scratch. If that's not you, use one of these [base contracts](/contractkit/extension-contracts/sigminterc721#availability-in-base-contracts) that already implement signature minting functionlity for you!

The `SignatureMintERC721` extension is an _abstract contract_, and expects you to implement the following functions by yourself:

| Name                                                                                        | Type                    | Parameters | Returns   | Description                                                                                                                                     |
| ------------------------------------------------------------------------------------------- | ----------------------- | ---------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSignMintRequest`](/contractkit/extension-contracts/sigminterc721#_cansignmintrequest) | internal view _virtual_ | n/a        | `bool`    | Runs on every attempt to mint tokens with signature on the contract. Returns whether the signer is authorized to issue a signature for minting. |
| [`mintWithSignature`](/contractkit/extension-contracts/sigminterc721#mintwithsignature)     | external payable        | n/a        | `address` | Mints tokens according to the provided mint request.                                                                                            |
