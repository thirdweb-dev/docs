---
slug: /solidity/extension-contracts/sigminterc721
...
The `SignatureMintERC721` extension is _already_ available in the following [base contracts](/solidity/base-contracts):

- **ERC721**: [`ERC721SignatureMint`](/solidity/base-contracts/erc-721/erc721signaturemint)
...
This section is meant for advanced users who want to write functionality from scratch. If that's not you, use one of these [base contracts](/solidity/extension-contracts/sigminterc721#availability-in-base-contracts) that already implement signature minting functionlity for you!
...
| ------------------------------------------------------------------------------------------- | ----------------------- | ---------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSignMintRequest`](/solidity/extension-contracts/sigminterc721#_cansignmintrequest) | internal view _virtual_ | n/a        | `bool`    | Runs on every attempt to mint tokens with signature on the contract. Returns whether the signer is authorized to issue a signature for minting. |
| [`mintWithSignature`](/solidity/extension-contracts/sigminterc721#mintwithsignature)     | external payable        | n/a        | `address` | Mints tokens according to the provided mint request.                                                                                            |
