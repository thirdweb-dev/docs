---
slug: /extensions/erc721claimablewithconditions
...
Allow other wallets to **claim** NFTs that you have lazy-minted using (using [ERC721LazyMintable](/extensions/erc721lazymintable))
