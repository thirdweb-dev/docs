---
slug: /contractkit/erc721claimablewithconditions
...
Allow other wallets to **claim** NFTs that you have lazy-minted using (using [ERC721LazyMintable](/contractkit/erc721lazymintable))
