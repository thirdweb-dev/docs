---
slug: /contract-kit/erc721claimablewithconditions
...
Allow other wallets to **claim** NFTs that you have lazy-minted using (using [ERC721LazyMintable](/contract-kit/erc721lazymintable))
