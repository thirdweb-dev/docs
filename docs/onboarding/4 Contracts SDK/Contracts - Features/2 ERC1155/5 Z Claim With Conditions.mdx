---
slug: /contract-kit/erc1155claimablewithconditions
...
Allow other wallets to **claim** NFTs that you have lazy-minted using (using [ERC1155LazyMintable](/contract-kit/erc1155lazymintable))
