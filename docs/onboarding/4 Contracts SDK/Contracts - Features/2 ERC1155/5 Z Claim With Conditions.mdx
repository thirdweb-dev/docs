---
slug: /contractkit/erc1155claimablewithconditions
...
Allow other wallets to **claim** NFTs that you have lazy-minted using (using [ERC1155LazyMintable](/contractkit/erc1155lazymintable))
