---
slug: /extensions/erc-1155/burnable
title: Burn
---
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="ERC1155 Base"
      link="/extensions/base-contracts/erc-1155/erc1155base"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/extensions/base-contracts/erc-1155/erc1155signaturemint"
      image="/assets/icons/general.png"
    />
  </div>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/extensions/base-contracts/erc-1155/erc1155lazymint"
      image="/assets/icons/general.png"
    />
  </div>
  <div className="col col--6" style={{ padding: 8 }}>
...
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------ |
| [Burn NFTs](/sdk/interacting-with-contracts/erc1155/erc1155burnable#burn-a-specified-amount-of-a-nfts-1)  | Burn a specific quantity of NFTs                                                     |
| [Burn Batch of NFTs](/sdk/interacting-with-contracts/erc1155/erc1155burnable#burn-a-batch-of-nfts)        | Burn a specific quantity of multiple NFTs in one transaction                         |
| [Burn From](/sdk/interacting-with-contracts/erc1155/erc1155burnable#burn-a-specified-amount-of-a-nfts)    | Burn a specific quantity of NFTs from another wallet (requires permission/allowance) |
| [Burn Batch of NFTs From](/sdk/interacting-with-contracts/erc1155/erc1155burnable#burn-a-batch-of-nfts-1) | Burn a specific quantity of NFTs                                                     |
