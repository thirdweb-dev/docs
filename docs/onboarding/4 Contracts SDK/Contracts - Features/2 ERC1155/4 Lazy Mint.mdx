...
| -------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [Lazy Mint Batch](/sdk/interacting-with-contracts/erc721/erc1155lazymintable#create-a-batch-of-nfts-to-be-claimed-in-the-future) | Pass in an array of NFT metadata and lazy-mint them for others to claim. |
