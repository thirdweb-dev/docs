---
slug: /contract-kit/erc1155revealable
...
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| [Delayed Reveals](/sdk/interacting-with-contracts/erc1155revealable#delayed-reveal) | Pass in an array of NFT metadata to encrypt it and reveal it at a later time. |
