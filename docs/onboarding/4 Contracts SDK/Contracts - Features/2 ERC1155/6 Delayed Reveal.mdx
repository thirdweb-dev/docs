---
slug: /extensions/erc-1155/delayed-reveal
...
| --------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------- |
| [Delayed Reveals](/sdk/interacting-with-contracts/erc1155/erc1155lazymintable#delayed-reveal) | Pass in an array of NFT metadata to encrypt it and reveal it at a later time. |
