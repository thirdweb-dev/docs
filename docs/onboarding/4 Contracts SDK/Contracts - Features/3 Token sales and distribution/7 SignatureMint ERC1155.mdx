---
slug: /contractkit/extension-contracts/sigminterc1155
title: Signature Minting ERC1155
---
...
The 'signature minting' mechanism in the `SignatureMintERC1155` extension uses [EIP-712](https://eips.ethereum.org/EIPS/eip-712), and is a way for a contract admin to authorize an external party's request to mint tokens on the admin's contract. At a high level, this means you can authorize some external party to mint tokens on your contract, and specify what exactly will be minted by that external party.
...
The `SignatureMintERC1155` extension is _already_ available in the following [base contracts](/contractkit/base-contracts):

- **ERC1155**: [`ERC1155SignatureMint`](/contractkit/base-contracts/erc-1155/erc1155signaturemint)
...
This section is meant for advanced users who want to write functionality from scratch. If that's not you, use one of these [base contracts](/contractkit/extension-contracts/sigminterc1155#availability-in-base-contracts) that already implement signature minting functionlity for you!
...
| -------------------------------------------------------------------------------------------- | ----------------------- | ---------- | --------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSignMintRequest`](/contractkit/extension-contracts/sigminterc1155#_cansignmintrequest) | internal view _virtual_ | n/a        | `bool`    | Runs on every attempt to mint tokens with signature on the contract. Returns whether the signer is authorized to issue a signature for minting. |
| [`mintWithSignature`](/contractkit/extension-contracts/sigminterc1155#mintwithsignature)     | external payable        | n/a        | `address` | Mints tokens according to the provided mint request.                                                                                            |
