...
The `SignatureMintERC20` extension is _already_ available in the following [base contracts](/extensions/base-contracts):

- **ERC20**: [`ERC20SignatureMint`](/extensions/base-contracts/erc-20/erc20signaturemint), [`ERC20SignatureMintVote`](/extensions/base-contracts/erc-20/erc20signaturemint-vote)
