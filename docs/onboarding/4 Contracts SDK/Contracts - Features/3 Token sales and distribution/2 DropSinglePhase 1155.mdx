---
slug: /extensions/dropsinglephase1155
title: Drop Single Phase (ERC 1155)
---

import ViewContractCodeButton from "@components/ViewContractCodeButton";
import QuickstartCard from "@components/QuickstartCard";

# Drop Single Phase (ERC 1155)
...
The `DropSinglePhase1155` extension is _already_ available in the following [base contracts](/extensions/base-contracts):

- **ERC1155**: [`ERC1155Drop`](/extensions/base-contracts/erc-1155/erc1155drop)
...
This section is meant for advanced users who want to write functionality from scratch. If that's not you, use one of these [base contracts](/extensions/dropsinglephase1155#availability-in-base-contracts) that already implement delayed reveal functionlity for you!
...
| ---------------------------------------------------------------------------------- | ----------------------- | ---------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`collectPriceOnClaim`](/extensions/dropsinglephase1155#collectpriceonclaim)       | internal _virtual_      | n/a        | n/a       | Collects and distributes the primary sale value of NFTs being claimed.                                                                           |
| [`transferTokensOnClaim`](/extensions/dropsinglephase1155#transfertokensonclaim)   | internal _virtual_      | n/a        | `uint256` | Transfers the NFTs being claimed.                                                                                                                |
| [`_canSetClaimConditions`](/extensions/dropsinglephase1155#_cansetclaimconditions) | internal view _virtual_ | n/a        | `bool`    | Runs on every attempt to set the claim condition on the contract. Returns whether the claim condition can be set in the given execution context. |
...
```solidity
function getClaimTimestamp(uint256 tokenId, address claimer)
    public
    view
...
```solidity
function transferTokensOnClaim(address to, uint256 tokenId, uint256 quantityBeingClaimed)
    internal
    virtual
