...
The `ContractMetadata` extension is _already_ available in the following [base contracts](/extensions/base-contracts):
...
| --------------------------------------------------------------------------- | ----------------------- | ---------- | --------- | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| [`collectPriceOnClaim`](/extensions/contractmetadata#_cansetcontracturi)    | internal _virtual_      | n/a        | n/a       | Collects and distributes the primary sale value of NFTs being claimed.                                                                           |
| [`transferTokensOnClaim`](/extensions/contractmetadata#_cansetcontracturi)  | internal _virtual_      | n/a        | `uint256` | Transfers the NFTs being claimed.                                                                                                                |
| [`_canSetClaimConditions`](/extensions/contractmetadata#_cansetcontracturi) | internal view _virtual_ | n/a        | `bool`    | Runs on every attempt to set the claim condition on the contract. Returns whether the claim condition can be set in the given execution context. |
