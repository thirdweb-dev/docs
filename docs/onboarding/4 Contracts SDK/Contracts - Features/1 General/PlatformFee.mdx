...
The `PlatformFee` extension is _not_ already included in any [base contracts](/extensions/base-contracts). To use this extension, check out the [implementation guide](/extensions/platformfee#implementing-the-contract-extension) and [full API reference](/extensions/platformfee#full-api-reference).
...
| -------------------------------------------------------------------------- | ----------------------- | ---------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSetPlatformFeeInfo`](/extensions/platformfee#_cansetplatformfeeinfo) | internal view _virtual_ | n/a        | `bool`  | Runs on every attempt to set a new platform fee recipient or bps. Returns whether this info can be set in the given execution context. |
...
- Paramter `platformFeeRecipient`: The address to set as the new platform fee recipient.
- Paramter `platformFeeBps`: The value to set as the new platform fee BPS.
