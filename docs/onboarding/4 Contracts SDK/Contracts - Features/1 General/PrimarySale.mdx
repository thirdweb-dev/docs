...
The `PrimarySale` extension is _already_ available in the following [base contracts](/extensions/base-contracts):

- **ERC20**: [`ERC20Drop`](/extensions/base-contracts/erc-20/erc20drop), [`ERC20SignatureMint`](/extensions/base-contracts/erc-20/erc20signaturemint), [`ERC20DropVote`](/extensions/base-contracts/erc-20/erc20drop-vote), [`ERC20SignatureMintVote`](/extensions/base-contracts/erc-20/erc20signaturemint-vote)
- **ERC721**: [`ERC721Drop`](/extensions/base-contracts/erc-721/erc721drop), [`ERC721SignatureMint`](/extensions/base-contracts/erc-721/erc721signaturemint)
- **ERC1155**: [`ERC1155Drop`](/extensions/base-contracts/erc-1155/erc1155drop), [`ERC1155SignatureMint`](/extensions/base-contracts/erc-1155/erc1155signaturemint)
...
| ------------------------------------------------------------------------------------ | ----------------------- | ---------- | ------- | ------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSetPrimarySaleRecipient`](/extensions/primarysale#_cansetprimarysalerecipient) | internal view _virtual_ | n/a        | `bool`  | Runs on every attempt to set a new primary sale recipient. Returns whether this info can be set in the given execution context. |
