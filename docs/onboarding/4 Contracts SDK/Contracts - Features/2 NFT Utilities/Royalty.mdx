...
- All [ERC721](/extensions/base-contracts/erc-721/erc721base) and [ERC1155](/extensions/base-contracts/erc-1155/erc1155base) base contracts.
...
| -------------------------------------------------------------- | ----------------------- | ---------- | ------- | --------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSetRoyaltyInfo`](/extensions/royalty#_cansetroyaltyinfo) | internal view _virtual_ | n/a        | `bool`  | Runs on every attempt to set a new royalty recipient or BPS. Returns whether this info can be set in the given execution context. |
