...
The `LazyMint` extension is _already_ available in the following [base contracts](/extensions/base-contracts):

- **ERC721**: [`ERC721LazyMint`](/extensions/base-contracts/erc-721/erc721lazymint), [`ERC721DelayedReveal`](/extensions/base-contracts/erc-721/erc721delayedreveal), [`ERC721Drop`](/extensions/base-contracts/erc-721/erc721drop)
- **ERC1155**: [`ERC1155LazyMint`](/extensions/base-contracts/erc-1155/erc1155lazymint), [`ERC1155DelayedReveal`](/extensions/base-contracts/erc-1155/erc1155delayedreveal), [`ERC1155Drop`](/extensions/base-contracts/erc-1155/erc1155drop)
...
| --------------------------------------------------- | ----------------------- | ---------- | ------- | -------------------------------------------------------------------------------------------------------------------------------- |
| [`_canLazyMint`](/extensions/lazymint#_canlazymint) | internal view _virtual_ | n/a        | `bool`  | Runs on every attempt to lazy mint NFTs on the contract. Returns whether NFTs can be lazy minted in the given execution context. |
