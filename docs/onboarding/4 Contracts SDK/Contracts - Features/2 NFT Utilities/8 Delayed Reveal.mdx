...
`DelayedReveal` uses the [`LazyMint`](/extensions/lazymint) extension. When first lazy minting tokens, you can encrypt the metadata of NFTs and can reveal this metadata once your lazy minted NFTs have been distributed. You can learn more about how delayed reveal NFTs work, in this [blogpost](https://blog.thirdweb.com/delayed-reveal-nfts).
...
The `DelayedReveal` extension is _already_ available in the following [base contracts](/extensions/base-contracts):

- **ERC721**: [`ERC721DelayedReveal`](/extensions/base-contracts/erc-721/erc721delayedreveal), [`ERC721Drop`](/extensions/base-contracts/erc-721/erc721drop)
- **ERC1155**: [`ERC1155DelayedReveal`](/extensions/base-contracts/erc-1155/erc1155delayedreveal), [`ERC1155Drop`](/extensions/base-contracts/erc-1155/erc1155drop)
...
This section is meant for advanced users who want to write functionality from scratch. If that's not you, use one of these [base contracts](/extensions/delayedreveal#availability-in-base-contracts) that already implement delayed reveal functionlity for you!
...
| -------------------------------------------- | -------- | ---------- | --------------- | --------------------------------------- |
| [`reveal`](/extensions/delayedreveal#reveal) | external | n/a        | `string memory` | Reveals a batch of delayed reveal NFTs. |
