...
Enable [signature-based minting](/glossary/signature-based-minting) of tokens in your smart contract by implementing `ERC20SignatureMint`.
...
| ----------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [Signature-Based Minting](/typescript/sdk.erc20signaturemintable) | Generate signatures that allow other wallets can use to mint NFTs into your collection. |
