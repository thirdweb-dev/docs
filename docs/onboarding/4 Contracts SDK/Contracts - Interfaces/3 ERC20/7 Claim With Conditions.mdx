...
| -------------------------------------------------------- | --------------------------------------------------------------------------------- |
| [Claim Tokens](/typescript/sdk.erc20claimconditions)     | Claim (mint) a lazy-minted NFT to a wallet address.                               |
| [Claim Conditions](/typescript/sdk.erc20claimconditions) | Mints a quantity of lazy-minted NFTs from the drop to a specified wallet address. |
