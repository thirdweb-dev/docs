...
| ------------------------------------------------------ | --------------------------------------------------------------------------------- |
| [Claim NFT](/typescript/sdk.erc721lazymintable)        | Claim (mint) a lazy-minted NFT to a wallet address.                               |
| [Claim Conditions](/typescript/sdk.erc721lazymintable) | Mints a quantity of lazy-minted NFTs from the drop to a specified wallet address. |
