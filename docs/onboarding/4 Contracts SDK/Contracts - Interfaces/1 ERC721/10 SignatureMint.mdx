...
Enable [signature-based minting](/glossary/signature-based-minting) of NFTs in your smart contract by implementing `ERC721SignatureMint`.
...
| -------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [Signature-Based Minting](/typescript/sdk.erc721signaturemint) | Generate signatures that allow other wallets can use to mint NFTs into your collection. |
