...
| ------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------- |
| [Delayed Reveals](/sdk/interacting-with-contracts/erc721lazymintable#delayed-reveal) | Pass in an array of NFT metadata to encrypt it and reveal it at a later time. |
