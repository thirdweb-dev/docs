...
ERC1155SignatureMint enables [signature-based minting](/glossary/signature-based-minting) of NFTs in your smart contract.
...
| ------------------------------------------------------------------- | --------------------------------------------------------------------------------------- |
| [Signature-Based Minting](/typescript/sdk.erc1155signaturemintable) | Generate signatures that allow other wallets can use to mint NFTs into your collection. |
