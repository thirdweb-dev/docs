...
| ------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| [Get All NFTs](/typescript/sdk.erc1155enumerable#getall)      | Load the metadata of all the minted NFTs in this contract.                          |
| [View Owned NFTs](/typescript/sdk.erc1155enumerable#getowned) | View all the NFTs a wallet address owns from this collection at this point in time. |
