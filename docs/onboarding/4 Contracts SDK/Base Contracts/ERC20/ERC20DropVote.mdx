...
The `ERC20Drop` base contract adds the [Drop](/sdk/interacting-with-contracts/erc20/erc20drop) extension to the [ERC20](/solidity/base-contracts/erc-20/erc20base)
