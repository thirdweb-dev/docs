...
Contract Kit gives you **base contracts** that you can use as the foundation of your smart contract.

**1.** To start, import and inherit the base contract that is right for your project.
...
**1.** To start, import and inherit the extension contract that is right for your project.
...
**Note:** for some extension contracts (e.g. `LazyMint`) you may see the following error at this step: `Contract "MyNFT" should be marked as abstract.`
