...
You can use ContractKit to build out your smart contract project _end-to-end_, or to simply add features to your own, existing smart contract.

### Using Base Contracts

ContractKit gives you [**base contracts**](/extension/base-contracts) that you can use as the foundation of your smart contract.
