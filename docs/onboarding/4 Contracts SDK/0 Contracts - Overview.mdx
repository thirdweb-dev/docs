...
- **Base Contracts** that you can build upon, such as [ERC721Base](/contract-kit/base-contracts/erc-721/erc721base).
- **Features** for you to implement, such as [Permission Controls](/contract-kit/permissions) and [Royalty Fees](/contract-kit/royalty).
...
For example, if you implement the [ERC721Base](/contract-kit/base-contracts/erc-721/erc721base) contract, you'll unlock the `mint` button in the dashboard and
