...
- **Extension contracts** that you can plug-in to unlock specific functionality, such as [Permission Controls](/contractkit/permissions) and [Royalty Fees](/contractkit/royalty).
...
With the foundation for your smart contract ready, you can now plug-in additional features to your smart contract using [**extension contracts**](/contractkit/features).

**1.** To start, import and inherit the extension contract that is right for your project. You can find the list of all available extensions [here](/contractkit/features#list-of-extensions).
...
**Note:** for some extension contracts (e.g. [`LazyMint`](/contractkit/erc721lazymintable)) you may see the following error at this step: `Contract "MyNFT" should be marked as abstract.`
