---
slug: /contractkit/base-contracts/erc-1155/erc1155signaturemint
...
The `ERC1155SignatureMint` smart contract adds [Signature-Based Minting](/contractkit/erc1155signaturemintable)
functionality to the the [ERC1155Base](/contractkit/base-contracts/erc-1155/erc1155base) contract.
...
<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/contractkit/erc1155#unlocked-features"
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Mintable"
      link="/contractkit/erc1155mintable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Batch Mintable"
      link="/contractkit/erc1155batchmintable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/contractkit/erc1155signaturemintable#unlocked-features"
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Enumerable"
      link="/contractkit/erc1155enumerable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Burnable"
      link="/contractkit/erc1155burnable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/contractkit/contractmetadata#unlocked-features"
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Royalties"
      link="/contractkit/royalty#unlocked-features"
      image="/assets/icons/general.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Primary Sale"
      link="/contractkit/primarysale#unlocked-features"
      image="/assets/icons/general.png"
    />
  </div>
</div>
