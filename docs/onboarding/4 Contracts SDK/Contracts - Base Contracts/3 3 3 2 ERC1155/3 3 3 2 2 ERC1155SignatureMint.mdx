---
slug: /contract-kit/base-contracts/erc-1155/erc1155signaturemint
...
The `ERC1155SignatureMint` smart contract adds [Signature-Based Minting](/contract-kit/erc1155signaturemintable)
functionality to the the [ERC1155Base](/contract-kit/base-contracts/erc-1155/erc1155base) contract.
...
<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/contract-kit/erc1155#unlocked-features"
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Mintable"
      link="/contract-kit/erc1155mintable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Batch Mintable"
      link="/contract-kit/erc1155batchmintable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/contract-kit/erc1155signaturemintable#unlocked-features"
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Enumerable"
      link="/contract-kit/erc1155enumerable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Burnable"
      link="/contract-kit/erc1155burnable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
