...
The `ERC1155SignatureMint` smart contract adds [Signature-Based Minting](/extensions/erc1155signaturemintable)
...
<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/extensions/erc1155signaturemintable#unlocked-features"
