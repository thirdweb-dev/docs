...
The `ERC20Drop` base contract adds the [Drop](/extensions/erc-20/drop) extension to the [ERC20](/extensions/base-contracts/erc-20/erc20base)
...
<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Droppable"
      link="/extensions/erc-20/drop#unlocked-features"
      image="/assets/icons/token.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
