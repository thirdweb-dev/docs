...
The `ERC20Drop` base contract adds the [Drop](/sdk/interacting-with-contracts/erc721/erc20drop) extension to the [ERC20](/contractkit/base-contracts/erc-20/erc20base)
...
<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Claim"
      link="/sdk/interacting-with-contracts/erc721/erc20drop"
      image="/assets/icons/token.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
