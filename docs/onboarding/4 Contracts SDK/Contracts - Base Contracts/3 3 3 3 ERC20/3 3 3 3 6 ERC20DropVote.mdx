...
The `ERC20Drop` base contract adds the [Drop](/contractkit/erc20claimablewithconditions) extension to the [ERC20](/contractkit/base-contracts/erc-20/erc20base)
to allow you to distribute your tokens under the criteria of claim conditions. It also
implements [ERC20Votes](https://github.com/thirdweb-dev/contracts/blob/main/contracts/openzeppelin-presets/token/ERC20/contractkit/ERC20Votes.sol),
...
<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Droppable"
      link="/contractkit/erc20claimablewithconditions#unlocked-features"
      image="/assets/icons/token.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
