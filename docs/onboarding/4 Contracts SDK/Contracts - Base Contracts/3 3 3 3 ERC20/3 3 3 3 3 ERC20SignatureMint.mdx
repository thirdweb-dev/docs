...
The `ERC20SignatureMint` smart contract adds [signature-based minting](/extensions/erc-20/signature-mint)
functionality to the the [ERC20Base](/extensions/base-contracts/erc-20/erc20base) contract.
