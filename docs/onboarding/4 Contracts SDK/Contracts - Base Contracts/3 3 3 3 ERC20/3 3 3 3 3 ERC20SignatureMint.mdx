---
slug: /contract-kit/base-contracts/erc-20/erc20signaturemint
...
The `ERC20SignatureMint` smart contract adds [signature-based minting](/contract-kit/erc20signaturemintable)
functionality to the the [ERC20Base](/contract-kit/base-contracts/erc-20/erc20base) contract.
