---
slug: /contract-kit/base-contracts/erc-721/erc721signaturemint
...
[ERC721Base](/contract-kit/base-contracts/erc-721/erc721base)
base contract along with the [SignatureMintERC721](/contract-kit/erc721signaturemintable) contract extension.
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    name="Mintable"
    link="/contract-kit/erc721mintable#unlocked-features"
    image="/assets/icons/nft.png"
  />
</div>
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    name="Batch Mintable"
    link="/contract-kit/erc721batchmintable#unlocked-features"
    image="/assets/icons/nft.png"
  />
</div>
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    ...
    link="/contract-kit/erc721signaturemintable#unlocked-features"
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    name="Ownable"
    link="/contract-kit/ownable#unlocked-features"
    image="/assets/icons/general.png"
  />
</div>
