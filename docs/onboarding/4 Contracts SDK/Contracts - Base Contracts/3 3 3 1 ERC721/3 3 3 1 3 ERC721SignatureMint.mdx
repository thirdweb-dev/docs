...
base contract along with the [SignatureMintERC721](/extensions/erc721signaturemintable) contract extension.
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    name="Mintable"
    link="/extensions/erc721mintable#unlocked-features"
    image="/assets/icons/nft.png"
  />
</div>
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    name="Batch Mintable"
    link="/extensions/erc721batchmintable#unlocked-features"
    image="/assets/icons/nft.png"
  />
</div>
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    ...
    link="/extensions/erc721signaturemintable#unlocked-features"
