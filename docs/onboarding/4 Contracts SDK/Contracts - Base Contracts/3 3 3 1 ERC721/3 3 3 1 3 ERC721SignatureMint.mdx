---
slug: /contractkit/base-contracts/erc-721/erc721signaturemint
...
[ERC721Base](/contractkit/base-contracts/erc-721/erc721base)
base contract along with the [SignatureMintERC721](/contractkit/erc721signaturemintable) contract extension.
...
<div className="col col--4" style={{padding:8}} >
  <QuickstartCard
    ...
    link="/contractkit/erc721#unlocked-features"
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    name="Mintable"
    link="/contractkit/erc721mintable#unlocked-features"
    image="/assets/icons/nft.png"
  />
</div>
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    name="Batch Mintable"
    link="/contractkit/erc721batchmintable#unlocked-features"
    image="/assets/icons/nft.png"
  />
</div>
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    ...
    link="/contractkit/erc721signaturemintable#unlocked-features"
...
<div className="col col--4" style={{ padding: 8 }}>
  <QuickstartCard
    name="Ownable"
    link="/contractkit/ownable#unlocked-features"
    image="/assets/icons/general.png"
  />
</div>
