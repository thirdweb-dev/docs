---
slug: /contractkit/base-contracts/erc-721/erc721base
title: Standard
---
...
<div className="col col--4" style={{ padding: 8 }}>
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard name="Ownable" link="/contractkit/extension-contracts/ownable" image="/assets/icons/general.png" />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Royalties"
