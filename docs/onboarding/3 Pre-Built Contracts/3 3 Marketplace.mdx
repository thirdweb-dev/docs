...
A Marketplace is a contract where you can buy and sell NFTs, such as to OpenSea or Rarible.
...
- If a user pays the asking price, they will be transferred the NFT and the seller will receive the funds.
...
- The user must bid a certain percentage higher than the current highest bid. This is to avoid users bidding minuscule amounts above the previous bid.
