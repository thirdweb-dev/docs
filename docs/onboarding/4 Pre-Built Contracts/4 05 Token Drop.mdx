...
including whitelists, release dates, and claim limits.
...
To start using your Token Drop contract inside your application, you'll need to use it's contract address. You can get the contract address from the [dashboard](https://thirdweb.com/dashboard).

<ThirdwebCodeSnippet contract={"TokenDrop"} name={"base"} isGetContractCode />
...
- How much you want to charge per tokens
- What currency you want to charge in
- Which wallet addreses are allowed to claim tokens (whitelist/allowlist)
...
Your users can claim tokens if they are included in the current claim phase.
