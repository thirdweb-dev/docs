...
The `AccountExtension` smart contract is the extension usable with the [Dynamic](/solidity/base-contracts/dynamic-account) and [Managed](/solidity/base-contracts/managed-account) Account smart contracts. It is the _default extension_ for these base contracts.
