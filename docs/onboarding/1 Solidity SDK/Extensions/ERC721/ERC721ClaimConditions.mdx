...
implementing [`ERC721`](/solidity/extensions/erc721) and [`DropSinglePhase`](/solidity/extensions/dropsinglephase) extensions.

This is an extension which is detectable in the dashboard if the smart contract implements the 
[`ERC721`](/solidity/extensions/erc721) and [`DropSinglePhase`](/solidity/extensions/dropsinglephase) extensions.
