...
The `Drop1155` smart contract is an extension meant for distributing [ERC1155](/solidity/extensions/erc1155) tokens. It allows setting up multiple claim phases unlike [`ERC1155DropSinglePhase`](/solidity/extensions/erc1155dropsinglephase). This series of claim phases is ordered by their respective `startTimestamp`.
