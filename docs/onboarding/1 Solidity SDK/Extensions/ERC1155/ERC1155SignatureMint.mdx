...
| ------------------------------------------------------------------ | ----------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSignMintRequest`](/solidity/extensions/erc1155signaturemint) | internal view _virtual_ | Runs on every attempt to mint tokens with signature on the contract. Returns whether the signer is authorized to issue a signature for minting. |
| [`mintWithSignature`](/solidity/extensions/erc1155signaturemint)   | external payable        | Mints tokens according to the provided mint request.                                                                                            |
