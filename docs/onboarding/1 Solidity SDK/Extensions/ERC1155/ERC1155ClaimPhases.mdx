...
Unlike [`ERC1155ClaimCondition`](/solidity/extensions/erc1155claimconditions), this extension allows you to set _multiple_ [claim phases](/glossary/claim-phases).
