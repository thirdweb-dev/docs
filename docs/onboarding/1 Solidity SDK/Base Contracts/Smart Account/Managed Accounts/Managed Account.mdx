...
Like [`DynamicAccount`](/solidity/base-contracts/dynamic-account), the `ManagedAccount` smart wallet is an *upgradeable* smart contract written in the [dynamic contract pattern](https://github.com/thirdweb-dev/dynamic-contracts).
