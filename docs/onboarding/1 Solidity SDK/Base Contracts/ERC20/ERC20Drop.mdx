---
slug: /solidity/base-contracts/erc20drop
title: ERC20 Drop
---
...
The `ERC20Drop` base contract adds the [Drop Single Phase](/solidity/extensions/dropsinglephase) extension contract to the [ERC20 base](/solidity/base-contracts/erc20base) contract
