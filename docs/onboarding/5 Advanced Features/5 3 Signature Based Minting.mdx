...
Signature-based minting allows you to specify exactly what tokens can be minted in to your smart contract.
...
This allows you to you grant signatures for specific wallets to mint tokens that have properties that you specify into your contract.
