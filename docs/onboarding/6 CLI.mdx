...
```bash
npx thirdweb@latest@latest create
```
...
Creates a versioned [release](/release) of your contract onto our registry:

- Compiles your smart contracts
- Uploads the contract [ABI](https://docs.soliditylang.org/en/v0.8.17/abi-spec.html)s to IPFS
- Allows you to [release](/release) them through the dashboard
...
<div className="heroGridImageContainer">
  <ThemedImage
    sources={{
      light: "/assets/release.png",
      dark: "/assets/release.png",
    }}
    className="heroGridImage"
    alt="thirdweb dashboard"
  />
...
```bash
npx thirdweb@latest@latest release
```
...
<p>
  ...
  <a href="/contractkit/extensions">extensions</a> you have implemented. This
  command:
</p>

- Detects the framework you're using
- Compiles all of your smart contracts
- Prints out the [extensions](/contractkit/extensions) you have implemented for each contract
