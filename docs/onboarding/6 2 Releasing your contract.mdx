...
Using the [CLI](https://github.com/thirdweb-dev/thirdweb-cli), run the following command to publish your smart contracts to the world's first **on-chain smart contract registry**;
