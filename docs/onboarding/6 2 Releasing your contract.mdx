...
One selected, click "Next" to move on to flow corresponding to the contract type selected:
...
## EIP-1967 Proxy Contract Release
...
Finally, click "Next" and fill out the details of the parameters on your contract.
