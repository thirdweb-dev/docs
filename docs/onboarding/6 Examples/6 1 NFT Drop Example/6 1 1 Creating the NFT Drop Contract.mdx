---
slug: /examples/nft-drop/creating-the-nft-drop-contract
---

# Creating an NFT Drop Contract

In this section, we'll create the smart contract that will be used to store our NFTs.

We'll also configure the metadata such as the name, image, description, and royalty fees of the NFT Drop.

Lastly, we'll deploy the contract to a test network, and set up our [claim phases](https://portal.thirdweb.com/pre-built-contracts/nft-drop#setting-claim-phases).
...
![Configure NFT Drop Contract Metadata](../assets/deploy-onto-mumbai.png)
...
we can configure that define **when** and **how** users can claim NFTs from our collection.
