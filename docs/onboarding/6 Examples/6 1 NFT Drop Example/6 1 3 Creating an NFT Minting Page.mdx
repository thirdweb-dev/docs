...
You can create a copy of this [template repository](https://github.com/thirdweb-example/custom-minting-page)
by using our `create-tw-app` CLI, or downloading the repository as a `.zip` file and unzipping it from the GitHub URL.
