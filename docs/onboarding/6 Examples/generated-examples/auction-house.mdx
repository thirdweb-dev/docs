---
slug: /examples/auction-house-example
hide_title: true
---
...
```
  ...
  <ul>
    <li>
      <a href="https://auction-house.thirdweb-example.com" >View Demo</a>
    </li>
    <li>
      <a href="https://github.com/thirdweb-example/auction-house">View Code on GitHub</a>
    </li>
  </ul>
...
<iframe
    src="https://auction-house.thirdweb-example.com"
    title="auction-house"
    width="100%"
    height="420px"
    scrolling="yes"
