...
Inside the [CurrentHighestBidArea](https://github.com/thirdweb-example/auction-house/blob/main/components/CurrentHighestBidArea.tsx) we check the current highest bid on the auction using [.getWinningBid
