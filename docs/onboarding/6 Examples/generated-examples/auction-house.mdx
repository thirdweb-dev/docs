...
Inside the [CurrentHighestBidArea](https://github.com/thirdweb-example/auction-house/blob/main/components/CurrentHighestBidArea.tsx)
...
We calculate this inside the [MinimumBidArea](https://github.com/thirdweb-example/auction-house/blob/main/components/MinimumBidArea.tsx)
...
In the [BidBuyArea](https://github.com/thirdweb-example/auction-house/blob/main/components/BidBuyArea.tsx)
