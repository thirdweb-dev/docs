...
- [Login with Wallet Next Flask](https://github.com/thirdweb-example/login-with-wallet/blob/main/login-with-wallet-next-flask) - Uses [Next.js](https://nextjs.com/) ([React](https://reactjs.org/)) for the frontend and a [Flask](https://flask.palletsprojects.org/) for the backend.
