...
<ul>
    <li>
      <a href="https://signature-based-minting.thirdweb-example.com" >View Demo</a>
    </li>
    <li>
      <a href="https://github.com/thirdweb-example/signature-based-minting">View Code on GitHub</a>
    </li>
  </ul>

<iframe
    src="https://signature-based-minting.thirdweb-example.com"
