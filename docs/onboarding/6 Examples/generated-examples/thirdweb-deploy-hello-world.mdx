...
<ul>
    <li>
      <a href="https://thirdweb-deploy-hello-world.thirdweb-example.com" >View Demo</a>
    </li>
    <li>
      <a href="https://github.com/thirdweb-example/thirdweb-deploy-hello-world">View Code on GitHub</a>
    </li>
  </ul>

<iframe
    src="https://thirdweb-deploy-hello-world.thirdweb-example.com"
    title="thirdweb-deploy-hello-world"
    width="100%"
    height="420px"
    scrolling="yes"
