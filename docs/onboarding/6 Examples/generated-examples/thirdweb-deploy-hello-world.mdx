...
We deploy a basic [HelloWorld](https://github.com/thirdweb-example/thirdweb-deploy-hello-world/blob/main/HelloWorld.sol)
...
In [HelloWorld.sol](https://github.com/thirdweb-example/thirdweb-deploy-hello-world/blob/main/HelloWorld.sol)
