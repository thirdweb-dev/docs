...
We wrap our application in the `ThirdwebProvider` component in the [\_app.tsx](https://github.com/thirdweb-example/signature-drop/blob/main/pages/_app.tsx) file.
...
Now we can utilize all of the functionality of the [React SDK](https://portal.thirdweb.com/react) to connect to the user's wallets and their network on the [index.tsx](https://github.com/thirdweb-example/signature-drop/blob/main/pages/index.tsx) file.
