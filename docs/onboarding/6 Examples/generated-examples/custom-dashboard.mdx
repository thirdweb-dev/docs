...
>
  <DemoButton
    link="https://custom-dashboard.thirdweb-example.com"
    name="custom-dashboard"
  />
  <ViewCodeButton
    link="https://github.com/thirdweb-example/custom-dashboard"
    name="custom-dashboard"
  />
</div>
...
On the [index.tsx](https://github.com/thirdweb-example/custom-dashboard/blob/main/pages/index.tsx) page, we use the [`.getContractList`](https://portal.thirdweb.com/typescript/sdk.thirdwebsdk.getcontractlist#thirdwebsdkgetcontractlist-method) function to view all the contracts we deployed so far:
...
On the [deploy.tsx](https://github.com/thirdweb-example/custom-dashboard/blob/main/pages/deploy.tsx) page, we use the [`.deployBuiltInContract`] function to deploy a contract, which is a generic function to deploy _any_ pre-built contract.
