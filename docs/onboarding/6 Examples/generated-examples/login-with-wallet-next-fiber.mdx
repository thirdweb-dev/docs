---
slug: /templates/login-with-wallet-next-fiber-template
hide_title: true
---
...
Login with wallet example using a Next frontend and Fiber backend

To create a new project using this template, use the [thirdweb CLI](/thirdweb-deploy/thirdweb-cli):

```jsx
npx thirdweb create --template login-with-wallet-next-fiber
```
...
>
  <ViewCodeButton
    link="https://github.com/thirdweb-example/login-with-wallet-next-fiber"
    name="login-with-wallet-next-fiber"
  />
</div>
