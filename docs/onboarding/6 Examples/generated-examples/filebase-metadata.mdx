...
This produces a unique identifier that you can copy into the [2-mint-nft.mjs](https://github.com/thirdweb-example/filebase-metadata/blob/main/scripts/2-mint-nft.mjs)
...
In the [3-batch-mint-nfts.mjs](https://github.com/thirdweb-example/filebase-metadata/blob/main/scripts/3-batch-mint-nfts.mjs)
...
Inside the [index.js](https://github.com/thirdweb-example/filebase-metadata/blob/main/pages/index.js)
