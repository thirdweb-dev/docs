...
<ul>
    <li>
      <a href="https://marketplace.thirdweb-example.com" >View Demo</a>
    </li>
    <li>
      <a href="https://github.com/thirdweb-example/marketplace-next-ts">View Code on GitHub</a>
    </li>
  </ul>

<iframe
    src="https://marketplace.thirdweb-example.com"
    title="marketplace-next-ts"
    width="100%"
    height="420px"
    scrolling="yes"
