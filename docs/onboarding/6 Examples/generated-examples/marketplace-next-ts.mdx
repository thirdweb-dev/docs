---
slug: /templates/marketplace-next-ts-template
hide_title: true
---
...
>
  <DemoButton
    link="https://marketplace.thirdweb-example.com"
    name="marketplace-next-ts"
  />
  <ViewCodeButton
    link="https://github.com/thirdweb-example/marketplace-next-ts"
    name="marketplace-next-ts"
  />
</div>
...
On the [index.tsx file](https://github.com/thirdweb-example/marketplace-next-ts/blob/main/pages/index.tsx), we're displaying all of the current **active** listings on the marketplace.
...
We'll leave the details of how best to display the listings up to you, but if you're looking for an example, check out the code in our [index.tsx file](https://github.com/thirdweb-example/marketplace-next-ts/blob/main/pages/index.tsx) file.

## Listing Items on the marketplace

We have a page called [create.tsx](https://github.com/thirdweb-example/marketplace-next-ts/blob/main/pages/create.tsx) that lets users upload existing NFTs onto the marketplace.
...
We attach these functions to the `onClick` handlers of our `Buy` and `Make Offer` buttons. If you want to see how we do that, check out the code in our [[listingId].tsx file](https://github.com/thirdweb-example/marketplace-next-ts/blob/main/pages/listing/[listingId].tsx) page.
