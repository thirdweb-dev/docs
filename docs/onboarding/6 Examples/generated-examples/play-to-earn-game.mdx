---
slug: /examples/play-to-earn-game-example
hide_title: true
---
...
```jsx
npx thirdweb create --example play-to-earn-game
```


  <ul>
    <li>
      <a href="https://play-to-earn.thirdweb-example.com" >View Demo</a>
    </li>
    <li>
      <a href="https://github.com/thirdweb-example/play-to-earn-game">View Code on GitHub</a>
    </li>
  </ul>
...
<iframe
    src="https://play-to-earn.thirdweb-example.com"
...
```bash
npx thirdweb create --example play-to-earn
```
