...
3. "Equip" (stake) the pickaxe NFT in the [Mining](https://github.com/thirdweb-example/play-to-earn-game/blob/main/contracts/contracts/Mining.sol) contract (built with [thirdweb deploy
...
2. The [contracts](https://github.com/thirdweb-example/play-to-earn-game/blob/main/contracts) folder contains our smart contract set up, including our [Mining
...
On the [index.tsx](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/pages/index.tsx) page, we use [useMetamask
