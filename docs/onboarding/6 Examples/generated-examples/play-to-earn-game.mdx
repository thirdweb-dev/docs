...
3. "Equip" (stake) the pickaxe NFT in the [Mining](https://github.com/thirdweb-example/play-to-earn-game/blob/main/contracts/contracts/Mining.sol)
...
Inside the [contractAddresses](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/const/contractAddresses.ts)
...
1. The [application](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application)

2. The [contracts](https://github.com/thirdweb-example/play-to-earn-game/blob/main/contracts)
...
On the [index.tsx](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/pages/index.tsx)
...
The logic of the game page is on the [play](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/pages/play.tsx)
...
1. [CurrentGear Component](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/CurrentGear.tsx)
2. [Rewards Component](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/Rewards.tsx)
3. [OwnedGear Component](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/OwnedGear.tsx)
4. [Shop Component](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/Shop.tsx)
...
There is a fun little component within this one caled [ApproxRewards](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/ApproxRewards.tsx)
