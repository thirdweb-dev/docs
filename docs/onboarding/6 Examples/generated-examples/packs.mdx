...
This project also includes a [deployPack](https://github.com/thirdweb-example/packs/blob/main/scripts/deployPack.mjs) script that you can use to deploy the pack contract and a [bundleTokens
...
Now in the [index.tsx](https://github.com/thirdweb-example/packs/blob/main/pages/index.tsx) file, we can use the [useMetamask
