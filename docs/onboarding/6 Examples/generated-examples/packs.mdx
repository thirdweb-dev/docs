...
This project also includes a [deployPack](https://github.com/thirdweb-example/packs/blob/main/scripts/deployPack.mjs)
...
Inside the [bundleTokens](https://github.com/thirdweb-example/packs/blob/main/scripts/bundleTokens.mjs)
...
We wrap our application in the `ThirdwebProvider` in the [\_app.tsx](https://github.com/thirdweb-example/packs/blob/main/pages/_app.tsx)
...
Now in the [index.tsx](https://github.com/thirdweb-example/packs/blob/main/pages/index.tsx)
