---
slug: /templates/nft-drop-template
hide_title: true
---
...
>
  <DemoButton
    link="https://custom-minting-page.thirdweb-example.com"
    name="nft-drop"
  />
  <ViewCodeButton
    link="https://github.com/thirdweb-example/nft-drop"
    name="nft-drop"
  />
</div>
...
You can fully customize the colors and style of this template by editing the values in the [`globals.css`](https://github.com/thirdweb-example/nft-drop/blob/main/styles/globals.css) file.
...
Replace the value of the `myNftDropContractAddress` inside [`index.tsx`](https://github.com/thirdweb-example/nft-drop/blob/main/pages/index.tsx) with your NFT Drop contract address you can find in the dashboard.
