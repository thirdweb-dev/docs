---
slug: /examples/nft-drop-example
hide_title: true
---
...
```jsx
npx thirdweb create --example nft-drop
```


  <ul>
    <li>
      <a href="https://custom-minting-page.thirdweb-example.com" >View Demo</a>
    </li>
    <li>
      <a href="https://github.com/thirdweb-example/nft-drop">View Code on GitHub</a>
    </li>
  </ul>
...
<iframe
    src="https://custom-minting-page.thirdweb-example.com"
    title="nft-drop"
    width="100%"
    height="420px"
    scrolling="yes"
