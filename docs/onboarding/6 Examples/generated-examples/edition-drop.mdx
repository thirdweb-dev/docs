---
slug: /examples/edition-drop-example
hide_title: true
---
...
```jsx
npx thirdweb create --example edition-drop
```


  <ul>
    <li>
      <a href="https://edition-drop.thirdweb-example.com" >View Demo</a>
    </li>
    <li>
      <a href="https://github.com/thirdweb-example/edition-drop">View Code on GitHub</a>
    </li>
  </ul>
...
<iframe
    src="https://edition-drop.thirdweb-example.com"
    title="edition-drop"
    width="100%"
    height="420px"
    scrolling="yes"
