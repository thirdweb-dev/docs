...
Let's explore how the [NFT Collection Smart Contract](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-contract-extensions/blob/main/contract/contracts/MyAwesomeNft.sol)
...
Inside the [home page](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-contract-extensions/blob/main/application/pages/index.js)
...
We configure the desired blockchain/network in the [`_app.js`](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-contract-extensions/blob/main/application/pages/_app.js)
...
Now we can easily call the functions of our [`NFT Collection contract`](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-contract-extensions/blob/main/contract/contracts/MyAwesomeNft.sol)
...
https://portal.thirdweb.com/react/react.thirdwebprovider), as seen in the [`_app.js`](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-contract-extensions/blob/main/application/pages/_app.js)
