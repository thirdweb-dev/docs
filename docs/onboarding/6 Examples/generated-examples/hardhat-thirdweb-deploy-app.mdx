...
Inside the [home page](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-app/blob/main/application/pages/index.js)
...
We configure the desired blockchain/network in the [`_app.js`](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-app/blob/main/application/pages/_app.js)
...
Now we can easily call the functions of our [`Greeter`](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-app/blob/main/contract/Greeter.sol)
...
https://portal.thirdweb.com/react/react.thirdwebprovider), as seen in the [`_app.js`](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-app/blob/main/application/pages/_app.js)
