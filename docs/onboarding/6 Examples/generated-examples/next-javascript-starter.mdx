---
slug: /examples/next-javascript-starter-example
hide_title: true
---
...
```
  ...
  <ul>
    <li>
      <a href="https://next-javascript-starter.thirdweb-example.com" >View Demo</a>
    </li>
    <li>
      <a href="https://github.com/thirdweb-example/next-javascript-starter">View Code on GitHub</a>
    </li>
  </ul>
...
<iframe
    src="https://next-javascript-starter.thirdweb-example.com"
