...
- Create the marketplace smart contract that will be used to store our listings
...
You can configure the **Name**, **Symbol**, and **Description** of the contract before you deploy it.
