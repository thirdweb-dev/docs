---
title: How to publish your contract
slug: /publish/how-to-publish
---
...
Select the contract type for your published contract. Choose the "standard contract" option (selected by default) if your contract does not follow the proxy or factory contract patterns.
Proxy contracts let your published contracts have cheaper deploys, and factory contracts let you invoke a factory function when the contract gets deployed.
Learn more about proxy contracts [here](https://portal.thirdweb.com/publish/proxy-contracts) and factory contracts [here](https://portal.thirdweb.com/publish/factory-contracts).
