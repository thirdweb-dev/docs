---
slug: /web3-sdk/interacting-with-contracts/custom-contracts/using-contracts
...
Transactions are made using the connected wallet if you have the [ThirdwebProvider](/web3-sdk/set-up-the-sdk/frontend#manual-installation) component configured.
