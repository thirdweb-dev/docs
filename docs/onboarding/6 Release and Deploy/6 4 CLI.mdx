...
You can also deploy a contract that has been [released](/release) by running:
...
Or one of our [pre-built contracts](/pre-built-contracts) by running:
...
You can also start with one of our [template repositories](https://github.com/thirdweb-example) by passing the `--template` flag and the name of the repo.
