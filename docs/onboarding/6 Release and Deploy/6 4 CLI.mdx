...
As you're developing your contracts, you may want to implement [Extensions](/extensions) to add standard functionality to your contracts like NFT minting, querying, and more.
...
Creating releases this way gives you a shareable URL to let others deploy your contracts in one click. It lets you manage released versions and get attribution for deployed contracts. Contract releases are registered on-chain (Polygon) and IPFS, for free [(gasless)](/sdk/advanced-features/gasless-transactions).
