...
<OpenSourceInfo
  repoName="auth"
  repoUrl="https://github.com/thirdweb-dev/js/tree/main/packages/auth"
/>
...
<div>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      name="NextAuth"
      link="/auth/integrations/next-auth"
      description=""
...
<div>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      name="Supabase"
      link="/auth/integrations/supabase"
      description=""
...
<div>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      name="Firebase"
      link="/auth/integrations/firebase"
      description=""
