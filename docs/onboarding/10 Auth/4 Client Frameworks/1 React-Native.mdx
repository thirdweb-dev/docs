...
Once you've setup an Auth API for your application, you can use the `@thirdweb-dev/react-native` and `@thirdweb-dev/auth` packages to add Auth support to your React Native apps.

## Getting Started

To add support for Auth to your React Native apps, you'll first need to setup your [React Native app](/react-native) and install the following package:
