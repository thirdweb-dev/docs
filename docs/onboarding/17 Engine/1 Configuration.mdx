...
Visual learner? [Watch our video tutorial](https://www.youtube.com/watch?v=NEhgvKojvqE) on how to configure a self-hosted version with Docker, instead.
...
3. Afterwards, to get the Engine Docker Image, navigate to the root of your project and run the following command in your command line:
   ...
   ```
   docker run --env-file .env -p 3005:3005 thirdweb/engine:v0.0.3
   ```
