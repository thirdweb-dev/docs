---
slug: /guides/engine/nft-checkout
title: NFT Checkout
---
...
<img
  src="/assets/engine/nft-checkout-overview.png"
  width="600px"
  alt="NFT checkout overview"
/>
...
- An [access token](/engine/authentication) for your Engine instance
...
Use [`<ConnectWallet>`](https://portal.thirdweb.com/react/react.connectwallet) to prompt the buyer for their wallet address. The buyer provides their credit card details and selects **Pay now** to send payment details directly to Stripe.
...
<img
  src="/assets/engine/nft-checkout-1.png"
...
<img
  src="/assets/engine/nft-checkout-2.png"
...
<img
  src="/assets/engine/nft-checkout-3.png"
...
<div className="col col--12" style={{ padding: 8 }}>
  <QuickstartCard
    name="NFT checkout template"
    link="https://github.com/thirdweb-example/engine-nft-checkout"
