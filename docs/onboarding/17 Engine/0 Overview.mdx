...
Engine is a self-hosted server that connects your application to any EVM blockchain through backend wallets. Your backend calls authenticated APIs to execute contract methods, manage smart wallets, handle wallet funds, and more. Wallet security, authentication, automatic retries, and nonce management are built-in.
