...
Engine is [open source](https://github.com/thirdweb-dev/engine), and core features will be free, forever. Advanced features for more sophisticated uses cases will be offered in the future.
