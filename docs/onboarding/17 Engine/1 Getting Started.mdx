...
```
POSTGRES_CONNECTION_URL=postgresql://postgres:<db_password>@host.docker.internal:5432/postgres?sslmode=disable
```
...
1. Navigate to [https://localhost:3005/json](https://localhost:3005/json).
    ...
    - Select **Show advanced** and select **Proceed to localhost (unsafe)**. This one-time step is required to allow your browser to connect to your local Engine instance.
