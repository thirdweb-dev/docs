...
- Base contracts that you can build upon, such as [ERC721Base](/contracts-sdk/base-contracts/erc-721/erc721base).
- Contract extensions you can implement, such as [Permission Controls](/contracts-sdk/contract-extensions/permissions) and [Royalty Fees](/contracts-sdk/contract-extensions/royalty).
...
- Unlock the features of [Dashboard](https://thirdweb.com/dashboard) and [SDK](/web3-sdk) on your own smart contracts.
...
For example, if you implement the [ERC721Base](/contracts-sdk/base-contracts/erc-721/erc721base), you'll unlock the `mint` button in the dashboard and
...
<div className="col col--12" style={{ marginTop: 8 }}>
  <QuickstartCard
    name="Quick Start - Contracts SDK + CLI"
    link="/contracts-sdk/quickstart"
...
Using the Contracts SDK requires knowledge of how to [define a contract](https://docs.soliditylang.org/en/v0.6.0/contracts.html#creating-contracts) in Solidity and an understanding of [Inheritance](https://docs.soliditylang.org/en/v0.6.0/contracts.html#inheritance).
