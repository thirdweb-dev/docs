...
Call the table `users`, make sure `Row Level Security` is enabled, and create 3 columns - `id`, `created_at`, and `address`.
...
First, we'll need to instantiate the Firebase SDK in our project as follows:
