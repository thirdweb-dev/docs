...
We'll start by cloning the [Basic Authentication](https://github.com/thirdweb-example/login-with-wallet) example project using the [thirdweb CLI](/thirdweb-deploy/thirdweb-cli)
