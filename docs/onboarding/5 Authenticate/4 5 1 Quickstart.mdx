...
We'll start by cloning the [Thirdweb Auth Next](https://github.com/thirdweb-example/thirdweb-auth-next) example project using the [thirdweb CLI](https://github.com/thirdweb-dev/js/tree/main/packages/cli)
