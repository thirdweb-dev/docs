...
We'll start by cloning the [Thirdweb Auth Next](https://github.com/thirdweb-example/thirdweb-auth-next) example project using the [thirdweb CLI](/cli)

```bash
npx thirdweb@latest create --template thirdweb-auth-next
```
