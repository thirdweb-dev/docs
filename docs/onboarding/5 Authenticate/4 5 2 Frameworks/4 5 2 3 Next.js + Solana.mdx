---
slug: /auth/frameworks/next-solana
title: Next.js + Solana
---

import QuickstartCard from "../../../../src/components/QuickstartCard";

Auth can be integrated into [Next.js](https://nextjs.org) for Solana apps to enable wallet-based login for Solana wallets. We'll go over the necessary setup below.

<div className="row" style={{ marginTop: 24 }}>
  <div className="col col--12">
    <QuickstartCard
      name="Example Repo: Next.js + Solana with Auth"
