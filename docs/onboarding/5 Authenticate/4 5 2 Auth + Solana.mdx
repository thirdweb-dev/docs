...
The `ThirdwebAuthHandler` functions automatically handle all the necessary API endpoints needed for Auth, and should be exported from the `/api/auth/[...thirdweb].js` file.
