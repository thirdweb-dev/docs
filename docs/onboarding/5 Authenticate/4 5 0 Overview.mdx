...
Auth uses the [sign-in with Ethereum](https://eips.ethereum.org/EIPS/eip-4361) standard to allow users to
verify they own a wallet by signing a message.

This enables wallet-based authentication flows for you to:

- Prove a user owns a wallet in a server-side context
- Restrict access to content/resources based on a user's wallet information
- Introduce web3 authentication to web2 applications
