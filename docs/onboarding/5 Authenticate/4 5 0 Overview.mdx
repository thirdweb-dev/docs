...
<div className="row" style={{ marginBottom: 12 }}>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      name="Guide: Add Sign In With Ethereum to a Next.js App"
      link="https://blog.thirdweb.com/guides/how-to-add-web3-sign-in-with-thirdweb/"
...
<div className="row">
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Next.js"
      link="https://portal.thirdweb.com/auth/frameworks/next"
      description=""
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Next.js + Solana"
      link="https://portal.thirdweb.com/auth/solana"
      description=""
      image="/assets/languages/nextjs.png"
    />
  </div>
...
<div className="row">
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="React"
      link="https://portal.thirdweb.com/auth/frameworks/react"
      description=""
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Express"
      link="https://portal.thirdweb.com/auth/frameworks/express"
      description=""
...
<div className="row" style={{ marginTop: 24 }}>
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.thirdweb.com/guides/create-a-discord-bot-that-gives-nft-holders-a-role/"
      description="Grant NFT holders a role in a Discord server"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      description="Integrate Auth into a Web2 Database"
      image="/assets/icons/onchain.png"
    />
  </div>
</div>
