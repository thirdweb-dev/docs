...
<div>
<p>thirdweb is a web3 application framework that enables you to easily build powerful, blockchain-based applications.</p>

<p>thirdweb offers three core pillars.</p>

1. **Contracts**: Smart contracts for you to deploy and tools to support building them.
...
Within the dashboard, you can perform the most common admin operations for
your projects without any code, such as:
