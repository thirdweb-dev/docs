...
For each contract you deploy using the [dashboard](https://thirdweb.com/dashboard) or the [CLI](https://github.com/thirdweb-dev/thirdweb-cli),
you unlock features in the dashboard for each [extension](/contract-kit) you implemented in your contract.
