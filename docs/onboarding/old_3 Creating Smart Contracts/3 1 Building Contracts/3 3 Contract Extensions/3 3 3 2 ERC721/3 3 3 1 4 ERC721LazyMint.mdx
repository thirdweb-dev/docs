---
slug: /contracts-sdk/base-contracts/erc-721/erc721lazymint
title: Lazy Mint
---
...
The `ERC721LazyMint` smart contract uses the [ERC721Base](/contracts-sdk/base-contracts/erc-721/erc721base) base contract along with the `LazyMint` contract extension.
