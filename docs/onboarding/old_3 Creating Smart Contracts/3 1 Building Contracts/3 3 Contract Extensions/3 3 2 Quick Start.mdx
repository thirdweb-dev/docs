...
Now we have a simple project with a `Lock` smart contract, let's introduce our Solidity SDK!
...
Let's first import the [ERC721Base](/solidity-sdk/base-contracts/erc-721/erc721base)
...
If we take a look at the [ERC-721 Base Contract](/solidity-sdk/base-contracts/erc-721/erc721base#implementing-the-contract-extension) page on the portal,
...
The [thirdweb CLI](/thirdweb-cli) provides a command to detect the implemented contract extensions.
...
That's it! Now you're ready to start building applications on top of your contract using the [SDK](/building-web3-apps/setting-up-the-sdk)!
