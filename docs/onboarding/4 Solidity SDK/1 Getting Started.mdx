...
All functions in the [base-contracts][extensions](/solidity/base-contracts) and [extensions][extensions](/solidity/extensions) can be modified by [overriding them][extensions](/solidity/getting-started#inheriting-and-overriding-functions).
...
For example, the `ERC721Base` contract has an implementation of the function `mintTo`, I could instead override this function to add custom logic 
