...
All functions in the [base-contracts](/solidity/base-contracts) and [extensions](/solidity/extensions) can be modified by [overriding them](/solidity/getting-started#inheriting-and-overriding-functions).
