...
implementing [`ERC721`](/solidity/extensions/erc721), [`LazyMint`](/solidity/extensions/lazymint) and [`ERC721Claimable`](/solidity/extensions/erc721claimable) extensions.
...
The functions which are available to be overridden are also detailed.
