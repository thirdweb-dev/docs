...
| ------------------------------------------------------------------------------------------- | ----------------------- |  ----------------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSignMintRequest`](/solidity/extension-contracts/sigminterc721#_cansignmintrequest) | internal view _virtual_ |  Runs on every attempt to mint tokens with signature on the contract. Returns whether the signer is authorized to issue a signature for minting. |
| [`mintWithSignature`](/solidity/extension-contracts/sigminterc721#mintwithsignature)     | external payable        |  Mints tokens according to the provided mint request.                                                                                            |
