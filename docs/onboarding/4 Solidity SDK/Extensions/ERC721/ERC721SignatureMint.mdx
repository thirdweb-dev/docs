...
The ['signature minting'](/glossary/signature-based-minting) mechanism in the `SignatureMintERC721` extension uses [EIP-712](https://eips.ethereum.org/EIPS/eip-712), and is a way for a contract admin to authorize an external party's request to mint tokens on the admin's contract. At a high level, this means you can authorize some external party to mint tokens on your contract, and specify what exactly will be minted by that external party.
...
<div className="row" style={{ marginBottom: 12 }}>
  ...
  <div className="col col--3" style={{ padding: 8 }}>
    <QuickstartCard
      name="Python"
      link="/python/erc721-signature-minting"
