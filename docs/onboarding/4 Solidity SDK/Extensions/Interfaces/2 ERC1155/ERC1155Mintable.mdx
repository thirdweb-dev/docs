---
slug: /solidity/extensions/interfaces/erc1155mintable
...
By implementing the `ERC1155Mintable` contract extension, you unlock the following features in the SDK and dashboard:
