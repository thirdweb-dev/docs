---
slug: /solidity/extensions/platformfee
title: PlatformFee
---
...
| ----------------------------------------------------------------------------------------------- | ----------------------- | ---------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSetPlatformFeeInfo`](/solidity/extension-contracts/platformfee#_cansetplatformfeeinfo) | internal view _virtual_ | n/a        | `bool`  | Runs on every attempt to set a new platform fee recipient or bps. Returns whether this info can be set in the given execution context. |
