...
| ----------------------------------------------------------------------------------------------- | ----------------------- | ------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [`_canSetPlatformFeeInfo`](/solidity/extension-contracts/platformfee#_cansetplatformfeeinfo) | internal view _virtual_ | `bool`  | Runs on every attempt to set a new platform fee recipient or bps. Returns whether this info can be set in the given execution context. |
...
<div className="row" style={{ marginBottom: 12 }}>
  <div className="col col--3" style={{ padding: 8 }}>
    <QuickstartCard
      name="React"
      link="/react/react.useplatformfees"
  ...
  <div className="col col--3" style={{ padding: 8 }}>
    <QuickstartCard
      name="Python"
      link="/python/contract-platform-fee"
...
<details>
<summary>getPlatformFeeInfo</summary>
<div>
...
<details>
<summary>setPlatformFeeInfo</summary>
<div>
...
<details>
<summary>_setupPlatformFeeInfo</summary>
<div>
...
<details>
<summary>_canSetPlatformFeeInfo</summary>
<div>
