...
In order for `ERC721Revealable`, `ERC20Revealable` or `ERC1155Revealable` extensions to be detected in the dashboard on your contract, the respective EIP 
([`ERC721`](/solidity/extensions/erc721), [`ERC1155`](/solidity/extensions/erc1155) or [`ERC20](/solidity/extensions/erc20)) needs to be inherited alongside the [`LazyMint`](/solidity/extensions/lazymint) extension.
