...
It is recommended to use this extension alongside the [`LazyMint`](/solidity/extensions/lazymint) extension to be detectable as the [`ERC1155ClaimPhases`](/solidity/extensions/erc1155claimphases) extension.
