...
The `ContractMetadata` smart contract is an extension usable with any base smart contract. It lets you define metadata with your smart contract. Additionally, `ContractMetadata` is necessary to enable royalties on NFT contracts on OpenSea.
