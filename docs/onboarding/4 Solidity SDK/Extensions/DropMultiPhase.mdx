---
slug: /solidity/extensions/dropmultiphase
title: DropMultiPhase
---

import ViewContractCodeButton from "@components/ViewContractCodeButton";
import QuickstartCard from "@components/QuickstartCard";

# DropMultiPhase (ERC20 & ERC721)
...
<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      ...
      link="/solidity/extensions/erc721claimconditions"
...
| [`_transferTokensOnClaim`](/solidity/extension-contracts/drop#_transfertokensonclaim) | internal _virtual_      | n/a        | `uint256` | Transfers the NFTs being claimed.                                                                                                                |
