---
slug: /gaming-kit/setting-up/installation
title: Installation
---
...
![Import Unity Package File](https://cdn.hashnode.com/res/hashnode/image/upload/v1668212676064/H5BffjB17.png)

After clicking `Import`, you can find the files in your `Project` window in the `Thirdweb` folder.

![Project window](https://cdn.hashnode.com/res/hashnode/image/upload/v1668213194792/Zl_10OQCV.png)
