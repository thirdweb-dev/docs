---
slug: /gaming/setting-up/connect-wallets
...
To [write transactions to the blockchain](/gaming/interact-with-contracts/write-transactions), you must have a connected wallet first.
