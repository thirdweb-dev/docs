---
slug: /gaming/interact-with-contracts/read-data
title: Read Data
---

import QuickstartCard from "@components/QuickstartCard";

After you have [instantiated the SDK](/gaming/setting-up/instantiating-the-sdk)
and [connected to a smart contract](/gaming/interact-with-contracts/connect-to-a-contract),
