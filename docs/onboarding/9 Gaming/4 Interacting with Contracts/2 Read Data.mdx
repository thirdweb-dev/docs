---
slug: /gaming-kit/interact-with-contracts/read-data
title: Read Data
---

import QuickstartCard from "@components/QuickstartCard";

After you have [instantiated the SDK](/gaming-kit/setting-up/instantiating-the-sdk)
and [connected to a smart contract](/gaming-kit/interact-with-contracts/connect-to-a-contract),
