---
slug: /gaming/interact-with-contracts/write-transactions
...
Writing transactions to the blockchain requires you to [connect to a wallet](/gaming/setting-up/connect-wallets) first.
