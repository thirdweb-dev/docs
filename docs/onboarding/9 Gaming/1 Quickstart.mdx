...
![Create New Project Unity Hub](https://cdn.hashnode.com/res/hashnode/image/upload/v1668212495039/5hwf-TtKD.png)

Next, select `3D`, give your project a name, and click `Create Project`:

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668212555757/mNNM_n6_E.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668212863206/Ap8VapfSX.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668212676064/H5BffjB17.png)

From here, select the file you just downloaded from GitHub, which will open the `Import Unity Package` menu:

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668213080058/7evzCA0-Y.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668213194792/Zl_10OQCV.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668213402193/MHAAgfIsp.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668213476859/lq24gmw1r.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668220794916/gzemOuhkY.png)

Next, click `Player Settings...` (bottom left corner) and set the `WebGL Template` under `Resolution and Presentation` to `Thirdweb`:

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668220894144/MlS9QjEiQ.png)

You may also need to disable `Auto Graphics API` in order to build your project:

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668221000440/gjFeshDHr.png)

Ensure you add your scenes to the `Scenes In Build` by clicking `Add Open Scenes`:

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668221043021/-pC_U5lGi.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668221151585/1y8EQusvM.png)

Voilà! Our game is built and we can test it out in the browser at [`localhost:50140`](http://localhost:50140/):

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668221317570/3f1B7yimW.png)

Now we can connect our wallet and start reading and writing transactions to the blockchain:
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1668221409295/fJP-jlxzR.png)

Awesome! 🥳🎉

## What's Next?

Now you've learnt how to get up and running with thirdweb in Unity, let's begin our multi-guide journey on creating a play-to-earn web3 game!
