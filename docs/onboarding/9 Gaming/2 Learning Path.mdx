---
slug: /gaming-kit/learning-path
title: Learning Path
---

import QuickstartCard from "@components/QuickstartCard";

We've prepared a set of resources to help you hit the ground running with our Gaming Kit.
...
## Gaming Kit Fundamentals

As you start to feel comfortable creating basic games in Unity, explore what's possible with the Gaming Kit.
...
Use [ContractKit](/contractkit) to create and deploy a burn-to-redeem NFT contract.
