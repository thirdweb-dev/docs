...
If you use [thirdweb deploy](/thirdweb-cli) you'll be able to select the delayed reveal option when you batch upload your NFTs.

![Delayed Reveal.png](../assets/delayed-reveal.png)

You can also set up and release a delayed reveal using the [SDK](/building-web3-apps/setting-up-the-sdk):

<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  <div className="col col--12" style={{ marginTop: 16 }}>
    <QuickstartCard
      name="Delayed Reveals in the SDK"
      link="/advanced-features/delayed-reveal"
