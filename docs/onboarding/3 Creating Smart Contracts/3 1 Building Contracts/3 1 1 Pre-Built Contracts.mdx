...
Each contract makes use of the [contract extensions](/thirdweb-deploy/contract-extensions) that are available in our [Solidity SDK](/thirdweb-deploy/contract-extensions),
