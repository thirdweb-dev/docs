...
A user signs in with their email address or social account and is provided a functional wallet your application manages. Afterward, they can purchase [NFTs with credit card](https://docs.withpaper.com/reference/shareable-checkout-links)s, view NFTs they own, transfer NFTs, and send blockchain transactions without being prompted to sign transactions.
