---
slug: /advanced-features/permission-controls
---
...
Each contract has a different set of configurable roles, you can find the full list in the [ALL_ROLES](sdk.all_roles#all_roles-variable) variable.
...
| pauser    | Can pause (and unpause) all external calls made to this contract's contract. | [Custom](/thirdweb-deploy/contract-extensions)                                 |
