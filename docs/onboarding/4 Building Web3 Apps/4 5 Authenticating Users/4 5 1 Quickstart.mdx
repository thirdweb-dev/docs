...
We'll start by cloning the [Basic Authentication](https://github.com/thirdweb-example/sign-in-with-ethereum) example project using the [thirdweb CLI](/thirdweb-deploy/thirdweb-cli)
