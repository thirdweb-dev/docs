...
Front-end applications are best-suited when you want users to connect their wallets to your web application and interact with your contracts using their wallet; such as an [NFT Minting Website](/examples/nft-drop).
...
You can start with one of our [example projects](/examples) by passing the `--template` flag and the name of the example repo.
