...
or you can build your own smart contract with our [Extensions](/extensions) and ship it with [Deploy](/deploy).
...
<div className="heroGrid">
  ...
  <div>
    <p>
      Each contract you deploy comes with an inuitive <a href='https://thirdweb.com/dashboard'>dashboard</a> to manage your applications.
    </p>
