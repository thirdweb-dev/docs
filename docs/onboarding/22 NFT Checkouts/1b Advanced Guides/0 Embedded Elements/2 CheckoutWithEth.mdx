---
slug: /checkouts/checkout-with-eth
title: CheckoutWithEth
---
...
> 👍 <a href="https://payments.thirdweb.com/sdk/2022-08-12/examples/checkout-with-eth" target="_blank">Try a demo!</a>
...
{
"image": [
"https://files.readme.io/41fcc3d-image.png",
null,
""
],
"align": "center",
...
{
"image": [
"https://files.readme.io/d1d7f1c-image.png",
null,
""
],
"align": "center",
...
| locale                      | enum (Valid values: `en`, `fr`, `es`, `it`, `de`, `ja`, `ko`, `zh`)                      | The language to show text in. Defaults to `en`.                                                                                                                                                                                                                          |
| options                     | object                                                                                   | Customize component styling. See [Customization](#customzation).                                                                                                                                                                                                         |
