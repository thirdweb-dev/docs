...
1. [Register your contract](register).
2. Create a [🔗 Shareable Checkout Link](shareable-link).
...
Yes! See [Marketplace Sales](TODO) for more details.

---

TODO: Did not go through the sections below this.
...
### Where does Paper send the funds after a customer has paid?

Paper directly calls the smart contract and pays for the mint using the native currency specified in the contract function. If you are looking for FIAT payout, it is available for the enterprise customers. Please [contact sales](mailto:sales@thirdweb.com) .
...
Yes, we support the ability for merchants to cover the gas fees related to transactions. See details [here](https://docs.withpaper.com/reference/send-gasless-transactions).

### If we use the Paper managed contracts, who covers the transaction fees?

Paper covers fees related to operations on [Paper-managed contracts](ref:create-paper-managed-contract).
...
| Goerli (Ethereum) | ETH      | [Faucet](https://goerlifaucet.com/)          |
| Sepolia (Etereum) | ETH      | [Faucet](https://sepoliafaucet.com/)         |
| Goerli (Optimism) | ETH      | [Faucet](https://faucet.paradigm.xyz/)       |
| SolanaDevnet      | SOL      | [Faucet](https://solfaucet.com)              |

## Customization

### Can I customize the checkout to match my branding?

Yes, customize colors and UI elements to fit your theme for [Shareable Checkout Links](ref:shareable-checkout-links). Or embed [Checkout Elements](ref:checkout-elements) in your app with granular control of colors.
...
Listen to [webhooks](ref:webhooks) to update your database or send a custom email when the NFT has been transferred.

### How do I customize the emails sent to buyers?

See [Advanced Customizations](ref:advanced-customizations) for more customization of the email after a buyer completes their purchase.

### Are checkouts translated into different languages?

Yes, the checkout is localized to the buyer's browser language, or you can force a specific language. See [Translations](ref:translations) for more details.

### How does checkout support referral codes or discounts?

You can use our dynamic one-time checkout links to generate payment links with discounts or referral codes for customers. For a full guide to how to implement this, refer [here](https://docs.withpaper.com/reference/buyer-allowlists).

### Does Paper support allowlists?

Yep, you can use our dynamic one-time checkout links to generate gated payment links for users who’ve verified their identity on your website. For a full guide to how to implement this, refer [here](https://docs.withpaper.com/reference/buyer-allowlists).

## Wallets

### What if my users don't have a wallet?

Buyers who don't have a wallet can create one with their email or social login. This uses our non-custodial [Embedded Wallet](ref:embedded-wallet-service-overview) product.
...
**\*For more questions related to our Embedded Wallets, see our** [Embedded Wallets FAQ](ref:embedded-wallets-faq).
...
### How does Paper handle compliance?
