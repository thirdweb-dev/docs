...
Yes, customize colors and UI elements to fit your theme for [Checkout Links](checkout-links). Or embed [Checkout Elements](elements) in your app with granular control of colors.
...
See the [Email Customizations](email-customizations) guide.
...
You can use our dynamic one-time checkout links to generate payment links with discounts or referral codes for customers. For a full guide to how to implement this, refer [here](allowlists).
