---
slug: /templates/signature-based-minting-template
hide_title: true
---
...
>
  <DemoButton
    link="https://signature-based-minting.thirdweb-example.com"
    name="signature-based-minting"
  />
  <ViewCodeButton
...
By the end, we'll have an NFT collection of NFTs that are all animal names, as specified in the [animalNames.ts](https://github.com/thirdweb-example/signature-based-minting/blob/main/animalNames.ts) file.
...
In the end, we'll have a community-made collection that only contains NFTs with animal names, by restricting the signatures we provide to only allow NFTs with one of our [animal names](https://github.com/thirdweb-example/signature-based-minting/blob/main/animalNames.ts)!
...
You can see an example of how to implement that logic in our [index.tsx file](https://github.com/thirdweb-example/signature-based-minting/blob/main/pages/index.tsx)
...
We'll let you decide how best to display your NFTs, but if you're looking for an example, check out the [index.tsx file](https://github.com/thirdweb-example/signature-based-minting/blob/main/pages/index.tsx) to see how we did it.
