...
Inside the [home page](https://github.com/thirdweb-example/hardhat-thirdweb-deploy-app/blob/main/application/pages/index.js) of the web application, connect to your smart contract inside the [`useContract`](https://portal.thirdweb.com/react/react.usecontract#usecontract-function) hook:
...
>>>>>>> main:docs/onboarding/6 Examples/generated-examples/hardhat-thirdweb-deploy-app.mdx
