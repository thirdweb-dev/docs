---
slug: /templates/play-to-earn-game-template
hide_title: true
---
...
>
  <DemoButton
    link="https://play-to-earn.thirdweb-example.com"
    name="play-to-earn-game"
  />
  <ViewCodeButton
    link="https://github.com/thirdweb-example/play-to-earn-game"
    name="play-to-earn-game"
  />
</div>
...
1. Mint your character NFT (ERC1155 using the [Edition Drop](https://portal.thirdweb.com/pre-built-contracts/edition-drop) contract)
2. Purchase a pickaxe NFT from the "Shop" (Another ERC1155 using an [Edition Drop](https://portal.thirdweb.com/pre-built-contracts/edition-drop) contract)
3. "Equip" (stake) the pickaxe NFT in the [Mining](https://github.com/thirdweb-example/play-to-earn-game/blob/main/contracts/contracts/Mining.sol) contract (built with [thirdweb deploy](https://portal.thirdweb.com/thirdweb-deploy))
4. Start earning "Gold Gems"; ERC20 tokens (using the [Token](https://portal.thirdweb.com/pre-built-contracts/token) contract)
...
Inside the [contractAddresses](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/const/contractAddresses.ts) file, you can change the contract addresses to your own contracts.

This project uses 4 contracts built with thirdweb:

| Name      | Contract Type            | Description                    | Link                                                                                                                        |
| --------- | ------------------------ | ------------------------------ | --------------------------------------------------------------------------------------------------------------------------- |
| Gold Gems | Token (ERC20)            | Gold Gems Rewards Token        | [View on thirdweb dashboard](https://thirdweb.com/dashboard/mumbai/token/0x18B18e5D2375c592997e1eaFf6C77A6bd24F5c44)        |
| Pickaxes  | Edition Drop (ERC1155)   | Pickaxe NFTs                   | [View on thirdweb dashboard](https://thirdweb.com/dashboard/mumbai/edition-drop/0x9d33597aD43bE6295Fe7626baDBF72B862F71bB2) |
| Miners    | Edition Drop (ERC1155)   | Character NFTs                 | [View on thirdweb dashboard](https://thirdweb.com/dashboard/mumbai/edition-drop/0x16A131b7e5a62E8fe83f0993aAF2ECCaBF519382) |
...
1. The [application](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application) folder contains the code for the front-end of the application.

2. The [contracts](https://github.com/thirdweb-example/play-to-earn-game/blob/main/contracts) folder contains our smart contract set up, including our [Mining](https://github.com/thirdweb-example/play-to-earn-game/blob/main/contracts/contracts/Mining.sol) contract. We're using [Hardhat](https://hardhat.ethereum.org/) so that we can write tests or scripts to interact with the smart contracts locally.
...
On the [index.tsx](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/pages/index.tsx) page, we use [useMetamask](https://portal.thirdweb.com/react/react.usemetamask) and [useAddress](https://portal.thirdweb.com/react/react.useaddress) to connect and read to the user's wallet.
...
The logic of the game page is on the [play](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/pages/play.tsx) page.
...
1. [CurrentGear Component](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/CurrentGear.tsx) - Shows the owned character NFT and currently staked pickaxe
2. [Rewards Component](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/Rewards.tsx) - Shows the available rewards in the mining contract, the balance of the connected wallet, and a client-side estimation of the rewards they have earnt since they loaded the page in this session.
3. [OwnedGear Component](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/OwnedGear.tsx) - Shows the owned pickaxes the wallet has and an "Equip" button to stake it.
4. [Shop Component](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/Shop.tsx) - Shows all of the pickaxes in the Pickaxe Edition Drop contract, the price for each, and a "Buy" button to claim it.
...
There is a fun little component within this one caled [ApproxRewards](https://github.com/thirdweb-example/play-to-earn-game/blob/main/application/components/ApproxRewards.tsx) that estimates the rewards that have been earnt during this session. \_It's probably not that accurate, it just looks pretty cool! It:
