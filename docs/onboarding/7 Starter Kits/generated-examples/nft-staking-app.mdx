---
slug: /templates/nft-staking-app-template
hide_title: true
---
...
>
  <DemoButton
    link="https://nft-staking-contract.thirdweb-example.com/"
    name="nft-staking-app"
  />
  <ViewCodeButton
    link="https://github.com/thirdweb-example/nft-staking-app"
    name="nft-staking-app"
  />
</div>
...
- Configure the network you deployed in [`index.js`](https://github.com/thirdweb-example/nft-staking-app/blob/main/src/index.js):
...
The NFT Staking contract in [StakingContract.sol](https://github.com/thirdweb-example/nft-staking-app/blob/main/StakingContract.sol) can be broken down into three parts:
...
On the [mint.tsx](https://github.com/thirdweb-example/nft-staking-app/blob/main/pages/mint.tsx), we connect to our NFT Drop contract using the [useNFTDrop](https://portal.thirdweb.com/react/react.usenftdrop) hook.
