...
Since each pack is an ERC1155 NFT itself, we can use the [useOwnedNFTs](https://portal.thirdweb.com/react/react.useownednfts) hook to view the packs (and quantity) that the user owns:
...
[useMetadata](https://portal.thirdweb.com/react/react.usemetadata) hook (for ERC20 tokens) to get the metadata of the tokens that were opened:

```jsx
// For ERC1155 / ERC721 tokens:
