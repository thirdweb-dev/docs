...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Guide: Create A Token Contract & Mint Supply Using the Web3 SDK"
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Guide: Check Token Balance using the Web3 SDK"
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Using the Token Drop Contract in the Web3 SDK"
      link="/web3-sdk/interacting-with-contracts/token"
