...
The Token Drop contract is a way of releasing your [ERC-20](https://eips.ethereum.org/EIPS/eip-20)
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="/guides/claim-erc20-token-nextjs"
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="/web3-sdk/interacting-with-contracts/token-drop"
      image="/assets/icons/drop.png"
    />
  </div>
</div>
