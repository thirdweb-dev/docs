...
<div className="row" style={{ marginBottom: 24 }}>
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Guide: Create an Early Access NFT Using our Web3 SDK"
      link="/guides/early-access-nft-with-typescript"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Using the Edition Drop Contract in the Web3 SDK"
      link="/web3-sdk/interacting-with-contracts/edition-drop"
      image="/assets/icons/edition-drop.png"
    />
  </div>
</div>
...
<div style={{ width: "fit-content" }}>
  <DeployThisContractButton
    link={"https://thirdweb.com/contracts/new/pre-built/token/edition-drop"}
    contractType="edition-drop"
  />
</div>
