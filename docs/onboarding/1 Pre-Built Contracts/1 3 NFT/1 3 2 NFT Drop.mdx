...
The NFT Drop contract is ideal when you want to release a collection of unique NFTs
using the [ERC721 Standard](https://eips.ethereum.org/EIPS/eip-721).

It allows you to define a set of conditions called **claim phases** in a sequence which defines
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="/guides/create-nft-drop-with-claim-phases"
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="/guides/nft-drop-with-delayed-reveal"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Using the NFT Drop Contract in the Web3 SDK"
      link="/web3-sdk/interacting-with-contracts/nft-drop"
      image="/assets/icons/drop.png"
    />
  </div>
</div>
