...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Guide: Create an NFT Marketplace with the Web3 SDK"
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Guide: List an NFT For Auction and Place a Bid with the Web3 SDK"
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Using the Marketplace Contract in the Web3 SDK"
      link="/web3-sdk/interacting-with-contracts/marketplace"
