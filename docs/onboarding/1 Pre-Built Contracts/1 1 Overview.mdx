...
Each contract makes use of the contract extensions that are available in our [Contracts SDK](/contracts-sdk),
and all come with a standard set of features that enable fine-grained control over the contract's behavior, such as:

- [Contract metadata](/web3-sdk/advanced-features/contract-settings#contract-metadata)
- [Permission controls](/web3-sdk/advanced-features/permission-controls)
- [Royalties and platform fees](/web3-sdk/advanced-features/contract-settings#royalty-fees)
