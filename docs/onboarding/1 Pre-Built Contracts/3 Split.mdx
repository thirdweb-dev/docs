...
To distribute funds recieved on the split contract, navigate to the Balances tab on your contract's [dashboard](/dashboard) and click 'Distribute Funds'.
On this tab you may also verify the recipients and view the balance on your contract.
