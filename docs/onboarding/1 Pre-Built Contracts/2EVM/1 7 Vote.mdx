...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={"https://thirdweb.com/thirdweb.eth/VoteERC20?via=portal"}
    contractType="vote"
  />
</div>
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="https://buildspace.so/builds/dao"
  ...
  <div className="col col--6" style={{ marginTop: 8 }}>
    <QuickstartCard
      ...
      link="https://blog.thirdweb.com/guides/build-treasury-and-governance-for-your-dao"
      image="/assets/icons/education.png"
    />
  </div>
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Using the Vote Contract in the SDK"
      link="/sdk/interacting-with-contracts/vote"
