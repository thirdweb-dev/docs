...
slug: /pre-built-contracts/marketplace-v3
---
...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={"https://thirdweb.com/thirdweb.eth/MarketplaceV3?via=portal"}
...
The Marketplace V3 contract allows users to list NFTs for direct sale or auction, as well as make offers to buy unlisted NFTs. Other users can place offers/bids or buy the NFTs for the specified amount in the listing, or auction. Users can accept offers for their unlisted NFTs.

In addition to Offers, the Marketplace V3 has other new features such as reserve listings for particular buyers, approve multiple currencies as valid payment when buying from your NFT listings, etc.
...
and it's limitations, visit our [Marketplace V3 Design Doc](/contracts/design/MarketplaceV3)!

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Marketplace V3 Smart Contract Design Document"
      link="/contracts/design/MarketplaceV3"
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Using the Marketplace V3 Contract in the SDK"
      link="/sdk/interacting-with-contracts/marketplace-v3"
      image="/assets/icons/marketplace.png"
    />
  </div>
</div>
...
![Create A Listing via Marketplace V3 Dashboard](./assets/new-listing.png)
