...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={"https://thirdweb.com/thirdweb.eth/SignatureDrop?via=portal"}
...
<div className="heroGrid">
  <div>
    <p>
      ...
      standard to release a collection of unique one-of-one NFTs for your community.
    </p>

It also includes [signature-based minting](/sdk/advanced-features/on-demand-minting) capabilities,
which allows you to grant users the ability to mint NFT(s)
based on a custom set of criteria, checked on-demand.

  </div>
  <div className="heroGridImageContainer">
    <YoutubeEmbed link={"https://www.youtube.com/embed/2ITg70MPFJ8"} />
  </div>
</div>

You <b>lazy-mint</b> your NFTs by uploading the metadata and configuring a <b> single </b>claim phase,
laying out the rules for how your users can claim NFTs fromyour drop; such as an allowlist, release date, or<a href="https://portal.thirdweb.com/sdk/advanced-features/delayed-reveal"> delayed reveal</a>.
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Video: Build An ERC721A NFT Drop with signature-based Minting"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Guide: Release An ERC721A NFT Drop Using the Signature Drop Contract"
  ...
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Guide: Simultaneous Allowlists using Signature Drop"
      link="https://blog.thirdweb.com/guides/simultaneous-allowlists/"
      image="/assets/icons/education.png"
    />
  </div>
</div>
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Using the Signature Drop Contract in the SDK"
      link="/sdk/interacting-with-contracts/signature-drop"
      image="/assets/icons/drop.png"
    />
  </div>
</div>
