---
slug: /glossary/proxy-contracts
title: Proxy Contracts
---

A Proxy smart contract contains the [Storage](/storage) for an [upgradable contract](/contracts/Upgradeable) that allows you to modify its logic post-deployment.
