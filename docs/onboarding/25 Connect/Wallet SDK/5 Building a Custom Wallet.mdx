...
3. Integrate with the Connect Wallet button in React/React Native
...
The last step is to integrate it with the [ConnectWallet](/react/react.connectwallet) by creating a wallet configurator - a function that returns a `WalletConfig` object and adding it in [ThirdwebProvider's supportedWallets](/react/react.thirdwebprovider#supportedwallets)
...
Take [embedded wallet](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/embeddedWallet.tsx) for example, It renders an input field where the user can enter their email address.
...
Take [embedded wallet](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/embeddedWallet.tsx) for example, It renders a Input field where the user can enter their email address.
...
- [WalletConnect](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/walletConnect/walletConnect.tsx)
- [Safe](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/safe/safeWallet.tsx)
- [Embedded wallet](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/embeddedWallet/embeddedWallet.tsx)
