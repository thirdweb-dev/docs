...
| [Custom Welcome Screen](/connect/connect-wallet/welcome-screen)        | Customize the welcome screen on wide modal.                        |
| [Custom Button](/connect/connect-wallet/custom-button)                 | Customize the details button.                                      |
