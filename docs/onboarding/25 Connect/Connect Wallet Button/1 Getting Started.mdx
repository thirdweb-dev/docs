...
To get started, let's setup a React Native project with the required dependencies.
...
Specify the network in the `activeChain` prop and specify the wallets to display in the Connect Wallet component by specifying an array to the `ThirdwebProvider` and wrap your application like so:
...
![Connect Wallet Button](../../../unity/assets/connectwallet.png)
