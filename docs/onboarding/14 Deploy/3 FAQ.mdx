...
If the contract has been deployed, but not yet published, you can verify the contract by following our _[How to verify thirdweb prebuilt contracts](https://support.thirdweb.com/other-faqs/tFbbEYCSbJ1GTeXoPs4QFw/how-to-verify-thirdweb-prebuilt-contracts/4VGyYhzjaSJ9JjmVQ6WNL6)_ support article.
