...
### What will happen if thirdweb shuts down? Will developers lose access to their wallets?

If thirdweb shuts down or decides to discontinue the embedded wallet product, we have committed to keeping our embedded wallet service running for a period of 12 months after the announcement. During this period users will be able to access their wallet and export the private key so they can maintain access to it.
