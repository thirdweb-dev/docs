...
let's you read any data from your smart contract.
...
For each of the [extensions](/extensions) you implemented in your smart contract,
you unlock a way to use that in your application.

Let's look at an example. The contract we built implements the [ERC721](/extensions/erc-721/standard)
and [ERC721Supply](/extensions/erc-721/supply) extensions.

By doing so, we can use the [View All](/sdk/interacting-with-contracts/erc721/erc721supply)
...
such as the [Mint](/sdk/interacting-with-contracts/erc721/erc721mintable) feature enabled by
implementing [ERC721Mintable](/extensions/erc-721/mintable#unlocked-features) in our smart contract.
...
Congratulations! We're so excited to see what you build. 🚀 Let us know what you think so far:
