...
Let's look at an example. The contract we built implements the [ERC721](/extensions/erc721)
and [ERC721Supply](/extensions/erc721supply) extensions.
...
implementing [ERC721Mintable](/extensions/erc721mintable#unlocked-features) in our smart contract.
