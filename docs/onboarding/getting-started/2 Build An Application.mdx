...
For each of the [extensions](/contract-kit/features) you implemented in your smart contract,
you unlock a way to use that in your application.

Let's look at an example. The contract we built implements the [ERC721](/contract-kit/erc721)
and [ERC721Supply](/contract-kit/erc721supply) extensions.
...
implementing [ERC721Mintable](/contract-kit/erc721mintable#unlocked-features) in our smart contract.
