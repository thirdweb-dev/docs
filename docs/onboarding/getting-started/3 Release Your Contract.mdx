...
From within the `contracts` folder, run the following command using the [CLI](https://github.com/thirdweb-dev/js/tree/main/packages/cli):
...
- Release date, license, and any [extensions](/contract-kit) you implemented.
