...
- Release date, license, and any [extensions](/contractkit/features) you implemented.
...
<TwitterCard
  text={`I just uploaded my contract to @thirdweb's on-chain smart contract registry 🔥 Check out my contract <share your release url to the world!>`}
/>
