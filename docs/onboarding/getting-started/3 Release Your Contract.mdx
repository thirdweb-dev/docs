...
From within the `contracts` folder, run the following command using the [CLI](https://github.com/thirdweb-dev/thirdweb-cli):
...
- The source code and all functions available in the contract.
- Release date, license, and any [extensions](/extensions) you implemented.
