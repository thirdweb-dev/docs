...
First, we can use the [CLI](https://github.com/thirdweb-dev/js/tree/main/packages/cli) to create a new project with a smart contract inside, and [Extensions](/extensions) installed for us.
