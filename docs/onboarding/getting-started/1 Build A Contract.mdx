...
and [Contract Kit](/contract-kit) installed for us.
...
Next, select the [ERC721 Base](/contract-kit/base-contracts/erc-721/erc721base) contract as our starting point,
which gives us an implementation of the [ERC721A](/contract-kit/erc721) NFT standard that we can modify and extend.
...
If we take a look at the code, you can see that our contract is inheriting the functionality of the [ERC721Base](/contract-kit/base-contracts/erc-721/erc721base),
by:
...
3. Implementing any [required methods](/contract-kit/base-contracts/erc-721/erc721base#implementing-the-contract) such as the `constructor`.
...
Features are a great way to add individual pieces of functionality to your contract, such as [Permissions](/contract-kit/features/permissions).
...
From the dashboard, we can see all of the [Contract Kit](/contract-kit) that our contract implements.
...
As well as tabs for each [extension](/contract-kit) that your contract implements:

- `NFTs`: since you implemented the [ERC721 Standard](/contract-kit/base-contracts/erc-721/erc721base).
- `Permissions`: since you implemented the [Permissions](/contract-kit/permissions#permissions-enumerable-contract) feature.
- `Settings`: since you implemented the [Contract Metadata](/contract-kit/contractmetadata) and [Royalty](/contract-kit/royalty) features.
