...
They are available to use for any smart contract that implements the [Drop Single Phase](/contractkit/extension-contracts/dropsinglephase)
or [Drop Multi Phase](/contractkit/extension-contracts/dropmultiphase) extension smart contracts, which includes our ready-to-deploy smart contracts like the
