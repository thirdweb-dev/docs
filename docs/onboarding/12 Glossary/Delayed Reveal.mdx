...
The owner of the smart contract (or a wallet with the appropriate permissions) can [lazy-mints](/glossary/lazy-mint) a batch of NFTs, along with placeholder metadata and a password.
...
The encrypted URI is stored on-chain, and the password is stored off-chain, only known by the owner.
