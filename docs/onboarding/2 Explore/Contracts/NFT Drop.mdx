...
<div className="deployContractBtnContainer" style={{ marginTop: -70 }}>
  <DeployThisContractButton
    link={"https://thirdweb.com/thirdweb.eth/DropERC721?via=portal"}
...
<div className="heroGrid">
  <div>
    <p>
      ...
      unique NFTs using the <a href="https://www.erc721a.org/">ERC721A</a>{" "}
      standard.
    </p>
...
<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Video: Create an NFT Drop with an Allowlist & Multiple Claim Phases"
      link="https://www.youtube.com/watch?v=Q63o_6RTVzY"
      image="/assets/icons/education.png"
    />
  </div>
  <div className="col col--6" style={{ padding: 8 }}>
    <QuickstartCard
      name="Video: Create an NFT Drop with Delayed Reveal"
      link="https://www.youtube.com/watch?v=NwnkHJ2PgIY"
      image="/assets/icons/education.png"
    />
  </div>
  <div className="col col--6" style={{ padding: 8 }}>
