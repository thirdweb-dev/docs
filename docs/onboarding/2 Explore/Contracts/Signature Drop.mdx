...
It also includes [signature-based minting](/glossary/signature-based-minting) capabilities,
...
laying out the rules for how your users can claim NFTs from your drop; such as an allowlist, release date, or<a href="https://portal.thirdweb.com/glossary/delayed-reveal"> delayed reveal</a>.
