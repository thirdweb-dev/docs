...
| [`generate`](/cli/generate) | Fetch contract ABIs and generate types for the SDK and improve performance.                    |
| [`upload`](/cli/upload)     | Upload any file or directory to decentralized storage (IPFS).                                  |
| [`deploy`](/deploy)         | Deploy your (or your team's) contracts securely to blockchains.                                |
