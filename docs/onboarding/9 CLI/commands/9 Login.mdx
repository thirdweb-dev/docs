...
Authenticate with the thirdweb CLI using your API secret key or replace an existing API secret key. You can find or create your API secret key at the [thirdweb dashboard](https://thirdweb.com/dashboard/settings/api-keys).
...
Note: If you want to login with a different API secret key, you can use the `--new` flag to replace your existing API secret key.
