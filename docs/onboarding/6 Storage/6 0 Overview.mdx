...
Storage provides the tools necessary to easily store and access files using decentralized storage systems like [IPFS](https://ipfs.tech/) ([Arweave](https://www.arweave.org/) and [Filecoin](https://filecoin.io/) are coming soon).
...
Discover what's possible with Storage by checking out the following resources:

<div className="row" style={{ marginBottom: 12 }}>
  <div className="col col--12" style={{ padding: 8 }}>
    <QuickstartCard
      name="Guide: Host Your Web Application On IPFS"
