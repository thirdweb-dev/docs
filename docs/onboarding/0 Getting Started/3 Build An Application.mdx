...
This wrapper allows us to use all of the [React SDK](/react)'s hooks and [UI Components](/ui-components) throughout the application, as well as configure an `activeChain`;
