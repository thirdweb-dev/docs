...
:::warning
Using the SDKs requires an API Key [dashboard](https://thirdweb.com/dashboard).
:::
...
The NFT Collection contract we built earlier implements the [ERC721](/solidity/base-contracts/erc721base)
