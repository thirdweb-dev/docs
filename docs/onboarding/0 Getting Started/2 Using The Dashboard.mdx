...
Each [extension](/solidity/extensions) you implement also unlocks additional features in the dashboard. For example,
...
Since our contract implements the [ERC721](/solidity/interfaces/erc721) standard, we unlock the `NFTs` tab in the dashboard.
...
As our contract also implements the [Permissions](/solidity/extension-contracts/permissions) extension, we unlock the `Permissions` tab in the dashboard.
