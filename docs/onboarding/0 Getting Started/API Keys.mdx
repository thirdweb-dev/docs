...
This is a list of addresses that the Smart Wallet is allowed to send transactions to/interact with. This is useful for e.g. restricting the Smart Wallet to only send transactions to your own contracts.

To restrict the contracts that smart wallet can interact with:
-  Click the edit button 
-  Enter the contract address(s) in the "Allowed Target Addresses" field. 
