...
:::info
Symbol metadata cannot be changed after contract has already been deployed.
:::

### Primary Sales

Primary Sales are revenue recieved on the initial sale of assets. To change the royalty fees, pass in a crypto address into the fields and
click 'Update Primary Sale Settings'. This will prompt a transaction in your wallet.
...
Royalty fees are received on secondary sales of assets. To change the royalty fees, pass in a crypto address and a corresponding percentage into the fields and
...
Platform fees are recieved by a platform. This is often used if you are deploying this contract for a third-party and want to charge fees for services. To change the platform fees, pass in a crypto address and a corresponding percentage into the fields and
