...
:::info
Symbol metadata cannot be modified after the contract hasbeen deployed.
:::

### Primary Sales

Primary Sales are revenue received on the initial sale of assets. To change the royalty fees, pass in an address into the fields and
click 'Update Primary Sale Settings'. This will prompt a transaction in your wallet.
