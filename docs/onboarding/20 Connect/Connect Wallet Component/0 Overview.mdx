...
Build your own wallet connector using the Wallet SDKK and add this wallet to the Connect Wallet component by following [this guide](/connect/build-a-wallet).
