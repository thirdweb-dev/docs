---
slug: /web3-sdk/ui-components/web3button
title: Web3 Button
---
...
1. There is a **connected wallet** (If there is not, renders a [ConnectWalletButton](/web3-sdk/ui-components/connectwalletbutton) component instead).
2. The connected wallet is on the **correct network**
   (as specified in the [ThirdwebProvider](https://portal.thirdweb.com/web3-sdk/set-up-the-sdk/frontend#manual-installation)'s `desiredChainId`).
...
The button has two required props:
