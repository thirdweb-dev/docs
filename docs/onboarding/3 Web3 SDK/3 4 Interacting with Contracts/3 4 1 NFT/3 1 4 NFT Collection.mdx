...
For more advanced use-cases, such as creating a **community-made collection**, you can use [signature-based minting](/web3-sdk/advanced-features/on-demand-minting).
