---
slug: /web3-sdk/interacting-with-contracts/custom-contracts/getting-a-contract
...
When you deploy one of our [pre-built contracts](/pre-built-contracts), or your contract implements a [contract extension](/contracts-sdk),
...
If your contract is a [pre-built](/pre-built-contracts) contract, or implements [contract extensions](/contracts-sdk),
