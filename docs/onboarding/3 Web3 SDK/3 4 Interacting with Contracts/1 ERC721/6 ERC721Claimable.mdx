...
ERC721Claimable is an extension of [ERC721Droppable](/extensions/erc-721/lazy-mint) that allows you to claim lazy minted NFTs

You can utilize these features of the SDK on your contract if it implements [ERC721Claimable](/extensions/erc-721/claim).
