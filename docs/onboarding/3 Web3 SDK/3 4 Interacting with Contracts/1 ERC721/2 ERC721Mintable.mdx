...
You can utilize these features of the SDK on your contract if it implements [ERC721Mintable](/extensions/erc-721/mintable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC721Mintable in your smart contract"
      link={"/extensions/erc-721/mintable"}
