---
slug: /sdk/interacting-with-contracts/erc1155/erc1155signaturemint
...
You can utilize these features of the SDK on your contract if it implements [ERC1155SignatureMint](/extensions/erc-1155/erc1155signaturemint).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC1155SignatureMint in your smart contract"
      link={"/extensions/erc-1155/erc1155signaturemint"}
