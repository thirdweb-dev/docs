...
You can utilise these features of the SDK on your contract if it implements [ERC1155Burnable](/extensions/erc-1155/erc1155burnable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC1155Burnable"
      link={"/extensions/erc-1155/erc1155burnable"}
