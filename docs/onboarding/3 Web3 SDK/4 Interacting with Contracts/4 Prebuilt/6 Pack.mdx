...
<CodeSnippetWithSummary contract={"PackImpl"} name={"royalties"} />
...
<CodeSnippetWithSummary contract={"PackImpl"} name={"airdrop"} />

## View Packs

### One

<CodeSnippetWithSummary contract={"PackImpl"} name={"get"} />

### All

<CodeSnippetWithSummary contract={"PackImpl"} name={"getAll"} />

### Owned by a specific wallet

<CodeSnippetWithSummary contract={"PackImpl"} name={"getOwned"} />

### Amount owned by a specific wallet

<CodeSnippetWithSummary contract={"PackImpl"} name={"balanceOf"} />
...
<CodeSnippetWithSummary contract={"PackImpl"} name={"open"} dontShowSummary />
