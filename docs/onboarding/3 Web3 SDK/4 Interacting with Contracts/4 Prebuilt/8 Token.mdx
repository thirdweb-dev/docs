...
<CodeSnippetWithSummary contract={"TokenImpl"} name={"mintBatchTo"} />
...
<CodeSnippetWithSummary contract={"TokenImpl"} name={"balance"} />

### Balance of a specified wallet

<CodeSnippetWithSummary contract={"TokenImpl"} name={"balanceOf"} />
...
<CodeSnippetWithSummary contract={"TokenImpl"} name={"transferBatch"} />

### Transfer from a specified wallet

<CodeSnippetWithSummary contract={"TokenImpl"} name={"transferFrom"} />
...
<CodeSnippetWithSummary contract={"TokenImpl"} name={"burn"} />
