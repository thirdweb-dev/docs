...
You can utilize these features of the SDK on your contract if it implements [Drop for ERC 1155](/contractkit/extension-contracts/dropsinglephase1155).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement Drop in your ERC 1155 smart contract"
      link={"/contractkit/extension-contracts/dropsinglephase1155"}
