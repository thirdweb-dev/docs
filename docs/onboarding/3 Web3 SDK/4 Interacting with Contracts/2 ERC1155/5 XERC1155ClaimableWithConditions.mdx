...
You can utilize these features of the SDK on your contract if it implements [ERC1155Claimable](/contractkit/erc1155claimable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC1155Claimable in your smart contract"
      link={"/contractkit/erc1155claimablewithconditions"}
