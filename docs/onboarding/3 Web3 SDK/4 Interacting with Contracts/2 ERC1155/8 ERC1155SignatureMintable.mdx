...
You can utilize these features of the SDK on your contract if it implements [ERC1155SignatureMint](/contract-kit/erc1155signaturemintable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC1155SignatureMint in your smart contract"
      link={"/contract-kit/erc1155signaturemintable"}
