...
You can utilise these features of the SDK on your contract if it implements [ERC1155Burnable](/contract-kit/erc1155burnable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC1155Burnable"
      link={"/contract-kit/erc1155burnable"}
