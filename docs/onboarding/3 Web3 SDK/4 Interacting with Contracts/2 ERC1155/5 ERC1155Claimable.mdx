...
You can utilize these features of the SDK if your contract implements the [ERC1155Claimable](/solidity/extensions/erc1155claimable) interface.

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC1155Claimable in your smart contract"
      link={"/solidity/extensions/erc1155claimable"}
