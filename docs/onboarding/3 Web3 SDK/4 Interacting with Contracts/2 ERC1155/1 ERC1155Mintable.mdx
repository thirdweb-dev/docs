...
You can utilize these features of the SDK if your contract implements the [ERC1155Mintable](/contractkit/interfaces/erc1155mintable) interface.

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC1155Mintable in your smart contract"
      link={"/contractkit/interfaces/erc1155mintable"}
