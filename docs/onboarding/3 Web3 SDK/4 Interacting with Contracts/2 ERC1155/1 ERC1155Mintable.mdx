...
You can utilize these features of the SDK on your contract if it implements [ERC1155Mintable](/contractkit/erc1155mintable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC1155Mintable in your smart contract"
      link={"/contractkit/erc1155mintable"}
