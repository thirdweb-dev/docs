...
You can utilize these features of the SDK on your contract if it implements [DelayedReveal](/contractkit/extension-contracts/delayedreveal).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement DelayedReveal in your smart contract"
      link={"/contractkit/extension-contracts/delayedreveal"}
