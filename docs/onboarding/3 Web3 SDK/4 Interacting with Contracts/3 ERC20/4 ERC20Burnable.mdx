...
You can utilize these features of the SDK if your contract implements the [ERC20Burnable](/contractkit/interfaces/erc20burnable) interface.

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC20Burnable in your smart contract"
      link={"/contractkit/interfaces/erc20burnable"}
