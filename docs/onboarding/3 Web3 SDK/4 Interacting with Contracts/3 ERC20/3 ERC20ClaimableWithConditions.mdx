...
You can utilize these features of the SDK on your contract if it implements [ERC20Drop](/contract-kit/erc20claimablewithconditions).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC20Drop in your smart contract"
      link={"/contract-kit/erc20claimablewithconditions"}
