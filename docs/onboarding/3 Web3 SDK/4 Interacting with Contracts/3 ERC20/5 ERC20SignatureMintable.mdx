...
You can utilize these features of the SDK on your contract if it implements [ERC20SignatureMintable](/contract-kit/erc20signaturemintable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC20SignatureMintable"
      link={"/contract-kit/erc20signaturemintable"}
