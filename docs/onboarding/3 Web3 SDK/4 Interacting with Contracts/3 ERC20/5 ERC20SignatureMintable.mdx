...
You can utilize these features of the SDK on your contract if it implements [SignatureMintERC20](/contractkit/extension-contracts/sigminterc20).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement SignatureMintERC20"
      link={"/contractkit/extension-contracts/sigminterc20"}
