...
You can utilize these features of the SDK on your contract if it implements [ERC721ClaimableWithConditions](/extensions/erc721claimable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC721Claimable in your smart contract"
      link={"/extensions/erc721claimablewithconditions"}
