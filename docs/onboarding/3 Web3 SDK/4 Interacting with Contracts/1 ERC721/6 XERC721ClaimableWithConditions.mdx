...
ERC721Claimable is an extension of [ERC721Claimable](/sdk/interacting-with-contracts/erc721claimable) that enables claim conditions.

You can utilize these features of the SDK on your contract if it implements [ERC721ClaimableWithConditions](/contract-kit/erc721claimable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC721Claimable in your smart contract"
      link={"/contract-kit/erc721claimablewithconditions"}
