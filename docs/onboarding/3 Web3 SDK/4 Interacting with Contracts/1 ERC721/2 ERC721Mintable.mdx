...
You can utilize these features of the SDK on your contract if it implements [ERC721Mintable](/contract-kit/erc721mintable).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC721Mintable in your smart contract"
      link={"/contract-kit/erc721mintable"}
