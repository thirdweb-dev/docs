...
You can utilize these features of the SDK on your contract if it implements [SignatureMintERC721](/contractkit/extension-contracts/sigminterc721).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement SignatureMintERC721 in your smart contract"
      link={"/contractkit/erc-721/erc721signaturemint"}
