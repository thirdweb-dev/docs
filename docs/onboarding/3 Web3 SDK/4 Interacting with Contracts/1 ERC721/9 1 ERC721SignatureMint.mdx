...
You can utilize these features of the SDK on your contract if it implements [ERC721SignatureMint](/contract-kit/erc-721/erc721signaturemint).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Learn how to implement ERC721SignatureMint in your smart contract"
      link={"/contract-kit/erc-721/erc721signaturemint"}
