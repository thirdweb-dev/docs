...
- [SignatureDrop](/pre-built-contracts/signature-drop)
...
This will create a Solidity project setup for you to create your contract inside.
...
2. Import one of the `SignatureMint` base contracts and inherit from it. You will need also to pass the information to the constructor:
...
3. You will need to implements the following functions:
