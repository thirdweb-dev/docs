...
| [Signature Drop](/pre-built-contracts/signature-drop) | ERC-721A | ❌              | ✅                  | <DeployThisContractButton link={"https://thirdweb.com/contracts/new/pre-built/drop/signature-drop"} contractType='signature-drop' additionalStyles={{minWidth: 236}} /> |
