...
The easiest way to get started is by using our [CLI](/cli).
...
Next, we'll learn how you can build and release custom smart contracts using the [Contracts SDK](/contracts-sdk).

<div className="row" style={{ marginBottom: 24 }}>
  <div className="col col--12" style={{ marginTop: 8 }}>
    <QuickstartCard
      name="Custom Contracts with the Contracts SDK"
