...
All the individual elements that make up our pre-built contracts are available in [Extensions](/extensions),
...
First, we can use the [CLI](/cli) to create a new project with a smart contract inside, and [Extensions](/extensions) installed for us.
