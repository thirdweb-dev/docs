...
Obtain an API key from the [thirdweb dashboard](https://thirdweb.com/api-keys).
...
Your thirdweb API key can be obtained from the [thirdweb dashboard](https://thirdweb.com/api-keys).
