...
- The contracts that the smart wallet will interact with must be added to the "Allowed Destination Contracts" list. Learn more [here](/api-keys#smart-wallet-allowed-destination-addresses).
:::
