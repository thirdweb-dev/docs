...
#### 1. Deploy a smart wallet factory contract, you can deploy one in 1-click via the [explore page](https://thirdweb.com/explore/smart-wallet)

#### 2. Get an API key, which you can obtain from the [thirdweb dashboard](https://thirdweb.com/dashboard/api-keys)
