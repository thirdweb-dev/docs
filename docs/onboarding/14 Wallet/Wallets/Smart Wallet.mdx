...
Let your users connect to their Smart Wallet - a wallet that is controlled by a smart contract following the [ERC-4337 specification](https://eips.ethereum.org/EIPS/eip-4337).

## Features

Smart Wallets work a little differently than other wallets since it's controlled by a smart contract rather than a regular EOA. This programmable wallet contract can:
...
- And more! Smart Wallets can be customized to each application's needs
...
const config: SmartWalletConfig = {
  ...
  thirdwebApiKey: "your_api_key", // obtained from the thirdweb dashboard
