...
If you call the `connect` method with `email`, a modal will open and prompt the user to check their mail and click on the link sent to their email. Once user completes this step, the modal will close and the user will be connected to your app.
