...
Take [Embedded wallet](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/embedded-wallet.tsx) for example, It renders an input field where the user can enter their email address.
...
Take [Embedded wallet](https://github.com/thirdweb-dev/js/blob/main/packages/react/src/wallet/wallets/embedded-wallet.tsx) for example, It renders a Input field where the user can enter their email address.
