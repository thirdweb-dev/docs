...
The `ERC1155SignatureMint` smart contract adds [Signature-Based Minting](/extensions/erc-1155/signature-mint)
functionality to the the [ERC1155Base](/extensions/base-contracts/erc-1155/erc1155base) contract.
...
<div className="row" style={{ marginBottom: 24, flexWrap: "wrap" }}>
  ...
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Mintable"
      link="/extensions/erc-1155/mintable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
    <QuickstartCard
      name="Batch Mintable"
      link="/extensions/erc-1155/batchmintable#unlocked-features"
      image="/assets/icons/edition.png"
    />
  </div>
  <div className="col col--4" style={{ padding: 8 }}>
