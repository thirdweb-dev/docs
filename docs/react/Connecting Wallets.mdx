...
| Embedded Wallet   | [`paperWallet`](/react/react.paperwallet)       | [`usePaperWallet`](/react/react.usepaperwallet)       | [`PaperWallet`](/wallet/paper)               |
...
If no `supportedWallets` prop is passed, the default wallets are:

- [`metamaskWallet`](/react/react.metamaskWallet)
- [`coinbaseWallet`](/react/react.coinbasewallet)
- [`walletConnect`](/react/react.walletconnect)
- [`trustWallet`](/react/react.trustWallet)
- [`rainbowWallet`](/react/react.rainbowWallet)
- [`zerionWallet`](/react/react.zerion)
- [`phantomWallet`](/react/react.phantom)
