...
| Rainbow Wallet    | [`rainbowWallet`](/react/react.rainbowWallet)   | [`useConnect`](/react/react.useConnect)               | [`WalletConnect`](/wallet/wallet-connect-v2) |
| Zerion Wallet     | [`zerionWallet`](/react/react.zerion)           | [`useConnect`](/react/react.useConnect)               | [`ZerionWallet`](/wallet/zerion-wallet)      |
| Blocto Wallet     | [`bloctoWallet`](/react/react.blocto)           | [`useConnect`](/react/react.useConnect)               | [`BloctoWallet`](/wallet/blocto)             |
| Frame Wallet      | [`frameWallet`](/react/react.frame)             | [`useConnect`](/react/react.useConnect)               | [`FrameWallet`](/wallet/frame)               |
...
If no `supportedWallets` prop is passed, the default is to support [`metamaskWallet`](/react/react.metamaskWallet), [`coinbaseWallet`](/react/react.coinbasewallet).
