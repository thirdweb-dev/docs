...
Connecting to a wallet involves a few steps:
...
If you just want to connect the wallet as mentioned above - there's a simple way to do it using the [useConnect](/react/react.useconnect) hook which does all the above steps for you.
...
Once the wallet is connected, you can use any of 100+ hooks to show connected wallet's details, send transactions, interact with smart contracts, sign messages, etc..

Here is a list of few hooks that will be useful when creating a custom UI:

| Hook                                                    | Description                                       |
| ------------------------------------------------------- | ------------------------------------------------- |
| [useAddress](/react/react.useaddress)                   | getting the currently connected wallet's address. |
| [useDisconnect](/react/react.usedisconnect)             | disconnect wallet                                 |
| [useWallet](/react/react.usewallet)                     | get currently connected wallet instance           |
| [useWalletConfig](/react/react.usewalletconfig)         | get currently connected wallet's config           |
| [useConnectionStatus](/react/react.useconnectionstatus) | get current status of wallet connection           |
| [useSigner](/react/react.useconnectionstatus)           | get signer of connected wallet                    |
