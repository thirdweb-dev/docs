---
slug: /solana/reference/react
title: react-core package
hide_title: true
...
| [useLogin()](./react.uselogin.md)                                              | **<i>(BETA)</i>** Hook to securely login to a backend with the connected wallet. The backend authentication URL must be configured on the ThirdwebProvider. |
...
| [useThirdwebAuthContext()](./react.usethirdwebauthcontext.md)                  |                                                                                                                                                             |
...
| [UserWithData](./react.userwithdata.md)             |                                                                                                                     |

## Variables

| Variable                                                | Description                                                                                                                                                                                      |
| ------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [ThirdwebAuthProvider](./react.thirdwebauthprovider.md) |                                                                                                                                                                                                  |
