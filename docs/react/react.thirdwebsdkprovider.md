...
```typescript
ThirdwebSDKProvider: <TChains extends Chain[] = ({
...
})[]>({ signer, children, queryClient, authConfig, ...restProps }: import("react").PropsWithChildren<ThirdwebSDKProviderProps<TChains>>) => JSX.Element
```
