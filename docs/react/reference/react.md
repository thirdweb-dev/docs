...
| [ThirdwebNftMedia](./react.thirdwebnftmedia.md) | <p>This component can be used to render NFTs from the thirdweb SDK. It will render the animation_url if it exists, otherwise it will render the image. The default size is 300px by 300px, but this can be changed using the <code>width</code> and <code>height</code> props.</p><p>Props: [ThirdwebNftMediaProps](./react.thirdwebnftmediaprops.md)</p>                                                                                                                       |
