...
:::info
This hook is deprecard. Use the [useChain](/react/react.usechain), [useSwitchChain](/react/react.useswitchchain) and [useChainId](/react/react.usechainid) hooks instead.
:::
