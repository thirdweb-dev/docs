...
To load the balance of the native token to your chain, such as Ether on Ethereum, import the `NATIVE_TOKEN_ADDRESS` constant from `@thirdweb-dev/sdk`.
