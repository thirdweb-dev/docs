...
slug: /react/react.useclaimednfts
...
Available to use on contracts that implement [`ERC721Claimable`], such as the
[NFT Drop](https://thirdweb.com/thirdweb.eth/DropERC721) prebuilt contract.
