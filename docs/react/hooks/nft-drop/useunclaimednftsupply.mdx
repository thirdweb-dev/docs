...
Available to use on contracts that implement either the [ERC721LazyMintable](/solidity/extensions/erc721lazymintable)
or [ERC1155LazyMintable](/solidity/extensions/erc1155lazymintable) interfaces;
