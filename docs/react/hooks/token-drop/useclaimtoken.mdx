...
Available to use on smart contracts that implement both the [ERC20](/solidity/extensions/erc20) interface
and the [`claim`](https://docs-k9c04zej3.thirdweb-preview.com/solidity/extensions/erc721claimable) function,
