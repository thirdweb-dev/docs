...
- Listing has not been purchased (all `quantity` of the NFTs have not been purchased)
...
To get a list of all valid direct listings, provide your Marketplace v3 contract instance and an optional filter object.
