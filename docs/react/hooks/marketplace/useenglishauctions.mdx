...
const { data, isLoading, error } = useEnglishAuctions(contract);
```

## Usage

Provide your Marketplace V3 contract instance and an optional filter object.
