...
slug: /react/react.useplatformfees
displayed_sidebar: react
---

Hook for getting the platform fees settings of a contract.

Available to use on contracts that implement the [PlatformFee](/contractkit/extension-contracts/platformfee) interface.
