...
slug: /react/react.useprimarysalerecipient
displayed_sidebar: react
---

Hook for getting the primary sales recipient of a smart contract.

Available to use on contracts that implement the [Primary Sale](/contractkit/extension-contracts/primarysale) interface.
