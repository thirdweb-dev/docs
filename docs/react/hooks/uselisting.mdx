---
title: useListing
slug: /react/react.useListing
displayed_sidebar: react
---

Hook for getting a specific listing from a marketplace contract.
...
use [useDirectListing](/react/hooks/useDirectListing) or [useEnglishAuction](/react/hooks/useEnglishAuction) instead.
