...
Available to use on contracts that implement either the [ERC721](https://portal.thirdweb.com/contractkit/interfaces/erc721)
or [ERC1155](https://portal.thirdweb.com/contractkit/interfaces/erc1155) standard.
