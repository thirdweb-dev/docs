...
:::caution API Key
You will require an API key to use thirdweb’s storage services with the SDK. If you haven’t created a key yet you can do so [**here**](https://thirdweb.com/create-api-key).
