...
Options you provide to the [`ThirdwebProvider`'s walletConnectors](/react/react.thirdwebprovider#walletconnectors)
...
| `btnTitle`    | Optional | Change the text of the button in the disconnected state. Default value is "Connect Wallet". | `string`                                |
