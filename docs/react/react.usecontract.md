...
```typescript
declare function useContract(contractAddress: RequiredParam<string>): {
    contract: undefined;
    data: undefined;
    error: unknown;
    isError: true;
