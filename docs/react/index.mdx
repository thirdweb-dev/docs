...
messages, and utilize common standards such as tokens, NFTs, marketplaces; all with built-in caching, RPC URLs, IPFS gateways, and more.
...
<Tabs>
  <TabItem value="npm" label="npm" default>
    <CodeBlock
      language={"bash"}
    >{`npm i @thirdweb-dev/react@nightly @thirdweb-dev/sdk@nightly ethers^5`}</CodeBlock>
  </TabItem>
  <TabItem value="yarn" label="yarn">
    <CodeBlock
      language={"bash"}
    >{`yarn add @thirdweb-dev/react@nightly @thirdweb-dev/sdk@nightly ethers^5`}</CodeBlock>
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    <CodeBlock
      language={"bash"}
    >{`pnpm i @thirdweb-dev/react@nightly @thirdweb-dev/sdk@nightly ethers^5`}</CodeBlock>
  </TabItem>
</Tabs>
