...
<Tabs>
  <TabItem value="npm" label="npm" default>
    <CodeBlock
      language={"bash"}
    >{`npm i @thirdweb-dev/react @thirdweb-dev/sdk ethers^5`}</CodeBlock>
  </TabItem>
  <TabItem value="yarn" label="yarn">
    <CodeBlock
      language={"bash"}
    >{`yarn add @thirdweb-dev/react @thirdweb-dev/sdk ethers^5`}</CodeBlock>
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    <CodeBlock
      language={"bash"}
    >{`pnpm i @thirdweb-dev/react @thirdweb-dev/sdk ethers^5`}</CodeBlock>
  </TabItem>
</Tabs>
