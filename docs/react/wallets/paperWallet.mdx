...
<details>
  <summary>paperClientId  </summary>
  <div>

Paper SDK requires a paper clientId for instantiation. You can create a paper clientId for your app on [paper.xyz](https://paper.xyz/product/wallet)
