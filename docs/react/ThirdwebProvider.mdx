...
The `clientId` prop is required to use the SDK. You can get a client ID by [creating an API key](/dashboard/settings) through the settings tab in the [Dashboard](https://thirdweb.com/dashboard).
