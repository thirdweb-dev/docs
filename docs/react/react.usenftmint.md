...
```typescript
declare function useNFTMint(contract: RequiredParam<Erc721<any>>, to?: string): react_query.UseMutationResult<_thirdweb_dev_sdk.TransactionResultWithId<_thirdweb_dev_sdk.NFTMetadataOwner>, unknown, string | {
