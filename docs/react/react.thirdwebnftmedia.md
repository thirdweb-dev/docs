...
This component can be used to render NFTs from the thirdweb SDK. It will render the animation\_url if it exists, otherwise it will render the image. The default size is 300px by 300px, but this can be changed using the `width` and `height` props.
