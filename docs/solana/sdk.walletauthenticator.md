---
slug: /sdk.walletauthenticator
title: WalletAuthenticator class
hide_title: true
...
```typescript
export declare class WalletAuthenticator
```
...
| ------------------------------------------------------------------- | --------- | ----------------------------------------------------------------------- |
| [(constructor)(wallet)](./sdk.walletauthenticator._constructor_.md) |           | Constructs a new instance of the <code>WalletAuthenticator</code> class |
...
| [verify(domain, payload)](./sdk.walletauthenticator.verify.md)                                |           | Verify Logged In Address      |
