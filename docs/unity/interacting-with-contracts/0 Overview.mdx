...
1. Generic reading data _from_ and writing transactions _to_ smart contracts using the [`call`](/unity/smartcontract.call) method.
...
| Name            | Description                                                                            | Documentation                             |
| --------------- | -------------------------------------------------------------------------------------- | ----------------------------------------- |
| DirectListings  | List NFTs for sale, allowing other users to make offers or buy them outright           | [DirectListings](/unity/directlistings)   |
| EnglishAuctions | List NFTs for auction, allowing users to bid on them                                   | [EnglishAuctions](/unity/englishauctions) |
| Offers          | Allow users to make offers on any NFT on a smart contract, even if not listed for sale | [Offers](/unity/offers)                   |

#### General Extensions

| Name             | Description                                                                                             | Documentation                               |
| ---------------- | ------------------------------------------------------------------------------------------------------- | ------------------------------------------- |
| ContractMetadata | Get and set metadata about a smart contract                                                             | [ContractMetadata](/unity/contractmetadata) |
| Ownable          | Get and set the owner wallet address of a smart contract                                                | [Ownable](/unity/ownable)                   |
| Gasless          | Enable gasless transactions for functions on a smart contract                                           | [Gasless](/unity/gasless)                   |
| Permissions      | Restrict function execution for users who hold specific roles                                           | [Permissions](/unity/permissions)           |
| PackVRF          | Special functionality for using the [PackVRF contract](https://thirdweb.com/thirdweb.eth/PackVRFDirect) | [PackVRF](/unity/packvrf)                   |
| PlatformFee      | Charge a percentage fee wherever there is a transfer of currency in your contract                       | [PlatformFee](/unity/platformfee)           |
| PluginRouter     | Special functionality for using [dynamic contracts](https://github.com/thirdweb-dev/dynamic-contracts)  | [PluginRouter](/unity/pluginrouter)         |
| PrimarySale      | Configure where/how much funds are sent for sales of tokens in your contract                            | [PrimarySale](/unity/contractprimarysale)   |
| Royalty          | Configure where/how much funds are sent for secondary sales of tokens in your contract                  | [Royalty](/unity/contractroyalty)           |
