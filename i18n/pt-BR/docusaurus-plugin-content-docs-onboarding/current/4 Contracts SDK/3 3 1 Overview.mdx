...
To get started, install the `contracts` package into your Solidity project:
...
By building with our extensions, you:
...
- Unlock the features of [Dashboard](https://thirdweb.com/dashboard) and [SDK](/sdk) on your own smart contracts.
