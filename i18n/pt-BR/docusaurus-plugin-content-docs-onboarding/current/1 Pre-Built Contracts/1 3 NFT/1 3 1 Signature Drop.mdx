...
The Signature Drop contract uses the [ERC721A](https://www.erc721a.org/) standard to
release a collection of unique one-of-one NFTs with lower gas fees for your community
compared to the regular ERC721 standard used in the [NFT Drop](/pre-built-contracts/nft-drop).
...
NFTs from your drop; such as an allowlist, release date, or [delayed reveal](/sdk/advanced-features/delayed-reveal).

The "signature" in the name refers to the [signature-based minting](/sdk/advanced-features/on-demand-minting) feature,
