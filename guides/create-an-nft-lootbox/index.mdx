...
In more detail, we'll bundle up ERC-20, ERC-1155, and ERC-721 tokens into a set of ERC-1155 NFTs using the [Pack](https://portal.thirdweb.com/pre-built-contracts/pack) contract!
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655793382843/umg37wLi-.png)
...
Head to [https://thirdweb.com/contracts/new](https://thirdweb.com/contracts/new), select "Create NFTs and Tokens", and select "Token".

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655688127715/2sUg-4aMM.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655688200341/XnYEirdLO.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655688424324/byuBC2loe.png)

Since we have a total supply of `0.0`, let's mint some tokens now, by clicking the **Mint** button!

I'll mint 100 $GOLD tokens:

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655688463894/j9IPiwvu3.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655688834106/QDkSugnTe.png)

Nice! Now we're ready to mint some NFTs into this collection. Here's how it looks so far:

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655688930210/Z4_fmfexL.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655690187754/Tq5wyKSKl.png)

After I've minted all the NFTs, it looks like this:

![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655699874962/UNn4XZRaE.png)
...
Let's use the `create-tw-app` CLI to create a new Next.js + TypeScript project:
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655705189339/3o39tdHD-.png)
...
![image.png](https://cdn.hashnode.com/res/hashnode/image/upload/v1655734747758/UAqWIuD28.png)
