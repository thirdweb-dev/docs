...
This guide will explore how to set up an NFT drop complete with an allowlist and social connectors courtesy of our friends at **[MintParty](https://about.mintparty.xyz/blog-pages/how-to-guide-mintparty-x-thirdweb-for-launching-your-nft-drop?utm_source=thirdweb&utm_medium=guide&utm_campaign=thirdparty)** during the premint phase. In addition, we’ll leverage thirdweb’s pre-built & audited [**NFT drop**](https://blog.thirdweb.com/guides/create-nft-drop-with-claim-phases) smart-contract to power the blockchain component. Finally, we’ll set up our drop with an allowlist (also known as NFT whitelist), multiple claim phases, AND [delayed reveal](https://blog.thirdweb.com/guides/nft-drop-with-delayed-reveal). EPIC. Let’s dive in!
...
- [Release an NFT drop on your own site without writing any code (Dashboard)](https://blog.thirdweb.com/guides/release-an-nft-drop-with-no-code)
...
- Release & Deploy: upload, display, and deploy custom smart contracts and layer on contract-extensions for unlimited composabability
