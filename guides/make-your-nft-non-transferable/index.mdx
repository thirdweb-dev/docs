...
![Deploy your contract](./contract-creation-settings.png)
...
![Update to non-transferable](./update-non-transferable-permission.png)
...
![Remove permissions](./remove-permissions.png)
