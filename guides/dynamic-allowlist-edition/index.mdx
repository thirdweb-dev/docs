...
- Add MetaMask authentication to the site. You can follow this [guide](https://blog.thirdweb.com/guides/add-connectwallet-to-your-website) to do this
...
In your metamask wallet, click on the three dots, then click account details. You will see an option to export private key there.
...
Using environment variables to store your private key is not secure.
