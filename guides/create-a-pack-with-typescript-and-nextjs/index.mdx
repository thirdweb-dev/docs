...
authors:
  ...
  image_url: https://portal.thirdweb.com/assets/portal/authors/oliver-jumpertz.jpg
...
:::warning Pack is not available on thirdweb v2. This guide is for thirdweb v1. We
will be adding Pack support for v2 soon. :::
...
![thirdweb Packs Project](./thirdweb-dashboard.png)
...
```TypeScript title="components/connect.tsx"
...
```TypeScript title="pages/api/pack.ts"
...
```TypeScript title="components/pack.tsx"
import styles from '../styles/Home.module.css';
