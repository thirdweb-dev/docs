...
You can use any of thirdweb's [NFT Contracts](/pre-built-contracts/nfts) to grant exclusive access to a Discord server or secret channels within a server.
...
2. Select [Edition](/pre-built-contracts/edition) from the pre-built contracts section and click **Deploy now**
...
5. Click **Mint** on the top right corner to mint your [ERC-1155](https://eips.ethereum.org/EIPS/eip-1155) membership NFTs.
