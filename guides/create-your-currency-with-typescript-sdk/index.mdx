...
Create ERC-20 tokens that can be used as your own currency with the thirdweb TypeScript SDK.
...
Now we are ready to deploy our Token, but before we do, let's add some code to mint tokens in our script.

## Minting Tokens

The parameters used here are the same as minting tokens inside the dashboard.
...
Congratulations! You have created your own ERC-20 token!
