...
To deploy one of thirdweb's [Pre-built contracts](https://portal.thirdweb.com/smart-contracts/pre-built-contracts-overview), head to the [dashboard](https://thirdweb.com/dashboard) and connect your wallet.
...
We'll be using the [thirdweb CLI](https://portal.thirdweb.com/thirdweb-deploy/thirdweb-cli) to initialize our application using Next.js and TypeScript.
