...
# How to shuffle your NFT drop without writing any code

Learn how to shuffle your NFT drop without writing any code.
...
We’re going to use Polygon Mumbai Testnet for this guide, therefore, grab some test MATIC for the Mumbai Testnet using our tutorial on [how to get Matic on the Polygon Mumbai Testnet](https://portal.thirdweb.com/guides/get-matic-on-polygon-mumbai-testnet-faucet).

Lastly, you can use the same images I use for this guide: [download the image assets here](https://portal.thirdweb.com/assets/files/random_eyes_assets-3f16a7de2b06549a46ac6844f9a898a8.zip).

Now, let’s head over to the [thirdweb dashboard](https://thirdweb.com/dashboard) and deploy the [NFT Drop pre-built contract](https://portal.thirdweb.com/pre-built-contracts/nft-drop).
...
Let's choose **Reveal upon mint** for this guide, if you prefer [delayed reveal](https://portal.thirdweb.com/guides/nft-drop-with-delayed-reveal) go ahead.
...
- Minting will still follow the order of token ID.
