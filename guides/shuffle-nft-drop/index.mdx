...
Now, let’s head over to the [thirdweb dashboard](https://thirdweb.com/dashboard) and deploy the [NFT Drop prebuilt contract](/pre-built-contracts/nft-drop).

![Deploy NFT drop contract](./deploy-nft-drop-contract.gif)

Next, fill out the metadata for your NFT Drop prebuilt contract.
...
Let’s upload your metadata and image assets to the thirdweb dashboard using the batch upload. Head back to the dashboard and select the NFT Drop prebuilt contract we created and click the batch upload button.
