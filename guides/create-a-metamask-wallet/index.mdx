...
In this guide, we'll create a MetaMask wallet and export the private key.
...
To execute transactions we need ETH to pay for gas, but paying for ETH on mainnet is quite expensive! L
uckily we can make use of so called 'testnets'. Testnets are networks that operate and behave just like the mainnet.
So we can deploy our smart contracts on the testnet and test it before we actually deploy our smart contract.
...
Head over to this [Rinkeby Faucet](https://rinkebyfaucet.com/) and paste your wallet in the input field.
