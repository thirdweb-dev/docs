...
Head over to the [MetaMask Website](https://metamask.io/download.html) and download the browser extension.

![Install MetaMask](./Untitled.png)

After downloading and installing MetaMask, the following screen should pop up.

![Welcome to MetaMask](./Untitled%201.png)
...
![New to Metamask Option select](./Untitled%202.png)

Choose whether you want to share data with MetaMask or not. Up to you...

![Help us improve metamask screen](./Untitled%203.png)
...
![Copy private key](./Untitled%2012.png)

## Getting ETH on Goerli Testnet

To execute transactions we need ETH to pay for gas, but paying for ETH on mainnet is quite expensive! Luckily
we can make use of so-called "testnets". Testnets are networks that operate and behave just like the mainnet.
So we can deploy our smart contracts on the testnet and test them before we deploy our smart contract.

Learn more about testnets on our [Which Blockchain & Network Should I use](https://blog.thirdweb.com/guides/which-network-should-you-use) guide.

We can switch between networks inside our wallet by clicking the current network located at the top:

![MetaMask wallet preview](./Untitled%2013.png)

Head over to this [Goerli Faucet](https://goerlifaucet.com/) and paste your wallet in the input field.
