...
If you want to know more about the token contract, check out our [prebuilt contract page](/pre-built-contracts/token).
...
Check out what else you can do with the token contract on our [prebuilt contract](/pre-built-contracts/token) page.
