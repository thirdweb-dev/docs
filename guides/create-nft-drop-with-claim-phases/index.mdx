...
# Release an NFT Drop with an allowlist and multiple claim phases

Learn how to create an NFT Drop with claim phases using the thirdweb dashboard
...
This guide assumes you have created an NFT Drop or Edition Drop on thirdweb and now need to set up claim settings. If you need a refresher on how to do so, check out our [NFT Drop with Delayed Reveal Guide](https://blog.thirdweb.com/guides/nft-drop-with-delayed-reveal).

After creating our NFT Drop or Edition Drop contract, let’s navigate to the Claim Phases tab.

![Claim phases tab](./0.png)
...
!["When will this phase start?" field](./1.png)
...
!["How many NFTs will you drop in this phase?" field](./2.png)
...
![Setting up the prices field](./3.png)
...
![Upload Snapshot Drag & Drop screen](./4.png)
...
![Snapshot edited on Google Sheets](./5.png)
...
![Setting limits on "How many NFTs can be claimed per transaction?"](./7.png)
...
![Second claim phase with fields populated](./8.png)
