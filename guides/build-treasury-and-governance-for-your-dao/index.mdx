...
Create a `vote.js` file, and make sure you [initialize the SDK](/getting-started/writing-data-to-smart-contracts) before you copy and paste the code.
...
Then, create a `treasury.js` file, and make sure the SDK is initialized before you try to use it.
...
Create a `proposals.js` file, and make sure the SDK is initialized before you try to use it.
