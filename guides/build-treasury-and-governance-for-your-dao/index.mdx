...
Learn how to use the [vote contract](/pre-built-contracts/vote), how to set up governance and create proposals.
...
First, we'll need to setup our local environment and instantiate the SDK.
...
Copy that **Vote** contract address, we are gonna need it! If you lose it, you can always get it from your [thirdweb dashboard](https://thirdweb.com/dashboard).
