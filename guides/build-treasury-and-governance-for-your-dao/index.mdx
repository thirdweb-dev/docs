...
As a pre-requisite, we need a **governance token** so users can vote on proposals. If you haven't deployed a token yet, you can follow [this guide](https://blog.thirdweb.com/guides/create-your-currency-with-typescript-sdk).
