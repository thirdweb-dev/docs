...
# Sell your NFT in multiple currencies

Learn how to make an ERC-1155 drop where users can pay with multiple currencies using signature minting, Next.js, and thirdweb
