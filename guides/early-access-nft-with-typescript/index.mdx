...
Our first step is to create an edition drop. This can be done in the [dashboard](https://thirdweb.com/dashboard) and if you aren't sure how to
create the contract please check [this guide.](/guides/create-nft-with-no-code)

### 2. Project Set-Up

Create a new React project with TypeScript by running:

```bash
npx create-tw-app --cra --ts
```

### 3. Instantiate the SDK

To create, configure and interact with our NFTs we will need to use the thirdweb SDK.
...
const editionDropAddress = "0x9cDeCE83f2dE927d9CbE258a9e7A836216b2e9fe";
...
In your root directory, run the code with this command in your console: `node ./scripts/createNft.mjs`
...
For our project, we are only going to set the start time, price, and supply. We can do this in a new file called `nftConfig.mjs`. Start by importing our module and the necessary library.
...
In your root directory, run the code with this command in your console: `node scripts/nftConfig.mjs`
