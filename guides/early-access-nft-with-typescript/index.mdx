...
authors:
  - name: Mordi Goldstein
    ...
    image_url: https://portal.thirdweb.com/assets/portal/authors/mordi.jpg
draft: false
tags: [edition-drop, typescript, react, v2]
description: "Easily create an early access NFT and a frontend for users to claim the NFT"
