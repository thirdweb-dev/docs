...
For this guide, we’ll assume you know how to set up the rest of your NFT Drop. For more information on how to complete your NFT drop, check out [this](/guides/release-an-nft-drop-with-no-code) guide.
