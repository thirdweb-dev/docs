...
Learn more about how to use test networks to create contracts on test networks for free in our [Which Blockchain & Network Should I Use Guide](https://blog.thirdweb.com/guides/which-network-should-you-use).
...
For this guide we'll choose "**Reveal upon mint**". If you are intestered in delayed reveal, check out this guide [here](https://blog.thirdweb.com/guides/nft-drop-with-delayed-reveal).
