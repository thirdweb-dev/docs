...
If you don't have any NFTs minted, check out our guide on [Minting an NFT Collection using TypeScript](https://blog.thirdweb.com/guides/mint-nft-collection-using-typescript-sdk).
...
To create a listing from your wallet, you'll first need to export your wallet's private key.
