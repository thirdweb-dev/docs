...
![New NFT Collection contract viewed in the thirdweb dashboard](./nft-collection-contract-dashboard-view.png)
...
![See NFT Collection contract address under contract name](./nft-collection-contract-dashboard-view.png)
