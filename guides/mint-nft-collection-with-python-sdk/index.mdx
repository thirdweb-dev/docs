...
You'll need to connect your wallet, so if you don't have a wallet, check out our guide on how to [Create a MetaMask wallet](/guides/create-a-metamask-wallet)
...
Next up use the following code in your terminal to install the ThirdWeb SDK!
