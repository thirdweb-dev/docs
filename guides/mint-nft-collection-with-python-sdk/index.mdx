...
You'll need to connect your wallet, so if you don't have a one, check out our guide on how to [Create a MetaMask wallet](https://blog.thirdweb.com/guides/create-a-metamask-wallet).
