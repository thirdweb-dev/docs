...
In this case, you can use thirdweb's [React](/react) and [TypeScript](/typescript) SDKs to help build out your application.
...
To connect to a user's wallet, you can use one of our [wallet connection hooks](https://portal.thirdweb.com/react/category/wallet-connection).

Then, connect to your smart contract with one of our [contract hooks](https://portal.thirdweb.com/react/category/contracts) and start interacting with it.
